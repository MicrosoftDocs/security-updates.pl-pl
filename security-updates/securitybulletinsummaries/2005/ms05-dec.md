---
TOCTitle: 'MS05-DEC'
Title: Microsoft Security Bulletin Summary for grudzień 2005
ms:assetid: 'ms05-dec'
ms:contentKeyID: 61233052
...
| **Streszczenie**                      | W jądrze systemu Windows istnieją usterki, które umożliwiają podniesienie uprawnień w systemie podlegającym tym usterkom. Osoba atakująca musi dysponować prawidłowymi poświadczeniami logowania oraz być w stanie zalogować się lokalnie, aby wykorzystać możliwości stwarzane przez usterkę. |
...
<td style="border:1px solid black;"><strong>[1]</strong></td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3832ff23-6b04-4ca2-80b9-d344b4cc98ea&amp;displaylang=pl">Ważny</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4005b74a-d6e6-4a32-a3b1-276686b4a428&amp;displaylang=pl">Krytyczny</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a8443cd2-d98d-427b-9f0e-bd7e19fcb994&amp;displaylang=pl">Krytyczny</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Internet Explorer 6 dla systemu Windows XP z dodatkiem Service Pack 2</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e4b5ba57-d4f2-4798-9154-2869e371c9d1&amp;displaylang=pl">Krytyczny</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9d70fb20-c7c9-43af-a864-6dbc9a542cc6&amp;displaylang=pl">Średni</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Internet Explorer 5.5 z dodatkiem Service Pack 2 w systemie Microsoft Windows Millennium Edition</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1ee790b9-e596-4344-aec3-fcb3289d7e9c">Średni (j.ang.)</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Internet Explorer 6 dla systemu Microsoft Windows XP Professional x64 Edition</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e1652b4a-6339-4b31-8acf-d2a844c24f70">Krytyczny (j.ang.)</a></td>
<td style="border:1px solid black;"></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Internet Explorer 6 dla systemu Windows Server 2003 x64 Edition</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8e9c23e5-7988-42da-a8bd-2c1a534bf995">Średni (j.ang.)</a></td>
<td style="border:1px solid black;"></td>
</tr>
</tbody>
</table>
...
**<sup>[2]</sup>** W konfiguracji domyślnej ten system operacyjny nie jest zagrożony problemem. System może być zagrożony, jeśli zainstalowane zostaną w nim inne programy lub składniki systemu. Więcej szczegółów znajduje się w odpowiednim biuletynie zabezpieczeń.
  
**<sup>[3]</sup>** Aktualizacje zabezpieczeń dla systemów Microsoft Windows Server 2003 z dodatkiem Service Pack 1 i Microsoft Windows Server 2003 x64 Edition mają również zastosowanie do systemu Microsoft Windows Server 2003 R2.
...
-   Andreasowi Sandblad i Jakobowi Balle z firmy [Secunia (j.ang.)](http://www.secunia.com/) za zgłoszenie problemu opisanego w biuletynie [MS05-054](http://technet.microsoft.com/security/bulletin/ms05-054).  
-   Willowi Dormannowi z [CERT/CC (j.ang.)](http://www.cert.org/) za zgłoszenie kilku identyfikatorów klasy udokumentowanych w biuletynie zabezpieczeń [MS05-054](http://technet.microsoft.com/security/bulletin/ms05-054).  
-   Firmie [eEye Digital Security (j.ang.)](http://eeye.com) za zgłoszenie usterki opisanej w biuletynie [MS05-055](http://technet.microsoft.com/security/bulletin/ms05-055)
