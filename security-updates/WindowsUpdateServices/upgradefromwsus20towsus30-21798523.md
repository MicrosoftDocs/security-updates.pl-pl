...
ms:contentKeyID: 21798523
ms:mtpsurl: 'https://technet.microsoft.com/pl-pl/library/Dd939791(v=WS.10)'
---
...
<thead>
<tr class="header">
<th style="border:1px solid black;" ><img src="images/Dd939791.note(WS.10).gif" />Uwaga</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
The WSUS Operations Guide, available at [http://go.microsoft.com/fwlink/?LinkId=139838](http://go.microsoft.com/fwlink/?linkid=139838), includes other types of migration documentation, such as migrating from Wewnętrzna baza danych systemu Windows to Microsoft SQL Server.
