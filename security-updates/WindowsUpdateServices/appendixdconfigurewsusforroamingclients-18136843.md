...
ms:contentKeyID: 18136843
ms:mtpsurl: 'https://technet.microsoft.com/pl-pl/library/Cc708563(v=WS.10)'
---
...
| ![](images/Cc708563.Important(WS.10).gif)Ważne |
|-----------------------------------------------------------------------------|
...
| ![](images/Cc708563.note(WS.10).gif)Uwaga                                                                                                                                                                                                                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
