...
ms:contentKeyID: 18136882
ms:mtpsurl: 'https://technet.microsoft.com/pl-pl/library/Cc708595(v=WS.10)'
---
...
| ![](images/Cc708595.note(WS.10).gif)Uwaga                                                                                |
|-------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc708595.Important(WS.10).gif)Ważne       |
|-----------------------------------------------------------------------------------|
