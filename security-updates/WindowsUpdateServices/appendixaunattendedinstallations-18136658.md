...
ms:contentKeyID: 18136658
ms:mtpsurl: 'https://technet.microsoft.com/pl-pl/library/Cc708476(v=WS.10)'
---
...
<td style="border:1px solid black;">Uninstall the product. Also uninstalls the Wewnętrzna baza danych systemu Windows instance if it is installed.</td>
</tr>
<tr class="odd">
