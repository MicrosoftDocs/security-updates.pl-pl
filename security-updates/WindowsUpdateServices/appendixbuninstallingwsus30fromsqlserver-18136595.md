...
ms:contentKeyID: 18136595
ms:mtpsurl: 'https://technet.microsoft.com/pl-pl/library/Cc720540(v=WS.10)'
---
...
For information about how to manually remove Network Service or ASP.NET accounts from a computer running SQL Server 2005 or Wewnętrzna baza danych systemu Windows, see SQL Server product documentation. You can download product documentation for SQL Server at [SQL Server Books Online](http://go.microsoft.com/fwlink/?linkid=81092) (http://go.microsoft.com/fwlink/?LinkId=81092).
