...
ms:contentKeyID: 18136506
ms:mtpsurl: 'https://technet.microsoft.com/pl-pl/library/Cc720448(v=WS.10)'
---
...
| ![](images/Cc720448.note(WS.10).gif)Uwaga                                          |
|-----------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720448.Important(WS.10).gif)Ważne                                                                                                                                                                                                                                                                                                                                               |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
