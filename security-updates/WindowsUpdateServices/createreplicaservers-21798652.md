...
ms:contentKeyID: 21798652
ms:mtpsurl: 'https://technet.microsoft.com/pl-pl/library/Dd939885(v=WS.10)'
---
...
> [!note]  
> During the client scan, if the server detects the client changed group membership (or name, or IP address, or operating system version), it marks the client as needing a full rollup. The downstream server will roll up these changes to the upstream server during the next rollup after client scan.</table>
