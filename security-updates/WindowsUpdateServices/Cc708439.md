...
ms:contentKeyID: 18136604
ms:mtpsurl: 'https://technet.microsoft.com/pl-pl/library/Cc708439(v=WS.10)'
---
...
-   **MSSQLSERVER** (if you are using Wewnętrzna baza danych systemu Windows, or if you are using SQL Server and are using the default instance name for the instance name).
