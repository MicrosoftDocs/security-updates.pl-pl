---
TOCTitle: 'MS09-019'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-019 - Krytyczna'
ms:assetid: 'ms09-019'
ms:contentKeyID: 61232738
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-019(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS09-019 - Krytyczna
==========================================================

Zbiorcza aktualizacja zabezpieczeń dla programu Internet Explorer (969897)
--------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla programu Internet Explorer 5.01 i wskaźnik ważności „ważny” dla programu Internet Explorer 6 z dodatkiem Service Pack 1 w obsługiwanych wersjach systemu Microsoft Windows 2000, wskaźnik ważności „krytyczny” dla programu Internet Explorer 6, Internet Explorer 7 i Internet Explorer 8 w obsługiwanych wersjach systemów Windows XP i Windows Vista oraz wskaźnik ważności „umiarkowany” dla programu Internet Explorer 6, Internet Explorer 7 i Internet Explorer 8 w obsługiwanych wersjach systemów Windows Server 2003 i Windows Server 2008. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń eliminuje luki w zabezpieczeniach poprzez zmianę sposobu, w jaki program Internet Explorer obsługuje skrypty i buforowaną zawartość oraz inicjalizuje pamięć. Więcej informacji na temat luk można znaleźć w podsekcji „Często zadawane pytania” w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** [W artykule 969897 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/969897) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
<td style="border:1px solid black;">
[Brak](http://go.microsoft.com/fwlink/?linkid=146659)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Szczegółowe informacje dotyczące plików znajdują się w [artykule 969897 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/969897).
...
<th>
Luka w zabezpieczeniach międzydomenowych związana z sytuacją wyścigu i umożliwiająca ujawnienie informacji — CVE-2007-3091
</th>
<th>
Luka w zabezpieczeniach międzydomenowych umożliwiająca ujawnienie informacji — CVE-2009-1140
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektu DHTML — CVE-2009-1141
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektu HTML — CVE-2009-1528
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem niezainicjowanej pamięci — CVE-2009-1529
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2009-1530
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2009-1531
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2009-1532
</th>
<th>
Zbiorczy wskaźnik ważności
</th>
...
<span></span>
W programie Internet Explorer istnieje luka umożliwiająca ujawnienie informacji, która może pozwolić na uzyskanie przez skrypt dostępu do zawartości w innym oknie przeglądarki sieci Web w innej domenie lub strefie programu Internet Explorer. Osoba atakująca może wykorzystać tę lukę, tworząc specjalnie przygotowaną stronę sieci Web umożliwiającą ujawnienie informacji dotyczących użytkownika, który odwiedzi tę stronę sieci Web. Osoba atakująca, której uda się wykorzystać tę lukę w zabezpieczeniach, może wyświetlić dane ze strony sieci Web znajdującej się w innej domenie programu Internet Explorer.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2007-3091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach międzydomenowych związanej z sytuacją wyścigu i umożliwiającej ujawnienie informacji — CVE-2007-3091
...
#### Obejścia dotyczące luki w zabezpieczeniach międzydomenowych związanej z sytuacją wyścigu i umożliwiającej ujawnienie informacji — CVE-2007-3091
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach międzydomenowych związanej z sytuacją wyścigu i umożliwiającej ujawnienie informacji — CVE-2007-3091

**Jaki zakres obejmuje ta luka?**  
Ta luka może doprowadzić do ujawnienia informacji. Osoba atakująca, która pomyślnie wykorzysta tę lukę, gdy użytkownik wyświetli stronę sieci Web, może wyświetlić w innym oknie przeglądarki sieci Web zawartość z domeny lub strefy programu Internet Explorer innej niż domena lub strefa osoby atakującej.

**W jaki sposób powstaje luka?**  
Skrypt może spowodować powstanie sytuacji wyścigu, która może złamać zasadę tożsamego pochodzenia programu Internet Explorer i spowodować odczytanie zawartości z innych domen.

**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**  
Osoba atakująca może wyświetlić w innym oknie przeglądarki sieci Web zawartość w domenie lub strefie programu Internet Explorer innej niż domena lub strefa tej osoby.
...
Aktualizacja zmienia sposób, w jaki program Internet Explorer rozpoznaje domenę wykonanego skryptu, wprowadzając ograniczenie możliwości wykonywania go do kontekstu jego oryginalnej domeny.

**Czy luka ta była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**  
Tak. Informacje o tej luce są znane publicznie. Do luki został przypisany numer w bazie danych znanych luk i zagrożeń [CVE-2007-3091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091).
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1140](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1140).

#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach międzydomenowych umożliwiającej ujawnienie informacji — CVE-2009-1140
...
-   Skutki istnienia luki można ograniczyć poprzez korzystanie z programu Windows Internet Explorer 7 w systemie Windows Vista lub Windows Server 2008.

#### Obejścia dotyczące luki w zabezpieczeniach międzydomenowych umożliwiającej ujawnienie informacji — CVE-2009-1140
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach międzydomenowych umożliwiającej ujawnienie informacji — CVE-2009-1140
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1141](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1141).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu DHTML — CVE-2009-1141
...
-   Domyślnie we wszystkich obsługiwanych wersjach programów Microsoft Outlook i Microsoft Outlook Express wiadomości e-mail w formacie HTML są domyślnie otwierane w strefie witryn z ograniczeniami. Strefa Witryny z ograniczeniami umożliwia ograniczenie liczby ataków osób usiłujących wykorzystać tę lukę, zapobiegając wykonywaniu aktywnych skryptów i wykorzystywaniu formantów ActiveX do odczytywania wiadomości e-mail w formacie HTML. Jeśli jednak użytkownik kliknie łącze znajdujące się w wiadomości e-mail, może być nadal zagrożony wykorzystaniem tej luki poprzez atak za pośrednictwem sieci Web.
-   Domyślnie program Internet Explorer w systemach Windows Server 2003 i Windows Server 2008 jest uruchamiany w trybie chronionym określanym jako [Konfiguracja zwiększonych zabezpieczeń](http://go.microsoft.com/fwlink/?linkid=92039). W tym trybie poziom zabezpieczeń strefy Internet jest Wysoki. Jest to czynnik ograniczający zagrożenie w przypadku witryn sieci Web, których nie dodano do strefy witryn zaufanych programu Internet Explorer. Dodatkowe informacje na temat konfiguracji zwiększonych zabezpieczeń programu Internet Explorer można znaleźć w sekcji często zadawanych pytań na temat tej luki.
-   Omawiana luka nie dotyczy programów Microsoft Internet Explorer 5.01 z dodatkiem Service Pack 4 i Microsoft Internet Explorer 6 z dodatkiem Service Pack 1 w systemach Microsoft Windows 2000, Windows Internet Explorer 7 oraz Windows Internet Explorer 8.

#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu DHTML — CVE-2009-1141
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu DHTML — CVE-2009-1141
...
**W jaki sposób powstaje luka?**  
Podczas wyświetlania przez program Internet Explorer strony sieci Web, która zawiera nieoczekiwane wywołania metody do obiektów HTML, może dojść do uszkodzenia pamięci systemowej w sposób umożliwiający osobie atakującej wykonanie dowolnego kodu.
...
**Co to jest DHTML?**
DHTML (Dynamic HTML) to zestaw funkcji wprowadzony przez firmę Microsoft po raz pierwszy w programie Internet Explorer 4.0, który umożliwia autorom stron sieci Web dynamiczne zmiany ich renderowania i zawartości w reakcji na działania użytkownika. Więcej informacji można znaleźć w artykule MSDN [Obiekty DHTML](http://msdn.microsoft.com/en-us/library/ms533054(vs.85).aspx) (j. ang.)
...
**W jaki sposób działa aktualizacja?**  
Aktualizacja zmienia sposób, w jaki program Internet Explorer obsługuje obiekty DHTML.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1528](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1528).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML — CVE-2009-1528
...
-   Domyślnie we wszystkich obsługiwanych wersjach programów Microsoft Outlook i Microsoft Outlook Express wiadomości e-mail w formacie HTML są domyślnie otwierane w strefie witryn z ograniczeniami. Strefa Witryny z ograniczeniami umożliwia ograniczenie liczby ataków osób usiłujących wykorzystać tę lukę, zapobiegając wykonywaniu aktywnych skryptów i wykorzystywaniu formantów ActiveX do odczytywania wiadomości e-mail w formacie HTML. Jeśli jednak użytkownik kliknie łącze znajdujące się w wiadomości e-mail, może być nadal zagrożony wykorzystaniem tej luki poprzez atak za pośrednictwem sieci Web.
-   Domyślnie program Internet Explorer w systemach Windows Server 2003 i Windows Server 2008 jest uruchamiany w trybie chronionym określanym jako [Konfiguracja zwiększonych zabezpieczeń](http://go.microsoft.com/fwlink/?linkid=92039). W tym trybie poziom zabezpieczeń strefy Internet jest Wysoki. Jest to czynnik ograniczający zagrożenie w przypadku witryn sieci Web, których nie dodano do strefy witryn zaufanych programu Internet Explorer. Dodatkowe informacje na temat konfiguracji zwiększonych zabezpieczeń programu Internet Explorer można znaleźć w sekcji często zadawanych pytań na temat tej luki.
-   Omawiana luka nie dotyczy programów Microsoft Internet Explorer 5.01 z dodatkiem Service Pack 4 i Microsoft Internet Explorer 6.0 z dodatkiem Service Pack 1 w systemie Microsoft Windows 2000 oraz programu Windows Internet Explorer 8.

#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML — CVE-2009-1528
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML — CVE-2009-1528
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1529).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci — CVE-2009-1529
...
-   Domyślnie we wszystkich obsługiwanych wersjach programów Microsoft Outlook i Microsoft Outlook Express wiadomości e-mail w formacie HTML są domyślnie otwierane w strefie witryn z ograniczeniami. Strefa Witryny z ograniczeniami umożliwia ograniczenie liczby ataków osób usiłujących wykorzystać tę lukę, zapobiegając wykonywaniu aktywnych skryptów i wykorzystywaniu formantów ActiveX do odczytywania wiadomości e-mail w formacie HTML. Jeśli jednak użytkownik kliknie łącze znajdujące się w wiadomości e-mail, może być nadal zagrożony wykorzystaniem tej luki poprzez atak za pośrednictwem sieci Web.
-   Domyślnie program Internet Explorer w systemach Windows Server 2003 i Windows Server 2008 jest uruchamiany w trybie chronionym określanym jako [Konfiguracja zwiększonych zabezpieczeń](http://go.microsoft.com/fwlink/?linkid=92039). W tym trybie poziom zabezpieczeń strefy Internet jest Wysoki. Jest to czynnik ograniczający zagrożenie w przypadku witryn sieci Web, których nie dodano do strefy witryn zaufanych programu Internet Explorer. Dodatkowe informacje na temat konfiguracji zwiększonych zabezpieczeń programu Internet Explorer można znaleźć w sekcji często zadawanych pytań na temat tej luki.
-   Omawiana luka nie dotyczy programów Microsoft Internet Explorer 5.01 z dodatkiem Service Pack 4 i Microsoft Internet Explorer 6.0 z dodatkiem Service Pack 1 w systemie Microsoft Windows 2000, programu Microsoft Internet Explorer 6.0 i programu Windows Internet Explorer 8.

#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z uszkodzeniem niezainicjowanej pamięci — CVE-2009-1529
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci — CVE-2009-1529
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1530).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML — CVE-2009-1530
...
-   Domyślnie we wszystkich obsługiwanych wersjach programów Microsoft Outlook i Microsoft Outlook Express wiadomości e-mail w formacie HTML są domyślnie otwierane w strefie witryn z ograniczeniami. Strefa Witryny z ograniczeniami umożliwia ograniczenie liczby ataków osób usiłujących wykorzystać tę lukę, zapobiegając wykonywaniu aktywnych skryptów i wykorzystywaniu formantów ActiveX do odczytywania wiadomości e-mail w formacie HTML. Jeśli jednak użytkownik kliknie łącze znajdujące się w wiadomości e-mail, może być nadal zagrożony wykorzystaniem tej luki poprzez atak za pośrednictwem sieci Web.
-   Domyślnie program Internet Explorer w systemach Windows Server 2003 i Windows Server 2008 jest uruchamiany w trybie chronionym określanym jako [Konfiguracja zwiększonych zabezpieczeń](http://go.microsoft.com/fwlink/?linkid=92039). W tym trybie poziom zabezpieczeń strefy Internet jest Wysoki. Jest to czynnik ograniczający zagrożenie w przypadku witryn sieci Web, których nie dodano do strefy witryn zaufanych programu Internet Explorer. Dodatkowe informacje na temat konfiguracji zwiększonych zabezpieczeń programu Internet Explorer można znaleźć w sekcji często zadawanych pytań na temat tej luki.
-   Omawiana luka nie dotyczy programów Microsoft Internet Explorer 5.01 z dodatkiem Service Pack 4, Microsoft Internet Explorer 6.0, Microsoft Internet Explorer 6.0 z dodatkiem Service Pack 1 i Windows Internet Explorer 8.

#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML — CVE-2009-1530
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML – CVE-2009-1530

**Jaki zakres obejmuje ta luka?**  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak zalogowany użytkownik. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

**W jaki sposób powstaje luka?**  
Kiedy program Internet Explorer w pewnych okolicznościach próbuje uzyskać dostęp do niezainicjowanej pamięci, może uszkodzić pamięć w sposób umożliwiający osobie atakującej wykonanie dowolnego kodu.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1531](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1531).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML — CVE-2009-1531
...
#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML — CVE-2009-1531
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML — CVE-2009-1531
...
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektu HTML — CVE-2009-1532
------------------------------------------------------------------------------------

<span></span>
W sposobie uzyskiwania przez program Internet Explorer dostępu do obiektu, który nie został prawidłowo zainicjowany lub został usunięty, istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu. Osoba atakująca może wykorzystać tę lukę poprzez utworzenie specjalnie spreparowanej strony sieci Web. Gdy użytkownik odwiedza taką stronę sieci Web, luka w zabezpieczeniach może pozwolić na zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak zalogowany użytkownik. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzysta tę lukę, może uzyskać pełną kontrolę nad systemem, którego ta luka dotyczy. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1532](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1532).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML — CVE-2009-1532
...
-   Domyślnie we wszystkich obsługiwanych wersjach programów Microsoft Outlook i Microsoft Outlook Express wiadomości e-mail w formacie HTML są domyślnie otwierane w strefie witryn z ograniczeniami. Strefa Witryny z ograniczeniami umożliwia ograniczenie liczby ataków osób usiłujących wykorzystać tę lukę, zapobiegając wykonywaniu aktywnych skryptów i wykorzystywaniu formantów ActiveX do odczytywania wiadomości e-mail w formacie HTML. Jeśli jednak użytkownik kliknie łącze znajdujące się w wiadomości e-mail, może być nadal zagrożony wykorzystaniem tej luki poprzez atak za pośrednictwem sieci Web.
-   Domyślnie program Internet Explorer w systemach Windows Server 2003 i Windows Server 2008 jest uruchamiany w trybie chronionym określanym jako [Konfiguracja zwiększonych zabezpieczeń](http://go.microsoft.com/fwlink/?linkid=92039). W tym trybie poziom zabezpieczeń strefy Internet jest Wysoki. Jest to czynnik ograniczający zagrożenie w przypadku witryn sieci Web, których nie dodano do strefy witryn zaufanych programu Internet Explorer. Dodatkowe informacje na temat konfiguracji zwiększonych zabezpieczeń programu Internet Explorer można znaleźć w sekcji często zadawanych pytań na temat tej luki.
-   Omawiana luka nie dotyczy programów Microsoft Internet Explorer 5.01 z dodatkiem Service Pack 4, Microsoft Internet Explorer 6.0, Microsoft Internet Explorer 6.0 z dodatkiem Service Pack 1 i Windows Internet Explorer 7.

#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML — CVE-2009-1532
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML — CVE-2009-1532
...
<td style="border:1px solid black;">Internet Explorer 5.01 z dodatkiem Service Pack 4 we wszystkich obsługiwanych wersjach systemu Windows 2000:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB969897-IE501SP4- 20090522.120000$\Spuninst<br />
<br />
Internet Explorer 6 z dodatkiem Service Pack 1 zainstalowany we wszystkich obsługiwanych wersjach systemu Windows 2000:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB969897-IE6SP1-20090501.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/969897">artykuł 969897 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 dla wszystkich obsługiwanych wersji systemu Windows XP:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB969897$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 dla wszystkich obsługiwanych wersji systemu Windows XP:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\ie7updates\KB969897-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 dla wszystkich obsługiwanych wersji systemu Windows XP:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\ie8updates\KB969897-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/969897">artykuł 969897 bazy wiedzy Microsoft Knowledge Base</a>.</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 dla wszystkich obsługiwanych wersji 32-bitowych i wersji x64 systemu Windows Server 2003:
KB969897-IE8.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Dodatkowe informacje</td>
...
-   David Bloom z firmy [Google Inc.](http://www.google.com/), za współpracę przy usuwaniu luki w zabezpieczeniach międzydomenowych związanej z sytuacją wyścigu i umożliwiającej ujawnienie informacji (CVE-2007-3091)  
-   Jorge Luis Alvarez Medina z firmy [Core Security Technologies](http://www.coresecurity.com/), za zgłoszenie luki w zabezpieczeniach międzydomenowych umożliwiającej ujawnienie informacji (CVE-2008-1448).  
-   Haifei Li z firmy [Fortinet](http://www.fortinet.com), za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu DHTML (CVE-2009-1141)  
-   Firmom [TippingPoint](http://www.tippingpoint.com/) i [Zero Day Initiative](http://www.zerodayinitiative.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML (CVE-2009-1528)  
...
-   Wushi, we współpracy z firmami [TippingPoint](http://www.tippingpoint.com/) i [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML (CVE-2009-1530)  
-   Wushi, we współpracy z firmami [TippingPoint](http://www.tippingpoint.com/) i [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML (CVE-2009-1531)  
-   Nils, we współpracy z firmami [TippingPoint](http://www.tippingpoint.com/) i [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML (CVE-2009-1532)
