...
<tr class="even">
<td style="border:1px solid black;">Patrz wiersz powyżej</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=049e5db5-7315-4188-99fd-4a54833e6bf2">Serwer WINS w systemie Windows Server 2003 z dodatkiem Service Pack 1 i Windows Server 2003 z dodatkiem Service Pack 2</a><br />
(961064)</td>
<td style="border:1px solid black;">Fałszowanie</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=111957">MS08-034</a></td>
...
<th>Luka w zabezpieczeniach związana ze sprawdzaniem poprawności kwerendy serwera DNS — CVE-2009-0233</th>
<th>Luka w zabezpieczeniach związana ze sprawdzaniem poprawności odpowiedzi serwera DNS — CVE-2009-0234</th>
<th>Luka w zabezpieczeniach serwera DNS związana z luką w zabezpieczeniach rejestracji usługi WPAD — CVE-2009-0093</th>
<th>Luka w zabezpieczeniach serwera WINS związana z rejestracją usługi WPAD — CVE-2009-0094</th>
<th>Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-0093](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0093).
...
-   Kevin Day za współpracę przy usuwaniu luki w zabezpieczeniach serwera DNS związanej z kwerendami (CVE-2009-0233) oraz luki w zabezpieczeniach serwera DNS związanej ze sprawdzaniem poprawności odpowiedzi (CVE-2009-0234)  
-   Dave Dagon z ośrodka [Georgia Tech Information Security Center](http://www.gtisc.gatech.edu/), za współpracę przy usuwaniu luki w zabezpieczeniach serwera DNS związanej z kwerendami (CVE-2009-0233) oraz luki w zabezpieczeniach serwera DNS związanej ze sprawdzaniem poprawności odpowiedzi (CVE-2009-0234)
...
-   Wersja 1.1 (11 marca 2009 r.): Wyjaśniono, że luka CVE-2009-0093 nie odnosi się do obsługiwanych wersji systemu Windows Server 2008. W części Znane problemy sekcji **Streszczenie** dodano łącze do artykułu 962238 bazy wiedzy Microsoft Knowledge Base. Wskazano systemy szczególnie zagrożone przez lukę CVE-2009-2033. Zaktualizowano także podziękowania dla osoby, która znalazła lukę CVE-2009-0233 i CVE-2009-0234.  
-   Wersja 2.0 (12 maja 2009 r.): Z tabeli „**Programy, których dotyczy problem**” usunięto biuletyn MS08-066, który został zastąpiony przez tę aktualizację. W efekcie tej zmiany aktualizacja opisana w biuletynie MS08-066 może być oferowana w przypadku systemów Windows Server 2003 zagrożonych luką, w przypadku których wcześniej nie oferowano tej aktualizacji. Firma Microsoft zaleca, aby klienci, którym zostanie zaproponowana aktualizacja opisana w biuletynie MS08-066, jak najszybciej ją zainstalowali.
