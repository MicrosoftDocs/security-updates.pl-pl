---
TOCTitle: 'MS09-068'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-068 - Ważna'
ms:assetid: 'ms09-068'
ms:contentKeyID: 61232787
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-068(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS09-068 - Ważna
======================================================

Luka w zabezpieczeniach programu Microsoft Office Word umożliwia zdalne wykonanie kodu (976307)
-----------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji pakietu Microsoft Office Word 2002 i Microsoft Office Word 2003, Microsoft Office 2004 dla komputerów Macintosh, Microsoft Office 2008 dla komputerów Macintosh, Open XML File Format Converter dla komputerów Macintosh i wszystkich obsługiwanych wersji programu Podgląd programu Microsoft Office Word. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń eliminuje lukę w zabezpieczeniach poprzez zmianę sposobu, w jaki program Microsoft Office Word otwiera specjalnie spreparowane pliki tego programu. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Dlaczego ta aktualizacja ma tylko wskaźnik ważności „ważny” dla wszystkich wersji programu Word zagrożonych przez lukę?**  
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu Microsoft Office Word związana z uszkodzeniem pamięci dotyczącej informacji o plikach — CVE-2009-3135
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-3135](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3135).

#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach programu Microsoft Office Word związanej z uszkodzeniem pamięci dotyczącej informacji o plikach — CVE-2009-3135
...
#### Obejścia luki w zabezpieczeniach programu Microsoft Office Word związanej z uszkodzeniem pamięci dotyczącej informacji o plikach — CVE-2009-3135

Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:

-   **Nie otwierać dokumentów programu Word pochodzących z niezaufanych źródeł**
...
-   **Użyj funkcji Microsoft Office Isolated Conversion Environment (MOICE) przy otwieraniu plików pochodzących z nieznanych lub niezaufanych źródeł.**
    ...
    Aby włączyć funkcję MOICE, zmień zarejestrowany uchwyt formatów plików .doc. W poniższej tabeli opisano polecenie służące do włączania i wyłączania funkcji MOICE dla formatów plików .doc:
...
#### Często zadawane pytania na temat luki w zabezpieczeniach programu Microsoft Office Word związanej z uszkodzeniem pamięci dotyczącej informacji o plikach — CVE-2009-3135
...
Istnieje luka w sposobie analizy spreparowanych plików Word przez program Microsoft Office Word, która może spowodować uszkodzenie pamięci systemowej w sposób umożliwiający osobie atakującej wykonanie dowolnego kodu.
...
| Podgląd programu Microsoft Office Word 2003 z dodatkiem Service Pack 3 oraz Podgląd programu Microsoft Office Word | Nie     | Nie                       | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/973444">artykuł 973444 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Word 2003:<br />
Zobacz <a href="http://support.microsoft.com/kb/973443">artykuł 973443 bazy wiedzy Microsoft Knowledge Base</a><br />
<br />
Aplet Podgląd programu Word 2003 oraz aplet Podgląd programu Word:<br />
Zobacz <a href="http://support.microsoft.com/kb/973866">artykuł 973866 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Jun Mao z firmy [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach programu Microsoft Office Word związanej z uszkodzeniem pamięci dotyczącej informacji o plikach (CVE-2009-3135).
