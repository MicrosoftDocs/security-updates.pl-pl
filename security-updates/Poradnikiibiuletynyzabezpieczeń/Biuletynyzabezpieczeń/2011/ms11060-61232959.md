---
TOCTitle: 'MS11-060'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-060 - Ważna'
ms:assetid: 'ms11-060'
ms:contentKeyID: 61232959
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-060(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-060 - Ważna
======================================================

Luki w zabezpieczeniach programu Microsoft Visio umożliwiają zdalne wykonanie kodu (2560978)
--------------------------------------------------------------------------------------------
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=866d64b3-7147-4b5f-80fe-4d3317f140df">Microsoft Visio 2003 z dodatkiem Service Pack 3</a><br />
(KB2553009)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a0eeabde-5a92-45ae-aef6-81b7bdb4e0cd">Microsoft Visio 2007 z dodatkiem Service Pack 2</a><br />
(KB2553010)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=204799">MS11-008</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=6da236c2-0ef5-4c13-8393-673b70298a77">Microsoft Visio 2010 i Microsoft Visio 2010 z dodatkiem Service Pack 1 (wersje 32-bitowe)</a><br />
(KB2553008)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b7f5f2a9-116a-41ef-a19e-a7dd0947d2cb">Microsoft Visio 2010 i Microsoft Visio 2010 z dodatkiem Service Pack 1 (wersje 64-bitowe)</a><br />
(KB2553008)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach RCE pStream Release — CVE-2011-1972</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach RCE Move Around the Block — CVE-2011-1979</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visio 2010 (wersje 32-bitowe) i Microsoft Visio 2010 (wersje 32-bitowe) z dodatkiem Service Pack 1</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Visio 2010 (wersje 64-bitowe) i Microsoft Visio 2010 (wersje 64-bitowe) z dodatkiem Service Pack 1</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Nie dotyczy</td>
<td style="border:1px solid black;"><strong>Ważny</strong></td>
...
Luka w zabezpieczeniach RCE pStream Release — CVE-2011-1972  
-----------------------------------------------------------
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1972](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1972).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach RCE pStream Release — CVE-2011-1972
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach RCE pStream Release — CVE-2011-1972
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach RCE pStream Release — CVE-2011-1972
...
Luka w zabezpieczeniach RCE Move Around the Block — CVE-2011-1979  
-----------------------------------------------------------------
  
<span></span>
W programie Microsoft Visio występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana ze sposobem sprawdzania poprawności obiektów w pamięci podczas analizowania specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1979](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1979).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach RCE Move Around the Block — CVE-2011-1979
...
#### Obejścia problemu związanego z luką w zabezpieczeniach RCE Move Around the Block — CVE-2011-1979
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach RCE Move Around the Block — CVE-2011-1979
...
| Microsoft Visio 2010 (wersje 32-bitowe) i Microsoft Visio 2010 (wersje 32-bitowe) z dodatkiem Service Pack 1 | Tak  |  
| Microsoft Visio 2010 (wersje 64-bitowe) i Microsoft Visio 2010 (wersje 64-bitowe) z dodatkiem Service Pack 1 | Tak  |
...
| Microsoft Visio 2007 z dodatkiem Service Pack 2                                                              | Tak                       | Tak                        |  
| Microsoft Visio 2010 (wersje 32-bitowe) i Microsoft Visio 2010 (wersje 32-bitowe) z dodatkiem Service Pack 1 | Tak                       | Tak                        |  
| Microsoft Visio 2010 (wersje 64-bitowe) i Microsoft Visio 2010 (wersje 64-bitowe) z dodatkiem Service Pack 1 | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2553009">artykuł 2553009 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2553010">artykuł 2553010 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### Microsoft Visio 2010 (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2553008">artykuł 2553008 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   LinLin za zgłoszenie luki w zabezpieczeniach RCE pStream Release (CVE-2011-1972)  
-   LinLin za zgłoszenie luki w zabezpieczeniach RCE Move Around the Block (CVE-2011-1979)
