---
TOCTitle: 'MS11-026'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-026 - Ważna'
ms:assetid: 'ms11-026'
ms:contentKeyID: 61232925
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-026(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-026 - Ważna
======================================================

Luka w zabezpieczeniach protokołu MHTML umożliwia ujawnienie informacji (2503658)
---------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń usuwa lukę w zabezpieczeniach procedury obsługi protokołu MHTML w systemach Microsoft Windows. Luka może pozwolić na ujawnienie informacji, jeśli użytkownik odwiedzi specjalnie spreparowaną witrynę sieci Web. W przypadku ataku za pośrednictwem sieci Web witryna sieci Web mogłaby zawierać specjalnie spreparowane łącze służące do wykorzystania tej luki. Osoba atakująca musi przekonać użytkowników do jej odwiedzenia i kliknięcia specjalnie spreparowanego łącza.

Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji systemu Windows XP, Windows Vista i Windows 7 oraz wskaźnik ważności „niski” dla wszystkich obsługiwanych wersji systemów Windows Server 2003, Windows Server 2008 i Windows Server 2008 R2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Niniejsza aktualizacja zabezpieczeń usuwa lukę, zmieniając na poprawny sposób, w jaki analizator protokołu MHTML obsługuje żądania. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.

Niniejsza aktualizacja zabezpieczeń dotyczy również luki w zabezpieczeniach opisanej po raz pierwszy w [Poradniku zabezpieczeń firmy Microsoft 2501696](http://technet.microsoft.com/security/advisory/2501696).
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7f0a4616-8e3e-4925-9d95-ce6e614e45ae)                                                                                                                                | Ujawnienie informacji              | Ważny                      | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b01fe9a5-66a4-4683-963b-e78aea214579)                                                                                                       | Ujawnienie informacji              | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0209a004-f23a-40d9-991f-864046f4605f)                                                                                                                       | Ujawnienie informacji              | Niski                      | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c287571-54ea-4298-8b7d-b98b2c830cc3)                                                                                                           | Ujawnienie informacji              | Niski                      | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3fb450a0-d087-4f36-9301-05ffbf94cc1a)                                                                                                | Ujawnienie informacji              | Niski                      | Brak                                               |
| [Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c8fce0fb-4c90-479b-8ce9-75e60d52d256)                                                                                  | Ujawnienie informacji              | Ważny                      | Brak                                               |
| [Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7da10b64-d0a9-4e42-aa3a-87c657122a8c)                                                          | Ujawnienie informacji              | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=036f1285-7484-4e3b-8799-2c6c08166596)\*\*                                           | Ujawnienie informacji              | Niski                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=1438cec8-8dab-4510-ad75-dc6959dac0d8)\*\*                                 | Ujawnienie informacji              | Niski                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f35ecdd1-6b5c-40e7-a00b-ca083bdf5cba)                             | Ujawnienie informacji              | Niski                      | Brak                                               |
| [Windows 7 dla systemów 32-bitowych i Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=aed201c1-f1fb-4df9-8875-6f57ea0eb15b)                                                                   | Ujawnienie informacji              | Ważny                      | Brak                                               |
| [Windows 7 dla systemów opartych na procesorach x64 i Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=1a32bf04-7eed-4d27-a8e4-054b4a5b76cb)                                   | Ujawnienie informacji              | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=665faa7e-2368-4421-9dd5-ea6df2c79498)\*\*     | Ujawnienie informacji              | Niski                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=140ea384-2877-401f-ac3b-f84f6966e970) | Ujawnienie informacji              | Niski                      | Brak                                               |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach protokołu MHTML związana ze sposobem interpretowania żądań w formacie MIME – CVE-2011-0096</th>
...
Luka w zabezpieczeniach protokołu MHTML związana ze sposobem interpretowania żądań w formacie MIME – CVE-2011-0096  
------------------------------------------------------------------------------------------------------------------
  
<span></span>
W sposobie interpretowania przez protokół MHTML żądań w formacie MIME dotyczących bloków zawartości w dokumencie istnieje luka umożliwiająca ujawnienie informacji. W określonych warunkach luka ta może umożliwić osobie atakującej uruchomienie skryptu wykonywanego po stronie klienta w nieprawidłowym kontekście zabezpieczeń. Podobnie, jak w przypadku luk w zabezpieczeniach wykonywania skryptów krzyżowych (XSS) po stronie serwera, w określonych warunkach luka ta może umożliwić osobie atakującej „wstrzyknięcie” skryptu wykonywanego po stronie klienta do odpowiedzi na żądanie sieci Web uruchomione w kontekście przeglądarki Internet Explorer użytkownika.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0096](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096).
  
#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach protokołu MHTML związanej ze sposobem interpretowania żądań w formacie MIME – CVE-2011-0096
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   W przypadku ataku za pośrednictwem sieci Web witryna sieci Web mogłaby zawierać specjalnie spreparowane łącze rozpoczynające się od „MHTML:” służące do wykorzystania tej luki. Osoba atakująca musiałaby przekonać użytkowników do odwiedzenia tej witryny i otwarcia specjalnie spreparowanego adresu URL, najczęściej zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej przekierowującego do witryny osoby atakującej, a następnie nakłaniając do kliknięcia specjalnie spreparowanego łącza.  
...
-   Domyślnie program Internet Explorer w systemach Windows Server 2003 i 2008 jest uruchamiany w trybie chronionym określanym jako [Konfiguracja zwiększonych zabezpieczeń](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp). W tym trybie zagrożenie spowodowane tą luką jest ograniczone. Dodatkowe informacje na temat konfiguracji zwiększonych zabezpieczeń w programie Internet Explorer można znaleźć w części „Często zadawane pytania” następnej podsekcji „Używam programu Internet Explorer dla systemu Windows Server 2003, Windows Server 2008 lub Windows Server 2008 R2. Czy jest to czynnik ograniczający zagrożenie wynikające z tej luki?”
  
#### Obejścia problemu związanego z luką w zabezpieczeniach protokołu MHTML związaną ze sposobem interpretowania żądań w formacie MIME – CVE-2011-0096
...
-   **Wyłączenie procedury obsługi protokołu MHTML**
    ...
    **Ostrzeżenie** Nieprawidłowe korzystanie z Edytora rejestru może spowodować poważne problemy, wymagające ponownego zainstalowania systemu operacyjnego. Firma Microsoft nie gwarantuje możliwości rozwiązania problemów, wynikających z nieprawidłowego użycia edytora rejestru. Zmian w rejestrze można dokonywać wyłącznie na własne ryzyko.
    ...
    Aby wyłączyć procedurę obsługi protokołu MHTML, wykonaj następujące czynności w celu wykonania kopii zapasowej, a następnie usunięcia klucza rejestru:
  
    1.  Uruchom edytor rejestru.  
    2.  Przejdź do następującego klucza w rejestrze:  
        HKEY\_CLASSES\_ROOT\\CLSID\\{05300401-BCBC-11d0-85E3-00C04FD85AB4}  
    3.  Wykonaj kopię zapasową klucza, klikając go prawym przyciskiem myszy, a następnie wybierając polecenie **Eksportuj** i zapisując dane jako plik rejestru (np. „mhtml.reg”).  
    4.  Usuń klucz z rejestru, klikając go prawym przyciskiem myszy, a następnie wybierając polecenie **Usuń**.
  
    **Uwaga** Wyeksportowany plik .reg można zastosować w innych systemach operacyjnych, kopiując go do systemu docelowego, a następnie klikając go dwukrotnie. Wykorzystując Zasady grupy, można go również zastosować na poziomie całej domeny. Więcej informacji na temat zasad grupy można znaleźć w artykule TechNet [Zbiór zasad grupy](http://go.microsoft.com/fwlink/?linkid=215719).
  
    **Wpływ obejścia**. Protokół MHTML przestanie działać. To obejście będzie miało wpływ na wszystkie aplikacje, które korzystają z protokołu MHTML.
  
    **Cofnięcie obejścia.** Aby cofnąć to obejście, kliknij dwukrotnie plik rejestru wyeksportowany w kroku nr 3.
  
-   **Włączenie blokady protokołu MHTML**
  
    **Ostrzeżenie** Nieprawidłowe korzystanie z Edytora rejestru może spowodować poważne problemy, wymagające ponownego zainstalowania systemu operacyjnego. Firma Microsoft nie gwarantuje możliwości rozwiązania problemów, wynikających z nieprawidłowego użycia edytora rejestru. Zmian w rejestrze można dokonywać wyłącznie na własne ryzyko.
  
    **Uwaga** Przeczytaj [artykuł 2503658 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2503658) dotyczący korzystania **z automatycznej opcji naprawy firmy Microsoft** w celu zastosowania lub cofnięcia tego obejścia.
    ...
    **Wpływ obejścia**. Protokół MHTML zostanie ograniczony, aby uniemożliwić uruchomienie skryptu we wszystkich strefach dokumentu MHTML. To obejście będzie miało wpływ na wszystkie aplikacje, które korzystają z protokołu MHTML. Obejście nie będzie miało wpływy na skrypty w standardowych plikach HTML.
  
    **Cofnięcie obejścia.** Aby cofnąć obejście, wklej tekst przedstawiony poniżej do edytora tekstu, np. do Notatnika. Następnie zapisz plik z rozszerzeniem .reg.
...
-   **Ustawienie poziomu zabezpieczeń „Wysoki” dla stref zabezpieczeń Internet i Lokalny intranet w celu zablokowania formantów ActiveX i wykonywania aktywnych skryptów**
    ...
    **Uwaga** Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samego problemu, lecz może pomóc w zablokowaniu znanych kierunków ataku, zanim zostanie udostępniona odpowiednia aktualizacja. Firma Microsoft przetestowała następujące obejście i przedstawia swoją opinię w kwestii ograniczania przez nie funkcjonalności.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach protokołu MHTML związanej ze sposobem interpretowania żądań w formacie MIME – CVE-2011-0096
  
**Jaki zakres obejmuje luka?**    
Luka ta może doprowadzić do ujawnienia informacji i dotyczy wszystkich obsługiwanych wersji systemów Microsoft Windows.
  
**Skąd bierze się luka?**    
Luka powstaje, gdy protokół MHTML interpretuje żądania w formacie MIME dotyczące bloków zawartości w dokumencie, co umożliwia osobie atakującej uruchomienie skryptu w nieprawidłowym kontekście zabezpieczeń (np. niektóre skrypty można uruchomić w niewłaściwej strefie zabezpieczeń programu Internet Explorer).
  
**Co to jest MHTML?**    
MHTML (MIME Encapsulation of Aggregate HTML) to standard internetowy, który definiuje strukturę MIME używaną do kodowania zawartości HTML. Procedura obsługi protokołu MHTML w systemie Windows zapewnia [protokół podłączania](http://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx), który umożliwia renderowanie dokumentów zakodowanych w języku MHTML w aplikacjach.
...
Składnikiem, którego luka dotyczy, jest protokół MHTML, który jest wykorzystywany przez szereg programów, w tym m.in. Outlook Express, Windows Mail, Internet Explorer oraz aplikacje pakietu Microsoft Office, jak np. Microsoft Word.
  
**Jakie mogą być skutki wykorzystania luki przez osobę atakującą?**     
Osoba atakująca, która pomyślnie wykorzystała tę lukę, może „wstrzyknąć” skrypt po stronie klienta, korzystając z instancji przeglądarki Internet Explorer. W witrynie sieci Web, której dotyczy luka, skrypt może w imieniu zaatakowanego użytkownika fałszować treść witryny, ujawniać informacje lub wykonywać każdą czynność, którą może wykonać użytkownik.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**     
Z uwagi na sposób, w jaki protokół MHTML interpretuje żądania w formacie MIME dotyczące bloków zawartości w dokumencie, osoba atakująca może wykorzystać opisywaną lukę, uruchamiając skrypt w nieprawidłowym kontekście zabezpieczeń.
...
**W celu włączenia blokady protokołu MHTML użyto automatycznej opcji naprawy firmy Microsoft. W jaki sposób wpłynie na system instalacja tej aktualizacji zabezpieczeń?**    
Automatyczna opcja naprawy firmy Microsoft opisana w [artykule 2503658 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2503658) umożliwia zablokowanie protokołu MHTML. Aktualizacja zabezpieczeń usuwa lukę w zabezpieczeniach protokołu MHTML, nie znosząc przy tym blokady protokołu MHTML nałożonej w ramach automatycznej opcji naprawy firmy Microsoft. Wpływ obejścia pozostaje bez zmian po zainstalowaniu aktualizacji zabezpieczeń. Użytkownicy, którzy chcą znieść blokadę protokołu MHTML mogą tego dokonać przy pomocy automatycznej opcji naprawy firmy Microsoft. Więcej informacji na temat automatycznej opcji naprawy firmy Microsoft można znaleźć w sekcji Obejście „Włączenie blokady protokołu MHTML” poprzedniej podsekcji.
  
**W celu włączenia blokady protokołu MHTML użyto automatycznej opcji naprawy firmy Microsoft. Czy konieczna jest dezinstalacja tej aktualizacji przed instalacją aktualizacji zabezpieczeń?**    
Nie. W celu instalacji tej aktualizacji zabezpieczeń dezinstalacja automatycznej opcji naprawy firmy Microsoft nie jest konieczna.
  
**W jaki sposób działa aktualizacja?**     
Aktualizacja usuwa lukę, zmieniając na poprawny sposób, w jaki analizator protokołu MHTML obsługuje żądania.
  
**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**    
Tak. Informacje o tej luce są znane publicznie. Do luki został przypisany numer w bazie danych znanych luk i zagrożeń [CVE-2011-0096](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096).
...
Tak. Ta aktualizacja zabezpieczeń eliminuje aktualnie wykorzystywaną lukę. Informacje o usuniętej luce w zabezpieczeniach zostały zarejestrowane w bazie danych znanych luk i zagrożeń pod numerem [CVE-2011-0096](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096).
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2503658$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2503658">artykuł 2503658 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Organizacja [Google Security Team](http://www.google.com/) za współpracę z firmą Microsoft przy usuwaniu luki w zabezpieczeniach protokołu MHTML związanej ze sposobem interpretowania żądań witryn sieci Web w formacie MIME (CVE-2011-0096)
