---
TOCTitle: 'MS11-014'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-014 - Ważna'
ms:assetid: 'ms11-014'
ms:contentKeyID: 61232913
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-014(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-014 - Ważna
======================================================

Luka w zabezpieczeniach usługi podsystemu lokalnego uwierzytelniania zabezpieczeń może pozwolić na lokalne podniesienie uprawnień (2478960)
-------------------------------------------------------------------------------------------------------------------------------------------

Opublikowano: 8 lutego 2011 | Zaktualizowano: 28 kwietnia 2011
...
Aktualizacja zabezpieczeń usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki usługa LSASS obsługuje określone wartości używane w procesie uwierzytelniania. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2478960 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2478960) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=541f228f-79b3-402a-8ff9-366c1e595227)                                 | Podniesienie uprawnień             | Ważny                      | Brak                                                      |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=82189bf2-3f34-4949-92da-eea98036d18e)        | Podniesienie uprawnień             | Ważny                      | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e31e6b1-577e-468e-9c94-67227d2273c2)                        | Podniesienie uprawnień             | Ważny                      | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=76e3c229-d812-433c-ad05-7cbd1f9c6a6d)            | Podniesienie uprawnień             | Ważny                      | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41) | Podniesienie uprawnień             | Ważny                      | [MS08-002](http://go.microsoft.com/fwlink/?linkid=104921) |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach usługi LSASS związana ze sprawdzaniem poprawności długości — CVE-2011-0039</th>
...
Luka w zabezpieczeniach usługi LSASS związana ze sprawdzaniem poprawności długości — CVE-2011-0039  
--------------------------------------------------------------------------------------------------
  
<span></span>
W sposobie przetwarzania specjalnie spreparowanych żądań uwierzytelniania przez procesy usługi podsystemu lokalnego uwierzytelniania zabezpieczeń (LSASS) systemu Windows istnieje luka w zabezpieczeniach umożliwiająca podniesienie uprawnień. Luka w zabezpieczeniach może pozwolić osobie atakującej na uruchomienie kodu z podniesionymi uprawnieniami. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami administratora.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0039](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0039).
  
#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach usługi LSASS związanej ze sprawdzaniem poprawności długości — CVE-2011-0039
...
#### Obejścia problemu dotyczącego luki w zabezpieczeniach usługi LSASS związanej ze sprawdzaniem poprawności długości — CVE-2011-0039
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach usługi LSASS związanej ze sprawdzaniem poprawności długości — CVE-2011-0039
...
Luka występuje, gdy usługa LSASS systemu Windows przetwarza specjalnie spreparowane żądane uwierzytelniania.
...
Aktualizacja usuwa tę lukę w zabezpieczeniach, modyfikując sposób, w jaki usługa LSASS obsługuje określone wartości używane w procesie uwierzytelniania.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2478960$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2478960">artykuł 2478960 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tester zabezpieczeń Jorge Moura z firmy Primavera BSS za zgłoszenie luki w zabezpieczeniach usługi LSASS związanej ze sprawdzaniem poprawności długości (CVE-2011-0039)
...
-   Wersja 1.1 (28 kwietnia 2011 r.): Dodano łącze do artykułu 2478960 bazy wiedzy Microsoft Knowledge Base w części „Znane problemy” sekcji „Streszczenie”.
