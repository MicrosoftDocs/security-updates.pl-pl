---
TOCTitle: 'MS11-023'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-023 - Ważna'
ms:assetid: 'ms11-023'
ms:contentKeyID: 61232922
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-023(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-023 - Ważna
======================================================

Luki w zabezpieczeniach pakietu Microsoft Office umożliwiają zdalne wykonanie kodu (2489293)
--------------------------------------------------------------------------------------------
...
**Znane problemy.** W [artykule 2489293 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2489293) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
Tak. Luka w zabezpieczeniach składnika pakietu Office związana z niebezpiecznym ładowaniem biblioteki (CVE-2011-0107) usuwana przez niniejszą aktualizację jest powiązana z klasą luk opisanych w [Poradniku zabezpieczeń firmy Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), które dotyczą sposobu ładowania bibliotek zewnętrznych przez aplikacje. Niniejsza aktualizacja usuwa konkretne wystąpienie luki tego rodzaju.

**Czy ta aktualizacja obejmuje jakiekolwiek zmiany funkcjonalności dotyczące zabezpieczeń?**  
Tak. Aktualizacje dla pakietów Microsoft Office 2003 z dodatkiem Service Pack 3 (KB2509503) i Microsoft Office 2007 z dodatkiem Service Pack 2 (KB2509488), w połączeniu z aktualizacjami dla programów Microsoft Word, Microsoft Excel i Microsoft PowerPoint, zapewniają obsługę funkcji sprawdzania poprawności plików pakietu Office. Aby uzyskać więcej informacji o funkcji Walidacja plików pakietu Office, zobacz [Poradnik zabezpieczeń firmy Microsoft 2501584](http://technet.microsoft.com/security/advisory/2501584).

**W jakim stopniu ta aktualizacja zabezpieczeń jest związana z aktualizacją MS11-029?**  
Pakiet aktualizacji zabezpieczeń dla pakietu Microsoft Office XP (KB2509461) oferowany w tym biuletynie usuwa również lukę w zabezpieczeniach, którą opisano w biuletynie [MS11-029](http://go.microsoft.com/fwlink/?linkid=208524). Użytkownicy pakietu Microsoft Office XP muszą zainstalować tylko jeden z tych pakietów aktualizacji zabezpieczeń.
...
**W biuletynach MS11-022 i MS11-021 opisano także luki w zabezpieczeniach pakietu Microsoft Office 2004 dla komputerów Macintosh, pakietu Microsoft Office 2008 dla komputerów Macintosh oraz programu Open XML File Format Converter dla komputerów Macintosh. W jaki sposób biuletyny MS11-022 i MS11-021 są powiązane z niniejszym biuletynem (MS11-023)?**  
Pakiety aktualizacji zabezpieczeń dla pakietu Microsoft Office 2004 dla komputerów Macintosh (KB2505924), pakietu Microsoft Office 2008 dla komputerów Macintosh (KB2505927) oraz programu Open XML File Format Converter dla komputerów Macintosh (KB2505935) oferowane w tym biuletynie usuwają również luki w zabezpieczeniach, które zostały opisane w biuletynach [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727) i [MS11-021](http://go.microsoft.com/fwlink/?linkid=210121). Użytkownicy programów Microsoft Office 2004 dla komputerów Macintosh, Microsoft Office 2008 dla komputerów Macintosh i Open XML File Format Converter dla komputerów Macintosh muszą zainstalować te pakiety aktualizacji zabezpieczeń tylko raz.
...
Luka ma na autonomiczne programy pakietu Microsoft Office wpływ o takim samym wskaźniku ważności, co na odpowiadające pakiety Microsoft Office. Przykładowo autonomiczna instalacja programu Microsoft Excel będzie dotknięta w takim samym stopniu, co instalacja zagrożonego pakietu Microsoft Office.
...
<th>
Luka w zabezpieczeniach składnika pakietu Office związana z niebezpiecznym ładowaniem bibliotek — CVE-2011-0107
</th>
<th>
Luka w zabezpieczeniach pakietu Microsoft Office związana z odwołaniem odniesienia do obiektu graficznego — CVE-2011-0977
</th>
<th>
Zbiorczy wskaźnik ważności
</th>
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach składnika pakietu Office związanej z niebezpiecznym ładowaniem bibliotek — CVE-2011-0107

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Aby atak mógł się powieść, użytkownik musi odwiedzić niezaufaną zdalną lokalizację systemu plików lub udział WebDAV i otworzyć plik pakietu Office (taki jak docx).
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach składnika pakietu Office związaną z niebezpiecznym ładowaniem bibliotek — CVE-2011-0107
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach składnika pakietu Office związanej z niebezpiecznym ładowaniem bibliotek — CVE-2011-0107
...
Osoba atakująca może przekonać użytkownika do otwarcia prawidłowego pliku pakietu Office (na przykład docx), który znajduje się w tym samym katalogu sieciowym, co specjalnie spreparowany plik biblioteki dołączanej dynamicznie (biblioteki DLL). Następnie podczas otwierania prawidłowego pliku pakiet Microsoft Office może podjąć próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.

Osoba atakująca za pośrednictwem poczty elektronicznej może wykorzystać omawianą lukę, wysyłając do użytkownika w załączniku prawidłowy plik pakietu Office (na przykład docx) i przekonując go do umieszczenia tego załącznika w katalogu, który zawiera specjalnie spreparowany plik DLL i do otwarcia go. Następnie podczas otwierania prawidłowego pliku pakiet Microsoft Office może podjąć próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
...
Tak. Informacje o tej luce są znane publicznie. Do luki został przypisany numer w bazie danych znanych luk i zagrożeń [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).
...
Tak. Niniejsza aktualizacja zabezpieczeń eliminuje lukę, która może być potencjalnie wykorzystana dzięki zastosowaniu publicznie dostępnego kodu koncepcyjnego. Informacje o usuniętej luce w zabezpieczeniach zostały zarejestrowane w bazie danych znanych luk i zagrożeń pod numerem [CVE-2011-0107](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107).

Luka w zabezpieczeniach pakietu Microsoft Office związana z odwołaniem odniesienia do obiektu graficznego — CVE-2011-0977
-------------------------------------------------------------------------------------------------------------------------

<span></span>
W sposobie, w jaki pakiet Microsoft Office obsługuje analizę obiektów graficznych w specjalnie spreparowanym pliku pakietu Office, występuje luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0977](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0977).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach pakietu Microsoft Office związanej z odwołaniem odniesienia do obiektu graficznego — CVE-2011-0977
...
-   Osoba atakująca za pośrednictwem sieci Web, która chce wykorzystać tę lukę, musi udostępnić witrynę sieci Web ze specjalnie spreparowanym plikiem pakietu Office. Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika, jak również witryny niesprawdzone, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystać lukę w zabezpieczeniach. Intruz nie może w żaden sposób zmusić użytkowników do odwiedzenia szkodliwych witryn. Osoba atakująca musi natomiast przekonać użytkowników do odwiedzenia tej witryny, najczęściej zachęcając do kliknięcia łącza przekierowującego do witryny osoby atakującej, a następnie nakłonić do otwarcia specjalnie spreparowanego pliku pakietu Office.

#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach pakietu Microsoft Office związaną z odwołaniem odniesienia do obiektu graficznego — CVE-2011-0977
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach pakietu Microsoft Office związanej z odwołaniem odniesienia do obiektu graficznego — CVE-2011-0977
...
**Skąd bierze się luka?**  
Luka powstaje, gdy pakiet Microsoft Office nieprawidłowo obsługuje odwołanie odniesienia do struktur danych podczas analizy specjalnie spreparowanego pliku pakietu Office, który zawiera obiekty graficzne.
...
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**   
Mimo że kod powodujący lukę w zabezpieczeniach istnieje we współużytkowanym składniku pakietu Office, znana metoda ataku polega na wykorzystaniu programu Microsoft Excel. Niniejsza luka może zostać wykorzystana pod warunkiem, że użytkownik otworzy specjalnie spreparowany plik programu Excel w wersji programu Microsoft Excel, której dotyczy problem.
...
**Metoda ataku z wykorzystaniem tej luki polega na użyciu programu Microsoft Excel. Dlaczego jest to biuletyn dotyczący pakietu Microsoft Office?**  
Mimo że znana metoda ataku z wykorzystaniem luki polega na użyciu programu Microsoft Excel, kod luki istnieje we współużytkowanym składniku pakietu Microsoft Office. Logika wykrywania luk w zagrożonych systemach została zaprojektowana do sprawdzania współużytkowanego składnika pakietu Office, którego dotyczy problem, i oferowania aktualizacji systemu, niezależnie od tego, czy jest w nim zainstalowany program Microsoft Excel.
...
**W jaki sposób działa aktualizacja?**   
Ta aktualizacja usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki pakiet Microsoft Office obsługuje obiekty graficzne ze specjalnie spreparowanych plików pakietu Office.
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2509503">artykuł 2509503 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2509488">artykuł 2509488 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Haifei Li z firmy [FortiGuard Labs firmy Fortinet](http://www.fortiguard.com/) za zgłoszenie luki w zabezpieczeniach składnika pakietu Office związanej z niebezpiecznym ładowaniem bibliotek (CVE-2011-0107)  
-   Anonimowy analityk współpracujący z oddziałem [Zero Day Initiative](http://www.tippingpoint.com/) firmy [TippingPoint](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach pakietu Microsoft Office związanej z odwołaniem odniesienia do obiektu graficznego (CVE-2011-0977)
