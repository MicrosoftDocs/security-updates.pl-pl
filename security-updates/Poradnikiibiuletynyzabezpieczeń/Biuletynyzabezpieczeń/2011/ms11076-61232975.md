---
TOCTitle: 'MS11-076'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-076 - Ważna'
ms:assetid: 'ms11-076'
ms:contentKeyID: 61232975
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-076(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-076 - Ważna
======================================================

Luka w zabezpieczeniach pakietu Windows Media Center może umożliwić zdalne wykonanie kodu (2604926)
---------------------------------------------------------------------------------------------------
...
Aktualizacja usuwa lukę, poprawiając sposób ładowania bibliotek zewnętrznych przez pakiet Windows Media Center. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=44f7f10b-86ff-470f-996a-d4aa51c4d18f">Windows Vista z dodatkiem Service Pack 2</a>[1]<br />
(KB2579686)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=cbb66cd7-2688-410f-8a03-fd28e6ef5b01">Windows Vista x64 Edition z dodatkiem Service Pack 2</a>[1]<br />
(KB2579686)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=76fcf0ec-9062-4090-acb2-401355341a2b">Windows 7 dla systemów 32-bitowych i Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych</a><br />
(KB2579686)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=78c099b7-4bcb-4da7-8967-512c6541c541">Windows 7 dla systemów opartych na procesorach x64 i Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64</a><br />
(KB2579686)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=60e50f72-4001-423c-831c-8ff1f1b8f090">Pakiet Windows Media Center TV Pack dla systemu Windows Vista (wersje 32-bitowe</a>)[2]<br />
(KB2579692)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=371c7dab-5aa6-4502-80ee-ae69b736b972">Pakiet Windows Media Center TV Pack dla systemu Windows Vista (wersje 64-bitowe</a>)[2]<br />
(KB2579692)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
Pakiet Windows Media Center TV Pack dla systemu Windows Vista jest dostępny tylko jako składnik opcjonalny w instalacjach OEM systemu Windows Vista w wersjach Home Premium oraz Ultimate. Klienci, którzy zainstalowali go w systemie z procesorem x64, powinni zastosować obydwie dostępne aktualizacje. Zgodnie z najlepszymi rozwiązaniami firma Microsoft zaleca zainstalowanie aktualizacji systemu operacyjnego (KB2579686) przed aktualizacją pakietu Windows Media Center TV Pack (KB2579692). Klienci, którzy zainstalowali pakiet Windows Media Center TV Pack w systemie 32-bitowym, muszą zainstalować tylko aktualizację KB2579692.
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach pakietu Media Center związana z niebezpiecznym ładowaniem bibliotek — CVE-2011-2009</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
Luka w zabezpieczeniach pakietu Media Center związana z niebezpiecznym ładowaniem bibliotek — CVE-2011-2009  
-----------------------------------------------------------------------------------------------------------
  
<span></span>
Sposób, w jaki pakiet Windows Media Center obsługuje ładowanie plików DLL, powoduje powstanie luki w zabezpieczeniach umożliwiającej zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-2009](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2009).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach pakietu Media Center związanej z niebezpiecznym ładowaniem bibliotek — CVE-2011-2009
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach pakietu Media Center związaną z niebezpiecznym ładowaniem bibliotek — CVE-2011-2009
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach pakietu Media Center związanej z niebezpiecznym ładowaniem bibliotek — CVE-2011-2009
...
Luka powstaje w wyniku nieprawidłowego ograniczania przez program Windows Media Player ścieżki używanej podczas ładowania bibliotek zewnętrznych.
...
Osoba atakująca mogłaby nakłonić użytkownika do otwarcia prawidłowego pliku znajdującego się w tym samym katalogu sieciowym, co specjalnie spreparowany plik biblioteki dołączanej dynamicznie (biblioteki DLL). Następnie podczas otwierania prawidłowego pliku pakiet Windows Media Center może podjąć próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
  
Osoba atakująca za pośrednictwem poczty e-mail może wykorzystać tę lukę, wysyłając do użytkownika prawidłowy plik, a następnie przekonując użytkownika do umieszczenia tego załącznika w katalogu, który zawiera specjalnie spreparowany plik DLL, i do otwarcia prawidłowego pliku. Następnie podczas otwierania prawidłowego pliku pakiet Windows Media Center może podjąć próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
...
Aktualizacja zabezpieczeń usuwa lukę, zmieniając sposób, w jaki pakiet Windows Media Center ładuje zewnętrzne biblioteki.
...
Tak. Informacje o tej luce są znane publicznie. Do luki został przypisany numer w bazie danych znanych luk i zagrożeń [CVE-2011-2009](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2009).
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2579686">artykuł 2579686 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2579692">artykuł 2579692 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;"><strong>Uwaga</strong> Klucz rejestru niezbędny do wykrycia obecności tej aktualizacji nie istnieje.</td>
