---
TOCTitle: 'MS11-039'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-039 - Krytyczna'
ms:assetid: 'ms11-039'
ms:contentKeyID: 61232938
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-039(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-039 - Krytyczna
==========================================================

Luka w zabezpieczeniach systemu .NET Framework i programu Microsoft Silverlight umożliwia zdalne wykonanie kodu (2514842)
-------------------------------------------------------------------------------------------------------------------------
...
**Znane problemy.** W [artykule 2514842 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2514842) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 z dodatkiem Service Pack 1 oraz Microsoft .NET Framework 3.5](http://www.microsoft.com/downloads/details.aspx?familyid=2eabacce-394f-4b9a-8306-0875ca19a3a9)  
(KB2478657)  
[Microsoft .NET Framework 2.0 z dodatkiem Service Pack 2 oraz Microsoft .NET Framework 3.5 z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=55fd3254-7e59-4cf9-afa8-45ae66bc7390)  
(KB2478659)  
[Microsoft .NET Framework 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)<sup>[1]</sup>
(KB2478663)
</td>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 z dodatkiem Service Pack 2 oraz Microsoft .NET Framework 3.5 z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=afa11dda-a543-42a7-b997-5292fd869a8b)  
(KB2478660)  
[Microsoft .NET Framework 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)<sup>[1]</sup>
(KB2478663)
</td>
...
[Microsoft .NET Framework 2.0 z dodatkiem Service Pack 1 oraz Microsoft .NET Framework 3.5](http://www.microsoft.com/downloads/details.aspx?familyid=2eabacce-394f-4b9a-8306-0875ca19a3a9)\*\*  
(KB2478657)  
[Microsoft .NET Framework 2.0 z dodatkiem Service Pack 2 i Microsoft .NET Framework 3.5 z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=55fd3254-7e59-4cf9-afa8-45ae66bc7390)\*\*  
(KB2478659)  
[Microsoft .NET Framework 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)\*\*<sup>[1]</sup>
(KB2478663)
</td>
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 z dodatkiem Service Pack 2 i Microsoft .NET Framework 3.5 z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=afa11dda-a543-42a7-b997-5292fd869a8b)\*\*  
(KB2478660)  
[Microsoft .NET Framework 4.0](http://www.microsoft.com/downloads/details.aspx?familyid=c72635e4-c733-4fa1-9db0-75de6ead9e1c)\*\*<sup>[1]</sup>
(KB2478663)
</td>
...
<tr>
<td style="border:1px solid black;">
[Microsoft Silverlight 4](http://www.microsoft.com/downloads/details.aspx?familyid=2f71b104-b66f-4146-9d70-fcde766c91b8) we wszystkich wersjach serwerów Microsoft Windows\*\*  
(KB2512827)
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
...
**Czy niniejsza aktualizacja zabezpieczeń jest związana z aktualizacją MS11-044 (Luka w zabezpieczeniach systemu .NET Framework umożliwia zdalne wykonanie kodu )?**
...
Program Microsoft Silverlight (kompilacja 4.0.60531.0), będący najbardziej aktualną wersją programu Microsoft Silverlight w momencie pierwszej publikacji tego biuletynu, eliminuje opisaną lukę i nie podlega jej. Kompilacje programu Microsoft Silverlight wcześniejsze niż 4.0.60531.0 są zagrożone przez lukę.
...
Wersja instalowana z tą aktualizacją zabezpieczeń to 4.0.60531.0. Jeśli numer wersji posiadanego programu jest równy lub wyższy, system nie jest zagrożony.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach związana z przesunięciem tablicy w systemie .NET Framework — CVE-2011-0664
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft .NET Framework 4.0 w systemach Windows 7 dla systemów opartych na procesorze x64 i Windows 7 dla systemów opartych na procesorze x64<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**Krytyczny**  
Zdalne wykonanie kodu
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0664](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0664).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach systemu .NET Framework związanej z przesunięciem tablicy — CVE-2011-0664
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach systemu .NET Framework związaną z przesunięciem tablicy — CVE-2011-0664
...
-   **Wyłączenie aplikacji przeglądarki XAMLw programie Internet Explorer**
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach systemu .NET Framework związanej z przesunięciem tablicy — CVE-2011-0664
...
Przyczyną tej luki w zabezpieczeniach jest nieprawidłowe przetwarzanie argumentów przekazywanych do wbudowanych funkcji sieciowych przez system .NET Framework i program Microsoft Silverlight.
...
Ta aktualizacja usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki system .NET Framework sprawdza poprawność wartości przekazanych do zaufanych interfejsów API.
...
| Microsoft Silverlight 3 na komputerach Macintosh                                                                                                                     | Tak  |
| Microsoft Silverlight 3 we wszystkich wersjach klientów Microsoft Windows                                                                                            | Tak  |
| Microsoft Silverlight 3 we wszystkich wersjach serwerów systemu Microsoft Windows                                                                                    | Tak  |
| Microsoft Silverlight 4 na komputerach Macintosh                                                                                                                     | Tak  |
...
| Microsoft Silverlight 3 na komputerach Macintosh                                                                                                                     | Tak                       | Tak                        |
| Microsoft Silverlight 3 we wszystkich wersjach klientów Microsoft Windows                                                                                            | Tak                       | Tak                        |
| Microsoft Silverlight 3 we wszystkich wersjach serwerów systemu Microsoft Windows                                                                                    | Tak                       | Tak                        |
| Microsoft Silverlight 4 na komputerach Macintosh                                                                                                                     | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zapoznaj się z podsekcją <strong>Narzędzia wykrywania i wdrażania</strong> <strong>oraz wskazówki</strong></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2514842">artykuł 2514842 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 4.0 w systemach 32-bitowych:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\ Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2478663<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 4.0 w systemach opartych na procesorze x64:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 4.0 w systemie Windows Server 2003 dla systemów z procesorami x64 :<br />
NDP40-KB2478663-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft .NET Framework 3.5 w systemie Windows Server 2003 dla systemów z procesorem Itanium:<br />
...
Aktualizacja dla programu Microsoft .NET Framework 4.0 obsługuje następujące przełączniki instalacji:
...
Aktualizacja dla programu Microsoft .NET Framework 3.5.1 obsługuje następujące przełączniki instalacji:
...
-   Michaelowi J. Liu za zgłoszenie luki w zabezpieczeniach programu .NET Framework związanej z przesunięciem tablicy (CVE-2011-0664)
