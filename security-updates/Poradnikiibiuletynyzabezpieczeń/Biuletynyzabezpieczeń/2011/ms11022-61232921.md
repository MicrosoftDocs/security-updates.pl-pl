...
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach OfficeArt Atom umożliwiającej zdalne wykonanie kodu — CVE-2011-0976
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2464617">artykuł 2464617 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2464588">artykuł 2464588 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### PowerPoint 2007 (wszystkie wersje), Pakiet zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 (wszystkie wersje) i PowerPoint Viewer 2007 (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">W przypadku programu PowerPoint 2007 zobacz <a href="http://support.microsoft.com/kb/2464594">artykuł 2464594 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku Pakietu zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 z dodatkiem Service Pack 2 zobacz <a href="http://support.microsoft.com/kb/2464635">artykuł 2464635 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku programu Podgląd programu PowerPoint Viewer 2007 Service Pack 2, zobacz <a href="http://support.microsoft.com/kb/2464623">artykuł 2464623 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### PowerPoint 2010 (wszystkie wersje), PowerPoint Viewer (wszystkie wersje) i PowerPoint Web App
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">PowerPoint 2010 (wersje 32-bitowe):<br />
PowerPoint2010-kb2519975-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">PowerPoint 2010 (wersje 64-bitowe):<br />
PowerPoint2010-kb2519975-fullfile-x64-glb.exe /passive</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">PowerPoint Viewer:<br />
office2010-kb2519984-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">PowerPoint Web App:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">W przypadku programu PowerPoint 2010 zobacz <a href="http://support.microsoft.com/kb/2519975">artykuł 2519975 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku programu Podgląd programu Microsoft PowerPoint zobacz <a href="http://support.microsoft.com/kb/2519984">artykuł 2519984 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku programu PowerPoint Web App, zobacz <a href="http://support.microsoft.com/kb/2520047">artykuł 2520047 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Anonimowy analityk, we współpracy z [TippingPoint's](http://www.tippingpoint.com/)* *[Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach Techno-color Time Bandit związanej z liczbami zmiennoprzecinkowymi i umożliwiającej zdalne wykonanie kodu (CVE-2011-0655)  
-   Anonimowy analityk, we współpracy z [TippingPoint's](http://www.tippingpoint.com/)* *[Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach związanej z pozostającym katalogiem i umożliwiającej zdalne wykonanie kodu (CVE-2011-0656)  
-   Anonimowy analityk, we współpracy z [TippingPoint's](http://www.tippingpoint.com/)* *[Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach OfficeArt Atom umożliwiającej zdalne wykonanie kodu (CVE-2011-0976)
...
-   Wersja 1.0 (12 kwietnia 2011 r.): Opublikowano biuletyn.
    ...
    Wersja 1.1 (20 kwietnia 2011 r.): Poprawiono informację o zastępowanych biuletynach dla aktualizacji Microsoft PowerPoint Web App (KB2520047). Zmiana ta ma wyłącznie charakter informacyjny. Nie wprowadzono żadnych zmian w logice wykrywania ani plikach aktualizacji.
