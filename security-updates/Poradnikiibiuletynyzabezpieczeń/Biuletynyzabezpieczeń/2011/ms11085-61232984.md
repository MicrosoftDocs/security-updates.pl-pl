---
TOCTitle: 'MS11-085'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-085 - Ważna'
ms:assetid: 'ms11-085'
ms:contentKeyID: 61232984
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-085(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-085 - Ważna
======================================================
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji systemu Windows Vista, wskaźnik ważności „umiarkowany” dla wszystkich obsługiwanych wersji systemu Windows Server 2008 oraz wskaźnik ważności „niski” dla wszystkich obsługiwanych wersji systemów Windows 7 i Windows Server 2008 R2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja usuwa lukę, poprawiając sposób ładowania bibliotek zewnętrznych przez programy Poczta systemu Windows i Obszar spotkań w systemie Windows. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e08266d8-fffa-40bf-b8f6-10a65ee27524)                                                                                                                             | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4f2365ed-d50e-44d9-b859-1ec54d3b4d38)                                                                                                                 | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów 32-bitowych z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f82dc413-668c-4ca8-a8c8-db74f05346bc)\*\*                                                                                          | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                               |
| [Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=06ad5637-56a1-4478-aaa0-063e877503c9)\*\*                                                                                     | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                               |
| [Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2de5de74-e643-4045-9c22-ff95b0dbcafc)                                                                                     | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                               |
| [Windows 7 dla systemów 32-bitowych i Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=2307fa93-8e45-4841-a5a9-7e89960712f9)                                                                   | Zdalne wykonanie kodu              | Niski                      | Brak                                               |
| [Windows 7 dla systemów opartych na procesorach x64 i Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=62603d18-1b21-400c-8eba-202193182960)                                   | Zdalne wykonanie kodu              | Niski                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=c9cf6a22-f9ab-427a-9b16-33c60baaabb5)\*\*     | Zdalne wykonanie kodu              | Niski                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=012777f5-51f2-4944-91af-a9c79b8081a1) | Zdalne wykonanie kodu              | Niski                      | Brak                                               |
...
Istnieje szereg funkcji pulpitu, takich jak Poczta systemu Windows, które nie są instalowane domyślnie w systemie Windows Server 2008. Zamiast tego można zainstalować je wszystkie poprzez zainstalowanie w systemie Windows Server 2008 funkcji Środowisko pulpitu. Więcej informacji można znaleźć w artykule TechNet [Poczta systemu Windows, Windows Media Player i inne składniki funkcji Środowisko pulpitu w systemie Windows Server 2008](http://technet.microsoft.com/en-us/library/cc771519(ws.10).aspx) (j. ang.)

**Dlaczego** **niniejsza aktualizacja jest oferowana** **systemom Windows Server 2008** **bez względu na to, czy funkcja** **Środowisko pulpitu** **została w nich** **zainstalowana?**
Niebezpieczny kod znajduje się w systemie Windows Server 2008 także wtedy, gdy funkcja Środowisko pulpitu nie jest w nim zainstalowana. Użytkownik otrzymuje propozycję zainstalowania aktualizacji ze względu na obecność tego kodu.

Z drugiej strony atak z wykorzystaniem omawianej luki jest możliwy za pośrednictwem programów Poczta systemu Windows oraz Obszar spotkań w systemie Windows. Programy Poczta systemu Windows i Obszar spotkań w systemie Windows domyślnie nie są instalowane w systemie Windows Server 2008. W systemach, w których wymienione programy nie są zainstalowane, niebezpieczny kod nie jest wykorzystywany.

Program Poczta systemu Windows można zainstalować w systemie Windows Server 2008 poprzez instalację funkcji Środowisko pulpitu. Firma Microsoft zaleca, aby użytkownicy systemu Windows Server 2008 zastosowali aktualizację w celu usunięcia potencjalnego kierunku ataku.

**Dlaczego** **wskaźnik ważności** **jest niższy dla systemów Windows 7 i Windows Server 2008 R2?** **
**Choć w systemach Windows 7 i Windows Server 2008 R2 niebezpieczny kod jest obecny, firma Microsoft nie ma żadnych informacji o możliwościach wykorzystania omawianej luki w tych systemach operacyjnych. Mimo to zaleca się użytkownikom wymienionych systemów zastosowanie niniejszej aktualizacji w ramach tworzenia kompleksowych zabezpieczeń.
...
**Czy inne klienty poczty, na przykład Poczta usługi Windows Live lub Outlook Express, są zagrożone przez omawianą lukę?** **
**Nie. Luka w zabezpieczeniach dotyczy wyłącznie programu Poczta systemu Windows zainstalowanego w systemach operacyjnych wyszczególnionych w tabeli Programy, których dotyczy problem. Nie ma ona wpływu na inne klienty poczty.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu Poczta systemu Windows związana z niebezpiecznym ładowaniem bibliotek — CVE-2011-2016
</th>
<th colspan="2">
...
<span></span>
Sposób, w jaki programy Poczta systemu Windows i Obszar spotkań w systemie Windows obsługują ładowanie plików DLL, powoduje powstanie luki w zabezpieczeniach umożliwiającej zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-2016](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2016).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Poczta systemu Windows związanej z niebezpiecznym ładowaniem bibliotek — CVE-2011-2016

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Aby atak mógł się powieść, użytkownik musi odwiedzić niezaufaną zdalną lokalizację systemu plików lub udział WebDAV i z takiej otworzyć lokalizacji prawidłowy plik (na przykład plik .eml lub .wcinv), który następnie zostanie załadowany przez aplikację zagrożoną przez omawianą lukę.
...
-   W systemie Windows Server 2008 programy Poczta systemu Windows i Obszar spotkań w systemie Windows nie są instalowane domyślnie. Program Poczta systemu Windows jest instalowany tylko razem z funkcją Środowisko pulpitu.
-   Choć w systemach Windows 7 i Windows Server 2008 R2 niebezpieczny kod jest obecny, firma Microsoft nie ma żadnych informacji o możliwościach wykorzystania omawianej luki w tych systemach operacyjnych.

#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Poczta systemu Windows związaną z niebezpiecznym ładowaniem bibliotek — CVE-2011-2016
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Poczta systemu Windows związanej z niebezpiecznym ładowaniem bibliotek — CVE-2011-2016
...
Luka powstaje w wyniku nieprawidłowego ograniczania przez programy Poczta systemu Windows i Obszar spotkań w systemie Windows ścieżki używanej podczas ładowania bibliotek zewnętrznych.
...
**Co to jest program Obszar** **spotkań w systemie Windows?**
Obszar spotkań w systemie Windows umożliwia udostępnianie dokumentów, programów i pulpitu innym użytkownikom komputerów z systemem Windows Vista. Program Obszar spotkań w systemie Windows wykorzystuje technologię sieci równorzędnej i w przypadku, gdy znalezienie istniejącej sieci nie jest możliwe, automatycznie konfiguruje sieć ad hoc. Aby uzyskać więcej informacji na ten temat, zapoznaj się z artykułem [Obszar spotkań w systemie Windows: często zadawane pytania](http://windows.microsoft.com/en-us/windows-vista/windows-meeting-space-frequently-asked-questions).
...
Osoba atakująca może przekonać użytkownika do otwarcia prawidłowego pliku (na przykład .eml lub .wcinv), który znajduje się w tym samym katalogu sieciowym, co specjalnie spreparowany plik biblioteki dołączanej dynamicznie (biblioteki DLL). Następnie, podczas otwierania poprawnego pliku program Poczta systemu Windows lub Obszar spotkań w systemie Windows może podjąć próbę załadowania pliku DLL i uruchomienia zawartego w nim kodu.

Osoba atakująca za pośrednictwem poczty e-mail może wykorzystać tę lukę, wysyłając do użytkownika prawidłowy plik (na przykład .eml lub .wcinv), a następnie przekonując użytkownika do umieszczenia tego pliku w katalogu, który zawiera specjalnie spreparowany plik DLL, i do otwarcia prawidłowego pliku. Następnie, podczas otwierania poprawnego pliku program Poczta systemu Windows lub Obszar spotkań w systemie Windows może podjąć próbę załadowania pliku DLL i uruchomienia zawartego w nim kodu.

Osoba atakująca za pośrednictwem sieci może umieścić prawidłowy plik (na przykład .eml lub .wcinv) oraz specjalnie spreparowany plik DLL w udziale sieciowym, na przykład w lokalizacji UNC lub WebDAV, a następnie przekonać użytkownika do otwarcia tego pliku.

**Jakie systemy są szczególnie narażone na skutki tej luki?**
Szczególnie narażone są systemy, w których używa się programów Poczta systemu Windows lub Obszar spotkań w systemie Windows, w tym stacje robocze i serwery terminalowe. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie programów. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.

**W jaki sposób działa aktualizacja?**
Aktualizacja usuwa tę lukę, poprawiając sposób ładowania bibliotek zewnętrznych przez programy Poczta systemu Windows i Obszar spotkań w systemie Windows.
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2620704">artykuł 2620704 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Ivan Sanchez z firmy EvilCode, za zgłoszenie luki w zabezpieczeniach programu Poczta systemu Windows związanej z niebezpiecznym ładowaniem bibliotek (CVE-2011-2016)
