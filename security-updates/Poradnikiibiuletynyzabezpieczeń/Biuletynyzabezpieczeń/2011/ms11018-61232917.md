---
TOCTitle: 'MS11-018'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-018 - Krytyczna'
ms:assetid: 'ms11-018'
ms:contentKeyID: 61232917
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-018(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-018 - Krytyczna
==========================================================

Zbiorcza aktualizacja zabezpieczeń programu Internet Explorer (2497640)
-----------------------------------------------------------------------

Opublikowano: 12 kwietnia 2011 | Zaktualizowano: 16 maja 2011
...
<span></span>
**Dlaczego 16 maja 2011 r. ponownie opublikowano ten biuletyn**  
? Firma Microsoft opublikowała ten biuletyn w celu rozwiązania problemu dotyczącego logiki wykrywania programu Internet Explorer 7 w obsługiwanych wersjach systemów Windows XP i Windows Server 2003, która może dotyczyć użytkowników pewnych konfiguracji. Problem ten może spowodować, że logika wykrywania nie będzie oferować tej aktualizacji lub będzie ją niewłaściwie identyfikować jako zainstalowaną pomyślnie. Ponowna publikacja obejmuje tylko wykrywanie i ma za zadanie skorygować logikę, nie wprowadzając zmian do plików binarnych aktualizacji.

Problem nie dotyczy użytkowników programu Internet Explorer 7 w obsługiwanych wersjach systemów Windows XP i Windows Server 2003, którzy wcześniej zainstalowali tę aktualizację ręcznie lub przy pomocy modułu aktualizacji, w związku z czym nie muszą oni podejmować żadnych działań. Użytkownikom korzystającym z konfiguracji, których dotyczy problem z logiką wykrywania, przez który nie zaoferowano im aktualizacji, otrzymają propozycję automatycznego pobrania aktualizacji. Aktualizacja ta powinna zostać niezwłocznie zainstalowana.

Administratorzy systemów IT: Problem z logiką wykrywania mógł spowodować, że mechanizmy skanowania Enterprise (takie jak WSUS, System Center Configuration Manager 2007 oraz SMS 2003 z ITMU) błędnie identyfikowały aktualizację jako pomyślnie zainstalowaną w systemach, których dotyczył problem. Systemy błędnie zidentyfikowane wcześniej jako zaktualizowane zostaną teraz prawidłowo zidentyfikowane jako wymagające aktualizacji.

Aktualizacja będzie oferowana tylko tym użytkownikom, których dotyczy problem. Klienci, którzy zainstalowali aktualizację ręcznie, oraz posiadacze konfiguracji, których nie dotyczy zmiana w logice wykrywania nie muszą podejmować żadnych działań.
...
Niniejsza aktualizacja zawiera kompleksową aktualizację, która wzmacnia ochronę pamięci w programie Internet Explorer.
...
**Programy Internet Explorer 6 i Internet Explorer 7 zostały wymienione jako produkty, których dotyczy problem zidentyfikowany jako CVE-2011-1244. Dlaczego firma Microsoft nie publikuje aktualizacji usuwającej problem CVE-2011-1244 w odniesieniu do wymienionych produktów?**  
W programach Internet Explorer 6 i Internet Explorer 7 brak architektury pozwalającej zapewnić właściwą obsługę poprawek, które zapobiegają clickjackingowi („porywaniu kliknięć”), co z kolei uniemożliwia stworzenie dla tych produktów poprawek usuwających lukę opisaną w biuletynie CVE-2011-1244.
...
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obsługi układów — CVE-2011-0094
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci MSHTML — CVE-2011-0346
</th>
<th>
Luka w zabezpieczeniach znacznika ramki umożliwiająca ujawnienie informacji — CVE-2011-1244
</th>
<th>
Luka w zabezpieczeniach skryptów Javascript umożliwiająca ujawnienie informacji — CVE-2011-1245
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci zarządzania obiektami — CVE-2011-1345
</th>
<th>
Zbiorczy wskaźnik ważności
</th>
...
<td style="border:1px solid black;">
**Umiarkowany**   
Ujawnienie informacji<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<sup>[1]</sup>Brak dostępnej aktualizacji. Więcej informacji można znaleźć w sekcji **Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń**.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0094](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0094).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obsługi układów — CVE-2011-0094
...
#### Obejścia problemu spowodowanego przez lukę zabezpieczeniach związaną z uszkodzeniem pamięci obsługi układów — CVE-2011-0094
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obsługi układów — CVE-2011-0094
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0346).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci MSHTML — CVE-2011-0346
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z uszkodzeniem pamięci MSHTML — CVE-2011-0346
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci MSHTML — CVE-2011-0346
...
**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**  
Tak. Informacje o tej luce są znane publicznie. Do luki został przypisany numer w bazie danych znanych luk i zagrożeń [CVE-2011-0346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0346).
...
<span></span>
W programie Internet Explorer występuje luka umożliwiająca ujawnienie informacji. Osoba atakująca może wykorzystać tę lukę poprzez utworzenie specjalnie spreparowanej strony sieci Web zamaskowanej pod postacią prawidłowej zawartości. Działania podejmowane na takiej stronie przez użytkownika mogą pozwolić na ujawnienie informacji lub clickjacking, poprzez który kliknięcia użytkownika powodują wykonanie niepożądanych działań.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1244).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach znacznika ramki umożliwiającej ujawnienie informacji — CVE-2011-1244
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach znacznika ramki umożliwiającą ujawnienie informacji — CVE-2011-1244

Firma Microsoft nie znalazła żadnego obejścia tej luki.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach znacznika ramki umożliwiającej ujawnienie informacji — CVE-2011-1244

**Jaki zakres obejmuje luka?**  
Ta luka może doprowadzić do ujawnienia informacji. Osoba atakująca, która wykorzysta tę lukę, może podstępnie skłonić użytkownika do kliknięcia złośliwej zawartości, maskując ją jako wiarygodną zawartość umieszczoną na specjalnie spreparowanej stronie sieci Web.
...
**Jakie mogą być skutki wykorzystania luki przez osobę atakującą?**   
Osoba atakująca, która wykorzysta tę lukę, może podstępnie skłonić użytkownika do kliknięcia złośliwej zawartości, stosując praktyką znaną jako clickjacking.

**Co to jest clickjacking?**  
Clickjacking (porywanie kliknięć) to jedno z zagrożeń online, którego działania polega na tym, że strona sieci Web osoby atakującej podstępnie skłania użytkownika do kliknięcia złośliwej zawartości, maskując ją jako wiarygodną zawartość. Prawidłowa strona sieci Web może na przykład być ukryta jako „ramka” wewnątrz złośliwej strony. Gdy użytkownik kliknie jakiś element złośliwej strony, w rzeczywistości klika coś innego: kupuje coś w witrynie sieci Web, zmienia ustawienia przeglądarki lub komputera lub wyświetla reklamy, za których wyświetlanie internetowi przestępcy dostają pieniądze.

**W jaki sposób osoba atakująca może wykorzystać tę lukę?**   
Osoba atakująca może udostępniać specjalnie spreparowaną witrynę sieci Web, której celem jest wykorzystanie tej luki w zabezpieczeniach w programie Internet Explorer, a następnie przekonać użytkownika do wyświetlenia takiej witryny i wykonania w niej jakichś czynności. Osoba ta może również wykorzystywać witryny sieci Web, które akceptują lub udostępniają treści lub reklamy wprowadzone przez użytkownika. Witryny te mogą zawierać specjalnie spreparowane treści, które mogą wykorzystywać omawianą lukę w zabezpieczeniach. Jednakże w żadnym przypadku osoba atakująca nie może zmusić użytkowników do odwiedzenia takich witryn. Musi natomiast przekonać użytkowników do odwiedzenia tej witryny, najczęściej zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej, które przekieruje użytkowników do witryny osoby atakującej. Może również istnieć możliwość wyświetlenia specjalnie spreparowanej zawartości strony sieci Web z wykorzystaniem reklam banerowych lub innych metod jej dostarczenia do systemów, których dotyczy luka.

**Jakie systemy są szczególnie narażone na skutki tej luki?**   
Aby ta luka umożliwiła wykonanie jakichkolwiek niepożądanych działań, użytkownik musiałby odwiedzić witrynę sieci Web i wykonać w niej jakąś czynność. Dlatego też, najbardziej narażone na skutki wykorzystania tej luki są systemy, w których często wykorzystywany jest program Internet Explorer, takie jak stacje robocze i serwery terminalowe.

**W jaki sposób działa aktualizacja?**   
Aktualizacja usuwa lukę, modyfikując sposób, w jaki program Internet Explorer obsługuje zawartość podczas określonych procesów.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1245](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1245).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach skryptów Javascript umożliwiającej ujawnienie informacji — CVE-2011-1245
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach skryptów Javascript umożliwiającą ujawnienie informacji — CVE-2011-1245
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach skryptów Javascript umożliwiającej ujawnienie informacji — CVE-2011-1245
...
**Skąd bierze się luka?**  
Przyczyną tej luki jest błędne zezwolenie przez niektóre procesy programu Internet Explorer na dostęp skryptów do zawartości z innych domen oraz jej odczytanie.
...
**Jakie systemy są szczególnie narażone na skutki tej luki?**   
Aby ta luka umożliwiła wykonanie jakichkolwiek niepożądanych działań, użytkownik musiałby być zalogowany i musiałby odwiedzić witrynę sieci Web, która zawiera odwołania do zawartości w zewnętrznych oknach. Najbardziej narażone na skutki wykorzystania tej luki są systemy, w których często wykorzystywany jest program Internet Explorer, takie jak stacje robocze i serwery terminalowe.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1345](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1345).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci zarządzania obiektami — CVE-2011-1345
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z uszkodzeniem pamięci zarządzania obiektami — CVE-2011-1345
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci zarządzania obiektami — CVE-2011-1345
...
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2497640$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 dla wszystkich obsługiwanych wersji systemu Windows XP:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\ie7updates\KB2497640-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 dla wszystkich obsługiwanych wersji systemu Windows XP:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\ie8updates\KB2497640-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2497640">artykuł 2497640 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Anonimowy analityk współpracujący z firmą [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obsługi układów (CVE-2011-0094)  
-   Organizacja [MITRE](http://mitre.org/), za współpracę z firmą Microsoft przy usuwaniu luki w zabezpieczeniach związanej z uszkodzeniem pamięci obsługi układów (CVE-2011-0094)  
-   Michał Zalewski z firmy [Google Inc.](http://www.google.com/), za współpracę z firmą Microsoft przy usuwaniu luki w zabezpieczeniach związanej z uszkodzeniem pamięci MSHTML (CVE-2011-0346)  
-   David Bloom z firmy [Google Inc.](http://www.google.com/), za zgłoszenie luki w zabezpieczeniach znacznika ramki umożliwiającej ujawnienie informacji (CVE-2011-1244)  
-   David Bloom z firmy [Google Inc.](http://www.google.com/), za zgłoszenie luki w zabezpieczeniach skryptów JavaScript umożliwiającej ujawnienie informacji (CVE-2011-1245)  
-   Stephen Fewer z firmy [Harmony Security](http://www.harmonysecurity.com), współpracujący z [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci zarządzania obiektami (CVE-2011-1345)
