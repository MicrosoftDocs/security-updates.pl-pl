---
TOCTitle: 'MS11-016'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-016 - Ważna'
ms:assetid: 'ms11-016'
ms:contentKeyID: 61232915
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-016(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-016 - Ważna
======================================================

Luka w zabezpieczeniach programu Microsoft Groove może pozwolić na zdalne wykonanie kodu (2494047)
--------------------------------------------------------------------------------------------------

Opublikowano: 8 marca 2011
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla programu Microsoft Groove 2007 z dodatkiem Service Pack 2. Więcej informacji można znaleźć w niniejszej sekcji, w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem**.

Aktualizacja zabezpieczeń usuwa lukę, zmieniając sposób, w jaki program Microsoft Groove 2007 ładuje biblioteki zewnętrzne. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=3981ab53-1082-4155-9000-11d8a976ff33">Microsoft Groove 2007 z dodatkiem Service Pack 2</a><br />
(KB2494047)</td>
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach programu Microsoft Groove związana z niebezpiecznym ładowaniem bibliotek — CVE-2010-3146</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Groove 2007 z dodatkiem Service Pack 2</td>
...
Luka w zabezpieczeniach programu Microsoft Groove związana z niebezpiecznym ładowaniem bibliotek — CVE-2010-3146  
----------------------------------------------------------------------------------------------------------------
  
<span></span>
Sposób, w jaki program Microsoft Groove 2007 obsługuje ładowanie plików DLL, powoduje powstanie luki w zabezpieczeniach umożliwiającej zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3146](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3146).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Microsoft Groove związanej z niebezpiecznym ładowaniem bibliotek — CVE-2010-3146
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Aby atak się powiódł, użytkownik musi odwiedzić niezaufaną zdalną lokalizację systemu plików lub udział WebDAV i otworzyć plik związany z programem Groove (na przykład .vcg lub .gta).  
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Microsoft Groove związaną z niebezpiecznym ładowaniem bibliotek — CVE-2010-3146
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Microsoft Groove związanej z niebezpiecznym ładowaniem bibliotek — CVE-2010-3146
...
Luka powstaje, gdy program Microsoft Groove 2007 nieprawidłowo ogranicza ścieżkę używaną do ładowania bibliotek zewnętrznych.
...
Osoba atakująca mogłaby przekonać użytkownika do otwarcia prawidłowego pliku związanego z programem Groove (na przykład .vcg lub .gta), który znajduje się w tym samym katalogu sieciowym, co specjalnie spreparowany plik biblioteki dołączanej dynamicznie (biblioteki DLL). Następnie podczas otwierania prawidłowego pliku program Microsoft Groove 2007 podjąłby próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
  
Osoba atakująca za pośrednictwem poczty elektronicznej może wykorzystać omawianą lukę, wysyłając do użytkownika w załączniku prawidłowy plik związany z programem Groove (na przykład .vcg lub .gta) i przekonując go do umieszczenia tego załącznika w katalogu, który zawiera specjalnie spreparowany plik DLL i do otwarcia go. Następnie podczas otwierania prawidłowego pliku program Microsoft Groove 2007 podjąłby próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
  
Osoba atakująca za pośrednictwem sieci może umieścić prawidłowy plik związany z programem Groove oraz specjalnie spreparowany plik DLL w udziale sieciowym, na przykład w lokalizacji UNC lub WebDAV, a następnie przekonać użytkownika do otwarcia tego pliku.
  
**Co to jest plik Microsoft Groove vCard (.vcg)?**    
Format vCard to standard formatu plików elektronicznych wizytówek. Plików Microsoft Groove vCard (.vcg) używa się w danych kontaktowych zapisanych w formacie vCard.
  
**Co to jest plik Microsoft Groove Tool Archive (.gta)?**    
Pliki Microsoft Groove Tool Archive (.gta) są używane przez narzędzia Groove będące miniaturowymi aplikacjami, które bazują na zdolności programu Groove do rozpowszechniania i synchronizowania zawartości z kopiami obszaru roboczego Groove innych członków.
...
Aktualizacja zabezpieczeń usuwa lukę, zmieniając sposób, w jaki program Microsoft Groove 2007 ładuje biblioteki zewnętrzne.
  
**Czy ta luka jest związana z poradnikiem zabezpieczeń firmy Microsoft 2269637?**    
Tak, luka usuwana przez tę aktualizację jest powiązana z kategorią luk opisanych w [Poradniku zabezpieczeń firmy Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), które dotyczą sposobu ładowania bibliotek zewnętrznych przez aplikacje. Niniejsza aktualizacja usuwa konkretne wystąpienie luki tego rodzaju.
  
**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**    
Tak. Informacje o tej luce są znane publicznie. Do luki został przypisany numer w bazie danych znanych luk i zagrożeń [CVE-2010-3146](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3146).
...
Tak. Niniejsza aktualizacja zabezpieczeń eliminuje lukę, która może być potencjalnie wykorzystana dzięki zastosowaniu publicznie dostępnego kodu koncepcyjnego. Informacje o usuniętej luce w zabezpieczeniach zostały zarejestrowane w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-3146](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3146).
...
| Oprogramowanie                                   | MBSA |  
|--------------------------------------------------|------|  
| Microsoft Groove 2007 z dodatkiem Service Pack 2 | Tak  |
...
|--------------------------------------------------|---------|---------------------------|---------------------------|----------------------------|  
| Microsoft Groove 2007 z dodatkiem Service Pack 2 | Nie     | Nie                       | Tak                       | Tak                        |
...
#### Microsoft Groove 2007 (wszystkie wersje)
...
<td style="border:1px solid black;">Microsoft Office Groove 2007 z dodatkiem Service Pack 2:<br />
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2494047">artykuł 2494047 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   HD Moore z firmy [Rapid 7](http://www.rapid7.com/), za zgłoszenie luki w zabezpieczeniach programu Microsoft Groove związanej z niebezpiecznym ładowaniem bibliotek (CVE-2010-3146)
