---
TOCTitle: 'MS11-021'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-021 - Ważna'
ms:assetid: 'ms11-021'
ms:contentKeyID: 61232920
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-021(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-021 - Ważna
======================================================

Luki w zabezpieczeniach programu Microsoft Excel umożliwiają zdalne wykonanie kodu
----------------------------------------------------------------------------------
...
Aktualizacja usuwa luki w zabezpieczeniach, modyfikując sposób, w jaki program Microsoft Excel zarządza strukturami danych, sprawdza poprawność informacji o rekordach, inicjuje zmienne używane w operacjach na pamięci oraz przydziela bufor podczas analizowania specjalnie spreparowanego pliku. Więcej informacji na temat luk może znaleźć w podsekcjach „Często zadawane pytania” dla pozycji określonych luk w zabezpieczeniach, znajdujących się poniżej następnej sekcji, Informacje o luce w zabezpieczeniach.
...
Znane problemy. W [artykule 2489279 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2489279) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
Tak. Aktualizacje dla programów Microsoft Excel 2003 z dodatkiem Service Pack 3 (KB2502786) i Microsoft Excel 2007 z dodatkiem Service Pack 2 (KB2464583), w połączeniu z aktualizacją w biuletynie [MS11-023](http://go.microsoft.com/fwlink/?linkid=210206), zapewniają obsługę funkcji sprawdzania poprawności plików pakietu Office. Aby uzyskać więcej informacji o funkcji Walidacja plików pakietu Office, zobacz [Poradnik zabezpieczeń firmy Microsoft 2501584](http://technet.microsoft.com/security/advisory/2501584).

W jakim stopniu ta aktualizacja zabezpieczeń jest związana z aktualizacjami MS10-087 i MS10-088?  
Aktualizacja dla pakietu Microsoft Office 2004 dla komputerów Macintosh (KB2505924) oferowana w tym biuletynie usuwa również luki w zabezpieczeniach, które opisano w biuletynach [MS10-087](http://go.microsoft.com/fwlink/?linkid=203241) i [MS10-088](http://go.microsoft.com/fwlink/?linkid=198186).

W biuletynach MS11-022 i MS11-023 opisano także luki w zabezpieczeniach pakietu Microsoft Office 2004 dla komputerów Macintosh, pakietu Microsoft Office 2008 dla komputerów Macintosh oraz programu Open XML File Format Converter dla komputerów Macintosh. W biuletynie MS11-022 również opisano luki w zabezpieczeniach pakietu Microsoft Office 2011 dla komputerów Macintosh. W jakim stopniu biuletyny MS11-022 i MS11-023 mają związek z tym biuletynem (MS11-021)?  
Pakiety aktualizacji zabezpieczeń dla pakietu Microsoft Office 2004 dla komputerów Macintosh (KB2505924), pakietu Microsoft Office 2008 dla komputerów Macintosh (KB2505927) oraz programu Open XML File Format Converter dla komputerów Macintosh (KB2505935) oferowane w tym biuletynie usuwają również luki w zabezpieczeniach, które zostały opisane w biuletynach [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727) i [MS11-023](http://go.microsoft.com/fwlink/?linkid=210206). Pakiet aktualizacji zabezpieczeń dla pakietu Microsoft Office 2011 dla komputerów Macintosh (KB2525412) oferowany w tym biuletynie usuwa również luki w zabezpieczeniach, które opisano w biuletynie [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727). Użytkownicy pakietu Microsoft Office 2004 dla komputerów Macintosh, pakietu Microsoft Office 2008 dla komputerów Macintosh, programu Open XML File Format Converter dla komputerów Macintosh lub pakietu Microsoft Office 2011 dla komputerów Macintosh 2011 muszą zainstalować niniejsze pakiety aktualizacji zabezpieczeń tylko raz.
...
<th>
Luka w zabezpieczeniach programu Excel związana z przepełnieniem liczby całkowitej — CVE-2011-0097
</th>
<th>
Luka w zabezpieczeniach programu Excel związana z przepełnieniem stosu — CVE-2011-0098
</th>
<th>
Luka w zabezpieczeniach programu Excel związana z czcionkami WriteAV podczas analizy rekordów — CVE-2011-0101
</th>
<th>
Luka w zabezpieczeniach programu Excel związana z uszkodzeniem pamięci — CVE-2011-0103
</th>
<th>
Luka w zabezpieczeniach programu Excel związana z zastąpieniem buforu — CVE-2011-0104
</th>
</tr>
<tr>
<th colspan="6">
...
<tr>
<td style="border:1px solid black;">
Microsoft Excel (wersje 64-bitowe)
</td>
<td style="border:1px solid black;">
Ważny   
Zdalne wykonanie kodu
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0097](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z przepełnieniem liczby całkowitej — CVE-2011-0097
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z przepełnieniem liczby całkowitej — CVE-2011-0097
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z przepełnieniem liczby całkowitej — CVE-2011-0097
...
Luka w zabezpieczeniach programu Microsoft Excel polega na nieprawidłowym przydzieleniu buforu podczas analizy informacji o rekordach ze specjalnie spreparowanego pliku programu Excel.
...
Aktualizacja usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki program Microsoft Excel przydziela bufor podczas analizy specjalnie spreparowanego pliku.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0098](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z przepełnieniem stosu – CVE-2011-0098
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z przepełnieniem stosu – CVE-2011-0098
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z przepełnieniem stosu – CVE-2011-0098
...
Skąd bierze się luka?  
Przyczyną tej luki w zabezpieczeniach programu Microsoft Excel jest wystąpienie błędu obsługi pamięci podczas sprawdzania poprawności informacji o rekordach z analizowanego specjalnie spreparowanego pliku programu Excel, co prowadzi do uszkodzenia pamięci systemowej w sposób umożliwiający osobie atakującej wykonanie dowolnego kodu.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0101](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z czcionkami WriteAV podczas analizy rekordów — CVE-2011-0101
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z czcionkami WriteAV podczas analizy rekordów — CVE-2011-0101
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z czcionkami WriteAV podczas analizy rekordów — CVE-2011-0101
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0103](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci – CVE-2011-0103
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z uszkodzeniem pamięci — CVE-2011-0103
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci — CVE-2011-0103
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0104](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z zastąpieniem buforu — CVE-2011-0104
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z zastąpieniem buforu — CVE-2011-0104
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z zastąpieniem buforu — CVE-2011-0104
...
Luka w zabezpieczeniach programu Excel związana z inicjalizacją danych — CVE-2011-0105
--------------------------------------------------------------------------------------

<span></span>
W programie Microsoft Excel istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez program Excel specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0105](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z inicjalizacją danych — CVE-2011-0105
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z inicjalizacją danych — CVE-2011-0105
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z inicjalizacją danych — CVE-2011-0105

Jaki zakres obejmuje luka?  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Skąd bierze się luka?  
Luka w zabezpieczeniach programu Microsoft Excel wynika z nieprawidłowego inicjowania zmiennej, która służy do określania długości operacji memcpy podczas analizowania specjalnie spreparowanego pliku programu Excel. Może ona zostać wykorzystana w celu przepełnienia buforu, które umożliwi wykonanie kodu w kontekście zabezpieczeń zalogowanego użytkownika.
...
W jaki sposób działa aktualizacja?   
Aktualizacja usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki program Microsoft Excel inicjalizuje zmienne używane w operacjach na pamięci.
...
Luka w zabezpieczeniach programu Excel związana z indeksowaniem tablic — CVE-2011-0978
--------------------------------------------------------------------------------------

<span></span>
W programie Microsoft Excel istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez program Excel specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0978](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z indeksowaniem tablic — CVE-2011-0978
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z indeksowaniem tablic — CVE-2011-0978
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z indeksowaniem tablic — CVE-2011-0978
...
Luka w zabezpieczeniach programu Excel związana z uszkodzeniem połączonej listy — CVE-2011-0979
-----------------------------------------------------------------------------------------------

<span></span>
W programie Microsoft Excel istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez program Excel specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0979](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu związanej z uszkodzeniem połączonej listy — CVE-2011-0979
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu związaną z uszkodzeniem połączonej listy — CVE-2011-0979
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu związanej z uszkodzeniem połączonej listy — CVE-2011-0979

Jaki zakres obejmuje luka?  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Skąd bierze się luka?  
Luka w zabezpieczeniach programu Microsoft Excel wynika z nieprawidłowego zarządzania elementami struktury danych podczas analizowania specjalnie spreparowanego pliku programu Excel.
...
W jaki sposób działa aktualizacja?   
Aktualizacja usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki program Microsoft Excel zarządza strukturami danych.
...
Luka w zabezpieczeniach programu Excel związana z zawieszonym wskaźnikiem — CVE-2011-0980
-----------------------------------------------------------------------------------------

<span></span>
W programie Microsoft Excel istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez program Excel specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0980](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z zawieszonym wskaźnikiem — CVE-2011-0980
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z zawieszonym wskaźnikiem — CVE-2011-0980
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z zawieszonym wskaźnikiem — CVE-2011-0980

Jaki zakres obejmuje luka?  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Skąd bierze się luka?  
Luka w zabezpieczeniach programu Microsoft Excel wynika z nieprawidłowego zarządzania strukturami danych podczas analizowania specjalnie spreparowanego pliku programu Excel.
...
| Przeglądarka programu Microsoft Excel z dodatkiem Service Pack 2                                                                | Nie     | Nie                       | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2466169">artykuł 2466169 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Informacje dotyczące plików</td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2502786">artykuł 2502786 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Weryfikacja klucza rejestru</td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<tr class="odd">
<td style="border:1px solid black;">Informacje dotyczące plików</td>
<td style="border:1px solid black;">W przypadku programu Microsoft Excel 2007 zobacz <a href="http://support.microsoft.com/kb/2464583">artykuł 2464583 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku Przeglądarki programu Microsoft Excel zobacz <a href="http://support.microsoft.com/kb/2466158">artykuł 2466158 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku Pakietu zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 zobacz <a href="http://support.microsoft.com/kb/2466156">artykuł 2466156 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Weryfikacja klucza rejestru</td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### Microsoft Excel 2010 (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;">Informacje dotyczące plików</td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2466146">artykuł 2466146 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Weryfikacja klucza rejestru</td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
Pobierz i zainstaluj odpowiednią wersję językową aktualizacji pakietu Microsoft Office 2004 dla komputerów Macintosh 11.6.3 z witryny sieci Web [Centrum pobierania Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=f756d836-6ab2-4adb-9dee-6cb523d7c1f5).
...
-   Otwórz na pulpicie wolumin Microsoft Office 2004 for Mac 11.6.3 Security Update. Ta czynność mogła zostać wykonana automatycznie.  
-   Aby rozpocząć proces aktualizacji, w oknie woluminu Microsoft Office 2004 for Mac 11.6.3 Update kliknij dwukrotnie aplikację Microsoft Office 2004 for Mac 11.6.3 Update i postępuj według instrukcji wyświetlanych na ekranie.  
-   Po pomyślnym zainstalowaniu aktualizacji instalator aktualizacji można usunąć z dysku twardego. Aby sprawdzić, czy instalacja została zakończona pomyślnie, zapoznaj się z następującą sekcją „Weryfikowanie instalacji aktualizacji”. Aby usunąć instalatora aktualizacji, najpierw przeciągnij wolumin Microsoft Office 2004 for Mac 11.6.3 Update do kosza, a następnie powtórz tę czynność dla pobranego pliku.
...
Jeśli wersja ma numer 11.6.3, aktualizacja została zainstalowana pomyślnie.
...
Pobierz i zainstaluj odpowiednią wersję językową aktualizacji pakietu Microsoft Office 2008 dla komputerów Macintosh 12.2.9 [z witryny Centrum pobierania Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=84dfe3f4-a2a1-47b9-8da1-29ae67230918).
  
-   Zamknij wszystkie działające aplikacje, w tym także programy antywirusowe, wszystkie aplikacje pakietu Microsoft Office, Microsoft Messenger dla komputerów Macintosh oraz Office Notifications, ponieważ mogą one zakłócać proces instalacji.  
-   Otwórz na pulpicie wolumin Microsoft Office 2008 for Mac 12.2.9 Update. Ta czynność mogła zostać wykonana automatycznie.  
-   Aby rozpocząć proces aktualizacji, w oknie woluminu Microsoft Office 2008 for Mac 12.2.9 Update kliknij dwukrotnie aplikację Microsoft Office 2008 for Mac 12.2.9 Update i postępuj zgodnie z instrukcjami wyświetlanymi na ekranie.  
-   Po pomyślnym zainstalowaniu aktualizacji instalator aktualizacji można usunąć z dysku twardego. Aby sprawdzić, czy instalacja została zakończona pomyślnie, zapoznaj się z następującą sekcją „Weryfikowanie instalacji aktualizacji”. Aby usunąć instalatora aktualizacji, najpierw przeciągnij wolumin Microsoft Office 2008 for Mac 12.2.9 Update do kosza, a następnie powtórz tę czynność w odniesieniu do pobranego pliku.
...
Jeśli wersja ma numer 12.2.9, aktualizacja została zainstalowana pomyślnie.
...
Pobierz i zainstaluj odpowiednią wersję językową aktualizacji pakietu Microsoft Office 2011 dla komputerów Macintosh 14.1 z witryny [Centrum pobierania Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=ef1e612f-d8e3-4628-9fe4-ad136f0debd3).
...
-   Otwórz na pulpicie wolumin Microsoft Office for Mac 2011 14.1 Update. Ta czynność mogła zostać wykonana automatycznie.  
-   Aby rozpocząć proces aktualizacji, w oknie woluminu Microsoft Office for Mac 2011 14.1 Update kliknij dwukrotnie aplikację Microsoft Office for Mac 2011 14.1 Update i postępuj zgodnie z instrukcjami wyświetlanymi na ekranie.  
-   Po pomyślnym zainstalowaniu aktualizacji instalator aktualizacji można usunąć z dysku twardego. Aby sprawdzić, czy instalacja została zakończona pomyślnie, zapoznaj się z następującą sekcją „Weryfikowanie instalacji aktualizacji”. Aby usunąć instalatora aktualizacji, najpierw przeciągnij wolumin Microsoft Office for Mac 2011 14.1 Update do kosza, a następnie powtórz tę czynność dla pobranego pliku.
...
Jeśli numer wersji ostatniej zainstalowanej aktualizacji to 14.1, aktualizacja została zainstalowana pomyślnie.
...
Pobierz i zainstaluj odpowiednią wersję językową programu Open XML File Format Converter for Mac 1.1.9 Update z [witryny Centrum pobierania Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=0c323a12-6385-4666-ad39-a9516a8eda14).
  
-   Zamknij wszystkie działające aplikacje, w tym także programy antywirusowe, wszystkie aplikacje pakietu Microsoft Office, Microsoft Messenger dla komputerów Macintosh oraz Office Notifications, ponieważ mogą one zakłócać proces instalacji.  
-   Otwórz na pulpicie wolumin Open XML File Format Converter for Mac 1.1.9 Update. Ta czynność mogła zostać wykonana automatycznie.  
-   Aby rozpocząć proces aktualizacji, w oknie woluminu Open XML File Format Converter for Mac 1.1.9 Update kliknij dwukrotnie aplikację Open XML File Format Converter for Mac 1.1.9 Update i postępuj zgodnie z instrukcjami wyświetlanymi na ekranie.  
-   Po pomyślnym zainstalowaniu aktualizacji instalator aktualizacji można usunąć z dysku twardego. Aby sprawdzić, czy instalacja została zakończona pomyślnie, zapoznaj się z następującą sekcją „Weryfikowanie instalacji aktualizacji”. Aby usunąć instalator aktualizacji, przeciągnij wolumin Open XML File Format Converter for Mac 1.1.9 Update do kosza, a następnie powtórz tę czynność w odniesieniu do pobranego pliku.
...
Jeśli wersja ma numer 1.1.9, aktualizacja została zainstalowana pomyślnie.
...
-   Alin Rad Pop z firmy [Secunia Research](http://secunia.com/) za zgłoszenie luki w zabezpieczeniach programu Excel związanej z przepełnieniem liczby całkowitej (CVE-2011-0097)  
-   Alin Rad Pop z firmy [Secunia Research](http://secunia.com/) za zgłoszenie luki w zabezpieczeniach programu Excel związanej z przepełnieniem stosu (CVE-2011-0098)  
-   Muhammad Junaid Bohio z firmy [Telus Security Labs](http://www.telussecuritylabs.com) za zgłoszenie luki w zabezpieczeniach programu Excel związanej z czcionkami WriteAV podczas analizy rekordów (CVE-2011-0101)  
-   Aniway, we współpracy z [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z czcionkami WriteAV podczas analizy rekordów (CVE-2011-0101)  
-   Anonimowy analityk współpracujący z firmą [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci (CVE-2011-0103)  
-   Rodrigo Rubira Branco z firmy [Check Point Vulnerability Discovery Team](http://www.checkpoint.com/) (VDT) za zgłoszenie luki w zabezpieczeniach programu Excel związanej z zastąpieniem buforu (CVE-2011-0104)  
-   Aniway, we współpracy z [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z inicjalizacją danych (CVE-2011-0105)  
-   Aniway, we współpracy z [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z indeksowaniem tablic (CVE-2011-0978)  
-   Anonimowy analityk, we współpracy z [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z uszkodzeniem połączonej listy (CVE-2011-0979)  
-   Anonimowy analityk, we współpracy z [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z zawieszonym wskaźnikiem (CVE-2011-0980)
