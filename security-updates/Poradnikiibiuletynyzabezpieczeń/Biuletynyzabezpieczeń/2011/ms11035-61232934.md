---
TOCTitle: 'MS11-035'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-035 - Krytyczna'
ms:assetid: 'ms11-035'
ms:contentKeyID: 61232934
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-035(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-035 - Krytyczna
==========================================================

Luka w zabezpieczeniach usługi WINS umożliwia zdalne wykonanie kodu (2524426)
-----------------------------------------------------------------------------

Opublikowano: 10 maja 2011
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla serwerów, na których działają obsługiwane wersje systemów Windows Server 2003, Windows Server 2008 (z wyjątkiem wersji dla procesorów Itanium) i Windows Server 2008 R2 (z wyjątkiem wersji dla procesorów Itanium) z zainstalowaną usługą WINS. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem, i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa lukę, korygując błąd logiczny, który występuje podczas analizowania buforów jako parametrów. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2524426 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2524426) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0d289146-8470-45dd-a886-d1b35a2c6d4b)                                                                                                                 | Zdalne wykonanie kodu              | Krytyczny                  | [MS09-039](http://go.microsoft.com/fwlink/?linkid=155974) |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0d3e85a9-42ff-447b-ab8c-095a1c0b224c)                                                                                                     | Zdalne wykonanie kodu              | Krytyczny                  | [MS09-039](http://go.microsoft.com/fwlink/?linkid=155974) |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=4c388fe8-883a-4118-a7ff-50f1e9d0a071)                                                                                          | Zdalne wykonanie kodu              | Krytyczny                  | [MS09-039](http://go.microsoft.com/fwlink/?linkid=155974) |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=9019a3ff-d953-4b0b-8c7a-05aa9cf65c92)\*                                       | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                                      |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=841130fa-4522-4079-b7eb-f8466ac3ef12)\*                             | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                                      |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=8732b41e-2f25-4ee1-a8b7-a8b8b9e22d08)\* | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                                      |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach usługi WINS związana z nieudaną odpowiedzią — CVE-2011-1248</th>
...
Luka w zabezpieczeniach usługi WINS związana z nieudaną odpowiedzią — CVE-2011-1248  
-----------------------------------------------------------------------------------
  
<span></span>
W zabezpieczeniach usługi Windows Internet Name Service (WINS) istnieje luka umożliwiająca zdalne wykonanie kodu, wynikająca z niewystarczającego sprawdzenia poprawności struktur danych w specjalnie spreparowanych pakietach sieciowych usługi WINS wysyłanych do tej usługi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1248](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1248).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach usługi WINS związanej z nieudaną odpowiedzią — CVE-2011-1248
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Domyślnie usługa WINS nie jest zainstalowana w żadnym systemie operacyjnym, którego dotyczy luka. Na skutki wykorzystania tej luki są narażeni tylko klienci, którzy ręcznie zainstalowali ten składnik.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach usługi WINS związaną z nieudaną odpowiedzią — CVE-2011-1248
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Zablokowanie portów TCP 42 i UDP 42 na zaporze.**
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach usługi WINS związanej z nieudaną odpowiedzią — CVE-2011-1248
...
Błąd logiczny występujący podczas obsługi przez usługę WINS wyjątku wysyłania przez gniazdo powoduje, że niektóre wartości dostarczone przez użytkownika pozostają w ramce stosu i są używane ponownie w innym kontekście. Zdalna osoba atakująca, której uda się wykorzystać tę lukę, może uszkodzić pamięć w sposób pozwalający na zdalne wykonanie kodu. Osoba atakująca może następnie uzyskać kontrolę nad danym systemem w kontekście konta System w przypadku systemu Windows Server 2003 lub w kontekście konta Usługa lokalna w przypadku systemów Windows Server 2008 i Windows Server 2008 R2.
...
Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod. Osoba atakująca może następnie instalować programy, wyświetlać, zmieniać lub usuwać dane, a także tworzyć nowe konta z uprawnieniami usługi WINS.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**     
Osoba atakująca może wykorzystać tę lukę, tworząc specjalnie spreparowane pakiety i wysyłając je do zagrożonego systemu WINS.
...
Aktualizacja poprawia błąd logiczny polegający na naruszeniu kontraktu między funkcjami podczas przekazywania buforów jako parametrów.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2524426$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2524426">artykuł 2524426 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Luigi Auriemma, we współpracy z [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach usługi WINS związanej z nieudaną odpowiedzią (CVE-2011-1248)
