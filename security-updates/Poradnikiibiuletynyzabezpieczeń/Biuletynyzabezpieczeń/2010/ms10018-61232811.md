---
TOCTitle: 'MS10-018'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-018 - Krytyczna'
ms:assetid: 'ms10-018'
ms:contentKeyID: 61232811
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-018(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-018 - Krytyczna
==========================================================

Zbiorcza aktualizacja zabezpieczeń dla programu Internet Explorer (980182)
--------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla wszystkich obsługiwanych wersji programu Internet Explorer: Internet Explorer 5.01, Internet Explorer 6 z dodatkiem Service Pack 1, Internet Explorer 6 na klientach Windows, Internet Explorer 7 oraz Internet Explorer 8 na klientach Windows. W przypadku programu Internet Explorer 6 zainstalowanego na serwerach Windows aktualizacja ta ma wskaźnik ważności „ważny”. Natomiast w przypadku programu Internet Explorer 8 zainstalowanego na serwerach Windows ta aktualizacja ma wskaźnik ważności „umiarkowany”. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem, i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa te luki, modyfikując sposób, w jaki program Internet Explorer weryfikuje pochodzenie skryptów i obsługuje obiekty w pamięci, ciągi kodujące korzystające z treści i długie adresy URL. Więcej informacji na temat luk można znaleźć w podsekcji „Często zadawane pytania” w następnej sekcji, **Informacje o luce w zabezpieczeniach**.

Ta aktualizacja zabezpieczeń usuwa także lukę opisaną po raz pierwszy w [Poradniku zabezpieczeń firmy Microsoft 981374](http://technet.microsoft.com/security/advisory/981374). Luka [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806) nie ma wpływu na system Windows 7, Windows Server 2008 R2 ani na program Internet Explorer 8.
...
Szczegółowe informacje dotyczące plików znajdują się w [artykule 980182 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/980182).
...
Niniejsza aktualizacja zawiera kompleksową aktualizację nagłówka HTTP X-XSS-Protection. Nowa składnia „mode=block" powoduje, że filtr XSS całkowicie wyłącza zawartość strony w wypadku, gdy zostaną wykryte odbite skrypty krzyżowe. Na przykład: X-XSS-Protection: 1; mode=block.
...
<th>
Luka w zabezpieczeniach związana z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0267
</th>
<th>
Luka w zabezpieczeniach powodująca ujawnienie informacji po zakończeniu kodowania – CVE-2010-0488
</th>
<th>
Luka w zabezpieczeniach powodująca uszkodzenie pamięci związane z sytuacją wyścigu – CVE-2010-0489
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0490
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML – CVE-2010-0491
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML – CVE-2010-0492
</th>
<th>
Luka w zabezpieczeniach międzydomenowych związana z elementem HTML – CVE-2010-0494
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci – CVE-2010-0805
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0806
</th>
<th>
Luka w zabezpieczeniach związana z uszkodzeniem pamięci usługi renderowania stron HTML – CVE-2010-0807
</th>
<th>
Zbiorczy wskaźnik ważności
</th>
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0267](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0267).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0267
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0267
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0267
...
<span></span>
W sposobie, w jaki program Internet Explorer obsługuje treści wykorzystując określone ciągi kodujące podczas przesyłania danych, występuje luka umożliwiająca ujawnienie informacji. Osoba atakująca może wykorzystać tę lukę, tworząc specjalnie przygotowaną stronę sieci Web umożliwiającą ujawnienie informacji dotyczących użytkownika, który odwiedzi tę stronę sieci Web. Osoba atakująca, której uda się wykorzystać tę lukę, może wyświetlić zawartość z komputera lokalnego lub innego okna przeglądarki sieci Web w innej domenie lub strefie programu Internet Explorer.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0488](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0488).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach powodującej ujawnienie informacji po zakończeniu kodowania – CVE-2010-0488
...
#### Obejścia problemu związanego z luką w zabezpieczeniach powodującą ujawnienie informacji po zakończeniu kodowania – CVE-2010-0488
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach powodującej ujawnienie informacji po zakończeniu kodowania – CVE-2010-0488

**Jaki zakres obejmuje ta luka?**  
Ta luka może doprowadzić do ujawnienia informacji. Osoba atakująca, która wykorzysta tę lukę, gdy użytkownik wyświetli stronę sieci Web, może przeglądać ważne dane przechowywane w pamięci systemu.

**W jaki sposób powstaje luka?**  
W sposobie, w jaki program Internet Explorer obsługuje treści wykorzystując określone ciągi kodujące podczas przesyłania danych, występuje luka umożliwiająca ujawnienie informacji.

**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**  
Osoba atakująca, której uda się wykorzystać tę lukę, gdy użytkownik wyświetla stronę sieci Web, może przeglądać ważne dane przechowywane w pamięci systemu.
...
**W jaki sposób działa aktualizacja?**  
Aktualizacja modyfikuje sposób, w jaki program Internet Explorer obsługuje treści, wykorzystując określone ciągi kodujące.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0489](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0489).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach powodującej uszkodzenie pamięci związane z sytuacją wyścigu – CVE-2010-0489
...
#### Obejścia problemu związanego z luką w zabezpieczeniach powodującą uszkodzenie pamięci związane z sytuacją wyścigu – CVE-2010-0489
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach powodującej uszkodzenie pamięci związane z sytuacją wyścigu – CVE-2010-0489
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0490](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0490).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0490
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0490
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0490
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0491](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0491).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML – CVE-2010-0491
...
#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML – CVE-2010-0491
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML – CVE-2010-0491
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0492](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0492).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML – CVE-2010-0492
...
-   W domyślnej konfiguracji wszystkie obsługiwane wersje programów Microsoft Outlook, Microsoft Outlook Express, i Poczta systemu Windows otwierają wiadomości e-mail w formacie HTML w strefie Witryny z ograniczeniami, co powoduje wyłączenie skryptów i formantów ActiveX . Oznacza to, że osoba atakująca nie może wykorzystać tej luki w zabezpieczeniach do uruchomienia złośliwego kodu. Jeśli użytkownik kliknie łącze znajdujące się w wiadomości e-mail, może być nadal zagrożony wykorzystaniem tej luki poprzez atak za pośrednictwem sieci Web.
-   Domyślnie program Internet Explorer w systemach Windows Server 2003 i Windows Server 2008 jest uruchamiany w trybie chronionym określanym jako [Konfiguracja zwiększonych zabezpieczeń](http://go.microsoft.com/fwlink/?linkid=92039). W tym trybie poziom zabezpieczeń strefy Internet jest Wysoki. Jest to czynnik ograniczający zagrożenie w przypadku witryn sieci Web, których nie dodano do strefy witryn zaufanych programu Internet Explorer. Dodatkowe informacje na temat konfiguracji zwiększonych zabezpieczeń programu Internet Explorer można znaleźć w sekcji często zadawanych pytań na temat tej luki.
-   Omawiana luka w zabezpieczeniach nie dotyczy programów Internet Explorer 6 i Internet Explorer 7.

#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML – CVE-2010-0492
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML – CVE-2010-0492
...
<span></span>
W programie Internet Explorer istnieje luka umożliwiająca ujawnienie informacji, która może pozwolić na uzyskanie przez skrypt dostępu do okna przeglądarki sieci Web w innej domenie lub strefie programu Internet Explorer. Osoba atakująca może wykorzystać tę lukę poprzez utworzenie specjalnie spreparowanej strony sieci Web umożliwiającej ujawnienie informacji w sytuacji, gdy użytkownik oglądający tę stronę przeciągnie okno przeglądarki nad drugim oknem przeglądarki.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0494](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0494).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach międzydomenowych związanej z elementem HTML – CVE-2010–0494
...
#### Obejścia problemu powodowanego przez lukę w zabezpieczeniach międzydomenowych związaną z elementem HTML – CVE-2010-0494
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach międzydomenowych związanej z elementem HTML – CVE-2010-0494

**Jaki zakres obejmuje ta luka?**  
Ta luka może doprowadzić do ujawnienia informacji. Osoba atakująca, która wykorzystała tę lukę, może wykonać skrypt w kontekście użytkownika w innej domenie programu Internet Explorer. W celu wykorzystania tej luki są jednak wymagane działania użytkownika.
...
**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**  
Osoba atakująca, która wykorzystała tę lukę, może wykonać skrypt w kontekście użytkownika w innej domenie programu Internet Explorer.
...
**W jaki sposób działa aktualizacja?**  
Aktualizacja wymusza sprawdzanie zabezpieczeń podczas weryfikacji pochodzenia skryptu.
...
<span></span>
W programie Internet Explorer występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, wynikająca ze sposobu, w jaki program Internet Explorer zarządza w niektórych sytuacjach długimi adresami URL. Osoba atakująca może wykorzystać tę lukę poprzez utworzenie specjalnie spreparowanej strony sieci Web. Gdy użytkownik odwiedza taką stronę sieci Web, luka w zabezpieczeniach może pozwolić na zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak zalogowany użytkownik. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzysta tę lukę, może uzyskać pełną kontrolę nad systemem, którego ta luka dotyczy. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0805](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0805).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci – CVE-2010-0805
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z uszkodzeniem pamięci – CVE-2010-0805
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci – CVE-2010-0805

**Jaki zakres obejmuje ta luka?**  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak zalogowany użytkownik. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

**W jaki sposób powstaje luka?**  
Formant ActiveX w przeglądarce Internet Explorer niepoprawnie zarządza w niektórych sytuacjach długimi adresami URL. W wyniku tego może dojść do uszkodzenia pamięci w sposób umożliwiający osobie atakującej wykonanie dowolnego kodu w kontekście zalogowanego użytkownika.
...
**W jaki sposób działa aktualizacja?**  
Aktualizacja zmienia sposób, w jaki formant ActiveX w przeglądarce Internet Explorer zarządza długimi adresami URL.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0806
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0806
...
-   **Wyłączenie równorzędnej klasy fabrycznej poprzez edycję kluczy rejestru pliku iepeers.dll**

    Najpierw utwórz kopię zapasową kluczy rejestru, uruchamiając następujące polecenie z wiersza polecenia, mając podniesione uprawnienia:

    `Regedit.exe /e Disable_Peer_Factory_backup.reg HKEY_CLASSES_ROOT\CLSID\{3050F4CF-98B5-11CF-BB82-00AA00BDCE0B}`

    W systemach Windows Vista i Windows Server 2008 należy najpierw przejąć własność gałęzi \[HKEY\_CLASSES\_ROOT\\CLSID\\{3050F4CF-98B5-11CF-BB82-00AA00BDCE0B}\], wykonując następujące czynności:
    ...
    2.  Przejdź do gałęzi \[HKEY\_CLASSES\_ROOT\\CLSID\\{3050F4CF-98B5-11CF-BB82-00AA00BDCE0B}\]
    ...
    6.  Powtórz czynności 3-5 dla wszystkich podkluczy

    Następnie zapisz następujący tekst w pliku z rozszerzeniem reg. Na przykład Disable\_Peer\_Factory.reg:

    `Edytor rejestru systemu Windows 5.00[-HKEY_CLASSES_ROOT\CLSID\{3050F4CF-98B5-11CF-BB82-00AA00BDCE0B}]`

    Następnie uruchom plik Disable\_Peer\_Factory.reg, wykonując następujące polecenie w wierszu polecenia z podniesionymi uprawnieniami:

    `Regedit.exe /s Disable_Peer_Factory.reg`

    **Wpływ obejścia.** Mogą być zagrożone funkcje zależne od fabryki równorzędnej, takie jak drukowanie czy foldery sieciowe.
...
-   **Zmodyfikowanie listy kontroli dostępu (ACL) do pliku iepeers.dll**

    Aby zmienić listę kontroli dostępu do pliku iepeers.dll na bardziej restrykcyjną, uruchom następujące polecenia z wiersza polecenia, mając uprawnienia administracyjne:
    ...
    **Wpływ obejścia.** Może być zagrożona rozszerzona funkcjonalność MSHTML, taka jak drukowanie czy foldery sieciowe.

    **Cofnięcie obejścia.**

    Uruchom następujące polecenia z wiersza polecenia, mając uprawnienia administracyjne:
...
-   **Włączenie funkcji zapobiegania wykonywaniu danych (Data Execution Prevention – DEP) w programie Internet Explorer 7**
    ...
    **Cofnięcie obejścia.**
    ...
    Użyj Internetowego panelu sterowania lub apletu System w Panelu sterowania.

-   **Włączanie funkcji DEP w programie Internet Explorer 7 przy użyciu opcji automatycznej naprawy firmy Microsoft**

    Zobacz [artykuł 980182 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/980182), aby użyć automatycznej opcji naprawy firmy Microsoft w celu zastosowania lub cofnięcia tego obejścia.

    **Wpływ obejścia.** Niektóre funkcje rozszerzeń przeglądarki mogą nie być zgodne z funkcją DEP, a jej działanie może zostać nagle zakończone. Jeśli tak się stanie, można wyłączyć określony dodatek lub przywrócić poprzednie ustawienie funkcji DEP za pomocą automatycznej opcji naprawy firmy Microsoft wyłączającej obejście.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci – CVE-2010-0806
...
**Czy luka ta była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**  
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806). Została także opisana w [Poradniku zabezpieczeń firmy Microsoft 981374](http://technet.microsoft.com/security/advisory/981374).

**Czy przed wydaniem niniejszego biuletynu firma Microsoft otrzymała jakiekolwiek zgłoszenia dotyczące wykorzystania tej luki?**  
Tak. Firma Microsoft wie, iż przeprowadzono pewną liczbę ataków próbujących wykorzystać tę lukę.

**Jeśli zastosowano rozwiązania opisane w Poradniku 981374, czy należy je cofnąć przed zastosowaniem tej aktualizacji?**  
Jeżeli zastosowane zostały rozwiązania zawarte w [Poradniku zabezpieczeń firmy Microsoft 981374](http://technet.microsoft.com/security/advisory/981374), należy je cofnąć, postępując zgodnie z instrukcjami cofnięcia obejścia przedstawionymi w podsekcji „Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z uszkodzeniem niezainicjowanej pamięci” – CVE-2010-0806. Jeżeli zastosowane zostało obejście pliku iepeers.dll lub obejście wykorzystujące DEP za pomocą funkcji „Zastosuj to obejście” dostępnej w [Poradniku zabezpieczeń firmy Microsoft 981374](http://technet.microsoft.com/security/advisory/981374), można cofnąć to obejście, wybierając opcję „Wyłącz to obejście" w [artykule w bazie wiedzy Microsoft Knowledge Base 980182](http://support.microsoft.com/kb/980182).
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0807](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0807).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci usługi renderowania stron HTML – CVE-2010-0807

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Osoba atakująca za pośrednictwem sieci Web, która chce wykorzystać tę lukę, może udostępniać witrynę zawierającą odpowiednią stronę sieci Web. Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika lub reklamy, jak również witryny niesprawdzone, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystać lukę w zabezpieczeniach. Jednakże w żadnym przypadku osoba atakująca nie może zmusić użytkowników do odwiedzenia takich witryn. Musi natomiast przekonać użytkowników do odwiedzenia tej witryny, najczęściej zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej, które przekieruje użytkowników do witryny osoby atakującej.
-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
-   Omawiana luka nie dotyczy programów Internet Explorer 5.01 z dodatkiem Service Pack 4, Internet Explorer 6, Internet Explorer 6 z dodatkiem Service Pack 1 i Internet Explorer 8.

#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci usługi renderowania stron HTML – CVE-2010-0807
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci usługi renderowania stron HTML – CVE-2010-0807
...
<td style="border:1px solid black;">Internet Explorer 5.01 z dodatkiem Service Pack 4 we wszystkich obsługiwanych wersjach systemu Windows 2000:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB980182-IE5SP4-20100305.120000$\Spuninst<br />
<br />
Internet Explorer 6 z dodatkiem Service Pack 1 zainstalowany we wszystkich obsługiwanych wersjach systemu Windows 2000:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB980182-IE6SP1-20100305.120000$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/980182">artykuł 980182 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania</strong></td>
<td style="border:1px solid black;">Internet Explorer 6 dla wszystkich obsługiwanych wersji systemu Windows XP:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB980182$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 dla wszystkich obsługiwanych wersji systemu Windows XP:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\ie7updates\KB980182-IE7\spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 8 dla wszystkich obsługiwanych wersji systemu Windows XP:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\ie8updates\KB980182-IE8\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/980182">artykuł 980182 bazy wiedzy Microsoft Knowledge Base</a></td>
...
-   Firmie [Secunia](http://secunia.com) za współpracę z nami przy usuwaniu luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci (CVE-2010-0267)  
-   Daiki Fukumori z firmy [Cyber Defense Institute Inc.](http://www.cyberdefense.jp/) za zgłoszenie luki w zabezpieczeniach powodującej ujawnienie informacji po zakończeniu kodowania (CVE-2010-0488)  
-   Alexander Kornbrust z firmy [Red Database Security](http://www.red-database-security.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci (CVE-2010-0490)  
-   Ivan Fratric z firmy [iSIGHT Partners](http://www.isightpartners.com/) Global Vulnerability Partnership za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci (CVE-2010-0490)  
-   Wushi z firmy [team509](http://www.team509.com/), we współpracy z firmą [VeriSign iDefense Labs](http://labs.idefense.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML (CVE-2010-0491)  
-   Simon Zuckerbraun, we współpracy z [Zero Day Initiative](http://www.zerodayinitiative.com/) firmy [TippingPoint](http://www.tippingpoint.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektu HTML (CVE-2010-0492)  
-   Paul Stone z firmy [Context Information Security](http://www.contextis.co.uk/) za zgłoszenie luki w zabezpieczeniach międzydomenowych związanej z elementem HTML (CVE-2010-0494)  
-   Anonimowy analityk współpracujący z [Zero Day Initiative](http://www.zerodayinitiative.com/) firmy [TippingPoint](http://www.tippingpoint.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci (CVE-2010-0805)  
-   ADLab z firmy [VenusTech](http://www.venustech.com.cn/), za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci (CVE-2010-0806)  
-   ADLab z firmy [VenusTech](http://www.venustech.com.cn/), za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci usługi renderowania stron HTML (CVE-2010-0807)
...
-   Wer. 1.0 (30 marca 2010 r.): Opublikowano biuletyn.
