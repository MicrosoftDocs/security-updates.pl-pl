---
TOCTitle: 'MS10-057'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-057 - Ważna'
ms:assetid: 'ms10-057'
ms:contentKeyID: 61232850
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-057(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-057 - Ważna
======================================================

Luka w zabezpieczeniach programu Microsoft Office Excel umożliwia zdalne wykonanie kodu (2269707)
-------------------------------------------------------------------------------------------------

Opublikowano: 10 sierpnia 2010 | Zaktualizowano: 11 sierpnia 2010
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji programów Microsoft Office Excel 2002, Microsoft Office Excel 2003, pakietu Microsoft Office 2004 dla komputerów Macintosh i pakietu Microsoft Office 2008 dla komputerów Macintosh oraz programu Open XML File Format Converter dla komputerów Macintosh. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem, i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja usuwa lukę, zmieniając sposób, w jaki program Microsoft Office Excel analizuje specjalnie spreparowane pliki programu Excel. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.

**Zalecenie.** Firma Microsoft zaleca klientom jak najszybsze zastosowanie tej aktualizacji.

**Znane problemy.** W [artykule 2269707 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2269707) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
| Przeglądarka programu Microsoft Office Excel z dodatkiem Service Pack 2                                                         |
...
Luka ma na autonomiczne programy pakietu Office wpływ o takim samym wskaźniku ważności, co na odpowiadające im składniki w pakiecie Office. Przykładowo, wskaźnik ważności luki dla autonomicznej instalacji programu Microsoft Office Excel jest taki sam, jak dla instalacji programu Microsoft Office Excel, który był dostarczony wraz z pakietem Office.
...
<th>
Luka w zabezpieczeniach programu Excel związana z uszkodzeniem pamięci – CVE-2010-2562
</th>
<th>
Zbiorczy wskaźnik ważności
</th>
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-2562](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2562).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci – CVE-2010-2562
...
#### Obejścia dotyczące luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci – CVE-2010-2562
...
-   **Nie należy otwierać plików pakietu Microsoft Office otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych**
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci – CVE-2010-2562
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2264397">artykuł 2264397 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2264403">artykuł 2264403 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Damián Frizza z firmy [Core Security Technologies](http://www.coresecurity.com/) za zgłoszenie luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci (CVE-2010-2562)
...
-   Wer. 1.1 (11 sierpnia 2010 r.): Dodano łącze do artykułu 2269707 bazy wiedzy Microsoft Knowledge Base w części „Znane problemy” sekcji „Streszczenie”.
