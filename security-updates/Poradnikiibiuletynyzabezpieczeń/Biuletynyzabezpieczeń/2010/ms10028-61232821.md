---
TOCTitle: 'MS10-028'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-028 - Ważna'
ms:assetid: 'ms10-028'
ms:contentKeyID: 61232821
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-028(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-028 - Ważna
======================================================

Luki w zabezpieczeniach programu Microsoft Visio umożliwiają zdalne wykonanie kodu (980094)
-------------------------------------------------------------------------------------------
...
Ta aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla programów Microsoft Office Visio 2002 z dodatkiem Service Pack 2, Microsoft Office Visio 2003 z dodatkiem Service Pack 3, Microsoft Office Visio 2007 z dodatkiem Service Pack 1 i Microsoft Office Visio 2007 z dodatkiem Service Pack 2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa te luki, modyfikując sposób, w jaki program Microsoft Office Visio sprawdza poprawność atrybutów i oblicza indeksy podczas otwierania specjalnie spreparowanych plików programu Visio. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2d563cbc-d8f7-486b-8c54-25d168085376">Microsoft Office Visio 2002 z dodatkiem Service Pack 2</a><br />
(KB979364)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=803a7ea0-a9da-46dd-9548-0177d3774be7">Microsoft Office Visio 2003 z dodatkiem Service Pack 3</a><br />
(KB979356)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=56fe020f-4444-4a43-aa98-e99a622f6a69">Microsoft Office Visio 2007 z dodatkiem Service Pack 1</a><br />
(KB979365)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=128107">MS09-005</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=56fe020f-4444-4a43-aa98-e99a622f6a69">Microsoft Office Visio 2007 z dodatkiem Service Pack 2</a><br />
(KB979365)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach procedury sprawdzania poprawności atrybutów programu Visio związana z uszkodzeniem pamięci — CVE-2010-0254</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach procedury obliczania indeksów programu Visio związana z uszkodzeniem pamięci — CVE-2010-0256</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Visio 2002 z dodatkiem Service Pack 2</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Visio 2003 z dodatkiem Service Pack 3</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Visio 2007 z dodatkiem Service Pack 1 i Microsoft Office Visio 2007 z dodatkiem Service Pack 2</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
...
Luka w zabezpieczeniach procedury sprawdzania poprawności atrybutów programu Visio związana z uszkodzeniem pamięci — CVE-2010-0254  
----------------------------------------------------------------------------------------------------------------------------------
  
<span></span>
W programie Microsoft Office Visio występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana ze sposobem sprawdzania poprawności atrybutów podczas obsługi specjalnie spreparowanych plików tego programu.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0254).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach procedury sprawdzania poprawności atrybutów programu Visio związanej z uszkodzeniem pamięci — CVE-2010-0254
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Użytkownicy programu Microsoft Office Visio 2002 i nowszych wersji będą przed otwarciem dokumentu monitowani o jego otwarcie, zapisanie lub anulowanie. Jest to czynnik ograniczający zagrożenie, ponieważ do wykorzystania luki w zabezpieczeniach jest wymagane więcej niż jedno działanie użytkownika.  
-   Luki nie można wykorzystać automatycznie, przez pocztę elektroniczną. Aby atak przeprowadzony w ten sposób powiódł się, użytkownik musi otworzyć załącznik wiadomości e-mail. Aby wykorzystać lukę w zabezpieczeniach, osoba atakująca musiałaby nakłonić użytkownika do otwarcia załącznika.  
...
#### Obejścia dotyczące luki w zabezpieczeniach procedury sprawdzania poprawności atrybutów programu Visio związanej z uszkodzeniem pamięci — CVE-2010-0254
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   Nie należy otwierać plików programu Visio otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik. Rozszerzenie nazw plików .vsd jest zazwyczaj skojarzone z plikami programu Visio.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach procedury sprawdzania poprawności atrybutów programu Visio związanej z uszkodzeniem pamięci — CVE-2010-0254
...
Luka wynika ze sposobu, w jaki program Microsoft Office Visio obsługuje pamięć podczas otwierania specjalnie spreparowanych plików tego programu.
...
Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik programu Visio przy użyciu zagrożonej tą luką wersji programu Microsoft Office Visio.
...
Szczególnie zagrożone są systemy, w których jest używany program Microsoft Office Visio, w tym stacje robocze i serwery terminali. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie programów. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.
  
**W jaki sposób działa aktualizacja?**    
Niniejsza aktualizacja usuwa lukę, poprawiając sposób, w jaki program Microsoft Office Visio sprawdza poprawność atrybutów podczas otwierania specjalnie spreparowanych plików tego programu.
...
Luka w zabezpieczeniach procedury obliczania indeksów programu Visio związana z uszkodzeniem pamięci — CVE-2010-0256  
--------------------------------------------------------------------------------------------------------------------
  
<span></span>
W programie Microsoft Office Visio występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana ze sposobem obliczania indeksów podczas obsługi specjalnie spreparowanych plików tego programu.
  
Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0256).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach procedury obliczania indeksów programu Visio związanej z uszkodzeniem pamięci — CVE-2010-0256
...
#### Obejścia dotyczące luki w zabezpieczeniach procedury obliczania indeksów programu Visio związanej z uszkodzeniem pamięci — CVE-2010-0256
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   Nie należy otwierać plików programu Visio otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach procedury obliczania indeksów programu Visio związanej z uszkodzeniem pamięci — CVE-2010-0256
...
**W jaki sposób działa aktualizacja?**    
Niniejsza aktualizacja usuwa lukę, poprawiając sposób, w jaki program Microsoft Office Visio oblicza indeksy podczas otwierania specjalnie spreparowanych plików tego programu.
...
|--------------------------------------------------------|------------|  
| Microsoft Office Visio 2002 z dodatkiem Service Pack 2 | Tak        |  
| Microsoft Office Visio 2003 z dodatkiem Service Pack 3 | Tak        |  
| Microsoft Office Visio 2007 z dodatkiem Service Pack 1 | Tak        |  
| Microsoft Office Visio 2007 z dodatkiem Service Pack 2 | Tak        |
...
|--------------------------------------------------------|---------|---------------------------|---------------------------|----------------------------|  
| Microsoft Office Visio 2002 z dodatkiem Service Pack 2 | Nie     | Nie                       | Tak                       | Tak                        |  
| Microsoft Office Visio 2003 z dodatkiem Service Pack 3 | Nie     | Nie                       | Tak                       | Tak                        |  
| Microsoft Office Visio 2007 z dodatkiem Service Pack 1 | Nie     | Nie                       | Tak                       | Tak                        |  
| Microsoft Office Visio 2007 z dodatkiem Service Pack 2 | Nie     | Nie                       | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/979364">artykuł 979364 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/979356">artykuł 979356 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/979365">artykuł 979365 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Bing Liu z [FortiGuard Labs](http://www.fortiguard.com/) firmy Fortinet, za zgłoszenie luki w zabezpieczeniach procedury sprawdzania poprawności atrybutów programu Visio związanej z uszkodzeniem pamięci (CVE-2010-0254)  
-   Bing Liu z [FortiGuard Labs](http://www.fortiguard.com/) firmy Fortinet, za zgłoszenie luki w zabezpieczeniach procedury obliczania indeksów programu Visio związanej z uszkodzeniem pamięci (CVE-2010-0256)
