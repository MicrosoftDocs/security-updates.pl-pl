---
TOCTitle: 'MS10-081'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-081 - Ważna'
ms:assetid: 'ms10-081'
ms:contentKeyID: 61232874
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-081(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-081 - Ważna
======================================================

Luka w zabezpieczeniach biblioteki wspólnych formantów systemu Windows umożliwia zdalne wykonanie kodu (2296011)
----------------------------------------------------------------------------------------------------------------
...
Aktualizacja usuwa lukę, poprawiając sposób, w jaki wspólne formanty systemu Windows obsługują komunikaty przekazywane z przeglądarki skalowalnej grafiki wektorowej (SVG) innej firmy. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=912a7c20-8177-4f65-b986-43fca6375ec1)                                                                                                    | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c651bca-adb1-4172-9714-cd5a6e5d2c2a)                                                                           | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b2eb449-ad55-4dfb-a3c5-aac767de6f45)                                                                                           | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54fc4bc6-f46c-447c-8307-afd8338e7ffb)                                                                               | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=64f5c311-d74a-4665-9775-ac91c6885ed3)                                                                    | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=95ceafc6-e37a-4c77-b16e-c9c94a7d89bd)                                                      | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dfe7cd18-53a3-433e-9a33-bd96b04b4deb)                              | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=d5f079b0-d8e1-47fe-b9dd-41eeb463a93c)\*\*               | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=8e88d9c5-eb57-4d39-a880-a478c5f286da)\*\*     | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=76e46d08-22d9-4a0c-82cd-d2753d07efe6) | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows 7 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=bdff9057-381a-44e8-b093-84f07d8d7e3c)                                                                                                       | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows 7 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=35a2b1a9-6dd6-4a7e-bc0a-b4fcffa06b28)                                                                                                  | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=25fff010-3abc-45e6-979e-21d2bae49418)\*\*                                                                      | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d0742526-b5ec-4658-82f1-c3680f33a790)                                                                      | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach biblioteki Comctl32 związana z przepełnieniem stosu – CVE-2010-2746</th>
...
Luka w zabezpieczeniach biblioteki Comctl32 związana z przepełnieniem stosu – CVE-2010-2746  
-------------------------------------------------------------------------------------------
  
<span></span>
Sposób renderowania przez bibliotekę wspólnych formantów systemu Windows specjalnie spreparowanych witryn sieci Web podczas korzystania z przeglądarki skalowalnej grafiki wektorowej (SVG) innej firmy powoduje powstanie luki w zabezpieczeniach umożliwiającej zdalne wykonanie kodu. Ta luka w zabezpieczeniach umożliwia zdalne wykonanie kodu, jeśli użytkownik odwiedzi specjalnie spreparowaną stronę sieci Web. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzysta tę lukę, może uzyskać pełną kontrolę nad systemem, którego ta luka dotyczy. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-2746](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2746).
  
#### Czynniki ograniczające zagrożenie powodowane przez lukę w zabezpieczeniach biblioteki Comctl32 związaną z przepełnieniem stosu – CVE-2010-2746
...
-   W domyślnej konfiguracji systemu Windows wykorzystanie tej luki jest niemożliwe. Aby wystąpiło zagrożenie omawianą luką, w systemie musi być zainstalowana aplikacja innego producenta, która renderuje grafikę SVG.
  
#### Obejścia problemu powodowanego przez lukę w zabezpieczeniach biblioteki Comctl32 związaną z przepełnieniem stosu – CVE-2010-2746
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach biblioteki Comctl32 związanej z przepełnieniem stosu – CVE-2010-2746
...
Podczas renderowania skalowalnej grafiki wektorowej biblioteka wspólnych formantów systemu Windows nie zapewnia prawidłowej obsługi pewnych komunikatów przekazywanych z przeglądarki grafiki SVG innego producenta.
  
**Co to są biblioteki wspólnych formantów systemu Windows?**    
Wspólne formanty to zestaw okien wdrażanych przez bibliotekę wspólnych formantów, Comctl32.dll, która jest plikiem DLL dostarczanym wraz z systemem operacyjnym Windows. Podobnie jak inne okna formantów, wspólny formant to okno potomne używane przez aplikację w połączeniu z innym oknem w celu umożliwienia interakcji z użytkownikiem. Aby uzyskać więcej informacji o tych bibliotekach, zapoznaj się z artykułem MSDN [Informacje o formantach wspólnych](http://msdn.microsoft.com/en-us/library/bb775493(vs.85).aspx).
  
**Czy wykorzystanie tej luki jest możliwe w domyślnej konfiguracji systemu Windows?**    
Nie. Aby wystąpiło zagrożenie omawianą luką, w systemie musi być zainstalowana aplikacja innego producenta, która renderuje grafikę SVG. Firma Microsoft nie znalazła żadnego kierunku ataku dla systemów, w których nie zainstalowano tego rodzaju przeglądarki. Listę wdrożeń SVG można znaleźć na stronie [wdrożeń SVG](http://www.w3.org/graphics/svg/wg/wiki/implementations) organizacji World Wide Web Consortium (W3C).
  
**Co to jest skalowalna grafika wektorowa?**    
Skalowalna grafika wektorowa (SVG) to standard tworzenia i wdrażania dwuwymiarowych grafik wektorowych przy użyciu dokumentów XML. Stosowanie go jest zaleceniem organizacji W3C (World Wide Web Consortium), w którego tworzeniu i zatwierdzaniu uczestniczył szereg organizacji branżowych. Grafika SVG zasadniczo jest dokumentem XML, który zachowuje zgodność ze schematem będącym elementem procesu ratyfikacji SVG. W specyfikacji zdefiniowano szereg podstawowych kształtów geometrycznych, jak na przykład prostokąty, okręgi, elipsy, linie, wielolinie, wielokąty i symbole w rodzaju tekstu. Do tworzenia bardziej złożonych kształtów używa się elementu ścieżki. Pozwala on definiować kształty będące sekwencjami linii, łuków i skomplikowanych krzywych Beziera. Podstawowe kształty przy odrobinie pomysłowości pozwalają narysować nawet najbardziej złożone twory geometryczne.
...
Aktualizacja usuwa lukę, poprawiając sposób, w jaki biblioteka wspólnych formantów systemu Windows obsługuje określone komunikaty przekazywane z przeglądarki skalowalnej grafiki wektorowej (SVG) innej firmy.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2296011$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2296011">artykuł 2296011 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Krystian Kloskowski (h07), we współpracy z firmą [Secunia](http://secunia.com/), za zgłoszenie luki w zabezpieczeniach biblioteki Comctl32 związanej z przepełnieniem stosu (CVE-2010-2746)
