---
TOCTitle: 'MS10-029'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-029 - Umiarkowana'
ms:assetid: 'ms10-029'
ms:contentKeyID: 61232822
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-029(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-029 - Umiarkowana
============================================================

Luka w zabezpieczeniach składnika ISATAP systemu Windows może umożliwić fałszowanie (978338)
--------------------------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 2 i Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613)                                                            | Fałszowanie                        | Umiarkowany                | Brak                                                      |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f)                                                                           | Fałszowanie                        | Umiarkowany                | Brak                                                      |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477)                                                                                           | Fałszowanie                        | Umiarkowany                | Brak                                                      |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb)                                                                               | Fałszowanie                        | Umiarkowany                | Brak                                                      |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d)                                                                    | Fałszowanie                        | Umiarkowany                | Brak                                                      |
| [Windows Vista, Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176)                                       | Fałszowanie                        | Umiarkowany                | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36)   | Fałszowanie                        | Umiarkowany                | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych\*](http://www.microsoft.com/downloads/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be)                 | Fałszowanie                        | Umiarkowany                | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64\*](http://www.microsoft.com/downloads/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84)       | Fałszowanie                        | Umiarkowany                | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842) | Fałszowanie                        | Umiarkowany                | [MS10-009](http://go.microsoft.com/fwlink/?linkid=167190) |

**\*Luka w zabezpieczeniach dotyczy instalacji Server Core.** Ta aktualizacja odnosi się, z takim samym wskaźnikiem ważności, do obsługiwanych wersji systemu Windows Server 2008, niezależnie od tego, czy zostały zainstalowane przy użyciu opcji instalacji Server Core. Aby uzyskać więcej informacji na temat tej opcji instalacji, zobacz artykuł MSDN, [Server Core](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx). Należy pamiętać, że opcja instalacji Server Core nie dotyczy niektórych wersji systemu Windows Server 2008; zobacz [Porównanie opcji instalacji Server Core](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx).
...
Niniejsza aktualizacja zabezpieczeń implementuje dwie nowe funkcje zabezpieczeń:

-   **Lista potencjalnych routerów (Potential Router List, PRL) na klientach ISATAP:** Lista PRL umożliwia klientom sprawdzenie adresu źródłowego dla nadchodzących tunelowanych pakietów ISATAP. Lista PRL jest włączana domyślnie po zainstalowaniu niniejszej aktualizacji zabezpieczeń i pomaga usunąć lukę w zabezpieczeniach protokołu ISATAP związaną z fałszowaniem adresów źródłowych IPv6, która została opisana pod numerem CVE-2010-0812. Więcej informacji o listach PRL można znaleźć w [artykule 978338 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/978338).
-   **Wykrywanie niedostępności sąsiadów (Neighbor Unreachability Detection, NUD) w interfejsach ISATAP:** Funkcja NUD służy do sprawdzania, czy sąsiednie urządzenie jest dostępne. Funkcja NUD jest używana przez węzły ISATAP przed przesłaniem pakietów ISATAP. Funkcja NUD domyślnie nie jest włączona i musi zostać ręcznie skonfigurowana przez administratorów sieci. Więcej informacji na temat funkcji NUD i sposobu jej włączenia można znaleźć w [artykule 978338 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/978338).

**Dlaczego system Microsoft Windows 2000 nie podlega omawianej luce w zabezpieczeniach?**
System Microsoft Windows 2000 nie oferuje obsługi IPv6 i dlatego nie podlega omawianej luce.

**Dlaczego omawiana luka w zabezpieczeniach nie dotyczy systemów Windows 7 ani Windows Server 2008 R2?**
Funkcje wdrażane przez niniejszą aktualizację zabezpieczeń, Lista potencjalnych routerów (PRL) oraz Wykrywanie niedostępności sąsiadów (NUD), są już dostępne w systemach Windows 7 i Windows Server 2008 R2.

**Uwaga** Funkcja PRL jest domyślnie uruchomiona na tych platformach, ale funkcja NUD nie jest i musi zostać ręcznie skonfigurowana przez administratora sieci. Dodatkowe informacje na temat tej funkcji można znaleźć w [artykule 978338 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/978338).

**Czy ta aktualizacja będzie oferowana nawet dla systemów bez włączonej obsługi protokołu IPv6?**
Tak, niniejsza aktualizacja zabezpieczeń będzie oferowana za pośrednictwem funkcji Aktualizacje automatyczne, ponieważ w systemach tych jest obecny niebezpieczny kod. Zaleca się, aby klienci planujący w przyszłości wdrożenie protokołu IPv6 zainstalowali tę aktualizację zabezpieczeń.
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach protokołu ISATAP związana z fałszowaniem adresów źródłowych IPv6 - CVE-2010-0812</th>
...
Luka w zabezpieczeniach protokołu ISATAP związana z fałszowaniem adresów źródłowych IPv6 - CVE-2010-0812  
--------------------------------------------------------------------------------------------------------
  
<span></span>
W stosie IPv6 systemu Microsoft Windows istnieje luka umożliwiająca fałszowanie, związana ze sposobem, w jaki system Windows sprawdza źródłowy adres IPv6 wewnętrznego pakietu w tunelowanym pakiecie protokołu ISATAP. Osoba atakująca, której uda się wykorzystać tę lukę, może podszywać się pod adres w celu ominięcia zapór na brzegu lub w hostach. Ponadto może dojść do ujawnienia informacji, jeśli zaatakowany komputer odpowie na komunikat przy użyciu źródłowego adresu IPv6 określonego przez osobę atakującą.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0812](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach protokołu ISATAP związanej z fałszowaniem adresów źródłowych IPv6 - CVE-2010-0812
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Omawiana luka ma wpływ tylko na systemy Windows, w których skonfigurowano interfejs ISATAP.
  
#### Obejścia dotyczące luki w zabezpieczeniach protokołu ISATAP związanej z fałszowaniem adresów źródłowych IPv6 - CVE-2010-0812
...
-   **Wyłączenie interfejsu ISATAP IPv6**
  
    Aby wyłączyć interfejs ISATAP IPv6, uruchom następujące polecenie z wiersza polecenia, mając podniesione uprawnienia:
    ...
    **Wpływ obejścia.** Wyłączenie interfejsu ISATAP zapobiegnie używaniu przez system protokołu ISATAP jako mechanizmu tunelowania IPv6.
  
    **Cofnięcie obejścia.**
  
    Aby ponownie włączyć interfejs ISATAP IPv6, uruchom następujące polecenie z wiersza polecenia, mając podniesione uprawnienia:
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach protokołu ISATAP związanej z fałszowaniem adresów źródłowych IPv6 - CVE-2010-0812
  
**Jaki zakres obejmuje ta luka?**  
Jest to luka w zabezpieczeniach związana z fałszowaniem. Luka ta może pozwolić osobie atakującej na sfałszowanie adresu IPv4, tak aby mógł on ominąć urządzenia filtrujące, które bazują na źródłowym adresie IPv4.
  
**W jaki sposób powstaje luka?**  
Przyczyną występowania luki jest brak odpowiedniego sprawdzenia źródłowego adresu IPv6 w tunelowanym pakiecie ISATAP przez stos TCP/IP systemu Windows.
  
**Co to jest ISATAP?**  
Protokół ISATAP (Intra-Site Automatic Tunnel Addressing Protocol) zapewnia łączność przy użyciu protokołu IPv6 w intranecie z protokołem IPv4. Informacje na temat protokołu ISATAP znajdują się w specyfikacji [RFC5214: Intra-Site Automatic Tunnel Addressing Protocol (ISATAP)](http://www.ietf.org/rfc/rfc5214.txt).
  
**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**  
Osoba atakująca może podszyć się pod innego użytkownika lub system, co może jej pozwolić na ominięcie filtrów adresów źródłowych, takich jak zapory na brzegu lub w hostach.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**  
Osoba atakująca może próbować wykorzystać tę lukę, tworząc w połączeniu ISATAP specjalnie spreparowane pakiety sieciowe zawierające specjalnie spreparowany źródłowy adres IPv6, który nie pasuje do odpowiadającego adresu źródłowego IPv4.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**  
Na skutki tej luki narażone są wszystkie systemy operacyjne z włączonymi funkcjami protokołu ISATAP IPv6.
  
**W jaki sposób działa aktualizacja?**  
Aktualizacja usuwa lukę, zmieniając sposób, w jaki stos TCP/IP systemu Windows sprawdza źródłowy adres IPv6 w tunelowanym pakiecie protokołu ISATAP.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB978338$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/978338">artykuł 978338 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
Gabi Nakibly z firmy National EW Research & Simulation Center (w Rafael), za zgłoszenie luki w zabezpieczeniach protokołu ISATAP związanej z fałszowaniem adresów źródłowych IPv6 - (CVE-2010-0812)
...
-   Wer. 1.1 (21 kwietnia 2010 r.): Poprawiono informację o zastępowanych biuletynach dla wszystkich pakietów aktualizacyjnych dla systemów Windows Vista i Windows Server 2008.
