---
TOCTitle: 'MS10-094'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-094 - Ważna'
ms:assetid: 'ms10-094'
ms:contentKeyID: 61232887
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-094(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-094 - Ważna
======================================================

Luka w zabezpieczeniach programu Windows Media Encoder może umożliwić zdalne wykonanie kodu (2447961)
-----------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji systemu Windows XP, Windows Server 2003 (z wyjątkiem wersji dla systemów z procesorem Itanium), Windows Vista i Windows Server 2008 (z wyjątkiem wersji dla systemów z procesorem Itanium). Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem, i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki program Windows Media Encoder ładuje biblioteki zewnętrzne. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach związana z niebezpiecznym ładowaniem bibliotek — CVE-2010-3965  
</th>
<th style="border:1px solid black;" >
...
Windows Media Encoder 9 x86 w systemie Windows XP z dodatkiem Service Pack 3
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<td style="border:1px solid black;">
Windows Media Encoder 9 x86 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
Windows Media Encoder 9 x64 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Encoder 9 x86 w systemie Windows Server 2003 z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
Windows Media Encoder 9 x86 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Encoder 9 x64 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
Windows Media Encoder 9 x86 w systemie Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Encoder 9 x86 w systemie Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
Windows Media Encoder 9 x64 w systemie Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Encoder 9 x86 w systemie Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych\*\*
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
Windows Media Encoder 9 x86 w systemie Windows Server 2008 dla systemów opartych na procesorze x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów opartych na procesorze x64\*\*
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Media Encoder 9 x64 w systemie Windows Server 2008 dla systemów opartych na procesorze x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów opartych na procesorze x64\*\*
</td>
<td style="border:1px solid black;">
**Ważny**   
Zdalne wykonanie kodu
...
<span></span>
Sposób, w jaki system Microsoft Windows obsługuje ładowanie plików DLL, powoduje powstanie luki w zabezpieczeniach umożliwiającej zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3965](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek — CVE-2010-3965

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Aby atak mógł się powieść, użytkownik musi odwiedzić niezaufaną zdalną lokalizację systemu plików lub udział WebDAV i otworzyć plik .prx.
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z niebezpiecznym ładowaniem bibliotek — CVE-2010-3965
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek — CVE-2010-3965
...
Luka powstaje, ponieważ program Windows Media Encoder nieprawidłowo ogranicza ścieżkę używaną do ładowania bibliotek zewnętrznych.

**Co to jest program Windows Media Encoder?**  
Program Microsoft Windows Media Encoder to łatwe w użyciu, zaawansowane narzędzie produkcyjne do konwersji dźwięku i filmów (zarówno wstępnie nagranych, jak i na żywo) do formatu Windows Media.

**Co to jest plik profilu Windows Media (.prx)?**  
Plik PRX zawiera ustawienia kodowania dla filmów. Pliki PRX są tworzone poprzez zastosowanie ustawień kodowania, takich jak szybkość transmisji bitów i rozmiar obrazu wideo, do filmu w programie Microsoft Expression Encoder lub Microsoft Windows Encoder, a następnie zapisanie tych ustawień na dysku twardym. Jeśli w programie Windows Encoder utworzono i zapisano określone ustawienia, można je udostępnić dla programu Expression Encoder, dzięki czemu nie będzie konieczne ponowne tworzenie złożonego zestawu określonych ustawień kodowania. Aby uzyskać więcej informacji na temat plików PRX, zobacz artykuł MSDN [Obsługa plików PRX](http://msdn.microsoft.com/en-us/library/cc294539.aspx).
...
Osoba atakująca mogłaby nakłonić użytkownika do otwarcia prawidłowego pliku .prx znajdującego się w tym samym katalogu sieciowym co specjalnie spreparowany plik biblioteki dołączanej dynamicznie (biblioteki DLL). Podczas otwierania pliku .prx program Windows Media Encoder podejmie próbę załadowania pliku DLL i wykonania zawartego w nim kodu.

Osoba atakująca za pośrednictwem poczty e-mail może wykorzystać tę lukę, wysyłając do użytkownika w załączniku prawidłowy plik .prx, a następnie przekonując użytkownika do umieszczenia tego załącznika w katalogu, który zawiera specjalnie spreparowany plik DLL i do otwarcia pliku .prx. Podczas otwierania pliku .prx program Windows Media Encoder podejmie próbę załadowania specjalnie spreparowanego pliku DLL i wykonania zawartego w nim kodu.

Osoba atakująca za pośrednictwem sieci może umieścić prawidłowy plik .prx wraz ze specjalnie spreparowanym plikiem DLL w lokalizacji UNC lub WebDAV, a następnie przekonać użytkownika do otwarcia pliku .prx.
...
Aktualizacja zabezpieczeń usuwa lukę, zmieniając sposób, w jaki program Windows Media Encoder ładuje zewnętrzne biblioteki.

**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**  
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-3965](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3965).
...
<td style="border:1px solid black;">Windows Media Encoder 9 x86 w systemie Windows XP z dodatkiem Service Pack 3:<br />
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2447961">artykuł 2447961 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Media Encoder 9 x86 w systemie Windows Server 2008 dla systemów z procesorem x64 z dodatkiem Service Pack 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\KB2447961</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Media Encoder 9 x64 w systemie Windows Server 2008 dla systemów z procesorem x64 z dodatkiem Service Pack 2<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\KB2447961</td>
</tr>
</tbody>
</table>
