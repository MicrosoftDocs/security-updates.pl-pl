...
#### Obejścia problemu wynikającego z luki związanej z analizowaniem formatu pliku programu Excel – CVE-2010-3232
...
-   Użyj funkcji File Block pakietu Microsoft Office w celu blokowania otwierania dokumentów pakietu Office w wersji 2003 lub wcześniejszej, pochodzących z nieznanych lub niezaufanych źródeł
    ...
    `Edytor reje``stru systemu Windows 5.00`
    ...
    Office 2003
    `Edytor rejestru systemu Windows 5.00`
    `[HKEY_CURRENT_USER\Software\Mic``rosoft\Office\11.0\Excel\Security\FileOpenBlock]`
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3233](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233).
...
Dlaczego ta luka ma umiarkowany wskaźnik ważności dla pakietu Microsoft Excel 2003 z dodatkiem Service Pack 3?  
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3234](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234).
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3237](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237).
...
-   Użyj funkcji File Block pakietu Microsoft Office w celu blokowania otwierania dokumentów pakietu Office w wersji 2003 lub wcześniejszej, pochodzących z nieznanych lub niezaufanych źródeł
    ...
    Pakiet Office 2003 
    `Edytor rejestru systemu Windows 5.00`
    `[HKEY_CURRENT_USER\Softwar``e\Microsoft\Office\11.0\Excel\Security\FileOpenBlock]`
    `"BinaryFiles"=dword:00000001`
    Uwaga Aby można było użyć funkcji „FileOpenBlock” w pakiecie Microsoft Office 2003, muszą być zainstalowane wszystkie najnowsze aktualizacje zabezpieczeń dla pakietu Microsoft Office 2003.
...
#### Najczęściej zadawane pytania na temat luki w zabezpieczeniach programu Word związanej z ujemną funkcją z przyszłą datą – CVE-2010-3238:

Jaki zakres obejmuje luka?  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może zdalnie uzyskać pełną kontrolę nad systemem jej podlegającym. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Skąd bierze się luka?  
Gdy w programie Microsoft Excel zostaną sprawdzone informacje o formacie pliku binarnego po otwarciu specjalnie spreparowanego pliku programu Excel, może nastąpić uszkodzenie pamięci systemowej, które umożliwi osobie atakującej wykonanie dowolnego kodu.
...
W jaki sposób działa aktualizacja?   
Aktualizacja usuwa lukę w zabezpieczeniach, modyfikując sposób sprawdzania poprawności formatu pliku binarnego w programie Microsoft Excel.
...
Luka w zabezpieczeniach związana z analizą dodatkowego rekordu przekroczenia granic – CVE-2010-3239
---------------------------------------------------------------------------------------------------

<span></span>
W programie Microsoft Excel istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez program Excel specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3239](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239).

#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach związanej z analizą dodatkowego rekordu przekroczenia granic – CVE-2010-3239
...
#### Obejścia luki w zabezpieczeniach związanej z analizą dodatkowego rekordu przekroczenia granic – CVE-2010-3239
...
#### Najczęściej zadawane pytania na temat luki w zabezpieczeniach związanej z analizą dodatkowego rekordu przekroczenia granic – CVE-2010-3239
...
Luka w zabezpieczeniach związana z rekordem tablic danych czasu rzeczywistego – CVE-2010-3240
---------------------------------------------------------------------------------------------

<span></span>
W programie Microsoft Excel istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez program Excel specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3240](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240).

#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach związanej z rekordem tablic danych czasu rzeczywistego – CVE-2010-3240
...
#### Obejścia luki w zabezpieczeniach związanej z rekordem tablic danych czasu rzeczywistego – CVE-2010-3240
...
-   Użyj funkcji File Block pakietu Microsoft Office w celu blokowania otwierania dokumentów pakietu Office w wersji 2003 lub wcześniejszej, pochodzących z nieznanych lub niezaufanych źródeł
    ...
    Wpływ obejścia. Użytkownicy, którzy skonfigurowali funkcję File Block, ale nie skonfigurowali specjalnego „katalogu wyjątków” omówionego w [artykule 922848 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/922848), nie będą mogli otwierać plików pakietu Office w wersji 2003 lub wcześniejszej w programach pakietu Office 2007.

    Cofnięcie obejścia.

    Pakiet Office 2007
    `Edyto``r rejestru systemu Windows 5.00`
    `[HKEY_CURRENT_USER\Software\Policies\Microsoft\Office\12.0\Excel\Security\FileOpenBlock]`
    `"BinaryFiles"=dword:00000000`
...
#### Najczęściej zadawane pytania na temat luki w zabezpieczeniach związanej z rekordem tablic danych czasu rzeczywistego – CVE-2010-3240
...
Luka w zabezpieczeniach związana z zapisem poza granicami dostępnej pamięci w trakcie analizy – CVE-2010-3241
-------------------------------------------------------------------------------------------------------------

<span></span>
W programie Microsoft Excel istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez program Excel specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3241](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241).

#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach związanej z zapisem poza granicami dostępnej pamięci w trakcie analizy – CVE-2010-3241
...
#### Obejścia luki w zabezpieczeniach związanej z zapisem poza granicami dostępnej pamięci w trakcie analizy – CVE-2010-3241
...
#### Najczęściej zadawane pytania na temat luki w zabezpieczeniach związanej z zapisem poza granicami dostępnej pamięci w trakcie analizy – CVE-2010-3241
...
Luka w zabezpieczeniach związana z analizą rekordów typu ghost – CVE-2010-3242
------------------------------------------------------------------------------

<span></span>
W programie Microsoft Excel istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez program Excel specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3242](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z analizą rekordów typu ghost – CVE-2010-3242
...
#### Obejścia luki w zabezpieczeniach związanej z analizą rekordów typu ghost – CVE-2010-3242
...
#### Najczęściej zadawane pytania na temat luki w zabezpieczeniach związanej z analizą rekordów typu ghost – CVE-2010-3242
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2345017">artykuł 2345017 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Informacje dotyczące plików</td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2344893">artykuł 2344893 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Weryfikacja klucza rejestru</td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### Excel 2007 (wszystkie wersje) i Przeglądarka programu Excel (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;">Informacje dotyczące plików</td>
<td style="border:1px solid black;">W przypadku pakietu Microsoft Excel 2007 patrz <a href="http://support.microsoft.com/kb/2345035">artykuł bazy wiedzy Microsoft Knowledge Base 2345035</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku Przeglądarki programu Microsoft Excel patrz <a href="http://support.microsoft.com/kb/2345088">artykuł bazy wiedzy Microsoft Knowledge Base 2345088</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku Pakietu zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 zobacz <a href="http://support.microsoft.com/kb/2344875">artykuł 2344875 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Weryfikacja klucza rejestru</td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Alin Rad Pop z firmy [Secunia](http://secunia.com/) za zgłoszenie luki w zabezpieczeniach programu Excel związanej z analizą liczb całkowitych (CVE-2010-3230)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach programu Excel związanej z analizowaniem rekordów i uszkodzeniem pamięci (CVE-2010-3231)  
-   Omair za zgłoszenie luki w zabezpieczeniach związanej z analizowaniem formatu pliku programu Excel (CVE-2010-3232)  
-   Carsten H. Eiram z firmy [Secunia](http://secunia.com/), za zgłoszenie luki w zabezpieczeniach związanej z analizowaniem skoroszytów programu Lotus 1-2-3 (CVE-2010-3233)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach związanej z podstrumieniami formuł i uszkodzeniem pamięci (CVE-2010-3234)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach związanej z rekordem Biff formuł (CVE-2010-3235)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach związanej z przekroczeniem zakresu tablicy (CVE-2010-3236)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach związanej ze wskaźnikami rekordów scalania komórek (CVE-2010-3237)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach związanej z ujemną funkcją z przyszłą datą (CVE-2010-3238)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach związanej z analizą dodatkowego rekordu przekroczenia granic (CVE-2010-3239)  
-   Alin Rad Pop z firmy [Secunia](http://secunia.com/) za zgłoszenie luki w zabezpieczeniach związanej z analizą dodatkowego rekordu przekroczenia granic (CVE-2010-3239)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach związanej z rekordem tablic danych czasu rzeczywistego (CVE-2010-3240)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach związanej z zapisem poza granicami dostępnej pamięci w trakcie analizy (CVE-2010-3241)  
-   Chaouki Bekrar z firmy [VUPEN Vulnerability Research Team](http://www.vupen.com/) za zgłoszenie luki w zabezpieczeniach związanej z analizą rekordów typu ghost (CVE-2010-3242)  
-   Carsten H. Eiram z firmy [Secunia](http://secunia.com/) za zgłoszenie luki w zabezpieczeniach związanej z analizą rekordów typu ghost (CVE-2010-3242)
