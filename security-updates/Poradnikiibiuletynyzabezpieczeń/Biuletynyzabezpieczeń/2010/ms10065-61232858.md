---
TOCTitle: 'MS10-065'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-065 - Ważna'
ms:assetid: 'ms10-065'
ms:contentKeyID: 61232858
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-065(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-065 - Ważna
======================================================

Luki w zabezpieczeniach programu Microsoft Internet Information Services (IIS) umożliwiają zdalne wykonanie kodu (2267960)
--------------------------------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla programów IIS 5.1, IIS 6.0, IIS 7.0 i IIS 7.5. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja usuwa luki, zmieniając sposób, w jaki program IIS obsługuje specjalnie spreparowane żądania HTTP. Więcej informacji na temat luk może znaleźć w podsekcjach „Często zadawane pytania” dla pozycji określonych luk w zabezpieczeniach, znajdujących się poniżej następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2267960 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2267960) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
<tr>
<th colspan="5">
Uwierzytelnianie programu Internet Information Services
</th>
</tr>
<tr>
<td style="border:1px solid black;">
...
<span></span>
**Dlaczego dla tego biuletynu dostępne są trzy osobne aktualizacje?**  
Udostępniono trzy osobne aktualizacje ze względu na rozbieżność produktów, których dotyczy problem, w przypadku każdej luki opisanej w niniejszym biuletynie. Aby określić, które aktualizacje mają zastosowanie do serwera sieci Web użytkownika, należy zapoznać się z tabelą „Programy, których dotyczy problem”.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu IIS związana z powtórzonym żądaniem parametrów i umożliwiająca atak typu „odmowa usługi” — CVE-2010-1899
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach związana z nagłówkiem żądania i przepełnieniem buforu — CVE-2010-2730
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach związana z obejściem uwierzytelniania katalogu — CVE-2010-2731
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
<tr>
<td style="border:1px solid black;">
Internet Information Services 5.1 w systemie Windows XP z dodatkiem Service Pack 3  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Internet Information Services 6.0 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr>
<td style="border:1px solid black;">
Program Internet Information Services 6.0 systemie Windows Server 2003 z dodatkiem Service Pack 2  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Program Internet Information Services 6.0 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr>
<td style="border:1px solid black;">
Program Internet Information Services 6.0 w systemie Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Program Internet Information Services 7.0 w systemie Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr>
<td style="border:1px solid black;">
Program Internet Information Services 7.0 w systemie Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Internet Information Services 7.0 w systemie Windows Server 2008 dla systemów 32-bitowych oraz Windows Server 2008 dla systemów 32-bitowych z dodatkiem Service Pack 2\*  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr>
<td style="border:1px solid black;">
Internet Information Services 7.0 w systemie Windows Server 2008 dla systemów opartych na procesorze x64 oraz Windows Server 2008 dla systemów opartych na procesorze x64 z dodatkiem Service Pack 2\*  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Internet Information Services 7.0 w systemie Windows Server 2008 dla systemów z procesorem Itanium oraz Windows Server 2008 dla systemów z procesorem Itanium z dodatkiem Service Pack 2  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr>
<td style="border:1px solid black;">
Program Internet Information Services 7.5 w systemie Windows 7 dla systemów 32-bitowych  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Program Internet Information Services 7.5 w systemie Windows 7 dla systemów opartych na procesorze x64  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr>
<td style="border:1px solid black;">
Program Internet Information Services 7.5 w systemie Windows Server 2008 R2 dla systemów opartych na procesorze x64\*  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Program Internet Information Services 7.5 w systemie Windows Server 2008 R2 dla systemów z procesorem Itanium  
(KB2124261)
</td>
<td style="border:1px solid black;">
**Ważny**   
...
<span></span>
W zabezpieczeniach programu Internet Information Services (IIS) istnieje luka umożliwiająca przeprowadzenie ataku typu „odmowa usługi”, która w przypadku udanego wykorzystania może pozwolić osobie atakującej na przerwanie świadczenia usługi, powodując, że serwer przestanie odpowiadać. Osoba atakująca może wykorzystać tę lukę, wysyłając specjalnie spreparowane żądania adresu URL do stron ASP w witrynie sieci Web hostowanej przez program IIS.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-1899](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1899).

#### Czynniki ograniczające zagrożenie powodowane przez lukę w zabezpieczeniach programu IIS związaną z powtórzonym żądaniem parametrów i umożliwiającą atak typu „odmowa usługi” — CVE-2010-1899

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   W programie IIS 6.0 użycie stron ASP jest domyślnie zabronione.
-   Możliwość wykorzystania luki występuje tylko wtedy, gdy skrypt ASP w odpowiedzi na żądanie zapisuje parametry z tego żądania.

#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu IIS związaną z powtórzonym żądaniem parametrów i umożliwiającą atak typu „odmowa usługi” — CVE-2010-1899

Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:

-   **Tymczasowe wyłączenie obsługi stron ASP na serwerze IIS**

    W menedżerze usług IIS zmień status ASP z **DOZWOLONE** na **ZABRONIONE**.

    Windows XP i Windows Server 2003

    1.  Uruchom plik inetmgr.exe, aby uruchomić Menedżera usług IIS.
    2.  Po nazwą serwera w okienku po lewej stronie wybierz węzeł **Rozszerzenia usługi sieci Web**.
    3.  W prawym okienku kliknij prawym przyciskiem myszy pozycję **Active Server Pages** i wybierz polecenie **Zabroń**.

    Windows Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2

    1.  Uruchom plik inetmgr.exe, aby uruchomić Menedżera usług IIS.
    2.  W okienku po lewej stronie zaznacz węzeł serwera.
    3.  W okienku po prawej stronie zaznacz pozycję **Mapowania obsługi** i dwukrotnie kliknij pozycję **AspClassic**.
    4.  Kliknij **Ograniczenia żądań**, wybierz kartę **Dostęp**, a następnie kliknij opcję **Brak**.
    5.  Kliknij przycisk **OK**, a następnie opcję **Nie**, aby wyłączyć rozszerzenie ISAPI.

    **Wpływ obejścia**. Strony ASP nie będą działać.

    **Cofnięcie obejścia.**

    W menedżerze usług IIS zmień status ASP z **ZABRONIONE** na **DOZWOLONE**.

    Windows XP i Windows Server 2003

    1.  Uruchom plik inetmgr.exe, aby uruchomić Menedżera usług IIS.
    2.  Po nazwą serwera w okienku po lewej stronie wybierz węzeł **Rozszerzenia usługi sieci Web**.
    3.  W prawym okienku kliknij prawym przyciskiem myszy pozycję **Active Server Pages** i wybierz polecenie **Zezwalaj**.
    ...
    2.  W okienku po lewej stronie zaznacz węzeł serwera.
    3.  W okienku po prawej stronie zaznacz pozycję **Mapowania obsługi** i dwukrotnie kliknij pozycję **AspClassic**.
    4.  Kliknij **Ograniczenia żądań**, wybierz kartę **Dostęp**, a następnie kliknij opcję **Script**.
    5.  Kliknij przycisk **OK**, a następnie opcję **Nie**, aby wyłączyć rozszerzenie ISAPI.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu IIS związanej z powtórzonym żądaniem parametrów i umożliwiającej atak typu „odmowa usługi” — CVE-2010-1899

**Jaki zakres obejmuje luka?**  
Ta luka powoduje awarię typu odmowa usługi. Serwer sieci Web może przestać reagować, jeśli osoba atakująca wyśle do niego specjalnie spreparowane żądanie. Omawiana luka nie powoduje awarii serwera ani utraty żadnych danych; po zresetowaniu usługi serwer zacznie znów działać normalnie.

**Skąd bierze się luka?**  
Ta luka w zabezpieczeniach umożliwiająca atak typu „odmowa usługi” występuje z powodu przepełnienia stosu w kodzie przetwarzania skryptów ASP.

**Jakie mogą być skutki wykorzystania luki przez osobę atakującą?**   
Ta luka powoduje awarię typu odmowa usługi. Po wykorzystaniu luki przez osobę atakującą zaatakowany system mógłby przestać odpowiadać. Mogłoby również dochodzić do jego powtórnego uruchamiania się. W tym czasie serwer nie może odpowiedzieć na żądania. Jeśli na skutek działań osoby atakującej usługa zostanie pięciokrotnie uruchomiona ponownie, kolejne ponowne uruchomienie będzie niemożliwe bez udziału administratora. Należy zauważyć, że luka umożliwiająca atak typu „odmowa usługi" nie pozwala atakującemu na wykonanie kodu lub podniesienie poziomu swoich uprawnień, lecz może spowodować, że zaatakowana usługa przestanie akceptować żądania.

**W jaki sposób osoba atakująca może wykorzystać tę lukę?**   
Aby wykorzystać tę lukę w zabezpieczeniach umożliwiającą atak typu „odmowa usługi”, osoba atakująca może wysłać specjalnie spreparowane żądania adresu URL do witryny sieci Web udostępniającej strony ASP.

**Jakie systemy są szczególnie narażone na skutki tej luki?**   
Omawiana luka dotyczy wszystkich systemów, w których uruchomiono program Microsoft Internet Information Services.

**W jaki sposób działa aktualizacja?**   
Niniejsza aktualizacja modyfikuje sposób, w jaki program IIS i biblioteka asp.dll obsługują specjalnie spreparowane żądania HTTP.
...
<span></span>
W zabezpieczeniach programu Internet Information Services (IIS) występuje luka umożliwiająca zdalne wykonanie kodu, która może zostać wykorzystana przez osobę atakującą, jeśli wyśle ona specjalnie spreparowane żądania HTTP do serwerów IIS z włączoną aplikacją FastCGI.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-2730](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2730).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z nagłówkiem żądania i przepełnieniem buforu — CVE-2010-2730

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Aplikacja FastCGI domyślnie nie jest włączona w programie IIS.

#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z nagłówkiem żądania i przepełnieniem buforu — CVE-2010-2730

Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:

-   Wyłączenie aplikacji FastCGI

    1.  Uruchom Menedżera serwerów i edytuj **Role**.
    2.  Usuń zaznaczenie pola **CGI** i kliknij przycisk **Dalej**.

    **Wpływ obejścia**. Moduły zależne od aplikacji FastCGI przestaną działać.

    **Cofnięcie obejścia.**

    Uruchom Menedżera serwerów i dodaj funkcję **CGI** w sekcji **Serwer sieci Web**.

-   Zainstaluj moduł URL Rewrite

    Zainstalowanie tego modułu zapewnia ochronę, nawet gdy nie jest wykorzystywany. Aby uzyskać więcej informacji o module URL Rewrite, zobacz [URL Rewrite](http://www.iis.net/download/urlrewrite).

#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z nagłówkiem żądania i przepełnieniem buforu — CVE-2010-2730

**Jaki zakres obejmuje luka?**  
Jest to luka umożliwiająca zdalne wykonanie kodu. Zdalna osoba atakująca, której uda się wykorzystać tę lukę, może wykonać w programie IIS Server działania z uprawnieniami procesu roboczego (WPI, Worker Process Identity). Ta tożsamość jest skonfigurowana jako tożsamość puli aplikacji wirtualnych w systemach Windows 7 i Windows Server 2008 R2.

**Skąd bierze się luka?**  
Przyczyną powstania tej luki w zabezpieczeniach jest sposób, w jaki serwery IIS z włączoną aplikacją FastCGI obsługują nagłówki żądań.

**Co to jest FastCGI?**  
Aplikacja FastCGI dla programu IIS umożliwia wydajne i niezawodne hostowanie na serwerach IIS popularnych struktur aplikacji obsługujących protokół FastCGI. FastCGI stanowi wysokowydajną alternatywę dla technologii CGI (Common Gateway Interface), która jest standardem w zakresie tworzenia interfejsu do serwerów sieci Web dla aplikacji zewnętrznych. Obsługa CGI była obecna wśród funkcji programu IIS od jego premiery.
...
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**   
W programie IIS występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, która wynika ze sposobu, w jaki program ten obsługuje nagłówki żądań skierowanych do serwerów IIS z włączoną aplikacją FastCGI. Osoba atakująca może wykorzystać tę lukę, tworząc specjalnie spreparowane żądanie HTTP.

**Jakie systemy są szczególnie narażone na skutki tej luki?**   
Udostępniające treści serwery sieci Web z włączoną aplikacją FastCGI.

**W jaki sposób działa aktualizacja?**   
Niniejsza aktualizacja modyfikuje sposób, w jaki serwery IIS z włączoną aplikacją FastCGI obsługują nagłówki żądań.
...
<span></span>
W programie Internet Information Services (IIS) występuje luka umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się ją pomyślnie wykorzystać, może ominąć konieczność uwierzytelnienia się w celu uzyskania dostępu do zastrzeżonych zasobów.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-2731](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2731).

#### Czynniki ograniczające zagrożenie spowodowane przez lukę w zabezpieczeniach związaną z obejściem uwierzytelniania katalogu — CVE-2010-2731

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Zagrożenie nie dotyczy witryn, w których nie jest stosowane uwierzytelnianie. W przypadku witryn wykorzystujących tylko uwierzytelnianie anonimowe nie istnieje możliwość ataku poprzez podniesienie uprawnień.

#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z obejściem uwierzytelniania katalogu — CVE-2010-2731

Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:

-   **Zainstalowanie i korzystanie z programu URLScan**

    Program URLScan ułatwia ochronę przed szeregiem problemów wynikających z nieprawidłowo skonstruowanych żądań URL, łącznie ze zgłoszonymi przez organizacje publiczne problemami opisanymi w niniejszym biuletynie. Program ten nie zabezpiecza systemu tak kompleksowo, jak moduł kodu ograniczającego zagrożenie czy opisany poniżej skrypt global.asax. Informacje na temat modułu URLScan można znaleźć w artykule sieci TechNet [Narzędzie zabezpieczeń UrlScan](http://www.microsoft.com/technet/security/tools/urlscan.mspx).

#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z obejściem uwierzytelniania katalogu — CVE-2010-2731

**Jaki zakres obejmuje luka?**  
Jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca może obejść uwierzytelnianie i wykonać skrypt ASP, do którego nie powinna mieć dostępu, jeśli wyśle specjalnie spreparowane żądanie na adres URL wymagający uwierzytelnienia.

**Skąd bierze się luka?**  
Przyczyną powstania tej luki w zabezpieczeniach jest sposób, w jaki program IIS analizuje specjalnie spreparowane adresy URL.

**Czy protokół SSL pomaga ograniczyć zagrożenie wynikające z tej luki?**  
Luka dotyczy obejścia uwierzytelniania katalogów. Protokół SSL (Secure Sockets Layer) nie pomaga w ograniczeniu zagrożenia.

**Jakie mogą być skutki wykorzystania luki przez osobę atakującą?**   
Osoba atakująca może wykorzystać omawianą lukę, aby obejść podstawowe uwierzytelnianie oparte o katalogi i uzyskać dostęp oraz możliwość uruchamiania zasobów, dla których uwierzytelnianie powinno być wymagane.

**W jaki sposób osoba atakująca może wykorzystać tę lukę?**   
Osoba atakująca może wysłać specjalnie spreparowany adres URL, aby obejść podstawowe uwierzytelnianie oparte o katalogi.

**Jakie systemy są szczególnie narażone na skutki tej luki?**   
Omawiana luka zagraża usługom sieci Web, w których wykorzystuje się podstawowe uwierzytelnianie.

**W jaki sposób działa aktualizacja?**   
Niniejsza aktualizacja modyfikuje sposób, w jaki program IIS obsługuje specjalnie spreparowane żądania, zapobiegając w ten sposób uzyskiwaniu przez nieuwierzytelnionych użytkowników dostępu do obsługiwanych na serwerach IIS zasobów, które nie powinny być dostępne bez uwierzytelnienia.

**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**  
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-2731](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2731).
...
<td style="border:1px solid black;">Internet Information Services 5.1 ASP w systemie Windows XP z dodatkiem Service Pack 3 (KB2124261):<br />
WindowsXP-KB2124261-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Information Services 6.0 ASP w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2 (KB2124261):<br />
WindowsServer2003.WindowsXP-KB2124261-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Information Services 5.1 Authentication w systemie Windows XP z dodatkiem Service Pack 3 (KB2290570):<br />
...
<td style="border:1px solid black;">Internet Information Services 5.1 ASP w systemie Windows XP z dodatkiem Service Pack 3 (KB2124261) oraz Internet Information Services 6.0 ASP w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2 (KB2124261):<br />
KB2124261.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">W przypadku programu Internet Information Services 5.1 ASP w systemie Windows XP z dodatkiem Service Pack 3 (KB2124261) oraz programu Internet Information Services 6.0 ASP w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2 (KB2124261) należy użyć narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe znajdującego się w folderze %Windir%\$NTUninstallKB2124261$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku programu Internet Information Services 5.1 Authentication w systemie Windows XP z dodatkiem Service Pack 3 (KB2290570), należy użyć narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe znajdującego się w folderze Windir%\$NTUninstallKB2290570$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Dla programu Internet Information Services 5.1 ASP w systemie Windows XP z dodatkiem Service Pack 3 (KB2124261) i Internet Information Services 6.0 ASP w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2 (KB2124261), zobacz <a href="http://support.microsoft.com/kb/2124261">artykuł 2124261 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Dla programu Internet Information Services 5.1 Authentication w systemie Windows XP z dodatkiem Service Pack 3 (KB2290570) zobacz <a href="http://support.microsoft.com/kb/2290570">artykuł 2290570 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania</strong></td>
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2124261$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2124261">artykuł 2124261 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Internet Information Services 7.5 ASP w systemie Windows 7 dla systemów 32-bitowych (KB2124261):<br />
Windows6.1-KB2124261-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Information Services 7.5 ASP w systemie Windows 7 dla systemów z procesorem x64 (KB2124261):<br />
Windows6.1-KB2124261-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Information Services 7.5 FastCGI w systemie Windows 7 dla systemów 32-bitowych (KB2271195):<br />
Windows6.1-KB2271195-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Information Services 7.5 FastCGI w systemie Windows 7 dla systemów z procesorem x64 (KB2271195):<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Internet Information Services 7.5 ASP w systemie Windows 7 dla systemów 32-bitowych (KB2124261) oraz Internet Information Services 7.5 ASP w systemie Windows 7 dla systemów z procesorem x64 (KB2124261):<br />
Zobacz <a href="http://support.microsoft.com/kb/2124261">artykuł 2124261 bazy wiedzy Microsoft Knowledge Base</a><br />
<br />
Internet Information Services 7.5 FastCGI w systemie Windows 7 dla systemów 32-bitowych (KB2271195) oraz Internet Information Services 7.5 FastCGI w systemie Windows 7 dla systemów z procesorem x64 (KB2271195):<br />
Zobacz <a href="http://support.microsoft.com/kb/2271195">artykuł 2271195 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;"><strong>Uwaga</strong> Klucz rejestru niezbędny do wykrycia obecności tej aktualizacji nie istnieje.</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Internet Information Services 7.5 ASP w systemie Windows Server 2008 R2 dla systemów z procesorem x64 (KB2124261):<br />
Windows6.1-KB2124261-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Information Services 7.5 ASP w systemie Windows Server 2008 R2 dla systemów z procesorem Itanium (KB2124261):<br />
Windows6.1-KB2124261-ia64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Information Services 7.5 FastCGI w systemie Windows Server 2008 R2 dla systemów z procesorem x64 (KB2271195):<br />
Windows6.1-KB2271195-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Information Services 7.5 FastCGI w systemie Windows Server 2008 R2 dla systemów z procesorem Itanium (KB2271195):<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Internet Information Services 7.5 ASP w systemie Windows Server 2008 R2 dla systemów z procesorem x64 (KB2124261) oraz Internet Information Services 7.5 ASP w systemie Windows Server 2008 R2 dla systemów z procesorem Itanium (KB2124261):<br />
Zobacz <a href="http://support.microsoft.com/kb/2124261">artykuł 2124261 bazy wiedzy Microsoft Knowledge Base</a><br />
<br />
Internet Information Services 7.5 FastCGI w systemie Windows Server 2008 R2 dla systemów z procesorem x64 (KB2271195) oraz Internet Information Services 7.5 FastCGI w systemie Windows Server 2008 R2 dla systemów z procesorem Itanium (KB2271195):<br />
Zobacz <a href="http://support.microsoft.com/kb/2271195">artykuł 2271195 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
...
-   Jinsik Shim, za zgłoszenie luki w zabezpieczeniach programu IIS związanej z powtórzonym żądaniem parametrów i umożliwiającej atak typu „odmowa usługi” (CVE-2010-1899)  
-   Travis Raybold z firmy Rubicon West, za zgłoszenie luki w zabezpieczeniach związanej z nagłówkiem żądania i przepełnieniem buforu (CVE-2010-2730)
