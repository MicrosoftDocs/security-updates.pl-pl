---
TOCTitle: 'MS10-023'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-023 - Ważna'
ms:assetid: 'ms10-023'
ms:contentKeyID: 61232816
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-023(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-023 - Ważna
======================================================

Luka w zabezpieczeniach programu Microsoft Office Publisher umożliwia zdalne wykonanie kodu (981160)
----------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla obsługiwanych wersji programu Microsoft Office Publisher 2002, Microsoft Office Publisher 2003 i Microsoft Office Publisher 2007. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja eliminuje lukę w zabezpieczeniach poprzez poprawienie sposobu, w jaki program Microsoft Office Publisher otwiera specjalnie spreparowane pliki tego programu. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.

**Zalecenie.** Firma Microsoft zaleca klientom jak najszybsze zastosowanie tej aktualizacji.

**Znane problemy.** W [artykule 981160 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/981160) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=943b3830-70d5-46c5-bffc-1b494434b5f7">Microsoft Office Publisher 2002 z dodatkiem Service Pack 3</a><br />
(KB980466)</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=7c2f4610-77bb-4d72-847b-1a06c523b137">Microsoft Office Publisher 2003 z dodatkiem Service Pack 3</a><br />
(KB980469)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=117907">MS08-027</a></td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=10ca2f71-0ab2-4344-b7fd-bbbd6a783a96">Microsoft Office Publisher 2007 z dodatkiem Service Pack 1</a><br />
(KB980470)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
...
<tr class="even">
<td style="border:1px solid black;">System Microsoft Office 2007 z dodatkiem Service Pack 2</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=10ca2f71-0ab2-4344-b7fd-bbbd6a783a96">Microsoft Office Publisher 2007 z dodatkiem Service Pack 2</a><br />
(KB980470)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
...
<th>Luka w zabezpieczeniach programu Microsoft Office Publisher dotycząca konwersji pliku i związana z przepełnieniem buforu przetwarzania pola tekstowego — CVE-2010-0479</th>
<th>Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Publisher 2002 z dodatkiem Service Pack 3</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;"><strong>Ważny</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Publisher 2003 z dodatkiem Service Pack 3</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;"><strong>Ważny</strong></td>
</tr>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Office Publisher 2007 z dodatkiem Service Pack 2</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;"><strong>Ważny</strong></td>
</tr>
...
Luka w zabezpieczeniach programu Microsoft Office Publisher dotycząca konwersji pliku i związana z przepełnieniem buforu przetwarzania pola tekstowego — CVE-2010-0479  
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
  
<span></span>
W programie Microsoft Office Publisher istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana ze sposobem otwierania plików tego programu. Osoba atakująca może wykorzystać tę lukę, tworząc specjalnie spreparowany plik programu Publisher, a następnie dołączając go do wiadomości e-mail lub umieszczając w specjalnie spreparowanej witrynie sieci Web lub witrynie sieci Web, do której się włamano, i przekonując użytkownika do otwarcia tego pliku.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0479](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0479).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Microsoft Office Publisher dotyczącej konwersji pliku i związanej z przepełnieniem buforu przetwarzania pola tekstowego — CVE-2010-0479
...
#### Obejścia dotyczące luki w zabezpieczeniach programu Microsoft Office Publisher dotyczącej konwersji pliku i związanej z przepełnieniem buforu przetwarzania pola tekstowego — CVE-2010-0479
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Microsoft Office Publisher dotyczącej konwersji pliku i związanej z przepełnieniem buforu przetwarzania pola tekstowego — CVE-2010-0479
...
Luka występuje w kodzie służącym do analizy plików, który używany jest, gdy program Microsoft Office Publisher próbuje otworzyć specjalnie spreparowany plik tego programu.
...
Niniejsza aktualizacja usuwa lukę, poprawiając sposób, w jaki program Microsoft Office Publisher otwiera specjalnie spreparowane pliki programu Publisher.
...
|------------------------------------------------------------|------------|  
| Microsoft Office Publisher 2002 z dodatkiem Service Pack 3 | Tak        |  
| Microsoft Office Publisher 2003 z dodatkiem Service Pack 3 | Tak        |  
| Microsoft Office Publisher 2007 z dodatkiem Service Pack 1 | Tak        |  
| Microsoft Office Publisher 2007 z dodatkiem Service Pack 2 | Tak        |
...
|------------------------------------------------------------|---------|---------------------------|---------------------------|----------------------------|  
| Microsoft Office Publisher 2002 z dodatkiem Service Pack 3 | Nie     | Nie                       | Tak                       | Tak                        |  
| Microsoft Office Publisher 2003 z dodatkiem Service Pack 3 | Nie     | Nie                       | Tak                       | Tak                        |  
| Microsoft Office Publisher 2007 z dodatkiem Service Pack 1 | Nie     | Nie                       | Tak                       | Tak                        |  
| Microsoft Office Publisher 2007 z dodatkiem Service Pack 2 | Nie     | Nie                       | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/980466">artykuł 980466 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/980469">artykuł 980469 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/980470">artykuł 980470 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Lionelowi d'Hauenens, we współpracy z oddziałem [Zero Day Initiative](http://www.zerodayinitiative.com/) firmy [TippingPoint](http://www.tippingpoint.com/), za zgłoszenie luki w zabezpieczeniach programu Microsoft Office Publisher dotyczącej konwersji pliku i związanej z przepełnieniem buforu przetwarzania pola tekstowego (CVE-2010-0479)
