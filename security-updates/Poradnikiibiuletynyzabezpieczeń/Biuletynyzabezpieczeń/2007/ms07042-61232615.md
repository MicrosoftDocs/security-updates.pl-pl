...
| Windows Vista i Windows Vista z dodatkiem Service Pack 1                                                                                                            | Nie          | Zobacz **Uwaga dotycząca systemu Windows** **Vista** **oraz systemu Windows Server 2008** poniżej |
| Windows Vista x64 Edition i Windows Vista x64 Edition z dodatkiem Service Pack 1                                                                                    | Nie          | Zobacz **Uwaga dotycząca systemu Windows** **Vista** **oraz systemu Windows Server 2008** poniżej |
| Windows Server 2008 dla systemów 32-bitowych                                                                                                                        | Nie          | Zobacz **Uwaga dotycząca systemu Windows** **Vista** **oraz systemu Windows Server 2008** poniżej |
| Windows Server 2008 dla systemów opartych na procesorach X64                                                                                                        | Nie          | Zobacz **Uwaga dotycząca systemu Windows** **Vista** **oraz systemu Windows Server 2008** poniżej |
| Windows Server 2008 dla systemów z procesorem Itanium                                                                                                               | Nie          | Zobacz **Uwaga dotycząca systemu Windows** **Vista** **oraz systemu Windows Server 2008** poniżej |
...
| Windows Vista i Windows Vista z dodatkiem Service Pack 1                                                                                                            | Nie     | Zobacz **Uwaga dotycząca systemu Windows** **Vista** **oraz systemu Windows Server 2008** poniżej |
| Windows Vista x64 Edition i Windows Vista x64 Edition z dodatkiem Service Pack 1                                                                                    | Nie     | Zobacz **Uwaga dotycząca systemu Windows** **Vista** **oraz systemu Windows Server 2008** poniżej |
| Windows Server 2008 dla systemów 32-bitowych                                                                                                                        | Nie     | Zobacz **Uwaga dotycząca systemu Windows** **Vistaoraz systemu Windows Server 2008** poniżej      |
| Windows Server 2008 dla systemów opartych na procesorach X64                                                                                                        | Nie     | Zobacz **Uwaga dotycząca systemu Windows** **Vistaoraz systemu Windows Server 2008** poniżej      |
| Windows Server 2008 dla systemów z procesorem Itanium                                                                                                               | Nie     | Zobacz **Uwaga dotycząca systemu Windows** **Vistaoraz systemu Windows Server 2008** poniżej      |
