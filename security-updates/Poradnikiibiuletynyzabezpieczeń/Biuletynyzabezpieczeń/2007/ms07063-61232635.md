...
<th>Luka w zabezpieczeniach podpisywania SMBv2 — CVE-2007-5351</th>
...
|-----------------------------|--------------------------------------------------------------|  
| Microsoft Vista             | Zobacz **Uwaga dotycząca systemu Windows** **Vista** poniżej |  
| Microsoft Vista x64 Edition | Zobacz **Uwaga dotycząca systemu Windows** **Vista** poniżej |
...
|-----------------------------|---------|--------------------------------------------------------------|  
| Microsoft Vista             | Nie     | Zobacz **Uwaga dotycząca systemu Windows** **Vista** poniżej |  
| Microsoft Vista x64 Edition | Nie     | Zobacz **Uwaga dotycząca systemu Windows** **Vista** poniżej |
