---
TOCTitle: 'MS06-073'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS06-073 - Krytyczna'
ms:assetid: 'ms06-073'
ms:contentKeyID: 61232508
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms06-073(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS06-073 - Krytyczna
==========================================================

Luka w zabezpieczeniach w programie Visual Studio 2005 umożliwia zdalne wykonanie kodu (925674)
-----------------------------------------------------------------------------------------------
...
**Kto powinien przeczytać ten dokument:** Klienci, którzy korzystają z programu Microsoft Visual Studio 2005
...
**Ostrzeżenia:** [W artykule 925674 bazy wiedzy Microsoft Knowledge Base (j.ang.)](http://support.microsoft.com/kb/925674)udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Więcej informacji na ten temat można znaleźć w [artykule 925674 bazy wiedzy Microsoft Knowledge Base (j.ang.)](http://support.microsoft.com/kb/925674).

**Lokalizacje, z których można pobrać przetestowane oprogramowanie i aktualizacje zabezpieczeń:**

**Podlegające oprogramowanie:**

-   Microsoft Visual Studio 2005 — [Pobierz aktualizację (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=c2682c53-8e9a-4c7d-b782-be78512dcbfa)

**Programy, których nie dotyczy problem:**

-   Microsoft Visual Studio 6.0 z dodatkiem Service Pack 6
-   Microsoft Visual Studio .NET 2002 z dodatkiem Service Pack 1
-   Microsoft Visual Studio .NET 2003 z dodatkiem Service Pack 1

**Uwaga** Nie wszystkie wersje programu Visual Studio 2005 zawierają plik, którego dotyczy omawiany problem. Brak pliku wmiscriptutils.dll w komputerze oznacza, że użytkownik nie jest zagrożony tą luką. Program Microsoft Visual Studio Express 2005 nie zawiera tego pliku.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Luka w zabezpieczeniach formantu WMI Object Broker — <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4704">CVE-2006-4704 (j.ang.)</a></td>
...
Bieżąca aktualizacja nie zastępuje wcześniejszych aktualizacji zabezpieczeń.
...
Tak. Program SMS może ułatwić wykrycie innych zainstalowanych programów posiadających zainstalowaną wersję składnika zawierającego lukę. Program SMS może wyszukać plik wmiscriptutils.dll. Zaktualizuj wszystkie wersje pliku wmiscriptutils.dll, które są starsze niż wersja 8.0.50727.236.
  
**Jakie znane problemy mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń?**  
[W artykule 925674 bazy wiedzy Microsoft Knowledge Base (j.ang.)](http://support.microsoft.com/kb/925674) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Więcej informacji na ten temat można znaleźć w [artykule 925674 bazy wiedzy Microsoft Knowledge Base (j.ang.)](http://support.microsoft.com/kb/925674).
  
Szczegółowe informacje o luce w zabezpieczeniach  
------------------------------------------------
  
<span></span>
#### Luka w zabezpieczeniach formantu WMI Object Broker — CVE-2006-4704:
  
W zabezpieczeniach formantu WMI Object Broker, który wykorzystywany jest przez kreator WMI w programie Visual Studio 2005, istnieje luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca może wykorzystać tę lukę, tworząc specjalnie przygotowaną stronę sieci Web umożliwiającą zdalne wykonanie kodu na komputerze użytkownika, który wyświetli tę stronę. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka.
  
#### Czynniki ograniczające zagrożenie spowodowane luką w zabezpieczeniach formantu WMI Object Broker — CVE-2006-4704:
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach formantu WMI Object Broker — CVE-2006-4704:
...
-   **Wyłączenie prób tworzenia wystąpienia formantu WMI Object Broker**
  
    Uruchamianie tego formantu ActiveX w programie Internet Explorer można wyłączyć, ustawiając dla danego formantu bit niszczący w rejestrze.
    ...
    **Ostrzeżenie** Nieprawidłowe korzystanie z Edytora rejestru może spowodować poważne problemy wymagające ponownego zainstalowania systemu operacyjnego. Firma Microsoft nie gwarantuje możliwości rozwiązania problemów, wynikających z nieprawidłowego użycia edytora rejestru. Zmian w rejestrze można dokonywać wyłącznie na własne ryzyko.
    ...
    Aby ustawić bit niszczący dla formantu o identyfikatorze CLSID {7F5B7F63-F06F-4331-8A26-339E03C0AE3D}, w edytorze tekstu, takim jak Notatnik, wklej tekst przedstawiony poniżej. Następnie zapisz plik z rozszerzeniem .reg.
    ...
    **Wpływ obejścia**: Kreator WMI w programie Visual Studio 2005 może nie być wyświetlany lub nie funkcjonować prawidłowo.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach formantu WMI Object Broker — CVE-2006-4704:
...
Przyczyną tej luki jest nieprawidłowy sposób sprawdzania poprawności formantów, których wystąpienia tworzone są przez formant WMI Object Broker.
  
**Co to jest WMI Object Broker?**  
WMI Object Broker to formant ActiveX, który jest wykorzystywany przez Kreatora WMI w programie Visual Studio 2005. Kiedy użytkownik wywoła funkcję Kreatora WMI w programie Visual Studio 2005, kreator używa wewnętrznie funkcji WMI Object Broker w celu utworzenia wystąpienia innych formantów.
...
**Mam zainstalowany program Internet Explorer w systemie Windows Server 2003. Czy ogranicza to zagrożenie ze strony omawianej luki?** Tak.  
Domyślnie program Internet Explorer w systemie Windows Server 2003 jest uruchamiany w trybie chronionym określanym jako [Konfiguracja zwiększonych zabezpieczeń (j.ang.)](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp). W tym trybie poziom zabezpieczeń strefy Internet jest Wysoki. Jest to czynnik ograniczający zagrożenie w przypadku witryn sieci Web, których nie dodano do strefy witryn zaufanych programu Internet Explorer. Więcej informacji na temat konfiguracji zwiększonych zabezpieczeń w programie Internet Explorer można znaleźć w sekcji „Często zadawane pytania” dla tej aktualizacji zabezpieczeń.
...
Aktualizacja usuwa lukę, modyfikując sposób tworzenia wystąpień innych formantów przez formant WMI Object Broker.
  
**Czy luka ta była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**
  
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem CVE-2006-4704.
  
**Czy firma Microsoft posiadała zgłoszenia o wykorzystaniu luki w czasie, gdy opublikowano niniejszy biuletyn?**  
Tak. Ta aktualizacja zabezpieczeń eliminuje aktualnie wykorzystywaną lukę. Informacje o usuniętej luce w zabezpieczeniach zostały zarejestrowane w bazie danych znanych luk i zagrożeń pod numerem CVE-2006-4704.
...
#### Visual Studio 2005 (wszystkie wersje)
  
**Warunki wstępne**  
Ta aktualizacja zabezpieczeń wymaga zainstalowanego programu Microsoft Visual Studio 2005.
...
**Uwaga** Wymienione parametry można łączyć w jedno polecenie. Więcej informacji na temat obsługiwanych parametrów instalacji można znaleźć w opisie opcji wiersza poleceń Instalatora Windows. Więcej informacji o Instalatorze Windows znajduje się w witrynie Windows Installer MSDN w sieci Web.
...
Aby zmniejszyć prawdopodobieństwo konieczności ponownego uruchomienia, przed rozpoczęciem instalacji aktualizacji zabezpieczeń zamknij wszystkie wystąpienia programu Visual Studio 2005. Więcej informacji o powodach wyświetlenia monitu o ponowne uruchomienie komputera znajduje się w [artykule 887012 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/887012).

**Informacje dotyczące usuwania**
Do usunięcia tej aktualizacji należy użyć narzędzia Dodaj lub usuń programy w Panelu sterowania.

**Informacje dotyczące pliku**
Podstawowe atrybuty plików dla anglojęzycznej wersji tej aktualizacji wymieniono w poniższej tabeli.. Daty i godziny ostatniej modyfikacji plików podano zgodnie z czasem UTC (Coordinated Universal Time). W czasie przeglądania informacje o pliku są konwertowane na czas lokalny. Aby określić różnicę między czasem UTC a lokalnym, skorzystaj z karty **Strefa czasowa** w narzędziu Data i godzina w Panelu sterowania.

Microsoft Visual Studio 2005

| Nazwa pliku        | Wersja        | Data        | Godzina | Rozmiar |
|--------------------|---------------|-------------|---------|---------|
| wmiscriptutils.dll | 8.0.50727.236 | 28-paź-2006 | 08:46   | 54 272  |
...
-   Firmom [TippingPoint](http://www.tippingpoint.com/) i [Zero Day Initiative](http://www.zerodayinitiative.com/) za zgłoszenie luki w zabezpieczeniach formantu WMI Object Broker — [CVE-2006-4704 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4704).
