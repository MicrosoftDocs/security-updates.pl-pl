---
TOCTitle: 'MS08-045'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS08-045 - Krytyczna'
ms:assetid: 'ms08-045'
ms:contentKeyID: 61232686
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms08-045(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS08-045 - Krytyczna
==========================================================

Zbiorcza aktualizacja zabezpieczeń dla programu Internet Explorer (953838)
--------------------------------------------------------------------------
...
Firma Microsoft zmieniła niniejszy biuletyn, aby poprawić wpis weryfikacji klucza rejestru dla systemu Windows XP i dodać czynnik ograniczający zagrożenie związane z luką w zabezpieczeniach CVE-2008-2256.

**Gdzie znajdują się szczegółowe informacje dotyczące plików?**  
Szczegółowe informacje dotyczące plików znajdują się w [artykule 953838 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/953838).
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2008-2254</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2008-2255</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z uszkodzeniem niezainicjowanej pamięci — CVE-2008-2256</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2008-2257</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2008-2258</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach obsługi składników HTML — CVE-2008-2259</th>
...
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2008-2254  
-------------------------------------------------------------------------------------
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-2254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2254).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML – CVE-2008-2254
...
#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML – CVE-2008-2254
...
-   **Aby uniknąć ataku z wykorzystaniem wiadomości e-mail w formacie HTML, należy odczytywać wiadomości e-mail w formacie zwykłego tekstu w programie Microsoft Outlook 2002 lub nowszym albo w programie Outlook Express 6 z dodatkiem SP1 lub nowszym.**
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML – CVE-2008-2254
...
Aktualizacja usuwa lukę, modyfikując sposób, w jaki program Internet Explorer obsługuje błąd, który umożliwia ich wykorzystanie.
...
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2008-2255  
-------------------------------------------------------------------------------------
  
<span></span>
W programie Internet Explorer istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana z próbami uzyskania dostępu do niezainicjowanej pamięci w określonych sytuacjach. Osoba atakująca może wykorzystać tę lukę poprzez utworzenie specjalnie spreparowanej strony sieci Web. Gdy użytkownik odwiedza taką stronę sieci Web, luka w zabezpieczeniach może pozwolić na zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak zalogowany użytkownik.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-2255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2255).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML – CVE-2008-2255
...
#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML – CVE-2008-2255
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML – CVE-2008-2255
...
**Czy luka ta była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**    
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem CVE-2008-2255.
  
**Czy przed wydaniem niniejszego biuletynu firma Microsoft otrzymała jakiekolwiek zgłoszenia dotyczące wykorzystania tej luki?**    
Nie. Firma Microsoft nie otrzymała żadnych informacji o tym, że luka ta była szeroko wykorzystywana do atakowania użytkowników i nie spotkała się z przykładami odpowiednich kodów w czasie, gdy został opublikowany niniejszy biuletyn.
  
Luka w zabezpieczeniach związana z uszkodzeniem niezainicjowanej pamięci — CVE-2008-2256  
----------------------------------------------------------------------------------------
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-2256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2256).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach dotyczącej uszkodzenia niezainicjowanej pamięci — CVE-2008-2256
  
-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
#### Obejścia luki w zabezpieczeniach dotyczącej uszkodzenia niezainicjowanej pamięci — CVE-2008-2256
  
-   Brak
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach dotyczącej uszkodzenia niezainicjowanej pamięci — CVE-2008-2256
...
Luka w zabezpieczeniach związana z uszkodzeniem pamięci obiektów HTML — CVE-2008-2257 i CVE-2008-2258  
-----------------------------------------------------------------------------------------------------
  
<span></span>
W programie Internet Explorer istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana z próbami uzyskania dostępu do niezainicjowanej pamięci w określonych sytuacjach. Osoba atakująca może wykorzystać tę lukę poprzez utworzenie specjalnie spreparowanej strony sieci Web. Gdy użytkownik odwiedza taką stronę sieci Web, luka w zabezpieczeniach może pozwolić na zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak zalogowany użytkownik.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-2257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2257) i [CVE-2008-2258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2258).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML — CVE-2008-2257 i CVE-2008-2258
...
#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML — CVE-2008-2257 i CVE-2008-2258
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML — CVE-2008-2257 i CVE-2008-2258
...
Luka w zabezpieczeniach obsługi składników HTML — CVE-2008-2259  
---------------------------------------------------------------
  
<span></span>
W programie Internet Explorer występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, która wynika ze sposobu sprawdzania poprawności argumentów podczas obsługi podglądu wydruku. Osoba atakująca może wykorzystać tę lukę poprzez utworzenie specjalnie spreparowanej strony sieci Web. Gdy użytkownik odwiedza taką stronę sieci Web, luka w zabezpieczeniach może pozwolić na zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same prawa jak zalogowany użytkownik.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-2259](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2259).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach obsługi składników HTML — CVE-2008-2259
  
-   Osoba atakująca za pośrednictwem sieci Web, która chce wykorzystać tę lukę, może udostępniać witrynę zawierającą odpowiednią stronę sieci Web. Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika lub reklamy, jak również witryny niesprawdzone, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystać lukę w zabezpieczeniach. Jednakże w żadnym przypadku osoba atakująca nie może zmusić użytkowników do odwiedzenia takich witryn. Musi natomiast przekonać użytkowników do odwiedzenia tej witryny, najczęściej zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej, które przekieruje użytkowników do witryny osoby atakującej.  
-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.  
-   Domyślnie program Internet Explorer w systemach Windows Server 2003 i Windows Server 2008 jest uruchamiany w trybie chronionym określanym jako [Konfiguracja zwiększonych zabezpieczeń](http://go.microsoft.com/fwlink/?linkid=92039). W tym trybie poziom zabezpieczeń strefy Internet jest Wysoki. Jest to czynnik ograniczający zagrożenie w przypadku witryn sieci Web, których nie dodano do strefy witryn zaufanych programu Internet Explorer. Dodatkowe informacje na temat konfiguracji zwiększonych zabezpieczeń programu Internet Explorer można znaleźć w sekcji często zadawanych pytań na temat tej luki.
  
#### Obejścia dotyczące luki w zabezpieczeniach obsługi składników HTML — CVE-2008-2259
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach obsługi składników HTML — CVE-2008-2259
...
**W jaki sposób powstaje luka?**    
W pewnych warunkach, podczas przetwarzania podglądów wydruku w programie Internet Explorer procedura sprawdzania poprawności argumentów działa nieprawidłowo. W wyniku tego specjalnie spreparowana strona sieci Web może zostać wyświetlona w sposób umożliwiający osobie atakującej wykonanie dowolnego kodu w kontekście zalogowanego użytkownika. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**    
Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**    
Osoba atakująca może udostępnić specjalnie spreparowaną witrynę sieci Web, której celem jest wykorzystanie tej luki w zabezpieczeniach programu Internet Explorer, a następnie nakłonić użytkownika do odwiedzenia takiej witryny. Osoba ta może również wykorzystywać witryny sieci Web, które akceptują lub udostępniają treści lub reklamy wprowadzone przez użytkownika. Witryny te mogą zawierać specjalnie spreparowane treści, które mogą wykorzystywać omawianą lukę w zabezpieczeniach. Jednakże w żadnym przypadku osoba atakująca nie może zmusić użytkowników do odwiedzenia takich witryn. Musi natomiast przekonać użytkowników do odwiedzenia tej witryny, najczęściej zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej, które przekieruje użytkowników do witryny osoby atakującej. Może również istnieć możliwość wyświetlenia specjalnie spreparowanej zawartości strony sieci Web z wykorzystaniem reklam banerowych lub innych metod jej dostarczenia do systemów, których dotyczy luka.
...
**W jaki sposób działa aktualizacja?**    
Aktualizacja usuwa lukę, modyfikując sposób obsługi argumentów przekazywanych do podglądu wydruków w programie Internet Explorer.
...
\* Programy SMS 2.0 i SMS 2003 z dodatkiem SUSFP obsługują wszystkie zagrożone luką wersje programu Internet Explorer oprócz IE7. Więcej informacji zawiera [artykuł 924178 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/924178).
...
<td style="border:1px solid black;">Internet Explorer 5.01 z dodatkiem Service Pack 4 we wszystkich obsługiwanych wersjach systemu Windows 2000:<br />
Użyj narzędzia Dodaj lub usuń programy w Panelu sterowania lub programu narzędziowego Spuninst.exe, który znajduje się w folderze %Windir%\$NTUninstallKB953838-IE501SP4-20080620.120000$\Spuninst.<br />
<br />
Internet Explorer 6 z dodatkiem Service Pack 1 zainstalowany we wszystkich obsługiwanych wersjach systemu Windows 2000:<br />
Użyj narzędzia Dodaj lub usuń programy w Panelu sterowania lub programu narzędziowego Spuninst.exe, który znajduje się w folderze %Windir%\$NTUninstallKB953838-IE6SP1-20080620.120000$\Spuninst.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/953838">artykuł 941203 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
Użyj narzędzia Dodaj lub usuń programy w Panelu sterowania lub narzędzia Spuninst.exe, który znajduje się w folderze %Windir%\$NTUninstal\KB953838$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Program Internet Explorer 7 dla systemu operacyjnego Windows XP:<br />
Użyj narzędzia Dodaj lub usuń programy w Panelu sterowania lub narzędzia Spuninst.exe, który znajduje się w folderze %Windir%\ie7updates\KB953838-IE7\spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/953838">Zobacz artykuł 953838 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
...
Użyj narzędzia Dodaj lub usuń programy w Panelu sterowania lub programu narzędziowego Spuninst.exe, który znajduje się w folderze %Windir%\$NTUninstallKB953838$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   Yamata Li z [Palo Alto Networks](http://www.paloaltonetworks.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML (CVE-2008-2254).  
-   Tavis Ormandy z [Google Security Team](http://www.google.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem niezainicjowanej pamięci (CVE-2008-2256).  
-   Samowi Thomasowi współpracującemu z firmami [TippingPoint](http://www.tippingpoint.com/) i [Zero Day Initiative](http://www.zerodayinitiative.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML (CVE-2008-2257).  
-   Firmom [TippingPoint](http://www.tippingpoint.com/) i [Zero Day Initiative](http://www.zerodayinitiative.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci obiektów HTML (CVE-2008-2258).
...
-   Wersja 1.1 (20 sierpnia 2008 r.): Poprawiono wpis weryfikacji klucza rejestru dla systemu Windows XP i dodano czynnik ograniczający zagrożenie związane z luką w zabezpieczeniach CVE-2008-2256.
