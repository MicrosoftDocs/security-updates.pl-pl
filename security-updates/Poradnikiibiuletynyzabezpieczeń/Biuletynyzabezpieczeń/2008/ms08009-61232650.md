---
TOCTitle: 'MS08-009'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS08-009 - Krytyczna'
ms:assetid: 'ms08-009'
ms:contentKeyID: 61232650
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms08-009(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS08-009 - Krytyczna
==========================================================

Luka w zabezpieczeniach programu Microsoft Word może pozwolić na zdalne wykonanie kodu (947077)
-----------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla obsługiwanych wersji pakietu Microsoft Office 2000 i wskaźnik ważności „ważny” dla pakietów Microsoft Office XP, Microsoft Office 2003 i apletu Podgląd programu Microsoft Office Word 2003. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** w tej sekcji..
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a513069b-8244-48e9-b136-01ddd3862802">Microsoft Word 2000 z dodatkiem Service Pack 3</a><br />
(KB943990)</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=78c338aa-e410-4422-9e36-562f70d742e9">Microsoft Word 2002 z dodatkiem Service Pack 3</a><br />
(KB943957)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=85cb1aa5-211f-4652-827b-2e79b8ffc2fc">Microsoft Word 2003 z dodatkiem Service Pack 2</a><br />
(KB943983)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=fd4ddecd-abd6-4783-b300-32b9d4bad22a">Podgląd programu Microsoft Office Word 2003</a><br />
(KB943992)</td>
...
Nie, mechanizm aktualizacji działa prawidłowo — pakiet aktualizacyjny zawiera nowszą wersję i w związku z tym aktualizacja jest oferowana.
...
<th>Luka w zabezpieczeniach programu Word związana z uszkodzeniem pamięci — CVE-2008-0109</th>
<th>Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Word 2003 z dodatkiem Service Pack 2</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;"><strong>Ważny</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Podgląd programu Microsoft Office Word 2003</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;"><strong>Ważny</strong></td>
</tr>
...
Luka w zabezpieczeniach programu Word związana z uszkodzeniem pamięci — CVE-2008-0109  
-------------------------------------------------------------------------------------
  
<span></span>
W programie Microsoft Word istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez program Word specjalnie spreparowanych plików programu Word. Luka ta umożliwia zdalne wykonanie kodu, jeśli użytkownik otworzy specjalnie spreparowany plik programu Word zawierający nieprawidłową wartość. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-0109](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0109).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Word związanej z uszkodzeniem pamięci — CVE-2008-0109
...
#### Obejścia luki w zabezpieczeniach programu Word związanej z uszkodzeniem pamięci — CVE-2008-0109
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Word związanej z uszkodzeniem pamięci — CVE-2008-0109
...
Luka w zabezpieczeniach związana jest z błędem obliczania pamięci, który występuje podczas przetwarzania specjalnie spreparowanego pliku programu Word. Błąd ten może spowodować uszkodzenie pamięci systemowej w sposób umożliwiający osobie atakującej wykonanie dowolnego kodu.
...
Aktualizacja usuwa lukę, modyfikując procedurę obliczania wymaganej ilości pamięci, którą trzeba przydzielić w programie Word w celu otwarcia plików tego programu.
...
| Podgląd programu Microsoft Office Word 2003    | Tak        |  
...
|------------------------------------------------|---------|----------------------------|---------------------------|-----------|  
| Microsoft Word 2000 z dodatkiem Service Pack 3 | Tak     | Tak                        | Nie                       | Tak       |  
...
| Podgląd programu Microsoft Office Word 2003    | Tak     | Tak                        | Tak                       | Tak       |
...
|-------------|------------|-------------|---------|-----------|  
| Winword.exe | 9.0.0.8966 | 20-paź-2007 | 07:09   | 8 835 124 |
...
| Nazwa pliku | Wersja      | Data        | Godzina | Rozmiar    |  
|-------------|-------------|-------------|---------|------------|  
| Winword.exe | 10.0.6838.0 | 13-gru-2007 | 01:55   | 10 744 840 |
...
Podgląd programu Word 2003: office2003-KB943992-FullFile-ENU /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Instalowanie bez ponownego uruchomienia</td>
<td style="border:1px solid black;">Word 2003: office2003-KB943983-FullFile-ENU /r:n
Podgląd programu Word 2003: office2003-KB943992-FullFile-ENU /r:n</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Plik dziennika aktualizacji</td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<tr class="even">
<td style="border:1px solid black;">Dodatkowe informacje</td>
<td style="border:1px solid black;">Zapoznaj się z podsekcją Narzędzia wykrywania i wdrażania oraz wskazówki.
Informacje na temat selektywnej instalacji funkcji można znaleźć w podsekcji <strong>Funkcje pakietu Office dla instalacji administracyjnych</strong> niniejszej sekcji.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Wymaganie dotyczące ponownego uruchomienia</strong></td>
...
Wszystkie obsługiwane wersje programu Word 2003:
  
| Nazwa pliku | Wersja      | Data        | Godzina | Rozmiar    |  
|-------------|-------------|-------------|---------|------------|  
| Winword.exe | 11.0.8202.0 | 20-lis-2007 | 03:35   | 12 311 048 |
  
Wszystkie obsługiwane wersje programu Word Viewer 2003:
  
| Nazwa pliku  | Wersja      | Data        | Godzina | Rozmiar   |  
|--------------|-------------|-------------|---------|-----------|  
| Wordview.exe | 11.0.8202.0 | 20-lis-2007 | 03:35   | 8 812 040 |
...
-   Rubénowi Santamarta z firmy [ReverseMode.com](http://reversemode.com/) za zgłoszenie luki w zabezpieczeniach programu Word związanej z uszkodzeniem pamięci (CVE-2008-0109).
...
-   V1.1 (16 kwietnia 2008 r.): Zaktualizowano biuletyn: Dodano wpis w sekcji Często zadawane pytania, opisujący dodatkowe funkcje zabezpieczeń dla pakietu Microsoft Office 2003 z dodatkiem Service Pack 2.  
-   Wersja 1.2 (10 września 2008 r.): Zaktualizowano biuletyn: W sekcji Często zadawane pytania dodano wyjaśnienie, dlaczego ta aktualizacja może zostać zaoferowana w przypadku pakietów Microsoft Office niezagrożonych luką w zabezpieczeniach.
