---
TOCTitle: 'MS08-JAN'
Title: Microsoft Security Bulletin Summary for styczeń 2008
ms:assetid: 'ms08-jan'
ms:contentKeyID: 61233088
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms08-jan(v=Security.10)'
---

Security Bulletin Summary

Microsoft Security Bulletin Summary for styczeń 2008
====================================================
...
Niniejsze podsumowanie biuletynów zabezpieczeń zawiera spis biuletynów za styczeń 2008 r.

Z chwilą opublikowania biuletynów za styczeń 2008 r. niniejsze podsumowanie biuletynów zastępuje powiadomienie o biuletynach zabezpieczeń wydane 3 stycznia 2008 r. Aby uzyskać więcej informacji na temat usługi powiadamiania o biuletynach, zobacz [Powiadomienia o biuletynach zabezpieczeń firmy Microsoft (j.ang.)](http://technet.microsoft.com/security/bulletin/advance).
...
9 stycznia 2008 r. o godz. 11:00 czasu Pacyfiku (godz. 20:00 czasu środkowoeuropejskiego) firma Microsoft udostępni emisję internetową, w której znajdą się odpowiedzi na pytania klientów dotyczące tych biuletynów (USA i Kanada). [Zarejestruj się, aby zobaczyć emisję internetową dotyczącą biuletynów zabezpieczeń za styczeń (j.ang.)](http://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032357213&eventcategory=4&culture=en-us&countrycode=us). Po tym dniu emisja internetowa będzie dostępna na żądanie. Aby uzyskać więcej informacji, zobacz [podsumowania biuletynów zabezpieczeń](http://technet.microsoft.com/security/bulletin/summary) i [emisje internetowe firmy Microsoft (j.ang.)](http://technet.microsoft.com/security/bulletin/summary).
...
<span></span>
| Identyfikator biuletynu           | Biuletyn zabezpieczeń firmy Microsoft MS08-001                                                                                                                                                                                                                                                                                                                                                                                                                       |
|-----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Tytuł biuletynu**               | [**Luki w zabezpieczeniach interfejsu TCP/IP systemu Windows umożliwiają zdalne wykonanie kodu (941644)**](http://www.microsoft.com/poland/technet/security/bulletin/2008/ms08-001.mspx)                                                                                                                                                                                                                                                                             |
| **Streszczenie**                  | Ta aktualizacja zabezpieczeń o krytycznym wskaźniku ważności usuwa dwie zgłoszone przez użytkowników luki w zabezpieczeniach przetwarzania protokołu TCP/IP (Transmission Control Protocol/Internet Protocol). Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. |
...
<span></span>
| Identyfikator biuletynu           | Biuletyn zabezpieczeń firmy Microsoft MS08-002                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|-----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Tytuł biuletynu**               | [**Luka w zabezpieczeniach LSASS umożliwia lokalne podniesienie uprawnień (943485)**](http://www.microsoft.com/poland/technet/security/bulletin/2008/ms08-002.mspx)                                                                                                                                                                                                                                                                                                                                                             |
| **Streszczenie**                  | Ta ważna aktualizacja usuwa zgłoszoną przez użytkowników lukę w usłudze podsystemu lokalnego uwierzytelniania zabezpieczeń (LSASS) systemu Windows. Luka w zabezpieczeniach może pozwolić osobie atakującej na uruchomienie dowolnego kodu z podniesionymi uprawnieniami. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. |
...
<td style="border:1px solid black;">
[**MS08-001**](http://www.microsoft.com/poland/technet/security/bulletin/2008/ms08-001.mspx)
</td>
<td style="border:1px solid black;">
[**MS08-002**](http://www.microsoft.com/poland/technet/security/bulletin/2008/ms08-002.mspx)
</td>
</tr>
...
<td style="border:1px solid black;">
[Umiarkowany](http://www.microsoft.com/downloads/details.aspx?familyid=980f5457-c7b5-421c-8643-0e57429ec156&displaylang=pl)
</td>
<td style="border:1px solid black;">
[Ważny](http://www.microsoft.com/downloads/details.aspx?familyid=7956632e-17d9-4876-8340-84fe3e43e5cc&displaylang=pl)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Krytyczny](http://www.microsoft.com/downloads/details.aspx?familyid=0a766242-2342-4fa0-9b66-8953c54a2211&displaylang=pl)
</td>
<td style="border:1px solid black;">
[Ważny](http://www.microsoft.com/downloads/details.aspx?familyid=6a4cf182-8e36-490e-aefe-edb7b3a0df9c&displaylang=pl)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Krytyczny (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=2e8bc7d5-fe81-4ed5-9efa-360738d160ee)
</td>
<td style="border:1px solid black;">
[Ważny (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=51fc657b-2b4a-4725-a744-d279e027c4a5)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Ważny](http://www.microsoft.com/downloads/details.aspx?familyid=fda060a5-9a1e-4036-9899-13eb61fdd8be&displaylang=pl)
</td>
<td style="border:1px solid black;">
[Ważny](http://www.microsoft.com/downloads/details.aspx?familyid=12397b47-b18f-4d4d-b8d7-adec8ff310d5&displaylang=pl)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Ważny (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=19d993f9-06dd-4dc4-b0cc-c59e822eb8fa)
</td>
<td style="border:1px solid black;">
[Ważny (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=f19fd790-a4e6-4a8a-8077-d1bbfe37ecca)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Ważny (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=2c2264f7-ebbb-40ab-9dbf-9b4e313665a7)
</td>
<td style="border:1px solid black;">
[Ważny (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=0382a195-aa3d-409b-8a79-9fe61588d8a9)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
Windows Small Business Server 2003 z dodatkiem Service Pack 1, Windows Small Business Server 2003 R2, Windows Small Business Server 2003 R2 z dodatkiem Service Pack 2 oraz Windows Home Server
</td>
<td style="border:1px solid black;">
[Krytyczny](http://www.microsoft.com/downloads/details.aspx?familyid=fda060a5-9a1e-4036-9899-13eb61fdd8be&displaylang=pl)
</td>
<td style="border:1px solid black;">
</td>
</tr>
...
<td style="border:1px solid black;">
[Krytyczny](http://www.microsoft.com/downloads/details.aspx?familyid=23c0e03a-db66-4618-bce0-af55e5c1b067&displaylang=pl)
</td>
<td style="border:1px solid black;">
</td>
</tr>
...
<td style="border:1px solid black;">
[Krytyczny](http://www.microsoft.com/downloads/details.aspx?familyid=5f6a37b1-c604-47c9-932f-485db2eda133&displaylang=pl)
</td>
<td style="border:1px solid black;">
</td>
</tr>
...
-   Firma Microsoft opublikowała pięć **niezwiązanych z zabezpieczeniami** aktualizacji o wysokim priorytecie, które dostępne są w witrynie Microsoft Update (MU) i za pośrednictwem usługi Windows Server Update Services (WSUS).
...
-   [Firmie IBM Internet Security Systems X-Force](http://www.iss.net/) reprezentowanej przez Alexa Wheelera i Ryana Smitha za zgłoszenie problemu opisanego w biuletynie [MS08-001](http://www.microsoft.com/poland/technet/security/bulletin/2008/ms08-001.mspx)
-   [Firmie IBM Internet Security Systems X-Force](http://www.iss.net/) reprezentowanej przez Alexa Wheelera i Ryana Smitha za zgłoszenie problemu opisanego w biuletynie [MS08-001](http://www.microsoft.com/poland/technet/security/bulletin/2008/ms08-001.mspx)
-   Thomasowi Garnierowi z firmy [SkyRecon](http://www.skyrecon.com/) za zgłoszenie problemu opisanego w biuletynie [MS08-002](http://www.microsoft.com/poland/technet/security/bulletin/2008/ms08-002.mspx)
...
-   V1.0 (8 stycznia 2008 r.): Opublikowane podsumowanie biuletynów zabezpieczeń.
-   V1.1 (23 stycznia 2008 r.): Podsumowanie biuletynów zaktualizowano w celu dodania systemu Windows Small Business Server 2003 z dodatkiem Service Pack 2 jako oprogramowania, którego dotyczy problem, dla biuletynu MS08-001.
-   V1.2 (25 stycznia 2008 r.): Podsumowanie biuletynów zaktualizowano w celu dodania systemów Windows Small Business Server 2003 z dodatkiem Service Pack 1, Windows Small Business Server 2003 R2, Windows Small Business Server 2003 R2 z dodatkiem Service Pack 2 oraz Windows Home Server do listy oprogramowania, którego dotyczy luka opisana w biuletynie MS08-001.
