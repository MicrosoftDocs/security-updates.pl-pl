---
TOCTitle: 'MS05-MAY'
Title: Microsoft Security Bulletin Summary for maj 2005
ms:assetid: 'ms05-may'
ms:contentKeyID: 61233057
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms05-may(v=Security.10)'
---

Security Bulletin Summary

Microsoft Security Bulletin Summary for maj 2005
================================================
...
Ten biuletyn obejmuje aktualizacje eliminujące nowo odkrytą usterkę:

Ważny (1)
---------

<span></span>
| Identyfikator biuletynu               | Biuletyn zabezpieczeń firmy Microsoft MS05-024                                                                                          |
|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| **Tytuł biuletynu**                   | [**Usterka funkcji Widok sieci Web umożliwia zdalne wykonanie kodu (894320)**](http://technet.microsoft.com/security/bulletin/ms05-024) |
| **Streszczenie**                      | Usterka umożliwia uruchomienie skryptu podczas edycji atrybutów plików w widoku sieci Web.                                              |
| **Maksymalny wskaźnik ważności**      | [Ważny](http://technet.microsoft.com/security/bulletin/rating)                                                                          |
| **Wpływ usterki**                     | Zdalne wykonanie kodu                                                                                                                   |
| **Programy, których dotyczy problem** | **Windows**                                                                                                                             |
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=67581d32-743f-44ff-9b53-30277c196923">Ważny</a></td>
</tr>
<tr class="odd">
