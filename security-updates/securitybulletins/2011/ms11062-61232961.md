---
TOCTitle: 'MS11-062'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-062 - Ważna'
ms:assetid: 'ms11-062'
ms:contentKeyID: 61232961
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-062(v=Security.10)'
---
Biuletyn zabezpieczeń firmy Microsoft MS11-062 - Ważna
======================================================

Luka w zabezpieczeniach sterownika NDISTAPI Usługi dostępu zdalnego umożliwia podniesienie uprawnień (2566454)
--------------------------------------------------------------------------------------------------------------
...
Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki sterownik NDISTAPI sprawdza dane wejściowe trybu użytkownika przed wysłaniem ich do jądra systemu Windows. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4)                                 | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b)        | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc)                        | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667)            | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d) | Podniesienie uprawnień             | Ważny                      | Brak                                               |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach sterownika NDISTAPI umożliwiająca podniesienie poziomu uprawnień — CVE-2011-1974</th>
...
Luka w zabezpieczeniach sterownika NDISTAPI umożliwiająca podniesienie poziomu uprawnień — CVE-2011-1974  
--------------------------------------------------------------------------------------------------------
  
<span></span>
W zabezpieczeniach sterownika NDISTAPI Usługi dostępu zdalnego istnieje luka umożliwiająca podniesienie uprawnień. Luka występuje, gdy sterownik NDISTAPI w nieprawidłowy sposób sprawdza poprawność danych wejściowych użytkownika podczas ich przekazywania do jądra systemu Windows z trybu użytkownika. Osoba atakująca lokalnie, której uda się wykorzystać tę lukę, mogłaby wykonać dowolny kod i uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1974](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach sterownika NDISTAPI umożliwiającej podniesienie poziomu uprawnień — CVE-2011-1974
...
#### Obejścia problemu spowodowanego luką w zabezpieczeniach sterownika NDISTAPI umożliwiającą podniesienie poziomu uprawnień — CVE-2011-1974
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach sterownika NDISTAPI umożliwiającej podniesienie poziomu uprawnień — CVE-2011-1974
  
**Jaki zakres obejmuje luka?**    
Jest to luka umożliwiająca podniesienie uprawnień.
  
**Skąd bierze się luka?**    
Luka występuje, gdy sterownik NDISTAPI w nieprawidłowy sposób sprawdza poprawność danych wejściowych użytkownika podczas ich przekazywania do jądra systemu Windows z trybu użytkownika.
  
**Jaki składnik jest dotknięty przez omawianą lukę?**    
Składnik systemu, którego dotyczy luka, to sterownik NDISTAPI.sys.
  
**Co to jest Usługa dostępu zdalnego (RAS)?**    
Usługa dostępu zdalnego (RAS) pozwala użytkownikom łączyć się z komputerami zdalnymi za pośrednictwem linii telefonicznej, Internetu lub innych połączeń sieciowych, aby umożliwić pracę, tak jakby komputer użytkownika był połączony z siecią zdalną. Usługa RAS pozwala użytkownikom na zdalne wykonywanie takich czynności, jak wysyłanie i odbieranie wiadomości e-mail, faksowanie dokumentów, pobieranie plików oraz drukowanie dokumentów na drukarce biurowej. Więcej informacji można znaleźć artykule MSDN zatytułowanym [RAS](http://msdn.microsoft.com/en-us/library/ff563285(v=vs.85).aspx)Architecture Overview (NDIS 5.1).
  
RAS jest usługą macierzystą systemów Windows XP oraz Windows Server 2003. W kolejnych wersjach systemów usługa RAS została zastąpiona Usługą routingu i dostępu zdalnego (RRAS). Usługa RRAS umożliwia komputerowi pełnienie w sieci roli routera. Usługa ta zapewnia także funkcje serwerowe nowej generacji dla usługi RAS dla systemów Windows. Usługa RRAS z funkcjami serwera jest kontynuacją i rozwinięciem funkcji RAS wchodzącej w skład starszych systemów operacyjnych.
  
**Co to jest sterownik NDISTAPI?**    
Sterownik NDISTAPI jest elementem architektury RAS łączącym sterownik NDISWAN z usługami TAPI. Aplikacje telefoniczne wdrażają usługi TAPI i mogą wysyłać żądania TAPI w celu konfiguracji, monitorowania oraz przerywania linii i połączeń. Sterownik NDISTAPI przesyła żądania TAPI do sterownika NDISWAN. Więcej informacji można znaleźć w artykule MSDN zatytułowanym [NDISTAPI Overview (NDIS 5.1)](http://msdn.microsoft.com/en-us/library/ff554813(v=vs.85).aspx).
  
**Co to jest NDISWAN?**    
NDISWAN to sterownik systemowy NDIS średniego poziomu, którego zadaniem jest zapewnianie takich funkcjonalności, jak kompresja danych, szyfrowanie, zapętlanie oraz ramkowanie danych PPP, wykorzystywanych przez sterowniki miniportów WAN. Zadaniem sterowników miniportów WAN jest zatem wdrażanie tylko tych funkcji, które są wymagane przez dane medium (np. w przypadku ISDN wymagane jest sygnałowanie Q931). Więcej informacji można znaleźć w artykule MSDN [NDISWAN Overview](http://msdn.microsoft.com/en-us/library/ff564653(v=vs.85).aspx).
  
**Co to jest usługa TAPI?**    
Usługa TAPI (Telephony Application Programming Interface) to interfejs programowania, który zapewnia usługi telefoniczne aplikacjom zdolnym nawiązywać połączenia telefoniczne.
  
**Co to jest NDIS?**    
NDIS (Network Driver Interface Standard) jest częścią w pełni zintegrowanego systemu programowania sterowników Windows Driver Kit, który zawiera zestaw Windows Driver Device Kit i zapewnia funkcje testowania stabilności i niezawodności sterowników systemu Windows. Biblioteka NDIS oddziela sprzęt sieciowy od sterowników sieciowych. NDIS określa ponadto standardowy interfejs pomiędzy sterownikami sieciowymi na różnych warstwach, oddzielając w ten sposób sterowniki niskiego poziomu, obsługujące sprzęt, od sterowników wysokiego poziomu, zarządzających np. transportem sieciowym Biblioteka ta przechowuje także informacje o stanie i parametrach sterowników sieciowych, w tym wskaźniki funkcji, aliasy i bloki parametrów dla połączeń i innych wartości systemowych.
  
**Jakie mogą być skutki wykorzystania luki przez osobę atakującą?**     
Osoba atakująca, która wykorzystałaby tę lukę, mogłaby wykonać dowolny kod w kontekście systemu lokalnego. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
...
Ta aktualizacja usuwa lukę, modyfikując sposób, w jaki sterownik NDISTAPI sprawdza dane wejściowe trybu użytkownika przed wysłaniem ich do jądra systemu Windows.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2566454$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2566454">artykuł 2566454 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Lufeng Li z firmy za zgłoszenie luki w zabezpieczeniach sterownika NDISTAPI umożliwiającej podniesienie poziomu uprawnień (CVE-2011-1974)
