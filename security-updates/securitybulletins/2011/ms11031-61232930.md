---
TOCTitle: 'MS11-031'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-031 - Krytyczna'
ms:assetid: 'ms11-031'
ms:contentKeyID: 61232930
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-031(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS11-031 - Krytyczna
==========================================================

Luka w zabezpieczeniach aparatów obsługi skryptów JScript i VBScript umożliwia zdalne wykonanie kodu (2514666)
--------------------------------------------------------------------------------------------------------------
...
<sup>[1]</sup>Problem nie dotyczy systemów z zainstalowanym programem Internet Explorer 9. Nie wymagają one tej aktualizacji. Systemy, których nie uaktualniono przy użyciu programu Internet Explorer 9, będą wymagać odpowiedniej aktualizacji zainstalowanych w nich aparatów obsługi skryptów JScript i VBScript. Instrukcje dotyczące ustalania wersji aparatów obsługi skryptów JScript i VBScript zainstalowanych w systemie znajdują się w sekcji **Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń** poniżej.

**Programy, których nie dotyczy problem**

| System operacyjny                                                                                                                                                    | Składnik                                                                                          |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| Windows Vista z dodatkiem Service Pack 2                                                                                                                             | Aparaty obsługi skryptów JScript 5.8 i VBScript 5.8 zainstalowane z programem Internet Explorer 9 |
| Windows Vista x64 Edition z dodatkiem Service Pack 2                                                                                                                 | Aparaty obsługi skryptów JScript 5.8 i VBScript 5.8 zainstalowane z programem Internet Explorer 9 |
| Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych                                                                                              | Aparaty obsługi skryptów JScript 5.8 i VBScript 5.8 zainstalowane z programem Internet Explorer 9 |
| Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64                                                                                         | Aparaty obsługi skryptów JScript 5.8 i VBScript 5.8 zainstalowane z programem Internet Explorer 9 |
| Windows 7 dla systemów 32-bitowych i Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych                                                                   | Aparaty obsługi skryptów JScript 5.8 i VBScript 5.8 zainstalowane z programem Internet Explorer 9 |
| Windows 7 dla systemów opartych na procesorach x64 i Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64                                   | Aparaty obsługi skryptów JScript 5.8 i VBScript 5.8 zainstalowane z programem Internet Explorer 9 |
| Windows Server 2008 R2 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64         | Aparaty obsługi skryptów JScript 5.8 i VBScript 5.8 zainstalowane z programem Internet Explorer 9 |
| Windows Server 2008 R2 dla systemów opartych na procesorach Itanium i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach Itanium | Aparaty obsługi skryptów JScript 5.8 i VBScript 5.8 zainstalowane z programem Internet Explorer 9 |
...
**W systemie jest zainstalowany program Internet Explorer 9. Czy muszę zainstalować tę aktualizację?**  
Nie. Jeśli w systemie jest zainstalowany program Internet Explorer 9, wersje aparatów obsługi skryptów JScript 5.8 i VBScript 5.8 są najnowsze i nie wymagają tej aktualizacji. Jeśli jednak w systemie nie ma zainstalowanego programu Internet Explorer 9, należy zainstalować odpowiednią wersję aktualizacji aparatów obsługi skryptów JScript i VBScript w systemie. Instrukcje dotyczące ustalania wersji aparatów zainstalowanych w systemie znajdują się w sekcji często zadawanych pytań poniżej.

**Jak ustalić, które wersje aparatów obsługi skryptów JScript i VBScript są zainstalowane w systemie?**  
Wersje aparatów obsługi skryptów JScript i VBScript w systemie zależą od zainstalowanej w tym systemie wersji programu Internet Explorer i zostaną zmienione na nowsze po zainstalowaniu nowszej wersji programu Internet Explorer. Poszczególne wersje programu Internet Explorer zawierają różne wersje aparatów obsługi skryptów. Internet Explorer 6: JScript 5.6 i VBScript 5.6; Internet Explorer 7: JScript 5.7 i VBScript 5.7; Internet Explorer 8: JScript 5.8 i VBScript 5.8. Program Internet Explorer 9 również zawiera aparaty obsługi skryptów JScript 5.8 i VBScript 5.8, ale są to najnowsze wersje i nie wymagają instalowania tej aktualizacji.

Aby ustalić, które wersje aparatów obsługi skryptów JScript i VBScript są zainstalowane w systemie, wykonaj następujące czynności:

1.  Otwórz program Eksplorator Windows.
2.  Przejdź do katalogu **%systemroot%\\system32**.
3.  Kliknij prawym przyciskiem myszy plik **jscript.dll**, wybierz polecenie **Właściwości**, a następnie kliknij kartę **Szczegóły** (powtórz ten krok dla pliku **vbscript.dll**, który znajduje się w tym samym katalogu).

Numer wersji zostanie wyświetlony w polu **Wersja pliku**. Jeśli numer wersji pliku rozpoczyna się od 5.8 (na przykład 5.8.7600.16385), w systemie jest zainstalowany aparat obsługi skryptów JScript 5.8.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach obsługi skryptów związana z ponownym przydzielaniem pamięci — CVE-2011-0663
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
Aparaty obsługi skryptów JScript 5.6 i VBScript 5.6
</th>
</tr>
<tr>
<td style="border:1px solid black;">
JScript 5.6 i VBScript 5.6 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.6 i VBScript 5.6 w systemie Windows Server 2003 z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.6 i VBScript 5.6 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.6 i VBScript 5.6 w systemie Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<th style="border:1px solid black;" colspan="3">
Aparaty obsługi skryptów JScript 5.7 i VBScript 5.7
</th>
</tr>
<tr>
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemie Windows XP z dodatkiem Service Pack 3
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemie Windows Server 2003 z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemie Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemach Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemach Windows Vista x64 Edition z dodatkiem Service Pack 1 oraz Windows Vista x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemie Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2\*\* dla systemów 32-bitowych
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemie Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2\*\* systemów z procesorem x64
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7 i VBScript 5.7 w systemie Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2\*\* systemów z procesorem Itanium
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<th style="border:1px solid black;" colspan="3">
Aparaty obsługi skryptów JScript 5.8 i VBScript 5.8
</th>
</tr>
<tr>
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows XP z dodatkiem Service Pack 3
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows Server 2003 z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemach Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemach Windows Vista x64 Edition z dodatkiem Service Pack 1 oraz Windows Vista x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2\*\* dla systemów 32-bitowych
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2\*\* systemów z procesorem x64
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows 7 dla systemów 32-bitowych i Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows 7 dla systemów opartych na procesorze x64 i Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorze x64
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr>
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows Server 2008 R2 dla systemów opartych na procesorze x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorze x64\*\*
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8 i VBScript 5.8 w systemie Windows Server 2008 R2 dla systemów z procesorem Itanium i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorze x64
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
W aparatach obsługi skryptów JScript i VBScript istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, wynikająca z błędu uszkodzenia pamięci. Osoba atakująca, która wykorzystała tę lukę, może wykonać dowolny kod w kontekście zalogowanego użytkownika. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0663](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0663).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach obsługi skryptów związanej z ponownym przydzielaniem pamięci — CVE-2011-0663
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach obsługi skryptów związaną z ponownym przydzielaniem pamięci — CVE-2011-0663
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach obsługi skryptów związanej z ponownym przydzielaniem pamięci — CVE-2011-0663
...
Luka w zabezpieczeniach wynika ze sposobu, w jaki aparaty skryptów JScript i VBScript przetwarzają skrypty na stronach sieci Web. Przy próbie ponownego przydzielenia pamięci w celu zdekodowania skryptu i uruchomienia go w aparacie obsługi skryptów może wystąpić przepełnienie liczby całkowitej.
...
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7 w systemie Windows XP z dodatkiem Service Pack 3:<br />
windowsxp-kb2510581-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8 w systemie Windows XP z dodatkiem Service Pack 3:<br />
ie8-windowsxp-kb2510531-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.6 i VBScript 5.6 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2:<br />
windowsserver2003.windowsxp-kb2510587-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2:<br />
windowsserver2003.windowsxp-kb2510581-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.6 i VBScript 5.6 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2: JScript 5.6 i VBScript 5.6 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2:<br />
...
<td style="border:1px solid black;">JScript 5.6 i VBScript 5.6: KB2510587.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7: KB2510581.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8: KB2510531-IE8.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">W przypadku aparatów JScript 5.6 i VBScript 5.6 użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2510587$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku aparatów JScript 5.7 i VBScript 5.7 użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2510581$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku aparatów JScript 5.8 i VBScript 5.8 użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\ie8updates\KB2510531-IE8$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">W przypadku aparatów JScript 5.6 i VBScript 5.6 zobacz <a href="http://support.microsoft.com/kb/2510587">artykuł 2510587 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku aparatów JScript 5.7 i VBScript 5.7 zobacz <a href="http://support.microsoft.com/kb/2510581">artykuł 2510581 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku aparatów JScript 5.8 i VBScript 5.8 zobacz <a href="http://support.microsoft.com/kb/2510531">artykuł 2510531 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">JScript 5.6 i VBScript 5.6 w systemie Windows Server 2003 z dodatkiem Service Pack 2:<br />
windowsserver2003-kb2510587-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7 w systemie Windows Server 2003 z dodatkiem Service Pack 2:<br />
windowsserver2003-kb2510581-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8 w systemie Windows Server 2003 z dodatkiem Service Pack 2:<br />
ie8-windowsserver2003-kb2510531-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.6 i VBScript 5.6 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2:<br />
windowsserver2003.windowsxp-kb2510587-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2:<br />
windowsserver2003.windowsxp-kb2510581-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2:<br />
ie8-windowsserver2003.windowsxp-kb2510531-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.6 i VBScript 5.6 w systemie Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium:<br />
windowsserver2003-kb2510587-ia64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7 w systemie Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">JScript 5.6 i VBScript 5.6:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2510587\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2510581\Filelist</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Vista:<br />
windows6.0-kb2510581-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Vista:<br />
ie8-windows6.0-kb2510531-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7 we wszystkich obsługiwanych wersjach x64 systemu Windows Vista:<br />
windows6.0-kb2510581-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8 we wszystkich obsługiwanych wersjach x64 systemu Windows Vista:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Server 2008:<br />
ie8-windows6.0-kb2510531-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7 we wszystkich obsługiwanych wersjach x64 systemu Windows Server 2008:<br />
windows6.0-kb2510581-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 i VBScript 5.8 we wszystkich obsługiwanych wersjach x64 systemu Windows Server 2008:<br />
ie8-windows6.0-kb2510531-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 i VBScript 5.7 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 dla systemów z procesorem Itanium:<br />
...
-   [Jesse Ruderman](http://www.squarefree.com/)z firmy [Mozilla](http://www.mozilla.org/), za współpracę przy usuwaniu luki w zabezpieczeniach obsługi skryptów związanej z ponownym przydzielaniem pamięci (CVE-2011-0663)
...
-   Wersja 1.1 (20 kwietnia 2011 r.): Biuletyn zaktualizowano w celu wyjaśnienia, że aktualizacja JScript 5.8 i VBScript 5.8 (KB2510531) zastępuje także biuletyn MS09-045, w dodatku do biuletynu MS10-022, w przypadku wszystkich obsługiwanych wersji systemu Windows XP, Windows Server 2003, Windows Vista oraz Windows Server 2008.
