---
TOCTitle: 'MS11-056'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-056 - Ważna'
ms:assetid: 'ms11-056'
ms:contentKeyID: 61232955
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-056(v=Security.10)'
---
Biuletyn zabezpieczeń firmy Microsoft MS11-056 - Ważna
======================================================

Luki w zabezpieczeniach podsystemu wykonawczego serwera/klienta systemu Windows umożliwiają podniesienie uprawnień (2507938)
----------------------------------------------------------------------------------------------------------------------------

Opublikowano: 12 lipca 2011 | Zaktualizowano: 21 lipca 2011
...
Aktualizacja zabezpieczeń usuwa luki, nie zezwalając na powiązywanie wielu obiektów konsoli z jednym procesem, zmieniając sposób, w jaki podsystem CSRSS inicjalizuje pamięć, sprawdzając poprawność danych wejściowych użytkownika zanim zostaną użyte jako indeks tablicy oraz modyfikując sprawdzanie granic w celu zapobieżenia uszkodzeniu pamięci. Więcej informacji na temat luk może znaleźć w podsekcjach „Często zadawane pytania” dla pozycji określonych luk w zabezpieczeniach, znajdujących się poniżej następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2507938 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2507938) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=425c705e-94f2-4fa6-9df2-dc71897215fa">Windows XP z dodatkiem Service Pack 3</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c389fa20-677e-49b6-af44-781e5522d08b">Windows XP Professional x64 Edition z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>,</em><br />
<a href="http://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=dff4c67a-8c8b-4d7d-84c7-57429becf0ff">Windows Server 2003 z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>,</em><br />
<a href="http://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1615a995-9a04-440a-ae52-5917738f0ecb">Windows Server 2003 x64 Edition z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>,</em><br />
<a href="http://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a81c011d-eeea-4383-9efb-df70515ab357">Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>,</em><br />
<a href="http://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a5e192af-dae5-47ef-a9d0-f761a8caa974">Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1007f5d3-9be1-4f03-a3f0-12ddb555653c">Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=36e3dbaf-36f5-4c74-8f11-ecbef46f58e1">Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych</a>*</td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b43d2ab5-e281-4c6b-bb37-1f1b5d86ac82">Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64</a>*</td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b70209f2-1c51-45af-b3c4-3473aebcdb35">Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ac3b435c-8caf-40cc-8f13-b52261b3b9e6">Windows 7 dla systemów 32-bitowych i Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=64e5f889-fa46-4884-9b22-3ba4e2fba1b9">Windows 7 dla systemów opartych na procesorach x64 i Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b99a40cf-8a31-43d9-bd0b-a458a533068b">Windows Server 2008 R2 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64</a>*</td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=784efc20-3a41-42ab-b48d-51fd59d71523">Windows Server 2008 R2 dla systemów opartych na procesorach Itanium i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach Itanium</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją AllocConsole — CVE-2011-1281</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją SrvSetConsoleLocalEUDC — CVE-2011-1282</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją SrvSetConsoleNumberOfCommand — CVE-2011-1283</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją SrvWriteConsoleOutput — CVE-2011-1284</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją SrvWriteConsoleOutputString — CVE-2011-1870</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją AllocConsole — CVE-2011-1281  
---------------------------------------------------------------------------------------------------------------------------------------------
  
<span></span>
W Podsystemie wykonawczym serwera/klienta (CSRSS) systemu Windows istnieje luka umożliwiająca podniesienie uprawnień wynikająca ze sposobu, w jaki podsystem CSRSS przypisuje pamięć dla określonych transakcji użytkownika. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod w trybie jądra. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1281).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją AllocConsole — CVE-2011-1281
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach podsystemu CSRSS umożliwiającą lokalne podniesienie poziomu uprawnień i związaną z funkcją AllocConsole — CVE-2011-1281
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją AllocConsole — CVE-2011-1281
  
**Jaki zakres obejmuje luka?**    
Jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Aby podjąć próbę wykorzystania luki, osoba atakująca musi zalogować się lokalnie do systemu i uruchomić program.
  
**Skąd bierze się luka?**    
Przyczyną powstawania tej luki jest sytuacja uszkodzenia pamięci, do której dochodzi, gdy wiele obiektów konsol jest powiązanych z procesem. Po zakończeniu procesu dodatkowe obiekty konsoli pozostają osierocone, a uchwyt obiektu może wtedy zostać przejęty przez inny utworzony proces o uprawnieniach wyższych niż zakładane.
  
**Co to jest Podsystem wykonawczy serwera/klienta (CSRSS) systemu Windows?**    
Podsystem CSRSS to część trybu użytkownika podsystemu Win32 (gdzie Win32.sys jest częścią trybu jądra). Jest to niezbędny podsystem, który musi być uruchomiony przez cały czas. Podsystem CSRSS odpowiada za okna konsoli i tworzenie i/lub usuwanie wątków.
  
**Jakie mogą być skutki wykorzystania luki przez osobę atakującą?**     
Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod w kontekście systemowym. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
...
Aktualizacja zabezpieczeń usuwa lukę, nie zezwalając na powiązywanie wielu obiektów konsoli z jednym procesem.
...
Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją SrvSetConsoleLocalEUDC — CVE-2011-1282  
-------------------------------------------------------------------------------------------------------------------------------------------------------
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1282](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1282).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvSetConsoleLocalEUDC — CVE-2011-1282
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Osoba atakująca musi dysponować prawidłowymi poświadczeniami logowania oraz być w stanie zalogować się lokalnie, aby wykorzystać możliwości stwarzane przez lukę.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach podsystemu CSRSS umożliwiającą lokalne podniesienie poziomu uprawnień i związaną z funkcją SrvSetConsoleLocalEUDC — CVE-2011-1282
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvSetConsoleLocalEUDC — CVE-2011-1282
  
**Jaki zakres obejmuje luka?**    
Jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Aby podjąć próbę wykorzystania luki, osoba atakująca musi zalogować się lokalnie do systemu i uruchomić program.
  
**Skąd bierze się luka?**    
Jest to luka związana z uszkodzeniem pamięci, która umożliwia wykonanie kodu w kontekście systemowym. Do funkcji podsystemu CSRSS przekazywany jest pusty wskaźnik, którego poprawność nie jest sprawdzana. Dzięki temu podsystem CSRSS może zapisywać na pustej stronie w przestrzeni procesu. W określonych warunkach, w systemie Windows XP, ta strona może być później wykorzystywana przez osobę atakującą w celu wykonania kodu z podniesionymi uprawnieniami.
...
**W jaki sposób działa aktualizacja?**     
Aktualizacja usuwa lukę, modyfikując sposób, w jaki podsystem CSRSS inicjalizuje pamięć w celu zapobiegania wykonaniu dowolnego kodu w kontekście systemowym.
...
Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją SrvSetConsoleNumberOfCommand — CVE-2011-1283  
-------------------------------------------------------------------------------------------------------------------------------------------------------------
  
<span></span>
W Podsystemie wykonawczym serwera/klienta (CSRSS) systemu Windows istnieje luka umożliwiająca podniesienie uprawnień wynikająca ze sposobu, w jaki podsystem CSRSS przypisuje pamięć dla określonych transakcji użytkownika. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod w trybie jądra. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1283](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1283).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvSetConsoleNumberOfCommand — CVE-2011-1283
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Osoba atakująca musi dysponować prawidłowymi poświadczeniami logowania oraz być w stanie zalogować się lokalnie, aby wykorzystać możliwości stwarzane przez lukę.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach podsystemu CSRSS umożliwiającą lokalne podniesienie poziomu uprawnień i związaną z funkcją SrvSetConsoleNumberOfCommand — CVE-2011-1283
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvSetConsoleNumberOfCommand — CVE-2011-1283
  
**Jaki zakres obejmuje luka?**    
Jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Aby podjąć próbę wykorzystania luki, osoba atakująca musi zalogować się lokalnie do systemu i uruchomić program.
  
**Skąd bierze się luka?**    
Luka powstaje, gdy dane wejściowe użytkownika zostają wykorzystane jako indeks tablicy bez ich uprzedniego sprawdzenia pod kątem wartości ujemnej. Dzięki temu osoba atakująca może odczytywać dane z różnych obszarów pamięci lub z uszkodzonej pamięci, w sposób pozwalający na wykonanie kodu.
...
**W jaki sposób działa aktualizacja?**     
Aktualizacja usuwa lukę, zapewniając sprawdzenie poprawności danych wejściowych użytkownika, zanim zostaną one użyte jako indeks tablicy.
...
Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją SrvWriteConsoleOutput — CVE-2011-1284  
------------------------------------------------------------------------------------------------------------------------------------------------------
  
<span></span>
W Podsystemie wykonawczym serwera/klienta (CSRSS) systemu Windows istnieje luka umożliwiająca podniesienie uprawnień wynikająca ze sposobu, w jaki podsystem CSRSS przypisuje pamięć dla określonych transakcji użytkownika. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod w trybie jądra. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1284](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1284).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvWriteConsoleOutput — CVE-2011-1284
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Osoba atakująca musi dysponować prawidłowymi poświadczeniami logowania oraz być w stanie zalogować się lokalnie, aby wykorzystać możliwości stwarzane przez lukę.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach podsystemu CSRSS umożliwiającą lokalne podniesienie poziomu uprawnień i związaną z funkcją SrvWriteConsoleOutput — CVE-2011-1284
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvWriteConsoleOutput — CVE-2011-1284
  
**Jaki zakres obejmuje luka?**    
Jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
**Skąd bierze się luka?**    
Przyczyną powstania tej luki w zabezpieczeniach jest przepełnienie liczby całkowitej, które może pozwolić osobie atakującej na wykonanie kodu w kontekście konta systemowego.
...
**W jaki sposób działa aktualizacja?**     
Niniejsza aktualizacja usuwa lukę w zabezpieczeniach przez zmianę sposobu sprawdzania granic w celu zapobieżenia uszkodzeniu pamięci i wykonaniu kodu.
...
Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień związana z funkcją SrvWriteConsoleOutputString — CVE-2011-1870  
------------------------------------------------------------------------------------------------------------------------------------------------------------
  
<span></span>
W Podsystemie wykonawczym serwera/klienta (CSRSS) systemu Windows istnieje luka umożliwiająca podniesienie uprawnień wynikająca ze sposobu, w jaki podsystem CSRSS przypisuje pamięć dla określonych transakcji użytkownika. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod w trybie jądra. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1870).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvWriteConsoleOutputString — CVE-2011-1870
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Osoba atakująca musi dysponować prawidłowymi poświadczeniami logowania oraz być w stanie zalogować się lokalnie, aby wykorzystać możliwości stwarzane przez lukę.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach podsystemu CSRSS umożliwiającą lokalne podniesienie poziomu uprawnień i związaną z funkcją SrvWriteConsoleOutputString — CVE-2011-1870
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvWriteConsoleOutputString — CVE-2011-1870
...
**W jaki sposób działa aktualizacja?**     
Niniejsza aktualizacja usuwa lukę w zabezpieczeniach przez zmianę sposobu sprawdzania granic w celu zapobieżenia uszkodzeniu pamięci.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2507938$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2507938">artykuł 2507938 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Matthew „j00ru” Jurczyk z firmy [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), za zgłoszenie luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją AllocConsole (CVE-2011-1281)  
-   Matthew „j00ru” Jurczyk z firmy [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), za zgłoszenie luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvSetConsoleLocalEUDC (CVE-2011-1282)  
-   Matthew „j00ru” Jurczyk z firmy [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), za zgłoszenie luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvSetConsoleNumberOfCommand (CVE-2011-1283)  
-   Matthew „j00ru” Jurczyk z firmy [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), za zgłoszenie luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvWriteConsoleOutput (CVE-2011-1284)  
-   Matthew „j00ru” Jurczyk z firmy [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/), za zgłoszenie luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień i związanej z funkcją SrvWriteConsoleOutputString (CVE-2011-1870)
...
-   Wersja 1.1 (21 lipca 2011 r.): Dodano łącze do artykułu 2507938 bazy wiedzy Microsoft Knowledge Base w części „Znane problemy” sekcji „Streszczenie”.
