---
TOCTitle: 'MS11-030'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-030 - Krytyczna'
ms:assetid: 'ms11-030'
ms:contentKeyID: 61232929
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-030(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS11-030 - Krytyczna
==========================================================

Luka w zabezpieczeniach usługi rozpoznawania nazw DNS umożliwia zdalne wykonanie kodu (2509553)
-----------------------------------------------------------------------------------------------
...
Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki klient DNS przetwarza specjalnie spreparowane kwerendy DNS. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2509553 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2509553) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2d433adb-bcaf-4c59-9405-a4892f8ccba3">Windows XP z dodatkiem Service Pack 3</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=29ff546e-a232-4f23-a223-c029c71ff1c6">Windows XP Professional x64 Edition z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=108231">MS08-020</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=119620">MS08-037</a>,<br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=753ed6e3-df2e-4b2d-9e9f-7275cd94d214">Windows Server 2003 z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=108231">MS08-020</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=119620">MS08-037</a>,<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a0192dbc-4d0d-4555-9ef7-3e10209a6389">Windows Server 2003 x64 Edition z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=108231">MS08-020</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=119620">MS08-037</a>,<br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f5ad6963-2d6a-4d59-9e25-4fc088647fcd">Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium</a></td>
<td style="border:1px solid black;">Podniesienie uprawnień</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=108231">MS08-020</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=119620">MS08-037</a>,<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2a17e44f-54aa-423d-b3c7-a4f404f7c28b">Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e708d24f-e348-4c4d-99ed-e78dd1689d01">Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9894be38-a582-4c15-ad0e-cc3afab2aebc">Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych*</a></td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2d7d2021-020f-4cc9-a027-258d7e5faec9">Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64*</a></td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c0275df0-10ac-4500-ab86-b7e9a34f8e1d">Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium</a></td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=8fdae09b-d1bb-4ef5-aa45-2a05f2a5e12d">Windows 7 dla systemów 32-bitowych i Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych</a></td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=40879dfb-efa4-41ba-8d5c-22e926a55eef">Windows 7 dla systemów opartych na procesorach x64 i Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64</a></td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2084c726-187e-41f9-9bea-da18f490d29e">Windows Server 2008 R2 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64</a>*</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=34d2793e-a2cd-49f6-b524-6598ea86175f">Windows Server 2008 R2 dla systemów opartych na procesorach Itanium i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach Itanium</a></td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
</tr>
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z kwerendami DNS — CVE-2011-0657</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
Luka w zabezpieczeniach związana z kwerendami DNS — CVE-2011-0657  
-----------------------------------------------------------------
  
Sposób, w jaki usługa klienta DNS obsługuje specjalnie spreparowane kwerendy LLMNR, powoduje powstanie luki w zabezpieczeniach, która umożliwia zdalne wykonanie kodu. Osoba atakująca, która wykorzystałaby tę lukę, mogłaby wykonać dowolny kod w kontekście konta Usługa sieciowa. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0657](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0657).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z kwerendami DNS — CVE-2011-0657
...
-   Sprawdzone metody działania stosowane w zaporach oraz standardowe domyślne konfiguracje zapór mogą pomóc w zabezpieczeniu sieci przed atakami spoza obszaru działania przedsiębiorstwa. Zgodnie ze standardowymi zasadami działania zaleca się, aby w systemach połączonych z Internetem była otwarta jak najmniejsza liczba portów. W takim przypadku dostęp do portów LLMNR z Internetu powinien zostać zablokowany. Zapoznaj się z często zadawanymi pytaniami dotyczącymi blokowania portów TCP 5355 i UDP 5355 na zaporze.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z kwerendami DNS — CVE-2011-0657
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Zablokowanie portu TCP 5355 i portu UDP 5355 na zaporze**
  
    Te porty są używane do inicjowania połączenia ze składnikiem, którego dotyczy luka. Zablokowanie tych portów na zaporze przedsiębiorstwa zarówno dla ruchu przychodzącego, jak i wychodzącego, może pomóc w zabezpieczeniu systemów chronionych zaporą przed próbami wykorzystania luki opisanej w tym biuletynie. W celu zapobieżenia atakom mogącym wykorzystywać inne porty zaleca się blokowanie całego niepożądanego ruchu przychodzącego z Internetu. Więcej informacji na temat portów znajduje się w artykule [Przypisywanie portów TCP i UDP](http://go.microsoft.com/fwlink/?linkid=21312) (j. ang.). Aby uzyskać więcej informacji na temat zapory systemu Windows, zobacz artykuł [Jak skonfigurować zaporę systemu Windows na pojedynczym komputerze](http://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx).
  
    **Wpływ obejścia.** Zablokowanie łączności na tych portach uniemożliwi próby wykorzystania omawianej luki za pomocą systemów znajdujących się za zaporą.
  
    **Cofnięcie obejścia.** Odblokowanie portu TCP 5355 i portu UDP 5355 na zaporze. Więcej informacji na temat portów znajduje się w artykule [Przypisywanie portów TCP i UDP](http://go.microsoft.com/fwlink/?linkid=21312) (j. ang.).
  
-   **Zablokowanie protokołu Link-Local Multicast Name Resolution (LLMNR) przy użyciu zasad grupy**
  
    Aby wyłączyć protokół LLMNR przy użyciu zasad grupy, wykonaj następujące czynności:
  
    1.  Uruchom edytor zasad grupy.  
    2.  Rozwiń pozycję **Konfiguracja komputera**, następnie **Szablony administracyjne**, **Sieć** i **Klient DNS**.  
    3.  Kliknij dwukrotnie pozycję **Wyłącz rozpoznawanie nazw z obsługą multiemisji**, kliknij opcję **Włączone**, a następnie przycisk **OK**.
  
    **Wpływ obejścia.** Komputer może być niewidoczny dla innych komputerów w sieci.
  
    **Cofnięcie obejścia.**
  
    Aby ponownie włączyć protokół LLMNR przy użyciu zasad grupy, wykonaj następujące czynności:
  
    1.  Uruchom edytor zasad grupy.  
    2.  Rozwiń pozycję **Konfiguracja komputera**, następnie **Szablony administracyjne**, **Sieć** i **Klient DNS**.  
    3.  Kliknij dwukrotnie pozycję **Wyłącz rozpoznawanie nazw z obsługą multiemisji**, kliknij opcję **Wyłączone**, a następnie przycisk **OK**.
  
-   **Wyłączenie odnajdowania sieci**
  
    Aby wyłączyć funkcję Odnajdowanie sieci, wykonaj następujące czynności:
  
    1.  Otwórz Panel sterowania.  
    2.  Kliknij pozycję **Sieć i Internet**, następnie **Centrum sieci i udostępniania** i **Zmień zaawansowane ustawienia udostępniania**.  
    3.  W pozycji Odnajdowanie sieci kliknij opcję **Wyłącz odnajdowanie sieci**, a następnie **Zapisz zmiany**.
  
    **Wpływ obejścia.** Komputer może być niewidoczny dla innych komputerów w sieci.
  
    **Cofnięcie obejścia.**
  
    Aby ponownie włączyć funkcję Odnajdowanie sieci, wykonaj następujące czynności:
  
    1.  Otwórz Panel sterowania.  
    2.  Kliknij pozycję **Sieć i Internet**, następnie **Centrum sieci i udostępniania** i **Zmień zaawansowane ustawienia udostępniania**.  
    3.  W pozycji Odnajdowanie sieci kliknij opcję **Włącz odnajdowanie sieci**, a następnie **Zapisz zmiany**.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z kwerendami DNS — CVE-2011-0657
  
**Jaki zakres obejmuje ta luka?**  
W systemie Windows Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2 jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, która wykorzystała tę lukę, może wykonać kod w kontekście konta usługi sieciowej.
  
W systemach XP i Windows Server 2003 jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca posiadająca poświadczenia użytkownika może wykorzystać tę lukę, co spowodowałoby podniesienie uprawnień i pozwoliło tej osobie wykonać kod w kontekście konta usługi sieciowej.
  
**W jaki sposób powstaje luka?**  
Przyczyną powstawania luki jest sposób, w jaki klient DNS obsługuje specjalnie spreparowane kwerendy LLMNR.
  
**Jaki składnik jest zagrożony przez omawianą lukę?**  
Składnikiem zagrożonym luką jest biblioteka DNSAPI.dll.
  
**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**  
Osoba atakująca, która wykorzystałaby tę lukę, mogłaby wykonać dowolny kod w kontekście konta Usługa sieciowa. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**  
W systemach Windows Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2 osoba atakująca musiałaby mieć dostęp do sieci, aby wykorzystać omawianą lukę. Osoba ta mogłaby wówczas stworzyć własny program, który wysyłałby do systemów docelowych specjalnie spreparowane kwerendy emisji LLMNR.
  
Aby wykorzystać tę lukę w systemach Windows XP i Windows Server 2003, osoba atakująca musi najpierw zalogować się do systemu. Osoba atakująca mogłaby wtedy uruchomić specjalnie spreparowaną aplikację, która pozwoliłaby wykorzystać lukę i podnieść uprawnienia tej osoby do poziomu uprawnień konta usługi sieciowej.
  
**Czy omawiana luka może zostać wykorzystana w sposób zdalny w przypadku systemu Windows XP lub Windows Server 2003?**  
Nie. Protokół LLMNR nie jest obsługiwany w systemach Windows XP i Windows Server 2003. Omawiana luka klienta DNS istnieje jednak w tych systemach i można ją wykorzystać wyłącznie lokalnie poprzez uruchomienie specjalnie spreparowanej aplikacji.
  
**Co to jest LLMNR?**  
LLMNR (Link-local Multicast Name Resolution) to nowy protokół oferujący dodatkową metodę rozpoznawania nazw sąsiednich komputerów. Protokół LLMNR jest szczególnie przydatny w sieciach pozbawionych serwera DNS. Protokół LLMNR korzysta z prostej wymiany komunikatów żądań i odpowiedzi, aby przetłumaczyć nazwy komputerów na adresy zgodne z protokołem IPv6 lub IPv4. Aby uzyskać więcej informacji o protokole LLMNR, zapoznaj się z artykułem [Lokalne rozpoznawanie nazw z obsługą multiemisji](http://technet.microsoft.com/en-us/library/bb878128.aspx) w witrynie Microsoft TechNet.
...
Ta aktualizacja usuwa lukę, modyfikując sposób, w jaki klient DNS przetwarza specjalnie spreparowane kwerendy DNS.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2509553$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2509553">artykuł 2509553 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Neel Mehta z firmy [Google Inc.](http://www.google.com/), za zgłoszenie luki w zabezpieczeniach związanej z kwerendami DNS (CVE-2011-0657)
...
-   Wersja 1.1 (13 marca 2012 r.): W części „Znane problemy” sekcji „Streszczenie” dodano łącze do artykułu 2509553 bazy wiedzy Microsoft Knowledge Base.
