---
TOCTitle: 'MS11-047'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-047 - Ważna'
ms:assetid: 'ms11-047'
ms:contentKeyID: 61232946
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-047(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-047 - Ważna
======================================================

Luka w zabezpieczeniach serwera Hyper-V umożliwia przeprowadzenie ataku typu „odmowa usługi” (2525835)
------------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji x64 systemów Microsoft Windows 2008 Server i Windows Server 2008 R2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki serwer Hyper-V przetwarza nieprawidłowo utworzone żądania od maszyn wirtualnych. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=24789423-72b7-48d1-bdc1-f0e5174d99bb)\* | Odmowa usługi                      | Ważny                      | [MS10-102](http://go.microsoft.com/fwlink/?linkid=205309) |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                                                  | Odmowa usługi                      | Ważny                      | [MS10-102](http://go.microsoft.com/fwlink/?linkid=205309) |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64 z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                       | Odmowa usługi                      | Ważny                      | Brak                                                      |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach magistrali VMBus umożliwiająca stałe ataki typu „odmowa usługi” — CVE-2011-1872</th>
...
Luka w zabezpieczeniach magistrali VMBus umożliwiająca stałe ataki typu „odmowa usługi” — CVE-2011-1872  
-------------------------------------------------------------------------------------------------------
  
<span></span>
Luka umożliwiająca przeprowadzenie ataku typu „odmowa usługi” istnieje w funkcji Hyper-V w systemach Windows Server 2008 i Windows Server 2008 R2. Przyczyną jej występowania jest niedostateczne sprawdzanie poprawności określonych sekwencji instrukcji maszyny przez serwery Hyper-V. Osoba atakująca, której uda się wykorzystać tę lukę, może spowodować, że zaatakowany system Hyper-V przestanie odpowiadać. Luka ta dotyczy wszystkich maszyn wirtualnych obsługiwanych przez ten system.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1872](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1872).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach magistrali VMBus umożliwiającej stałe ataki typu „odmowa usługi” — CVE-2011-1872
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach magistrali VMBus umożliwiającą stałe ataki typu „odmowa usługi” — CVE-2011-1872
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach magistrali VMBus umożliwiającej stałe ataki typu „odmowa usługi” — CVE-2011-1872
  
**Jaki zakres obejmuje luka?**    
Ta luka powoduje awarię typu odmowa usługi. Osoba atakująca, która wykorzysta tę lukę, może spowodować, że zaatakowany serwer Hyper-V przestanie odpowiadać i może być wymagane jego ponowne uruchomienie. Należy zauważyć, że luka umożliwiająca atak typu „odmowa usługi" nie pozwala atakującemu na wykonanie kodu ani podniesienie poziomu praw użytkownika na serwerze Hyper-V, lecz może spowodować, że zaatakowany system przestanie akceptować żądania.
  
**Skąd bierze się luka?**    
Przyczyną powstania luki jest niedostateczne sprawdzanie poprawności określonych pakietów przesyłanych od gościa do hosta. W wyniku niedostatecznego sprawdzenia poprawności przetwarzanie tych instrukcji może spowodować nadmierne zużycie zasobów przez aplikację serwera Hyper-V.
  
**Co to jest Hyper-V?**    
Hyper-V to technologia oparta na funkcji hypervisor, która jest kluczową funkcją systemów Windows Server 2008 i Windows Server 2008 R2. Zapewnia ona skalowalną, niezawodną i wysoce dostępną platformę wirtualizacji. Tego rodzaju środowisko jest przydatne, ponieważ umożliwia tworzenie maszyn wirtualnych i zarządzanie nimi, co z kolei pozwala uruchamiać wiele systemów operacyjnych na jednym komputerze fizycznym przy jednoczesnym oddzieleniu tych systemów operacyjnych od siebie.
  
**Jakie mogą być skutki wykorzystania luki przez osobę atakującą?**     
Osoba atakująca, której uda się wykorzystać tę lukę, może spowodować, że komputer użytkownika przestanie odpowiadać i będzie wymagać ponownego uruchomienia. Należy pamiętać, że omawiana luka może spowodować całkowite zużycie zasobów serwera Hyper-V, włącznie z zasobami wszystkich obsługiwanych przez ten serwer maszyn wirtualnych gościa.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**     
Osoba atakująca musi być administratorem uwierzytelnionym na jednej z obsługiwanych przez serwer Hyper-V maszyn wirtualnych gościa. Osoba atakująca musiałaby mieć możliwość wykonania dowolnego kodu w tym systemie, na przykład poprzez uruchomienie niezaufanego pliku wykonywalnego. Ten plik wykonywalny mógłby następnie wywołać nieprawidłową sekwencję instrukcji maszyny, która spowodowałaby zużycie zasobów, a w rezultacie wprowadzenie serwera Hyper-V w nieskończoną pętlę i uniemożliwienie mu tym samym przetwarzania żądań innych maszyn wirtualnych.
  
**Jakich uprawnień potrzebuje osoba atakująca, aby przeprowadzić atak typu „odmowa usługi”?**    
Aby przeprowadzić atak typu „odmowa usługi” przeciwko serwerowi Hyper-V i wszystkim działającym na nim maszynom wirtualnym, osoba atakująca musiałaby mieć uprawnienia administratora do jednej z tych maszyn wirtualnych. Nie byłoby potrzebne posiadanie uprawnień dostępu administratora do samego serwera Hyper-V.
...
Ta aktualizacja zabezpieczeń poprawia sposób, w jaki serwer Hyper-V przetwarza nieprawidłowo utworzone żądania od maszyn wirtualnych. Dzięki poprawce aplikacja serwera Hyper-V może prawidłowo sprawdzać poprawność pakietów magistrali VMBus przesyłanych od gościa do hosta.
...
<td style="border:1px solid black;">Serwer Hyper-V we wszystkich obsługiwanych wersjach x64 systemu Windows Server 2008:<br />
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2525835">artykuł 2525835 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Serwer Hyper-V we wszystkich obsługiwanych wersjach x64 systemu Windows Server 2008 R2:<br />
...
-   Nicolas Economou z firmy [Core Security Technologies](http://www.coresecurity.com/), za zgłoszenie luki w zabezpieczeniach magistrali VMBus umożliwiającej stałe ataki typu „odmowa usługi” (CVE-2011-1872)
