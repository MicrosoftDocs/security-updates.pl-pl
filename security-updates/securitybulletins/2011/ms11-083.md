---
TOCTitle: 'MS11-083'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-083 - Krytyczna'
ms:assetid: 'ms11-083'
ms:contentKeyID: 61232982
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-083(v=Security.10)'
---
Biuletyn zabezpieczeń firmy Microsoft MS11-083 - Krytyczna
==========================================================
...
Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki stos TCP/IP systemu Windows śledzi pakiety UDP w pamięci. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| [Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fc3fe87c-2493-431d-a904-dec9310f6042)                                                                                                                             | Krytyczny                          | Zdalne wykonanie kodu      | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=042c1a8f-834d-4eed-8a59-9e030ccc6d39)                                                                                                                 | Krytyczny                          | Zdalne wykonanie kodu      | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 dla systemów 32-bitowych z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79382bf2-d2cb-42ea-92dc-64f949353521)\*                                                                                            | Krytyczny                          | Zdalne wykonanie kodu      | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 dla systemów z procesorem x64 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71ff3a89-d7ad-4dda-9e59-fab54b21bd5d)\*                                                                                       | Krytyczny                          | Zdalne wykonanie kodu      | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=b1c0cb05-c284-49b1-ae4f-92813fdf520f)                                                                                     | Krytyczny                          | Zdalne wykonanie kodu      | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7 dla systemów 32-bitowych i Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=4ddb4c2a-bada-49b0-ad78-e07e7e11ced7)                                                                   | Krytyczny                          | Zdalne wykonanie kodu      | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7 dla systemów opartych na procesorach x64 i Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=05eef5d7-acf6-46e4-abfc-dc83f0a7cae5)                                   | Krytyczny                          | Zdalne wykonanie kodu      | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=3f9f74a6-e984-4aab-837c-ef7286e7305f)\*       | Krytyczny                          | Zdalne wykonanie kodu      | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=b20bfcbd-a515-4074-b56e-b82539fe5bad) | Krytyczny                          | Zdalne wykonanie kodu      | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z przepełnieniem licznika odwołań — CVE-2011-2013</th>
...
Luka w zabezpieczeniach związana z przepełnieniem licznika odwołań — CVE-2011-2013  
----------------------------------------------------------------------------------
  
<span></span>
W zabezpieczeniach stosu TCP/IP systemu Windows istnieje luka umożliwiająca zdalne wykonanie kodu, związana z przetwarzaniem ciągłego strumienia specjalnie spreparowanych pakietów UDP. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod w trybie jądra. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-2013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2013).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z przepełnieniem licznika odwołań — CVE-2011-2013
  
Firma Microsoft nie znalazła dla tej luki żadnych czynników ograniczających zagrożenie.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z przepełnieniem licznika odwołań — CVE-2011-2013
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Zablokowanie nieużywanych portów UDP na zaporze zewnętrznej**
  
    Zablokowanie nieużywanych (zamkniętych) portów UDP na zaporze zewnętrznej pomaga chronić systemy znajdujące się za tą zaporą przed próbami wykorzystania omawianej luki w zabezpieczeniach. Więcej informacji na temat portów można znaleźć w artykule TechNet [Przypisywanie portów TCP i UDP](http://go.microsoft.com/fwlink/?linkid=21312) (j. ang.) Aby uzyskać więcej informacji na temat zapory systemu Windows, zobacz artykuł TechNet [Jak skonfigurować zaporę systemu Windows na pojedynczym komputerze](http://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx).
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z przepełnieniem licznika odwołań — CVE-2011-2013
  
**Jaki zakres obejmuje ta luka?**    
Jest to luka umożliwiająca zdalne wykonanie kodu w kontekście jądra systemu Windows.
  
**W jaki sposób powstaje luka?**    
Luka powstaje, gdy stos TCP/IP systemu Windows przetwarza ciągły strumień specjalnie spreparowanych pakietów UDP, co powoduje przepełnienie liczby całkowitej.
...
**Co to jest UDP?**  
Protokół UDP (User Datagram Protocol) to standard protokołu TCP/IP zdefiniowany w dokumencie RFC 768 „User Datagram Protocol (UDP)”. Niektóre programy używają protokołu UDP zamiast TCP, aby szybko, pewnie i niewielkim nakładem zasobów przekazywać dane między hostami TCP/IP. Protokół UDP zapewnia bezpołączeniową usługę datagramów, która umożliwia dostarczanie na zasadzie optymalnego rozwiązania (best effort). Oznacza to, że protokół UDP nie gwarantuje dostarczenia ani weryfikacji sekwencji datagramów. Źródłowy host, który wymaga niezawodnej komunikacji, musi używać protokołu TCP albo programu, który zapewnia własne usługi sekwencjonowania i potwierdzania. Aby uzyskać więcej informacji, zobacz artykuł TechNet [User Datagram Protocol (UDP)](http://technet.microsoft.com/en-us/library/cc785220(ws.10).aspx).
...
Osoba atakująca może wykorzystać tę lukę, wysyłając do zamkniętego portu w systemie docelowym ciągły strumień specjalnie spreparowanych pakietów UDP.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**    
Zagrożone są szczególnie stacje robocze i serwery.
  
**W jaki sposób działa aktualizacja?**    
Ta aktualizacja usuwa lukę, modyfikując sposób, w jaki stos TCP/IP systemu Windows śledzi pakiety UDP w pamięci.
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2588516">artykuł 2588516 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
