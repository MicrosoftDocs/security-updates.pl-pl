...
**Czy użytkownicy programu Microsoft Excel 2007 lub Microsoft Excel 2010 muszą zainstalować wszystkie aktualizacje dotyczące tego oprogramowania wymienione w tabeli Programy, których dotyczy problem?**  
...
**Dlaczego w biuletynie dotyczącym programu Microsoft Excel otrzymuję propozycję zainstalowania aktualizacji zabezpieczeń KB2553091 i KB2553096 dla pakietu Microsoft Office 2010?**  
...
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel dotyczącej czcionek WriteAV i związanej z użyciem po zwolnieniu — CVE-2011-1986
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1987](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1987).
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1988](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1988).
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z uszkodzeniem stosu — CVE-2011-1988

**Jaki zakres obejmuje ta luka?**  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może zdalnie uzyskać pełną kontrolę nad systemem jej podlegającym. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

**W jaki sposób powstaje luka?**  
Luka powstaje, gdy program Microsoft Excel nieprawidłowo analizuje określone rekordy w plikach programu Excel.
...
**W jaki sposób działa aktualizacja?**  
Aktualizacja usuwa lukę, poprawiając sposób, w jaki program Microsoft Excel analizuje określone rekordy w plikach programu Excel.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1989](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1989).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z analizą wyrażeń warunkowych — CVE-2011-1989
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z analizą wyrażeń warunkowych — CVE-2011-1989
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z analizą wyrażeń warunkowych — CVE-2011-1989

**Jaki zakres obejmuje ta luka?**  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może zdalnie uzyskać pełną kontrolę nad systemem jej podlegającym. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

**W jaki sposób powstaje luka?**  
Luka powstaje, gdy program Microsoft Excel nie analizuje prawidłowo wyrażeń stosowanych w celu określenia wymagań w zakresie formatowania.
...
**W jaki sposób działa aktualizacja?**  
Aktualizacja usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki program Microsoft Excel obsługuje pewne rodzaje wyrażeń warunkowych.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1990](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1990).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z indeksowaniem tablicy poza zakresem — CVE-2011-1990
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Excel związaną z indeksowaniem tablicy poza zakresem — CVE-2011-1990
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z indeksowaniem tablicy poza zakresem — CVE-2011-1990

**Jaki zakres obejmuje ta luka?**  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może zdalnie uzyskać pełną kontrolę nad systemem jej podlegającym. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

**W jaki sposób powstaje luka?**  
Luka powstaje, gdy program Microsoft Excel nie sprawdza znaku liczby całkowitej użytej jako indeks w tablicy.
...
**W jaki sposób działa aktualizacja?**  
Aktualizacja usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki program Microsoft Excel przeprowadza sprawdzenie granic na wartościach indeksu tablicy.
...
| Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 32-bitowe)                                                                       | Tak  |
| Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 64-bitowe)                                                                       | Tak  |
| Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2010 i Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2010 z dodatkiem Service Pack 1 | Tak  |
| Microsoft Excel Web App 2010 i Microsoft Excel Web App 2010 z dodatkiem Service Pack 1                                                                                                                     | Tak  |
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Excel 2007 z dodatkiem Service Pack 2</td>
<td style="border:1px solid black;">Tak</td>
<td style="border:1px solid black;">Tak</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Excel 2010 i Microsoft Excel
<div>
2010 z dodatkiem Service Pack 1 (wersje 32-bitowe)
</div></td>
<td style="border:1px solid black;">Tak</td>
<td style="border:1px solid black;">Tak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2010 oraz Microsoft Office 2010 z dodatkiem Service Pack 1 (wersje 32-bitowe)</td>
<td style="border:1px solid black;">Tak</td>
<td style="border:1px solid black;">Tak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Microsoft Excel 2010 i Microsoft Excel
<div>
2010 z dodatkiem Service Pack 1 (wersje 64-bitowe)
</div></td>
<td style="border:1px solid black;">Tak</td>
<td style="border:1px solid black;">Tak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Pakiet Microsoft Office 2010 i Microsoft Office 2010 z dodatkiem Service Pack 1 (wersje 64-bitowe)</td>
<td style="border:1px solid black;">Tak</td>
<td style="border:1px solid black;">Tak</td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">Przeglądarka programu Microsoft Excel z dodatkiem Service Pack 2</td>
<td style="border:1px solid black;">Tak</td>
<td style="border:1px solid black;">Tak</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Pakiet zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 z dodatkiem Service Pack 2</td>
<td style="border:1px solid black;">Tak</td>
<td style="border:1px solid black;">Tak</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 32-bitowe)</td>
<td style="border:1px solid black;">Tak. Patrz <strong>Uwaga dotycząca programów Microsoft Office SharePoint Server 2007</strong> i <strong>Microsoft Office SharePoint Server 2010</strong> poniżej</td>
<td style="border:1px solid black;">Tak. Patrz <strong>Uwaga dotycząca programów Microsoft Office SharePoint Server 2007</strong> i <strong>Microsoft Office SharePoint Server 2010</strong> poniżej</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 64-bitowe)</td>
<td style="border:1px solid black;">Tak. Patrz <strong>Uwaga dotycząca programów Microsoft Office SharePoint Server 2007</strong> <strong>i</strong> <strong>2010</strong> poniżej.</td>
<td style="border:1px solid black;">Tak. Patrz <strong>Uwaga dotycząca programów Microsoft Office SharePoint Server 2007</strong> i <strong>Microsoft Office SharePoint Server 2010</strong> poniżej</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2010 i Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2010 z dodatkiem Service Pack 1</td>
<td style="border:1px solid black;">Tak. Patrz <strong>Uwaga dotycząca programów Microsoft Office SharePoint Server 2007</strong> i <strong>Microsoft Office SharePoint Server 2010</strong> poniżej</td>
<td style="border:1px solid black;">Tak. Patrz <strong>Uwaga dotycząca programów Microsoft Office SharePoint Server 2007</strong> i <strong>Microsoft Office SharePoint Server 2010</strong> poniżej</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Excel Web App 2010 i Microsoft Excel Web App 2010 z dodatkiem Service Pack 1</td>
<td style="border:1px solid black;">Tak</td>
<td style="border:1px solid black;">Tak</td>
</tr>
</tbody>
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2553072">artykuł 2553072 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
#### Excel 2007 (wszystkie wersje) i Office 2007 (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Microsoft Excel 2007 z dodatkiem Service Pack 2:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Przeglądarka programu Microsoft Excel z dodatkiem Service Pack 2:<br />
...
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Microsoft Excel 2007 z dodatkiem Service Pack 2:<br />
Zobacz <a href="http://support.microsoft.com/kb/2553073">artykuł 2553073 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office 2007 z dodatkiem Service Pack 2:<br />
Zobacz <a href="http://support.microsoft.com/kb/2553089">artykuł 2553089 bazy wiedzy Microsoft Knowledge Base</a><br />
Zobacz <a href="http://support.microsoft.com/kb/2553090">artykuł 2553090 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Przeglądarka programu Microsoft Excel z dodatkiem Service Pack 2:<br />
Zobacz <a href="http://support.microsoft.com/kb/2553075">artykuł 2553075 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
Zobacz <a href="http://support.microsoft.com/kb/2553074">artykuł 2553074 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### Excel 2010 (wszystkie wersje), Microsoft Office 2010 (wszystkie wersje) oraz Microsoft Excel Web App (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Microsoft Excel 2010 i Microsoft Excel 2010 z dodatkiem Service Pack 1 (wersje 32-bitowe):<br />
Excel2010-kb2553070-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Pakiet Microsoft Office 2010 i Microsoft Office 2010 z dodatkiem Service Pack 1 (wersje 32-bitowe):<br />
Office2010-kb2553091-fullfile-x86-glb.exe /passive<br />
Office2010-kb2553096-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel 2010 i Microsoft Excel 2010 z dodatkiem Service Pack 1 (wersje 64-bitowe):<br />
Excel2010-kb2553070-fullfile-x64-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Pakiet Microsoft Office 2010 i Microsoft Office 2010 z dodatkiem Service Pack 1 (wersje 64-bitowe):<br />
...
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Microsoft Excel 2010 i Microsoft Excel 2010 z dodatkiem Service Pack 1 (wersje 32-bitowe):<br />
Zobacz <a href="http://support.microsoft.com/kb/2553070">artykuł 2553070 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Pakiet Microsoft Office 2010 i Microsoft Office 2010 z dodatkiem Service Pack 1 (wersje 32-bitowe):<br />
Zobacz <a href="http://support.microsoft.com/kb/2553091">artykuł bazy wiedzy Microsoft Knowledge Base 2553091</a><br />
Zobacz <a href="http://support.microsoft.com/kb/2553096">artykuł bazy wiedzy Microsoft Knowledge Base 2553096</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Excel 2010 i Microsoft Excel 2010 z dodatkiem Service Pack 1 (wersje 64-bitowe):<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Excel Web App:<br />
Zobacz <a href="http://support.microsoft.com/kb/2553095">artykuł bazy wiedzy Microsoft Knowledge Base 2553095</a></td>
</tr>
<tr class="even">
...
Pobierz i zainstaluj odpowiednią wersję językową aktualizacji pakietu Microsoft Office 2004 dla komputerów Macintosh 11.6.5 z witryny sieci Web [Centrum pobierania Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=868f4d9f-3498-4d59-a017-59204553889c).
...
-   Otwórz na pulpicie wolumin Microsoft Office 2004 for Mac 11.6.5 Update. Ta czynność mogła zostać wykonana automatycznie.  
-   Aby rozpocząć proces aktualizacji, w oknie woluminu Microsoft Office 2004 for Mac 11.6.5 Update kliknij dwukrotnie aplikację Microsoft Office 2004 for Mac 11.6.5 Update i postępuj zgodnie z instrukcjami wyświetlanymi na ekranie.  
-   Po pomyślnym zainstalowaniu aktualizacji instalator aktualizacji można usunąć z dysku twardego. Aby sprawdzić, czy instalacja została zakończona pomyślnie, zapoznaj się z następującą sekcją „Weryfikowanie instalacji aktualizacji”. Aby usunąć instalatora aktualizacji, najpierw przeciągnij wolumin Microsoft Office 2004 for Mac 11.6.5 Update do kosza, a następnie powtórz tę czynność dla pobranego pliku.
...
Jeśli wersja ma numer **11.6.5**, aktualizacja została zainstalowana pomyślnie.
...
Pobierz i zainstaluj odpowiednią wersję językową aktualizacji pakietu Microsoft Office 2008 dla komputerów Macintosh 12.3.1 [z witryny Centrum pobierania Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=afa79cfc-6e8a-4d0b-88aa-0d7e05031e44).
  
-   Zamknij wszystkie działające aplikacje, w tym także programy antywirusowe, wszystkie aplikacje pakietu Microsoft Office, Microsoft Messenger dla komputerów Macintosh oraz Office Notifications, ponieważ mogą one zakłócać proces instalacji.  
-   Otwórz na pulpicie wolumin Microsoft Office 2008 for Mac 12.3.1 Update. Ta czynność mogła zostać wykonana automatycznie.  
-   Aby rozpocząć proces aktualizacji, w oknie woluminu Microsoft Office 2008 for Mac 12.3.1 Update kliknij dwukrotnie aplikację Microsoft Office 2008 for Mac 12.3.1 Update i postępuj zgodnie z instrukcjami wyświetlanymi na ekranie.  
-   Po pomyślnym zainstalowaniu aktualizacji instalator aktualizacji można usunąć z dysku twardego. Aby sprawdzić, czy instalacja została zakończona pomyślnie, zapoznaj się z następującą sekcją „Weryfikowanie instalacji aktualizacji”. Aby usunąć instalatora aktualizacji, najpierw przeciągnij wolumin Microsoft Office 2008 for Mac 12.3.1 Update do kosza, a następnie powtórz tę czynność dla pobranego pliku.
...
Jeśli wersja ma numer **12.3.1**, aktualizacja została zainstalowana pomyślnie.
...
Pobierz i zainstaluj odpowiednią wersję językową aktualizacji pakietu Microsoft Office 2011 dla komputerów Macintosh 14.1.3 z witryny [Centrum pobierania Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=535fcf4a-eeb2-44eb-b2a6-9c512509c49d).
...
-   Otwórz na pulpicie wolumin Microsoft Office for Mac 2011 14.1.3 Update. Ta czynność mogła zostać wykonana automatycznie.  
-   Aby rozpocząć proces aktualizacji, w oknie woluminu Microsoft Office for Mac 2011 14.1.3 Update kliknij dwukrotnie aplikację Microsoft Office for Mac 2011 14.1.3 Update i postępuj zgodnie z instrukcjami wyświetlanymi na ekranie.  
-   Po pomyślnym zainstalowaniu aktualizacji instalator aktualizacji można usunąć z dysku twardego. Aby sprawdzić, czy instalacja została zakończona pomyślnie, zapoznaj się z następującą sekcją „Weryfikowanie instalacji aktualizacji”. Aby usunąć instalatora aktualizacji, najpierw przeciągnij wolumin Microsoft Office for Mac 2011 14.1.3 Update do kosza, a następnie powtórz tę czynność dla pobranego pliku.
...
Jeśli numer wersji ostatniej zainstalowanej aktualizacji to **14.1.3**, aktualizacja została zainstalowana pomyślnie.
...
Pobierz i zainstaluj odpowiednią wersję językową programu Open XML File Format Converter for Mac 1.2.1 Update z witryny [Centrum pobierania Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=9796588d-238f-4694-9598-1aa8d2becb55).
  
-   Zamknij wszystkie działające aplikacje, w tym także programy antywirusowe, wszystkie aplikacje pakietu Microsoft Office, Microsoft Messenger dla komputerów Macintosh oraz Office Notifications, ponieważ mogą one zakłócać proces instalacji.  
-   Otwórz na pulpicie wolumin Open XML File Format Converter for Mac 1.2.1 Update. Ta czynność mogła zostać wykonana automatycznie.  
-   Aby rozpocząć proces aktualizacji, w oknie woluminu Open XML File Format Converter for Mac 1.2.1 Update kliknij dwukrotnie aplikację Open XML File Format Converter for Mac 1.2.1 Update i postępuj zgodnie z instrukcjami wyświetlanymi na ekranie.  
-   Po pomyślnym zainstalowaniu aktualizacji instalator aktualizacji można usunąć z dysku twardego. Aby sprawdzić, czy instalacja została zakończona pomyślnie, zapoznaj się z następującą sekcją „Weryfikowanie instalacji aktualizacji”. Aby usunąć instalator aktualizacji, przeciągnij wolumin Open XML File Format Converter for Mac 1.2.1 Update do kosza, a następnie powtórz tę czynność w odniesieniu do pobranego pliku.
...
Jeśli wersja ma numer **1.2.1**, aktualizacja została zainstalowana pomyślnie.
...
#### Usługi programu Excel w systemie SharePoint Server 2007 (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 32-bitowe):<br />
office2007-kb2553093-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 64-bitowe):<br />
...
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 32-bitowe):<br />
Zobacz <a href="http://support.microsoft.com/kb/2553093">artykuł bazy wiedzy Microsoft Knowledge Base 2553093</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 64-bitowe):<br />
...
#### Usługi programu Excel w systemie SharePoint Server 2010 (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2010 i Usługi programu Excel zainstalowane w systemie Microsoft Office SharePoint Server 2010 z dodatkiem Service Pack 1:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2553094">artykuł bazy wiedzy Microsoft Knowledge Base 2553094</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Anonimowy analityk, współpracownik firmy [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach programu Excel dotyczącej czcionek WriteAV i związanej z użyciem po zwolnieniu (CVE-2011-1986)  
-   Sean Larsson z firmy [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z indeksowaniem tablicy poza zakresem (CVE-2011-1987)  
-   Anonimowy analityk, współpracownik firmy [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z uszkodzeniem stosu (CVE-2011-1988)  
-   Anonimowy analityk, we współpracy z oddziałem [Zero Day Initiative](http://www.zerodayinitiative.com/) firmy [TippingPoint](http://www.tippingpoint.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z analizą wyrażeń warunkowych (CVE-2011-1989)  
-   Omair, we współpracy z oddziałem [Zero Day Initiative](http://www.zerodayinitiative.com/) firmy [TippingPoint's](http://www.tippingpoint.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z indeksowaniem tablicy poza zakresem (CVE-2011-1990)
...
-   Wersja 1.1 (11 października 2011 r.): Ogłoszono zmianę sposobu wykrywania pakietów aktualizacji KB2553094. Nie wprowadzono żadnych zmian do plików aktualizacji zabezpieczeń. Szczegółowe informacje znajdują się w sekcji Często zadawane pytania.
