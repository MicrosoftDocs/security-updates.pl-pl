---
TOCTitle: 'MS11-010'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-010 - Ważna'
ms:assetid: 'ms11-010'
ms:contentKeyID: 61232909
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-010(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-010 - Ważna
======================================================

Luka w zabezpieczeniach podsystemu wykonawczego serwera/klienta systemu Windows umożliwia podniesienie uprawnień (2476687)
--------------------------------------------------------------------------------------------------------------------------
...
Ta aktualizacja zabezpieczeń usuwa zgłoszoną przez użytkowników lukę w zabezpieczeniach podsystemu wykonawczego serwera/klienta systemu Microsoft Windows (CSRSS) w systemach Windows XP i Windows Server 2003. Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji tych systemów operacyjnych. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem, i programy, których nie dotyczy problem** niniejszej sekcji.
...
Aktualizacja usuwa lukę, poprawiając sposób przerywania działania procesów użytkownika po wylogowaniu. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cfa10178-9859-4e03-bedc-e3f5297a0251)                                 | Podniesienie uprawnień             | Ważny                      | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9f0b7b77-5b90-4a4b-97a4-0c1ce6a70126)        | Podniesienie uprawnień             | Ważny                      | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aed08b96-24cc-4e23-8fd5-c7e52f8ef41a)                        | Podniesienie uprawnień             | Ważny                      | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ca7879e1-e295-445d-a658-0a31be1928cc)            | Podniesienie uprawnień             | Ważny                      | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=50855101-a15c-4c81-ad81-a7fe3f1d2026) | Podniesienie uprawnień             | Ważny                      | [MS10-011](http://go.microsoft.com/fwlink/?linkid=179798) |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca podniesienie poziomu uprawnień — CVE-2011-0030</th>
...
Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca podniesienie poziomu uprawnień — CVE-2011-0030  
-----------------------------------------------------------------------------------------------------
  
<span></span>
W sposobie przerywania procesu przez Podsystem wykonawczy serwera/klienta systemu Windows (CSRSS) po wylogowaniu użytkownika istnieje luka w zabezpieczeniach umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić kod przeznaczony do monitorowania działań użytkownika, który zaloguje się do systemu jako następny. Może to doprowadzić do ujawnienia poufnych informacji lub odczytania dostępnych zalogowanemu użytkownikowi danych znajdujących się w systemie, którego dotyczy problem. Takie poufne dane mogą obejmować poświadczenia logowania kolejnych użytkowników, które osoba atakująca może następnie wykorzystać w celu podniesienia uprawnień lub wykonania kodu jako inny użytkownik w systemie. Należy zauważyć, że luka ta nie pozwala atakującemu na bezpośrednie wykonanie kodu lub podniesienie poziomu swoich uprawnień. Może zostać wykorzystana do zebrania użytecznych informacji celem dalszego spenetrowania systemu, którego dotyczy luka. Jeśli następnie do systemu zaloguje się użytkownik z uprawnieniami administracyjnymi, osoba atakująca będzie mogła uruchomić dowolny kod w trybie jądra. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami systemowymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0030](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0030).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach podsystemu CSRSS umożliwiającej podniesienie poziomu uprawnień — CVE-2011-0030
...
#### Obejścia problemu spowodowanego luką w zabezpieczeniach podsystemu CSRSS umożliwiającą podniesienie poziomu uprawnień — CVE-2011-0030
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach podsystemu CSRSS umożliwiającej podniesienie poziomu uprawnień — CVE-2011-0030:
  
**Jaki zakres obejmuje ta luka?**    
Jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami systemowymi. Aby podjąć próbę wykorzystania luki, osoba atakująca musi zalogować się lokalnie do systemu i uruchomić program.
  
**W jaki sposób powstaje luka?**    
Przyczyną występowania tej luki jest nieprawidłowy sposób przerywania procesów użytkownika przez Podsystem wykonawczy klienta/serwera systemu Windows (CSRSS), kiedy użytkownik wyloguje się z systemu.
...
Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić kod przeznaczony do monitorowania działań użytkownika, który zaloguje się do systemu jako następny. Może to doprowadzić do ujawnienia poufnych informacji lub odczytania dostępnych zalogowanemu użytkownikowi danych znajdujących się w systemie, którego dotyczy problem. Takie poufne dane obejmują poświadczenia, które osoba atakująca może następnie wykorzystać w celu podniesienia uprawnień lub wykonania kodu jako inny użytkownik w systemie. Po ujawnieniu takich poufnych informacji osoba atakująca, która pomyślnie wykorzystała tę lukę, może uruchomić kod z uprawnieniami tego użytkownika, który zaloguje się do systemu jako następny. Jeśli do systemu zaloguje się administrator, kod osoby atakującej może zostać wykonany z podniesionymi uprawnieniami.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2476687$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2476687">artykuł 2476687 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Sihan Qing (profesor), Weiping Wen (profesor nadzwyczajny), Liang Yin i Husheng Zhou (doktoranci), [Wydział Bezpieczeństwa Informacji, Uniwersytet Pekiński](http://www.ss.pku.edu.cn/en/), za zgłoszenie luki w zabezpieczeniach podsystemu CSRSS umożliwiającej podniesienie poziomu uprawnień (CVE-2011-0030)
