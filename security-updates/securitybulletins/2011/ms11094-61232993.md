---
TOCTitle: 'MS11-094'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-094 - Ważna'
ms:assetid: 'ms11-094'
ms:contentKeyID: 61232993
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-094(v=Security.10)'
---
Biuletyn zabezpieczeń firmy Microsoft MS11-094 - Ważna
======================================================
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla programu Microsoft PowerPoint 2007 z dodatkiem Service Pack 2, Microsoft PowerPoint 2010 i pakietu Microsoft Office 2008 dla komputerów Macintosh. Niniejsza aktualizacja zabezpieczeń ma również wskaźnik ważności „ważny” dla Pakietu zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 z dodatkiem Service Pack 2 oraz programu Microsoft PowerPoint Viewer 2007 z dodatkiem Service Pack 2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa luki, modyfikując sposób ładowania zewnętrznych bibliotek przez program PowerPoint oraz zmieniając sposób, w jaki program sprawdza poprawność rekordów OfficeArt podczas otwierania plików PowerPoint. Więcej informacji na temat luk może znaleźć w podsekcjach „Często zadawane pytania” dla pozycji określonych luk w zabezpieczeniach, znajdujących się poniżej następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2639142 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2639142) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
| Microsoft PowerPoint 2007 z dodatkiem Service Pack 3                     |
| Microsoft PowerPoint 2010 z dodatkiem Service Pack 1 (wersje 32-bitowe)  |
| Microsoft PowerPoint 2010 z dodatkiem Service Pack 1 (wersje 64-bitowe)  |
...
| Program Microsoft PowerPoint Viewer 2007 z dodatkiem Service Pack 3      |
...
**Mam zainstalowany program** **PowerPoint** **2010 z dodatkiem Service Pack 1. Jeżeli nie dotyczy go opisywany problem, dlaczego otrzymuję propozycję zainstalowania tej aktualizacji?**  
Mimo że luki opisane w biuletynach CVE-2011-3396 i CVE-2011-3413 nie mają wpływu na program PowerPoint 2010 z dodatkiem Service Pack 1, mechanizm aktualizacji proponuje jej zainstalowanie, ponieważ wykrywa w systemie niższą wersję plików niż oferowane w pakiecie aktualizacyjnym.
...
Po zastosowaniu niniejszej aktualizacji zabezpieczeń do zagrożonego oprogramowania klienci korzystający z obsługiwanych wersji programu Microsoft PowerPoint 2003 i Microsoft PowerPoint 2007 mogą generować zaktualizowane wersje swoich prezentacji, które utworzono przy użyciu [funkcji pakowania prezentacji na CD](http://support.microsoft.com/kb/828504) programu PowerPoint. W ten sposób dołączany do ich prezentacji program PowerPoint Viewer będzie chroniony przed lukami opisanymi w niniejszym biuletynie.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach związana z niebezpiecznym ładowaniem biblioteki PowerPoint — CVE-2011-3396
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach OfficeArt Shape umożliwiająca zdalne wykonanie kodu — CVE-2011-3413
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
<span></span>
Sposób, w jaki program Microsoft PowerPoint obsługuje ładowanie plików DLL, powoduje powstanie luki w zabezpieczeniach umożliwiającej zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-3396](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3396).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem biblioteki PowerPoint — CVE-2011-3396
...
-   Aby atak się powiódł, użytkownik musi odwiedzić niezaufaną zdalną lokalizację systemu plików lub udział WebDAV i otworzyć plik programu PowerPoint (na przykład .ppt).

#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z niebezpiecznym ładowaniem biblioteki PowerPoint — CVE-2011-3396
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem biblioteki PowerPoint — CVE-2011-3396
...
Luka powstaje, gdy program Microsoft PowerPoint nieprawidłowo ogranicza ścieżkę używaną do ładowania bibliotek zewnętrznych.
...
Osoba atakująca mogłaby nakłonić użytkownika do otwarcia prawidłowego pliku znajdującego się w tym samym katalogu sieciowym, co specjalnie spreparowany plik biblioteki dołączanej dynamicznie (biblioteki DLL). Następnie podczas otwierania prawidłowego pliku program Microsoft PowerPoint może podjąć próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.

Osoba atakująca za pośrednictwem poczty e-mail może wykorzystać tę lukę, wysyłając do użytkownika w załączniku prawidłowy plik, a następnie przekonując użytkownika do umieszczenia tego załącznika w katalogu, który zawiera specjalnie spreparowany plik DLL, i do otwarcia prawidłowego pliku. Następnie podczas otwierania prawidłowego pliku program Microsoft PowerPoint może podjąć próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
...
Aktualizacja usuwa lukę, modyfikując sposób, w jaki program PowerPoint ładuje biblioteki zewnętrzne.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-3413](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3413).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach OfficeArt Shape umożliwiającej zdalne wykonanie kodu — CVE-2011-3413
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach OfficeArt Shape umożliwiającą zdalne wykonanie kodu — CVE-2011-3413
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach OfficeArt Shape umożliwiającej zdalne wykonanie kodu — CVE-2011-3413
...
| Podgląd programu Microsoft PowerPoint 2007 z dodatkiem Service Pack 2                                                           | Tak                       | Tak                        |
...
#### Microsoft PowerPoint 2007 (wszystkie wersje) i Microsoft PowerPoint Viewer 2007 (wszystkie wersje)
...
<td style="border:1px solid black;">Program PowerPoint 2007 z dodatkiem Service Pack 2:<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Podgląd programu Microsoft PowerPoint 2007 z dodatkiem Service Pack 2:<br />
...
<td style="border:1px solid black;">Program PowerPoint 2007 z dodatkiem Service Pack 2:<br />
Zobacz <a href="http://support.microsoft.com/kb/2596764">artykuł 2596764 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Pakiet zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 z dodatkiem Service Pack 2:<br />
Zobacz <a href="http://support.microsoft.com/kb/2596843">artykuł 2596843 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Podgląd programu Microsoft PowerPoint 2007 z dodatkiem Service Pack 2:<br />
Zobacz <a href="http://support.microsoft.com/kb/2596912">artykuł 2596912 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
#### Microsoft PowerPoint 2010 (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Microsoft PowerPoint 2010 (wersje 32-bitowe):<br />
powerpoint2010-kb2553185-fullfile-x86-glb.exe /passive</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft PowerPoint 2010 (wersje 64-bitowe):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2553185">artykuł 2553185 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
Pobierz i zainstaluj odpowiednią wersję językową aktualizacji pakietu Microsoft Office 2008 for Mac 12.3.2 [z witryny Centrum pobierania Microsoft](http://www.microsoft.com/downloads/details.aspx?familyid=2c4d0381-f7ab-49ed-a0c0-b381387d1e68).
...
-   Otwórz na pulpicie wolumin Microsoft Office 2008 for Mac 12.3.2 Update. Ta czynność mogła zostać wykonana automatycznie.  
-   Aby rozpocząć proces aktualizacji, w oknie woluminu Microsoft Office 2008 for Mac 12.3.2 Update kliknij dwukrotnie aplikację Microsoft Office 2008 for Mac 12.3.2 Update i postępuj zgodnie z instrukcjami wyświetlanymi na ekranie.  
-   Po pomyślnym zainstalowaniu aktualizacji instalator aktualizacji można usunąć z dysku twardego. Aby sprawdzić, czy instalacja została zakończona pomyślnie, zapoznaj się z następującą sekcją „Weryfikowanie instalacji aktualizacji”. Aby usunąć instalatora aktualizacji, najpierw przeciągnij wolumin Microsoft Office 2008 for Mac 12.3.2 Update do kosza, a następnie powtórz tę czynność dla pobranego pliku.
...
Jeśli wersja ma numer **12.3.2**, aktualizacja została zainstalowana pomyślnie.
...
-   Greg MacManus z [iSIGHT Partners Labs](http://www.isightpartners.com/) za zgłoszenie luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem biblioteki PowerPoint (CVE-2011-3396)  
-   Anonimowy analityk, we współpracy z oddziałem [Zero Day Initiative](http://www.tippingpoint.com/)[firmy TippingPoint](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach OfficeArt Shape umożliwiającej zdalne wykonanie kodu (CVE-2011-3413)
...
-   Wersja 1.1 (21 grudnia 2011 r.): W sekcji „Często zadawane pytania dotyczące aktualizacji” dodano wpis objaśniający, dlaczego ta aktualizacja jest oferowana użytkownikom programu PowerPoint 2010 z dodatkiem Service Pack 1.
