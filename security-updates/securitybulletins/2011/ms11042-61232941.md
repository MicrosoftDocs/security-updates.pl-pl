---
TOCTitle: 'MS11-042'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-042 - Krytyczna'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61232941
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-042(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-042 - Krytyczna
==========================================================

Luki w zabezpieczeniach rozproszonego systemu plików (DFS) mogą umożliwić zdalne wykonanie kodu (2535512)
---------------------------------------------------------------------------------------------------------

Opublikowano: 14 czerwca 2011 | Zaktualizowano: 14 czerwca 2011
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                                                    | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                                           | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                                           | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                                               | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                                    | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                                      | Odmowa usługi                      | Ważny                      | Brak                                               |
| [Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                              | Odmowa usługi                      | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\*                 | Odmowa usługi                      | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*       | Odmowa usługi                      | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4) | Odmowa usługi                      | Ważny                      | Brak                                               |
| [Windows 7 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                                                       | Odmowa usługi                      | Ważny                      | Brak                                               |
| [Windows 7 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                                                  | Odmowa usługi                      | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                                        | Odmowa usługi                      | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                                      | Odmowa usługi                      | Ważny                      | Brak                                               |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z uszkodzeniem pamięci systemu plików DFS — CVE-2011-1868</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z odpowiedziami odwołań DFS — CVE-2011-1869</th>
...
Luka w zabezpieczeniach związana z uszkodzeniem pamięci systemu plików DFS — CVE-2011-1868  
------------------------------------------------------------------------------------------
  
<span></span>
Sposób, w jaki klient rozproszonego systemu plików DFS analizuje specjalnie spreparowane odpowiedzi DFS, powoduje powstanie luki umożliwiającej zdalne wykonanie nieuwierzytelnionego kodu. Wykorzystanie tej luki nie wymaga uwierzytelnienia, dzięki czemu osoba atakująca może ją wykorzystać, wysyłając specjalnie spreparowaną odpowiedź DFS na żądanie DFS zainicjowane przez klienta. Osoba atakująca, której uda się wykorzystać tę lukę, mogłaby wykonać dowolny kod i uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci systemu plików DFS — CVE-2011-1868
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Sprawdzone metody działania stosowane w zaporach oraz standardowe domyślne konfiguracje zapór mogą pomóc w zabezpieczeniu sieci przed atakami spoza obszaru działania przedsiębiorstwa. Zgodnie ze standardowymi zasadami działania zaleca się, aby w systemach połączonych z Internetem była otwarta jak najmniejsza liczba portów.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z uszkodzeniem pamięci systemu plików DFS — CVE-2011-1868
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci systemu plików DFS — CVE-2011-1868
...
Luka powstaje, gdy implementacja rozproszonego systemu plików firmy Microsoft (DFS) nieprawidłowo sprawdza poprawność wszystkich pól w specjalnie spreparowanych odpowiedziach DFS.
  
**Co to jest rozproszony system plików (DFS)?**    
Rozproszony system plików (DFS) pozwala administratorom łączyć w grupy udostępnione foldery, które znajdują się na różnych serwerach, poprzez ich transparentne łączenie z jedną lub wieloma przestrzeniami nazw DFS. Przestrzeń nazw DFS to wirtualny widok udostępnionych folderów w firmie. Za pomocą narzędzi DFS administrator wybiera foldery udostępnione, które mają być obecne w przestrzeni nazw, projektuje hierarchię, w której mają być wyświetlane oraz określa nazwy, pod jakimi foldery te widnieją w przestrzeni nazw. Gdy użytkownik wyświetla przestrzeń nazw, foldery wydają się być umieszczone na pojedynczym dysku twardym o dużej pojemności. Użytkownik może poruszać się po folderach w przestrzeni nazw, nie musząc znać nazw serwerów ani folderów udostępnionych zawierających dane. Więcej informacji można znaleźć w artykule [DFS — informacje techniczne](http://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx) (j. ang).
...
Osoba atakująca może udostępnić specjalnie spreparowany serwer przeznaczony do wykorzystania tej luki, a następnie przekonać użytkownika do zainicjowania połączenia DFS z takim serwerem. Dodatkowo osoba atakująca w sieci lokalnej może przeprowadzić atak typu man-in-the-middle, aby w reakcji na prawidłowe żądanie DFS wysłać nieprawidłową odpowiedź DFS.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**     
Luka dotyczy wszystkich obsługiwanych wersji systemu Windows XP i Windows Server 2003.
  
**W jaki sposób działa aktualizacja?**     
Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki klient DFS sprawdza poprawność pól w specjalnie spreparowanych odpowiedziach DFS.
...
Luka w zabezpieczeniach związana z odpowiedziami odwołań DFS — CVE-2011-1869  
----------------------------------------------------------------------------
  
<span></span>
Sposób obsługi specjalnie spreparowanych odpowiedzi odwołań przez rozproszony system plików (DFS) powoduje powstanie luki, która może pozwolić na atak typu „odmowa usługi”. Wykorzystanie tej luki nie wymaga uwierzytelnienia, pozwalając osobie atakującej na wykorzystanie jej poprzez wysłanie specjalnie spreparowanej wiadomości sieciowej do komputera, na którym uruchomiona jest usługa Serwer.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z odpowiedziami odwołań DFS — CVE-2011-1869
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Ta luka umożliwiająca atak typu „odmowa usługi” nie pozwala atakującemu na wykonanie kodu lub podniesienie poziomu uprawnień, lecz może spowodować, że zaatakowany system przestanie reagować i trzeba go będzie ręcznie uruchomić ponownie.  
-   Sprawdzone metody działania stosowane w zaporach oraz standardowe domyślne konfiguracje zapór mogą pomóc w zabezpieczeniu sieci przed atakami spoza obszaru działania przedsiębiorstwa. Zgodnie ze standardowymi zasadami działania zaleca się, aby w systemach połączonych z Internetem była otwarta jak najmniejsza liczba portów.
  
#### Obejścia problemu spowodowanego przez lukę związaną z odpowiedziami odwołań DFS — CVE-2011-1869
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z odpowiedziami odwołań DFS — CVE-2011-1869
...
**Skąd bierze się luka?**    
Luka powstaje, gdy implementacja rozproszonego systemu plików DFS nieprawidłowo obsługuje specjalnie spreparowane odpowiedzi odwołań DFS.
...
**Jakie systemy są szczególnie narażone na skutki tej luki?**     
Omawiana luka zagraża wszystkim obsługiwanym wersjom systemu Windows.
  
**W jaki sposób działa aktualizacja?**     
Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki usługa DFS obsługuje specjalnie spreparowane odpowiedzi odwołań DFS.
...
| Windows 7 dla systemów 32-bitowych                                                                                                       | Tak                       | Tak                        |  
| Windows 7 dla systemów z procesorem x64                                                                                                  | Tak                       | Tak                        |  
| Windows Server 2008 R2 dla systemów opartych na procesorach x64                                                                          | Tak                       | Tak                        |  
| Windows Server 2008 R2 dla systemów opartych na procesorach Itanium                                                                      | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2535512$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2535512">artykuł 2535512 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">System Windows 7 dla systemów 32-bitowych:<br />
Windows6.1-KB2535512-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">System Windows 7 dla systemów z procesorem x64:<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Wszystkie wersje systemu Windows 7 dla systemów z procesorem x64:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Windows 2008 R2 dla systemów z procesorem x64:<br />
Windows6.1-KB2535512-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows 2008 R2 dla systemów z procesorem Itanium:<br />
...
-   Laurent Gaffié z firmy [NGS Software](http://www.ngssoftware.com/), za zgłoszenie luki w zabezpieczeniach związanej z odpowiedziami odwołań DFS (CVE-2011-1869)
...
-   Wersja 1.1 (14 czerwca 2011 r.): Przeniesiono system Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych, Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64, Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach Itanium z tabeli „Programy, których dotyczy problem” do tabeli „Programy, których nie dotyczy problem”. Zmiana ta ma wyłącznie charakter informacyjny. Nie wprowadzono żadnych zmian do plików aktualizacji zabezpieczeń ani logiki wykrywania.
