---
TOCTitle: 'MS11-008'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS11-008 - Ważna'
ms:assetid: 'ms11-008'
ms:contentKeyID: 61232907
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms11-008(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS11-008 - Ważna
======================================================

Luki w zabezpieczeniach programu Microsoft Visio umożliwiają zdalne wykonanie kodu (2451879)
--------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla programu Microsoft Visio 2002 z dodatkiem Service Pack 2, Microsoft Visio 2003 z dodatkiem Service Pack 3 oraz Microsoft Visio 2007 z dodatkiem Service Pack 2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa luki, modyfikując sposób, w jaki program Microsoft Visio obsługuje uszkodzone struktury i obiekty w pamięci podczas analizowania specjalnie spreparowanych plików tego programu. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=273d8078-0dc7-43d8-bcae-54c811e49e0e">Microsoft Visio 2002 z dodatkiem Service Pack 2</a><br />
(KB2434711)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=f1067eaa-d18d-4bff-a02e-1d990c36ca7f">Microsoft Visio 2003 z dodatkiem Service Pack 3</a><br />
(KB2434733)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=097a642b-b786-4724-a907-79f37cded836">Microsoft Visio 2007 z dodatkiem Service Pack 2</a><br />
(KB2434737)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=190554">MS10-036</a></td>
...
|-----------------------------------------|  
| Microsoft Visio 2010 (wersje 32-bitowe) |  
| Microsoft Visio 2010 (wersje 64-bitowe) |  
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach programu Visio związana z uszkodzeniem pamięci obiektów — CVE-2011-0092</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach programu Visio związana z uszkodzeniem pamięci typu danych — CVE-2011-0093</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visio 2007 z dodatkiem Service Pack 2</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
...
Luka w zabezpieczeniach programu Visio związana z uszkodzeniem pamięci obiektów — CVE-2011-0092  
-----------------------------------------------------------------------------------------------
  
<span></span>
W programie Microsoft Visio występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana ze sposobem sprawdzania poprawności obiektów w pamięci podczas analizowania specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0092](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0092).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Visio związanej z uszkodzeniem pamięci obiektów — CVE-2011-0092
...
#### Obejścia problemu dotyczącego luki w zabezpieczeniach programu Visio związanej z uszkodzeniem pamięci obiektów — CVE-2011-0092
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Ograniczenie dostępu do pliku ORMELEMS.DLL**
    ...
    **32-bitowe wersje systemu Windows XP i Windows Server 2003:**
    ...
    `cacls "%ProgramFiles%\Microsoft Office\<wersja_office>\ormelems.dll" /E /P everyone:N`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Visio 2002, „Office11” w przypadku programu Microsoft Visio 2003 lub „Office12” w przypadku programu Microsoft Visio 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
    **64-bitowe wersje systemu Windows XP i Windows Server 2003:**
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\ormelems.dll" /E /P everyone:N`
    ...
    **Wpływ obejścia**. Użytkownicy nie będą mogli korzystać z funkcji Modelowanie bazy danych w programie Visio.
    ...
    **Jak cofnąć obejście tymczasowe:**
    ...
    `cacls "%ProgramFiles%\Microsoft Office\<wersja_office>\ormelems.dll" /E /R everyone`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Visio 2002, „Office11” w przypadku programu Microsoft Visio 2003 lub „Office12” w przypadku programu Microsoft Visio 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
    64-bitowe wersje systemu Windows XP i Windows Server 2003:
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\ormelems.dll" /E /R everyone`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Visio 2002, „Office11” w przypadku programu Microsoft Visio 2003 lub „Office12” w przypadku programu Microsoft Visio 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
    32-bitowe wersje systemu Windows Vista, Windows Server 2008 i Windows 7:
  
    `takeown /f "%ProgramFiles%\Microsoft Office\<wersja_office>\ormelems.dll"cacls "%ProgramFiles%\Microsoft Office\<wersja_office>\ormelems.dll" /E /R everyone`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Visio 2002, „Office11” w przypadku programu Microsoft Visio 2003 lub „Office12” w przypadku programu Microsoft Visio 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
    64-bitowe wersje systemu Windows Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2:
  
    `takeown /f "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\ormelems.dll"cacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\ormelems.dll" /E /R everyone`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Visio 2002, „Office11” w przypadku programu Microsoft Visio 2003 lub „Office12” w przypadku programu Microsoft Visio 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
-   **Wyłączenie dodatków w programie Microsoft Visio 2007**
  
    Uruchom program Visio 2007 i wykonaj następujące czynności:
  
    1.  Kliknij **Narzędzia**.  
    2.  Kliknij opcję **Centrum zaufania**.  
    3.  Kliknij opcję **Dodatki**.  
    4.  Upewnij się, że pole wyboru **Wyłącz wszystkie dodatki aplikacji** jest zaznaczone.  
    5.  Kliknij przycisk **OK**, aby zastosować ustawienia.
  
    **Wpływ obejścia**. Funkcje zależne od dodatków programu Visio nie będą działać.
    ...
    **Cofnięcie obejścia.**
    ...
    2.  Kliknij opcję **Centrum zaufania**.  
    3.  Kliknij opcję **Dodatki**.  
    4.  Upewnij się, że pole wyboru **Wyłącz wszystkie dodatki aplikacji** nie jest zaznaczone.  
    5.  Kliknij przycisk **OK**, aby zastosować ustawienia.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Visio związanej z uszkodzeniem pamięci obiektów — CVE-2011-0092
...
Program Microsoft Visio błędnie sprawdza poprawność obiektów w pamięci podczas analizowania specjalnie spreparowanych plików tego programu.
...
Niniejsza aktualizacja usuwa lukę, poprawiając sposób, w jaki program Microsoft Visio sprawdza poprawność obiektów w pamięci podczas analizowania specjalnie spreparowanych plików tego programu.
...
Luka w zabezpieczeniach programu Visio związana z uszkodzeniem pamięci typu danych — CVE-2011-0093  
--------------------------------------------------------------------------------------------------
  
<span></span>
W programie Microsoft Visio występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana ze sposobem analizowania określonych struktur podczas obsługi specjalnie spreparowanych plików tego programu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2011-0093](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0093).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Visio związanej z uszkodzeniem pamięci typu danych — CVE-2011-0093
...
#### Obejścia problemu dotyczącego luki w zabezpieczeniach programu Visio związanej z uszkodzeniem pamięci typu danych — CVE-2011-0093
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Ograniczenie dostępu do pliku ELEMENTS.DLL**
  
    Uruchom następujące polecenia w wierszu polecenia po zalogowaniu się jako administrator:
  
    **32-bitowe wersje systemu Windows XP i Windows Server 2003:**
  
    `cacls "%ProgramFiles%\Microsoft Office\<wersja_office>\elements.dll" /E /P everyone:N`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Visio 2002, „Office11” w przypadku programu Microsoft Visio 2003 lub „Office12” w przypadku programu Microsoft Visio 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
    **64-bitowe wersje systemu Windows XP i Windows Server 2003:**
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\elements.dll" /E /P everyone:N`
    ...
    **Jak cofnąć obejście tymczasowe:**
    ...
    `cacls "%ProgramFiles%\Microsoft Office\<wersja_office>\elements.dll" /E /R everyone`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Visio 2002, „Office11” w przypadku programu Microsoft Visio 2003 lub „Office12” w przypadku programu Microsoft Visio 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
    64-bitowe wersje systemu Windows XP i Windows Server 2003:
  
    `cacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\elements.dll" /E /R everyone`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Visio 2002, „Office11” w przypadku programu Microsoft Visio 2003 lub „Office12” w przypadku programu Microsoft Visio 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
    32-bitowe wersje systemu Windows Vista, Windows Server 2008 i Windows 7:
  
    `Takeown /f "%ProgramFiles%\Microsoft Office\<wersja_office>\elements.dll"cacls "%ProgramFiles%\Microsoft Office\<wersja_office>\elements.dll" /E /R everyone`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Visio 2002, „Office11” w przypadku programu Microsoft Visio 2003 lub „Office12” w przypadku programu Microsoft Visio 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
    64-bitowe wersje systemu Windows Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2:
  
    `Takeown /f "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\elements.dll"cacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\elements.dll" /E /R everyone`
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Visio związanej z uszkodzeniem pamięci typu danych — CVE-2011-0093
  
**Jaki zakres obejmuje luka?**    
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
**Skąd bierze się luka?**    
Program Microsoft Visio nie obsługuje odpowiednio uszkodzonych struktur podczas otwierania specjalnie spreparowanych plików tego programu.
...
**W jaki sposób działa aktualizacja?**     
Niniejsza aktualizacja usuwa lukę, poprawiając sposób, w jaki program Microsoft Office Visio analizuje uszkodzone struktury podczas otwierania specjalnie spreparowanych plików tego programu.
...
| Microsoft Visio 2007 z dodatkiem Service Pack 2 | Tak  |
...
| Microsoft Visio 2003 z dodatkiem Service Pack 3 | Nie     | Nie                       | Tak                       | Tak                        |  
| Microsoft Visio 2007 z dodatkiem Service Pack 2 | Nie     | Nie                       | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2434711">artykuł 2434711 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2434733">artykuł 2434733 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### Microsoft Visio 2007 (wszystkie wersje)
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2434737">artykuł 2434737 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Procyun, we współpracy z [Zero Day Initiative](http://www.tippingpoint.com/) firmy [TippingPoint](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach programu Visio związanej z uszkodzeniem pamięci obiektów (CVE-2011-0092)  
-   Xin Ouyang z firmy [Palo Alto Networks](http://www.paloaltonetworks.com/) za zgłoszenie luki w zabezpieczeniach programu Visio związanej z uszkodzeniem pamięci obiektów (CVE-2011-0092)  
-   Xin Ouyang z firmy [Palo Alto Networks](http://www.paloaltonetworks.com/) za zgłoszenie luki w zabezpieczeniach programu Visio związanej z uszkodzeniem pamięci typu danych (CVE-2011-0093)
