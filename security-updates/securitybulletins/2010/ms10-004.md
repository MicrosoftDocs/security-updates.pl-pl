---
TOCTitle: 'MS10-004'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-004 - Ważna'
ms:assetid: 'ms10-004'
ms:contentKeyID: 61232797
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-004(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-004 - Ważna
======================================================

Luki w zabezpieczeniach programu Microsoft Office PowerPoint umożliwiają zdalne wykonanie kodu (975416)
-------------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla obsługiwanych wersji programu Microsoft Office PowerPoint 2002 i Microsoft Office PowerPoint 2003, a także pakietu Microsoft Office 2004 dla komputerów Macintosh. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa luki w zabezpieczeniach, zmieniając sposób, w jaki programy Microsoft Office PowerPoint i Microsoft PowerPoint Viewer analizują specjalnie spreparowane pliki programu PowerPoint. Więcej informacji na temat luk może znaleźć w podsekcjach „Często zadawane pytania” dla pozycji określonych luk w zabezpieczeniach, znajdujących się poniżej następnej sekcji, **Informacje o luce w zabezpieczeniach**.

**Zalecenie.** Firma Microsoft zaleca klientom jak najszybsze zastosowanie tej aktualizacji.

**Znane problemy.** [W artykule 975416 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/975416) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
W [artykule 975416 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/975416) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.

**Dlaczego dla programu Microsoft Office PowerPoint Viewer 2003 nie jest oferowany pakiet aktualizacji?**    
W dziale Często zadawane pytania dotyczące luki w zabezpieczeniach dla luki CVE-2010-0033 zamieszczono informację, że niniejsza aktualizacja usuwa lukę, zmieniając sposób, w jaki program Microsoft Office PowerPoint Viewer analizuje specjalnie spreparowane pliki PowerPoint. Nie jest jednak oferowany pakiet aktualizacji dla autonomicznego programu PowerPoint Viewer 2003.

Jest tak, ponieważ dla autonomicznych instalacji programu PowerPoint Viewer 2003 [upłynął okres pomocy technicznej](http://blogs.technet.com/office_sustained_engineering/archive/2008/12/09/excel-viewer-2003-word-viewer-2003-and-powerpoint-viewer-2003-to-retire.aspx) i niniejsza aktualizacja nie będzie dla nich oferowana. Zamiast tego aktualizacja oferowana jest użytkownikom programu Microsoft Office PowerPoint 2003, aby mogli oni opublikować zaktualizowane wersje swoich prezentacji utworzone przy użyciu [funkcji pakowania prezentacji na CD](http://support.microsoft.com/kb/828504) programu PowerPoint, która wykorzystuje program PowerPoint Viewer 2003.

Klienci korzystający z autonomicznych instalacji programu PowerPoint Viewer 2003 powinni traktować priorytetowo migrację do wersji obsługiwanych, aby zapobiec ewentualnym skutkom wystąpienia luk mogących się pojawić w przyszłości. Luki opisane w tym biuletynie nie stanowią zagrożenia dla programu PowerPoint Viewer 2007. Można go pobrać z witryny [Microsoft Download Center](http://www.microsoft.com/downloads/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en).

**W biuletynie MS10-003 opisano także lukę w zabezpieczeniach pakietu Microsoft Office 2004 dla komputerów Macintosh. Jaki jest związek biuletynu MS10-003 z niniejszym biuletynem (MS10-004)?**    
W ramach zbiorczego modelu usług dla pakietu Microsoft Office 2004 dla komputerów Macintosh niniejsza aktualizacja zabezpieczeń dla pakietu Microsoft Office 2004 dla komputerów Macintosh (KB979674) usuwa także lukę opisaną w biuletynie MS10-003. Użytkownicy, którzy zainstalowali pakiet Microsoft Office 2004 dla komputerów Macintosh, będą musieli zainstalować tę aktualizację zabezpieczeń, ale wystarczy jednorazowa instalacja.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu PowerPoint związana z przepełnieniem buforu obsługi ścieżek plików – CVE-2010-0029
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu PowerPoint związana z przepełnieniem stosu LinkedSlideAtom – CVE-2010-0030
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu PowerPoint związana z indeksowaniem nieprawidłowej tablicy OEPlaceholderAtom 'placementId' – CVE-2010-0031
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu PowerPoint związana z użyciem OEPlaceholderAtom po zwolnieniu – CVE-2010-0032
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu PowerPoint Viewer związana z przepełnieniem stosu rekordu TextBytesAtom – CVE-2010-0033
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu Office PowerPoint Viewer związana z przepełnieniem stosu rekordu TextCharsAtom – CVE-2010-0034
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0029).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu PowerPoint związanej z przepełnieniem buforu obsługi ścieżek plików – CVE-2010-0029
...
#### Obejścia dotyczące luki w zabezpieczeniach programu PowerPoint związanej z przepełnieniem buforu obsługi ścieżek plików – CVE-2010-0029

Firma Microsoft nie znalazła żadnego obejścia tej luki.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu PowerPoint związanej z przepełnieniem buforu obsługi ścieżek plików – CVE-2010-0029
...
Przyczyną występowania luki jest sposób, w jaki program Microsoft Office PowerPoint analizuje format plików PowerPoint podczas otwierania specjalnie spreparowanego pliku programu PowerPoint.
...
Szczególnie zagrożone są systemy, w których jest używany program Microsoft Office PowerPoint, w tym stacje robocze i serwery terminali. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie programów. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.

**W jaki sposób działa aktualizacja?**    
Niniejsza aktualizacja eliminuje lukę, zmieniając sposób, w jaki program Microsoft Office PowerPoint analizuje specjalnie spreparowane pliki programu PowerPoint.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0030](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0030).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu PowerPoint związanej z przepełnieniem stosu LinkedSlideAtom – CVE-2010-0030
...
#### Obejścia dotyczące luki w zabezpieczeniach programu PowerPoint związanej z przepełnieniem stosu LinkedSlideAtom – CVE-2010-0030
...
-   **Użyj funkcji File Block pakietu Microsoft Office w celu blokowania otwierania dokumentów pakietu Office w wersji 2003 lub wcześniejszej, pochodzących z nieznanych lub niezaufanych źródeł.**
    ...
    **Wpływ obejścia.**  Użytkownicy, którzy skonfigurowali funkcję File Block, ale nie skonfigurowali specjalnego „katalogu wyjątków” omówionego w [artykule 922847 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/922847), nie będą mogli otwierać plików pakietu Office w wersji 2003 lub wcześniejszej w programach pakietu Office 2003.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu PowerPoint związanej z przepełnieniem stosu LinkedSlideAtom – CVE-2010-0030
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0031](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0031).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu PowerPoint związanej z indeksowaniem nieprawidłowej tablicy OEPlaceholderAtom 'placementId' – CVE-2010-0031
...
#### Obejścia dotyczące luki w zabezpieczeniach programu PowerPoint związanej z indeksowaniem nieprawidłowej tablicy OEPlaceholderAtom 'placementId' – CVE-2010-0031
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu PowerPoint związanej z indeksowaniem nieprawidłowej tablicy OEPlaceholderAtom 'placementId' – CVE-2010-0031
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0032](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0032).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu PowerPoint związanej z użyciem OEPlaceholderAtom po zwolnieniu – CVE-2010-0032
...
#### Obejścia dotyczące luki w zabezpieczeniach programu PowerPoint związanej z użyciem OEPlaceholderAtom po zwolnieniu – CVE-2010-0032
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu PowerPoint związanej z użyciem OEPlaceholderAtom po zwolnieniu – CVE-2010-0032
...
W programie Microsoft Office PowerPoint Viewer istnieje luka w zabezpieczeniach pozwalająca na zdalne wykonanie kodu, związana ze sposobem obsługi przez ten program specjalnie spreparowanych plików programu PowerPoint. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0033](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0033).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu PowerPoint Viewer związanej z przepełnieniem stosu rekordu TextBytesAtom – CVE-2010-0033
...
-   Osoba atakująca za pośrednictwem sieci Web, która chce wykorzystać tę lukę, może udostępniać witrynę zawierającą odpowiednią stronę sieci Web. Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika lub reklamy, jak również witryny niesprawdzone, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystać lukę w zabezpieczeniach. Jednakże w żadnym przypadku osoba atakująca nie może zmusić użytkowników do odwiedzenia takich witryn. Osoba atakująca musiałaby natomiast przekonać użytkowników do odwiedzenia tej witryny, najczęściej zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej, przekierowującego do witryny osoby atakującej, a następnie nakłonić do otwarcia specjalnie spreparowanego pliku programu PowerPoint.
-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
-   Program Microsoft Office PowerPoint Viewer 2007 nie jest zagrożony tą luką. Program Microsoft Office PowerPoint Viewer 2007 można zainstalować po pobraniu go z witryny [Microsoft Download Center](http://www.microsoft.com/downloads/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en).

#### Obejścia dotyczące luki w zabezpieczeniach programu PowerPoint Viewer związanej z przepełnieniem stosu rekordu TextBytesAtom – CVE-2010-0033

Firma Microsoft nie znalazła żadnego obejścia tej luki.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu PowerPoint Viewer związanej z przepełnieniem stosu rekordu TextBytesAtom – CVE-2010-0033

**Jaki zakres obejmuje ta luka?**    
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może zdalnie uzyskać pełną kontrolę nad systemem jej podlegającym. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

**W jaki sposób powstaje luka?**    
Przyczyną występowania luki jest sposób, w jaki program Microsoft Office PowerPoint Viewer analizuje format plików PowerPoint podczas otwierania specjalnie spreparowanego pliku programu PowerPoint.

**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**    
Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod jako użytkownik zalogowany. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca może uzyskać pełną kontrolę nad systemem podlegającym luce. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

**W jaki sposób osoba atakująca może wykorzystać tę lukę?**    
Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik programu PowerPoint przy użyciu wersji programu Microsoft Office PowerPoint Viewer, w której ta luka występuje.
...
**Jakie systemy są szczególnie narażone na skutki tej luki?**    
Szczególnie zagrożone są systemy, w których jest używany program Microsoft Office PowerPoint Viewer, w tym stacje robocze i serwery terminali. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie programów. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.

**W jaki sposób działa aktualizacja?**    
Niniejsza aktualizacja eliminuje lukę, zmieniając sposób, w jaki program Microsoft Office PowerPoint Viewer analizuje specjalnie spreparowane pliki programu PowerPoint.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0034](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0034).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Office PowerPoint Viewer związanej z przepełnieniem stosu rekordu TextCharsAtom – CVE-2010-0034
...
#### Obejścia dotyczące luki w zabezpieczeniach programu Office PowerPoint Viewer związanej z przepełnieniem stosu rekordu TextCharsAtom – CVE-2010-0034

Firma Microsoft nie znalazła żadnego obejścia tej luki.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Office PowerPoint Viewer związanej z przepełnieniem stosu rekordu TextCharsAtom – CVE-2010-0034
...
|-------------------------------------------------------------|---------|---------------------------|---------------------------|----------------------------|
| Microsoft Office PowerPoint 2002 z dodatkiem Service Pack 3 | Nie     | Nie                       | Tak                       | Tak                        |
| Microsoft Office PowerPoint 2003 z dodatkiem Service Pack 3 | Nie     | Nie                       | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/973143">artykuł 973143 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/976881">artykuł 976881 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Carsten Eiram z firmy [Secunia](http://secunia.com/), za zgłoszenie luki w zabezpieczeniach programu PowerPoint związanej z przepełnieniem buforu obsługi ścieżek plików (CVE-2010-0029)  
-   Sean Larsson z firmy [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach programu PowerPoint związanej z przepełnieniem stosu LinkedSlideAtom (CVE-2010-0030)  
-   Sean Larsson z firmy [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach programu PowerPoint związanej z indeksowaniem nieprawidłowej tablicy OEPlaceholderAtom 'placementId' (CVE-2010-0031)  
-   Sean Larsson z firmy [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach programu PowerPoint związanej z użyciem OEPlaceholderAtom po zwolnieniu (CVE-2010-0032)  
-   SkD, we współpracy z [Zero Day Initiative](http://www.zerodayinitiative.com/) firmy [TippingPoint](http://www.tippingpoint.com/), za zgłoszenie luki w zabezpieczeniach programu PowerPoint Viewer związanej z przepełnieniem stosu rekordu TextBytesAtom (CVE-2010-0033)  
-   Cody Pierce z firmy [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/), za zgłoszenie luki w zabezpieczeniach programu Office PowerPoint Viewer związanej z przepełnieniem stosu rekordu TextCharsAtom (CVE-2010-0034)
