---
TOCTitle: 'MS10-093'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-093 - Ważna'
ms:assetid: 'ms10-093'
ms:contentKeyID: 61232886
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-093(v=Security.10)'
---


Biuletyn zabezpieczeń firmy Microsoft MS10-093 - Ważna
======================================================

Luka w zabezpieczeniach programu Windows Movie Maker umożliwia zdalne wykonanie kodu (2424434)
----------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla programu Windows Movie Maker 2.6 we wszystkich obsługiwanych wersjach systemu Windows Vista. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem, i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki program Windows Movie Maker ładuje biblioteki zewnętrzne. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|-------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2                         | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=55141a02-3ad3-4691-98b9-80dd8ecb14c5)<sup>[1]</sup> | Zdalne wykonanie kodu              | Ważny                      | [MS10-050](http://go.microsoft.com/fwlink/?linkid=197103) |
| Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2 | [Movie Maker 2.6](http://www.microsoft.com/downloads/details.aspx?familyid=5b078136-a492-4a2e-939d-82799f774d82)<sup>[1]</sup> | Zdalne wykonanie kodu              | Ważny                      | [MS10-050](http://go.microsoft.com/fwlink/?linkid=197103) |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z niebezpiecznym ładowaniem bibliotek — CVE-2010-3967</th>
...
Luka w zabezpieczeniach związana z niebezpiecznym ładowaniem bibliotek — CVE-2010-3967  
--------------------------------------------------------------------------------------

Sposób, w jaki program Windows Movie Maker obsługuje ładowanie plików DLL, powoduje powstanie luki w zabezpieczeniach umożliwiającej zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3967](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3967).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek — CVE-2010-3967
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z niebezpiecznym ładowaniem bibliotek — CVE-2010-3967
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek — CVE-2010-3967
...
Luka powstaje, gdy program Windows Movie Maker nieprawidłowo ogranicza ścieżki służące do ładowania zewnętrznych bibliotek.
  
**Co to jest Windows Movie Maker?**      
Windows Movie Maker jest programem, który umożliwia tworzenie i edytowanie filmów oraz dodawanie do nich efektów specjalnych. Program Windows Movie Maker jest dołączony do systemów Windows XP i Windows Vista. Luka dotyczy tylko programu Movie Maker 2.6, który jest dostępny jako opcja do pobrania i można go zainstalować w zagrożonych systemach operacyjnych.
...
Osoba atakująca mogłaby nakłonić użytkownika do otwarcia prawidłowego pliku programu Windows Movie Maker (.mswmm) znajdującego się w tym samym katalogu sieciowym, co specjalnie spreparowany plik biblioteki dołączanej dynamicznie (biblioteki DLL). Następnie, podczas otwierania pliku .mswmm program Windows Movie Maker podjąłby próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
  
Osoba atakująca za pośrednictwem poczty e-mail może wykorzystać tę lukę, wysyłając do użytkownika w załączniku prawidłowy plik .mswmm, a następnie przekonując użytkownika do umieszczenia tego załącznika w katalogu, który zawiera specjalnie spreparowany plik DLL i do otwarcia pliku .mswmm. Następnie, podczas otwierania pliku .mswmm program Windows Movie Maker podjąłby próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
  
Osoba atakująca za pośrednictwem sieci może umieścić prawidłowy plik .mswmm wraz ze specjalnie spreparowanym plikiem DLL w lokalizacji UNC lub WebDAV, a następnie przekonać użytkownika do otwarcia pliku .mswmm.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**       
Ta luka dotyczy głównie stacji roboczych, na których wymaga się od użytkowników otwierania załączników z niezaufanych lokalizacji sieciowych.
  
**W jaki sposób działa aktualizacja?**       
Aktualizacja zabezpieczeń usuwa lukę, zmieniając sposób, w jaki program Windows Movie Maker ładuje zewnętrzne biblioteki.
  
**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**      
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-3967](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3967).
...
<td style="border:1px solid black;">Movie Maker 2.6 we wszystkich obsługiwanych wersjach 32-bitowych systemu Windows Vista:<br />
WindowsMovieMaker2.6-KB2424434.exe /q:a</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Movie Maker 2.6 we wszystkich obsługiwanych wersjach systemu Windows Vista dla systemów opartych na procesorze x64:<br />
WindowsMovieMaker2.6-KB2424434.exe /q:a</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2424434">artykuł 2424434 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
