---
TOCTitle: 'MS10-061'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-061 - Krytyczna'
ms:assetid: 'ms10-061'
ms:contentKeyID: 61232854
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-061(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS10-061 - Krytyczna
==========================================================

Luka w zabezpieczeniach usługi buforu wydruku może pozwolić na zdalne wykonanie kodu (2347290)
----------------------------------------------------------------------------------------------

Opublikowano: 14 września 2010 | Zaktualizowano: 29 września 2010
...
Aktualizacja zabezpieczeń usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki usługa buforu wydruku sprawdza poprawność uprawnień użytkowników. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2347290 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2347290) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=93faba6b-0a85-4acc-b527-a012bbf56b13)                                                                                                    | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9f7f3737-056d-44bd-b644-51093b5b501b)                                                                           | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3d79680b-c071-462f-9cea-551fbd42edf0)                                                                                           | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=073b3305-4a81-4ef8-b6aa-e53b31a936b4)                                                                               | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ca35a520-c4da-41bb-abcc-d5bc534ff19a)                                                                    | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=028977fd-0f39-42d4-9fee-0d90a2931cfd)                                                      | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c68b9337-883d-4e98-ba0a-90b5cad46184)                              | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=e2e788de-8400-4bf6-b96b-a915154aa20a)\*                 | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=e08d4f49-5a13-4e1d-b0a7-27b314c2edb5)\*       | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=098537d5-bf6e-4e04-ad33-1cde697e062f) | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows 7 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=34619e9e-1f00-40e4-be6f-5bbf5e3c801b)                                                                                                       | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows 7 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=dbb747a5-658d-44cf-bd49-425d1700157f)                                                                                                  | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=11e20088-1be2-4166-9c97-234b7e9f1c4f)\*                                                                        | Podniesienie uprawnień             | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=d8c635f8-8978-44bf-b457-e07368f08ef4)                                                                      | Podniesienie uprawnień             | Ważny                      | Brak                                               |
...
**Dlaczego ta luka w zabezpieczeniach ma wyższy wskaźnik ważności dla systemu Windows XP?**  
W systemie Windows XP konto gościa jest domyślnie włączone, co pozwala anonimowym użytkownikom uzyskiwać dostęp do zasobów udostępnionych drukarek. W systemach Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2 osoba atakująca musi zostać uwierzytelniona, aby wykorzystać tę lukę, chyba że udostępnianie chronione hasłem jest wyłączone. Jeśli udostępnianie na podstawie haseł zostało wyłączone, osoby atakujące mogą wykorzystać tę lukę w tych systemach bez konieczności uwierzytelniania.
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach usługi buforu wydruku związana z podszywaniem - CVE-2010-2729</th>
...
Luka w zabezpieczeniach usługi buforu wydruku związana z podszywaniem - CVE-2010-2729  
-------------------------------------------------------------------------------------

W usłudze buforu wydruku systemu Windows istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu. Umożliwia ona nieupoważnionej zdalnej osobie atakującej wykonanie dowolnego kodu w systemie Windows XP, którego dotyczy ten problem. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta. Jest to luka umożliwiająca podniesienie uprawnień, która dotyczy wszystkich pozostałych obsługiwanych wersji systemu Microsoft Windows.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-2729](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729).
  
#### Czynniki ograniczające zagrożenie spowodowane przez lukę w zabezpieczeniach usługi buforu wydruku związaną z podszywaniem - CVE-2010-2729
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   W żadnym z obecnie obsługiwanych systemów operacyjnych Windows drukarki nie są domyślnie udostępnione.  
-   Na zdalny atak narażone są tylko systemy, w których udostępniono drukarkę, a zdalna osoba atakująca może uzyskać do niej dostęp.  
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach usługi buforu wydruku związaną z podszywaniem - CVE-2010-2729
...
-   **Zablokowanie portów związanych ze zdalnym wywołaniem procedury (RPC) na zaporze**
    ...
    **Cofnięcie obejścia.** Odblokowanie portów UDP 135, 137, 138 i 445 oraz portów TCP 135, 139, 445 i 593 na zaporze Więcej informacji na temat portów znajduje się w dodatku [Przypisywanie portów TCP i UDP](http://go.microsoft.com/fwlink/?linkid=21312) (j. ang.).
  
-   **Wyłączenie udostępniania drukarek**
  
    W celu wyłączenia udostępniania drukarek wykonaj następujące czynności:
  
    W systemach Windows XP i Windows 2003
  
    1.  Kliknij przycisk **Start**, a następnie pozycję **Drukarki i faksy**.  
    2.  Prawym przyciskiem myszy kliknij ikonę drukarki i wybierz pozycję **Udostępnianie**.  
    3.  Wybierz polecenie **Nie udostępniaj tej drukarki**, a następnie kliknij przycisk **OK**.  
    4.  Powtórz ten proces dla każdej udostępnionej w danym systemie drukarki.
  
    We wszystkich nowszych systemach operacyjnych Windows:
  
    1.  Kliknij przycisk **Start**, a następnie **Urządzenia i drukarki**.  
    2.  Prawym przyciskiem myszy kliknij ikonę drukarki i wybierz pozycję **Właściwości drukarki**.  
    3.  Wybierz kartę **Udostępnianie**.  
    4.  Upewnij się, że opcja **Udostępnij tę drukarkę** nie jest zaznaczona i kliknij przycisk **OK**.  
    5.  Powtórz ten proces dla każdej udostępnionej w danym systemie drukarki.
  
    **Wpływ obejścia**. Wyłączenie tej funkcji sprawi, że zdalni użytkownicy nie będą mogli drukować na drukarce, której dotyczy luka.
    ...
    **Jak cofnąć obejście tymczasowe:**
    ...
    1.  Kliknij przycisk **Start**, a następnie pozycję **Drukarki i faksy**.  
    2.  Prawym przyciskiem myszy kliknij ikonę drukarki i wybierz pozycję **Udostępnianie**.  
    3.  Wybierz polecenie **Udostępnij tę drukarkę**, a następnie kliknij przycisk **OK**.  
    4.  Powtórz ten proces dla każdej udostępnionej w danym systemie drukarki.
    ...
    2.  Prawym przyciskiem myszy kliknij ikonę drukarki i wybierz pozycję **Właściwości drukarki**.  
    3.  Wybierz kartę **Udostępnianie**.  
    4.  Wybierz polecenie **Udostępnij tę drukarkę**, a następnie kliknij przycisk **OK**.  
    5.  Powtórz ten proces dla każdej udostępnionej w danym systemie drukarki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach usługi buforu wydruku związanej z podszywaniem - CVE-2010-2729
...
Luka powstaje, ponieważ usługa buforu wydruku niewystarczająco ogranicza uprawnienia użytkowników do korzystania ze zdalnych buforów wydruku.
...
Osoba atakująca może wykorzystać tę lukę, tworząc i wysyłając specjalnie spreparowane, złośliwe żądanie drukowania do zagrożonego systemu, w którym interfejs buforu jest udostępniony za pośrednictwem RPC. System docelowy nie przeprowadzi wystarczającego sprawdzenia, czy zdalny użytkownik posiada wystarczające uprawnienia i zezwoli mu na utworzenie pliku w katalogu systemowym systemu Windows. Ten plik, umieszczony w określonych lokalizacjach, może zostać automatycznie wykonany przez system.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**  
Szczególnie zagrożone są stacje robocze i serwery terminali udostępniające daną drukarkę, a także serwery wydruku. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie programów. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.
  
**W jaki sposób działa aktualizacja?**  
Aktualizacja zabezpieczeń usuwa lukę w zabezpieczeniach, korygując sposób, w jaki usługa buforu wydruku sprawdza uprawnienia użytkowników do korzystania z buforów wydruku.
  
**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**  
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-2729](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729).
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2347290$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2347290">artykuł 2347290 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Sergey Golovanov, Alexander Gostev, Maxim Golovkin i Alexey Monastyrsky z firmy [Kaspersky Lab](http://www.kaspersky.com), a także Vitaly Kiktenko i Alexander Saprykin z firmy [Design and Test Lab](http://www.dnt-lab.com), za zgłoszenie luki w zabezpieczeniach usługi buforu wydruku związanej z podszywaniem (CVE-2010-2729)  
-   Liam O Morchu z firmy [Symantec](http://www.symantec.com/index.jsp), za zgłoszenie luki w zabezpieczeniach usługi buforu wydruku związanej z podszywaniem (CVE-2010-2729)
...
-   Wersja 1.1 (29 września 2010 r.): Dodano łącze do artykułu 2347290 bazy wiedzy Microsoft Knowledge Base w części „Znane problemy” sekcji „Streszczenie”.
