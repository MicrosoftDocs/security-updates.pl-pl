---
TOCTitle: 'MS10-096'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-096 - Ważna'
ms:assetid: 'ms10-096'
ms:contentKeyID: 61232889
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-096(v=Security.10)'
---


Biuletyn zabezpieczeń firmy Microsoft MS10-096 - Ważna
======================================================

Luka w zabezpieczeniach książki adresowej systemu Windows umożliwia zdalne wykonanie kodu (2423089)
---------------------------------------------------------------------------------------------------
...
Aktualizacja usuwa lukę, poprawiając sposób, w jaki Książka adresowa systemu Windows ładuje biblioteki zewnętrzne. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=46baa431-126c-4fa5-9a7b-525008e2817d)                                                                                                    | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b9ce9d62-2eaa-48d8-bb6d-ea137e63d077)                                                                           | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e0b2837c-019b-419b-954d-5bdc71a3a332)                                                                                           | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4c5cb600-9a39-40a0-be42-1593b1e0b97d)                                                                               | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=9abc8270-f3ac-474d-9ebc-410aaa6262cc)                                                                    | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a1c7f1b5-e054-4cd6-857d-2ab0a2fe9f62)                                                      | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=73624b68-a69d-4517-b971-f0b7d2ccc9d6)                              | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=118f528f-bd05-49c2-a4a4-78314cd00992)\*\*               | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=77e288fb-b51f-4f57-baac-1443d8fbd37b)\*\*     | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=82f71194-6f1f-4f43-8752-4bf5e5f94a93) | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows 7 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=4e8ad5cd-af27-4f00-9378-ad778b8ee7b3)                                                                                                       | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows 7 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=35a3e821-b463-411c-858b-d01eb5aed42b)                                                                                                  | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=9e2c95f6-9381-4484-b11b-814ab9138118)\*\*                                                                      | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cb4211f3-1082-4245-8f03-7cbac90e9a31)                                                                      | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
...
Tak, ta luka jest powiązana z kategorią luk opisanych w [Poradniku zabezpieczeń firmy Microsoft 2269637](http://technet.microsoft.com/security/advisory/2269637), które wpływają na sposób ładowania zewnętrznych bibliotek przez aplikacje. Niniejszy biuletyn zabezpieczeń usuwa konkretne wystąpienie luki tego rodzaju.
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z niebezpiecznym ładowaniem bibliotek — CVE-2010-3147</th>
...
Luka w zabezpieczeniach związana z niebezpiecznym ładowaniem bibliotek — CVE-2010-3147  
--------------------------------------------------------------------------------------

Sposób, w jaki Książka adresowa systemu Windows obsługuje ładowanie plików DLL, powoduje powstanie luki w zabezpieczeniach umożliwiającej zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3147](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek — CVE-2010-3147
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z niebezpiecznym ładowaniem bibliotek — CVE-2010-3147
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek — CVE-2010-3147
...
Luka powstaje, gdy Książka adresowa systemu Windows nieprawidłowo ogranicza ścieżkę służącą do ładowania zewnętrznych bibliotek.
  
**Co to jest Książka adresowa systemu Windows?**    
System Windows udostępnia książkę adresową służącą do przechowywania informacji kontaktowych. Książka adresowa systemu Windows (WAB) to aplikacja i usługa, która umożliwia użytkownikom gromadzenie informacji o osobach. Książka adresowa systemu Windows jest wyposażona w lokalną bazę danych oraz interfejs użytkownika, które służą do wyszukiwania i edycji informacji o osobach, a także może wysyłać zapytania do serwerów usług katalogowych w sieci, korzystając z protokołu Lightweight Directory Access Protocol (LDAP). Inne aplikacje mogą korzystać z WAB. Przykładowo, program Microsoft Outlook korzysta z tej aplikacji jako książki adresów e-mail.
...
Osoba atakująca mogłaby nakłonić użytkownika do otwarcia prawidłowego pliku Książki adresowej systemu Windows znajdującego się w tym samym katalogu sieciowym co specjalnie spreparowany plik biblioteki dołączanej dynamicznie (biblioteki DLL). Następnie, podczas otwierania pliku książki adresowej, aplikacja WAB podjęłaby próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
  
Osoba atakująca za pośrednictwem poczty e-mail może wykorzystać tę lukę, wysyłając do użytkownika w załączniku prawidłowy plik książki adresowej, a następnie przekonując użytkownika do umieszczenia tego załącznika w katalogu, który zawiera specjalnie spreparowany plik DLL i do otwarcia pliku książki adresowej. Następnie, podczas otwierania pliku książki adresowej, aplikacja WAB podjęłaby próbę załadowania pliku DLL i wykonania dowolnego zawartego w nim kodu.
  
Osoba atakująca za pośrednictwem sieci może umieścić prawidłowy plik książki adresowej wraz ze specjalnie spreparowanym plikiem DLL w lokalizacji UNC lub WebDAV, a następnie przekonać użytkownika do otwarcia pliku książki adresowej.
...
Aktualizacja usuwa lukę, poprawiając sposób, w jaki Książka adresowa systemu Windows ładuje biblioteki zewnętrzne.
  
**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**    
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-3147](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147).
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2423089$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2423089">artykuł 2423089 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
#### Windows Server 2003 (wszystkie wersje 32-bitowe)
...
-   Simon Raner z firmy [ACROS Security](http://www.acrossecurity.com/), za zgłoszenie luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek (CVE-2010-3147)  
-   HD Moore z firmy [Rapid7](http://www.rapid7.com/), za zgłoszenie luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek (CVE-2010-3147)  
-   Muhaimin Dzulfakar z firmy [NGS Software](http://www.ngssoftware.com/), za zgłoszenie luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek (CVE-2010-3147)
