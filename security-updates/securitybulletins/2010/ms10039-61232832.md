---
TOCTitle: 'MS10-039'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-039 - Ważna'
ms:assetid: 'ms10-039'
ms:contentKeyID: 61232832
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-039(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-039 - Ważna
======================================================

Luki w zabezpieczeniach programu Microsoft SharePoint umożliwiają podniesienie poziomu uprawnień (2028554)
----------------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń usuwa jedną lukę zgłoszoną przez organizacje publiczne oraz dwie luki zgłoszone przez użytkowników, które istnieją w programie Microsoft SharePoint. Najpoważniejsza z omawianych luk może umożliwić podniesienie uprawnień, jeśli osoba atakująca przekona użytkownika atakowanej witryny programu SharePoint do kliknięcia specjalnie spreparowanego łącza.

Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji programu Microsoft SharePoint Services 3.0 oraz wszystkich obsługiwanych wersji programów Microsoft Office InfoPath 2003, Microsoft Office InfoPath 2007 i Microsoft Office SharePoint Server 2007. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa luki, modyfikując sposób, w jaki program Microsoft SharePoint sprawdza poprawność danych wejściowych przekazywanych do kwerendy HTTP, sposób oczyszczania zawartości HTML w programie Microsoft SharePoint przez metodę toStaticHTML, a także sposób obsługi przez program Microsoft SharePoint specjalnie spreparowanych żądań skierowanych do strony Pomocy. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.

Niniejsza aktualizacja zabezpieczeń dotyczy również luki w zabezpieczeniach opisanej po raz pierwszy w [Poradniku zabezpieczeń firmy Microsoft 983438](http://technet.microsoft.com/security/advisory/983438).

**Zalecenie.** Firma Microsoft zaleca klientom jak najszybsze zastosowanie tej aktualizacji.

**Znane problemy.** W [artykule 2028554 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2028554) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 64-bitowe)](http://www.microsoft.com/downloads/details.aspx?familyid=4d84a25b-532f-4319-9ab2-90e5b82ebd90)  
(KB979445)<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
Ujawnienie informacji
...
| Windows SharePoint Services i Microsoft SharePoint                        |
|---------------------------------------------------------------------------|
...
<span></span>
**W jakim stopniu ta aktualizacja zabezpieczeń (MS10-039) jest związana z aktualizacją opisaną w biuletynie MS10-035, „Zbiorcza aktualizacja zabezpieczeń dla programu Internet Explorer (982381)”?**
Opisana w tym biuletynie luka w zabezpieczeniach metody toStaticHTML umożliwiająca ujawnienie informacji, [CVE-2010-1257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257), dotyczy także programu Internet Explorer. Aktualizacja [MS10-035](http://go.microsoft.com/fwlink/?linkid=190898), Zbiorcza aktualizacja zabezpieczeń dla programu Internet Explorer (982381), usuwa omawianą lukę w odniesieniu do programu Internet Explorer. Jeśli program Internet Explorer został zainstalowany, zainstaluj wymagane aktualizacje zgodnie z biuletynem [MS10-035](http://go.microsoft.com/fwlink/?linkid=190898). Jeśli w systemie zainstalowano program Microsoft SharePoint, zainstaluj wymagane aktualizacje zgodnie z niniejszym biuletynem .
...
W [artykule 2028554 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2028554) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
W zależności od tego, który produkt SharePoint jest zainstalowany w systemie, konieczne będzie zastosowanie jednej lub obu aktualizacji. W systemach, gdzie zainstalowano tylko program Microsoft Windows SharePoint Services 3.0, należy zastosować aktualizację KB983444. W systemach, gdzie zainstalowano program Microsoft Office SharePoint Server 2007, należy zastosować aktualizacje KB979445 i KB983444. Nie istnieje konfiguracja, w której można by mieć tylko program Microsoft Office SharePoint Server 2007 bez programu Microsoft Windows SharePoint Services 3.0.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach pliku Help.aspx związana ze skryptami krzyżowymi (XSS) - CVE-2010-0817
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach metody toStaticHTML umożliwiająca ujawnienie informacji - CVE-2010-1257
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach strony pomocy programu Sharepoint umożliwiająca atak typu „odmowa usługi” - CVE-2010-1264
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 1 i Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 2 (wersje 32-bitowe)
</td>
<td style="border:1px solid black;">
**Ważny**  
Podniesienie uprawnień
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 1 i Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 2 (wersje 64-bitowe)
</td>
<td style="border:1px solid black;">
**Ważny**  
Podniesienie uprawnień
...
<span></span>
W programach Microsoft Windows SharePoint Services 3.0 oraz Microsoft Office SharePoint Server 2007 występuje luka w zabezpieczeniach umożliwiająca wykonywanie skryptów krzyżowych i fałszowanie, która mogłaby pozwolić osobie atakującej na przekonanie użytkownika, by uruchomił złośliwy skrypt. Osoba atakująca, która z powodzeniem wykorzysta omawianą lukę, może zmodyfikować zawartość pamięci podręcznej przeglądarki sieci Web oraz pamięci podręcznej pośredniczącego serwera proxy. Dodatkowo może ona również umieścić w tych pamięciach podręcznych sfałszowane dane. Osoba ta może być również w stanie wykorzystać lukę do przeprowadzenia ataków z wykorzystaniem skryptów krzyżowych.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0817](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0817).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach pliku Help.aspx związanej ze skryptami krzyżowymi (XSS) - CVE-2010-0817

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Użytkownicy programu Internet Explorer 8 przechodzący pod adres witryny programu SharePoint w strefie internetowej są narażeni na mniejsze ryzyko, ponieważ filtr XSS programu Internet Explorer 8 blokuje ataki tego typu w strefie internetowej. Filtr XSS programu Internet Explorer 8 nie jest jednak domyślnie włączony dla strefy intranetowej.
...
#### Obejścia problemu dotyczącego luki w zabezpieczeniach pliku Help.aspx związanej ze skryptami krzyżowymi (XSS) - CVE-2010-0817

Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:

-   **Ograniczenie dostępu do pliku SharePoint Help.aspx**

    Administrator może zastosować listę kontroli dostępu do pliku SharePoint Help.aspx, aby uniemożliwić jego ładowanie. To skutecznie zapobiega wykorzystaniu luki do ataku tą metodą.

    Aby ograniczyć dostęp do narażonego na działanie luki pliku Help.aspx, uruchom następujące polecenia w wierszu polecenia:
    ...
    **Wpływ obejścia.** To obejście spowoduje całkowite wyłączenie funkcji pomocy na serwerze programu SharePoint.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach pliku Help.aspx związanej ze skryptami krzyżowymi (XSS) - CVE-2010-0817

**Jaki zakres obejmuje ta luka?**
Jest to luka w zabezpieczeniach związana ze skryptami, której wykorzystanie mogłoby spowodować podniesienie poziomu uprawnień w programach Microsoft Windows SharePoint Services 3.0 oraz Microsoft Office SharePoint Server 2007 i przez to umożliwić osobie atakującej nakłonienie użytkownika do uruchomienia złośliwego skryptu. Intruz, któremu uda się wykorzystać lukę, może przeprowadzić ataki z wykorzystaniem skryptów krzyżowych, spowodować wyświetlanie fałszywych informacji użytkownikom lub spowodować przekierowanie odpowiedzi serwera do innego użytkownika. Osoba atakująca może również wykorzystać tę lukę do zmiany zawartości pamięci podręcznej przeglądarki sieci Web oraz pośredniczącego serwera proxy i umieszczenia w nich sfałszowanych treści.

**W jaki sposób powstaje luka?**
Programy Microsoft Windows SharePoint Services 3.0 i Microsoft Office SharePoint Server 2007 nie przeprowadzają prawidłowego sprawdzenia poprawności danych wejściowych przekazywanych do kwerendy HTML przed przesłaniem tych danych do przeglądarki.

**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**
Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia w witrynie programu SharePoint, jak zaatakowany użytkownik. W następstwie powyższego osoba atakująca uzyska możliwość wydawania poleceń serwerowi programu SharePoint, dysponując uprawnieniami zaatakowanego użytkownika.
...
Szczególnie narażone są systemy klienckie, których użytkownicy przeglądają Internet.

**Co to jest filtr skryptów krzyżowych (XSS) programu Internet Explorer 8?**
Ataki typu XSS są próbą wykorzystania luk w zabezpieczeniach witryn sieci Web, z których korzystają użytkownicy. Za przykład może posłużyć luka opisana w niniejszym biuletynie. W tym przypadku użytkownik może otrzymać wiadomość e-mail zawierającą specjalnie spreparowany adres sieci Web, pod którym kryje się skrypt. Po kliknięciu adresu użytkownik zostaje przekierowany pod uprawniony adres witryny programu SharePoint, gdzie uruchomiony zostaje skrypt przygotowany przez osobę atakującą. W ostatnim czasie ataki typu XSS urosły do rangi głównych zagrożeń online, w związku z czym program Internet Explorer 8 został wyposażony w filtr skryptów krzyżowych, który potrafi wykrywać takie ataki i wyłączać szkodliwe skrypty. Filtr skryptów krzyżowych jest domyślnie włączony w programie Internet Explorer 8 dla strefy Internet.

**W jaki sposób działa aktualizacja?**
Ta aktualizacja eliminuje lukę w zabezpieczeniach poprzez zmianę sposobu, w jaki programy Microsoft Windows SharePoint Services 3.0 i Microsoft Office SharePoint Server 2007 sprawdzają poprawność danych wejściowych przekazywanych do kwerendy HTML przed przesłaniem tych danych do klienta.

**Czy luka ta była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-0817](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0817). Po raz pierwszy opisano ją w [Poradniku zabezpieczeń firmy Microsoft 983438](http://technet.microsoft.com/security/advisory/983438).
...
Tak. Niniejsza aktualizacja zabezpieczeń eliminuje lukę, która może być potencjalnie wykorzystana dzięki zastosowaniu publicznie dostępnego kodu koncepcyjnego. Informacje o usuniętej luce w zabezpieczeniach zostały zarejestrowane w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-0817](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0817).

Luka w zabezpieczeniach metody toStaticHTML umożliwiająca ujawnienie informacji - CVE-2010-1257
-----------------------------------------------------------------------------------------------

<span></span>
W sposobie oczyszczania zawartości HTML przez API toStaticHTML programu SharePoint istnieje luka w zabezpieczeniach umożliwiająca ujawnienie informacji, która może pozwolić osobie atakującej na przeprowadzenie ataków z wykorzystaniem skryptów krzyżowych i uruchomienie skryptu w kontekście zabezpieczeń zalogowanego użytkownika.
...
-   Potencjalnie zagrożone są tylko witryny programu SharePoint, w których używana jest metoda toStaticHTML.
...
**Jaki zakres obejmuje ta luka?**
Ta luka może doprowadzić do ujawnienia informacji. Osoba atakująca, której uda się wykorzystać tę lukę, może przeprowadzać stałe ataki z wykorzystaniem skryptów krzyżowych wymierzone przeciwko użytkownikom danej witryny programu SharePoint.

**W jaki sposób powstaje luka?**
Przyczyną powstawania luki jest sposób, w jaki metoda toStaticHTML API oczyszcza zawartość HTML w witrynie programu SharePoint.

**Co to jest toStaticHTML?**
Metoda toStaticHTML to API, które umożliwia oczyszczanie zawartości HTML poprzez usunięcie z danych wejściowych użytkownika atrybutów zdarzeń i skryptów zanim zawartość ta zostanie wyświetlona jako HTML. Aby uzyskać więcej informacji, zobacz artykuł w witrynie MSDN Library [Metoda toStaticHTML](http://msdn.microsoft.com/en-us/library/cc848922(vs.85).aspx) (j. ang.).
...
**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**
Osoba atakująca, której uda się wykorzystać tę lukę, może przeprowadzać ataki z wykorzystaniem skryptów krzyżowych wymierzone przeciwko użytkownikom zaatakowanej witryny programu SharePoint. Osoba atakująca mogłaby następnie uruchomić w kontekście zabezpieczeń użytkowników witryny skrypt wymierzony przeciwko witrynie SharePoint używającej metody toStaticHTML.

**W jaki sposób osoba atakująca może wykorzystać tę lukę?**
Aby móc wykorzystać omawianą lukę, osoba atakująca musi mieć możliwość przesłania do atakowanej witryny programu SharePoint specjalnie spreparowanego skryptu. Luka powoduje, że w określonych sytuacjach specjalnie spreparowany skrypt nie zostaje prawidłowo oczyszczony przy użyciu metody toStaticHTML, co w konsekwencji może prowadzić do uruchomienia skryptu dostarczonego przez osobę atakującą w kontekście zabezpieczeń użytkownika, który wyświetla niebezpieczną zawartość w witrynie programu SharePoint.

Aby ta luka umożliwiła wykonanie niepożądanych działań w przypadku ataku z wykorzystaniem skryptów krzyżowych, użytkownik musi odwiedzić określoną witrynę programu SharePoint. Przykładowo, gdy osobie atakującej uda się przesłać specjalnie spreparowany skrypt do atakowanej witryny programu SharePoint, każda zawierająca ten skrypt strona sieci Web w tej witrynie staje się potencjalnym kierunkiem ciągłych ataków z wykorzystaniem skryptów krzyżowych. Gdy użytkownik odwiedzi stronę sieci Web zawierającą specjalnie spreparowany skrypt, skrypt ten może zostać uruchomiony w kontekście zabezpieczeń tego użytkownika w witrynie SharePoint.
...
**W jaki sposób działa aktualizacja?**
Ta aktualizacja eliminuje lukę w zabezpieczeniach poprzez zmianę sposobu, w jaki metoda toStaticHTML oczyszcza zawartość HTML.

**Czy ta luka w zabezpieczeniach jest związana z luką CVE-2010-1257 opisaną w biuletynie**[**MS10-035**](http://go.microsoft.com/fwlink/?linkid=190898)**, Zbiorcza aktualizacja zabezpieczeń dla programu Internet Explorer (982381)?**
Tak, luka w zabezpieczeniach metody toStaticHTML umożliwiająca ujawnienie informacji, [CVE-2010-1257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257), dotyczy także programu Internet Explorer.
...
<span></span>
W zabezpieczeniach programu Microsoft SharePoint istnieje luka umożliwiająca przeprowadzenie ataku typu „odmowa usługi” związana ze sposobem, w jaki program ten obsługuje specjalnie spreparowane żądania do strony pomocy. Osoba atakująca może próbować wykorzystać tę lukę, wysyłając specjalnie spreparowane pakiety do atakowanego serwera SharePoint, co w rezultacie mogłoby spowodować, że serwer sieci Web przestanie reagować do momentu ponownego uruchomienia powiązanej puli aplikacji.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-1264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1264).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach strony pomocy programu Sharepoint umożliwiającej atak typu „odmowa usługi” - CVE-2010-1264

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Osoba atakująca nie może uruchomić dowolnego kodu na docelowym serwerze SharePoint. Jest to luka umożliwiająca wyłącznie atak typu „odmowa usługi”.
-   Aby móc wykorzystać omawianą lukę, osoba atakująca musi być uwierzytelniona w witrynie programu SharePoint.

#### Obejścia problemu dotyczącego luki w zabezpieczeniach strony pomocy programu Sharepoint umożliwiającej atak typu „odmowa usługi” - CVE-2010-1264

Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:

-   **Ograniczenie dostępu do pliku SharePoint Help.aspx**

    Administrator może zastosować listę kontroli dostępu do pliku Help.aspx programu SharePoint, uniemożliwiając jego ładowanie. Jest to rozwiązanie skutecznie zapobiegające wykorzystaniu omawianej luki za pośrednictwem tego kierunku ataku.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach strony pomocy programu Sharepoint umożliwiającej atak typu „odmowa usługi” - CVE-2010-1264

**Jaki zakres obejmuje ta luka?**
W zabezpieczeniach programu Microsoft Office SharePoint Server 2007 występuje luka umożliwiająca atak typu „odmowa usługi”. Osoba atakująca, której uda się wykorzystać tę lukę, może spowodować sytuację typu „odmowa usługi”, wysyłając specjalnie spreparowane żądania do strony Pomocy serwera SharePoint.

**W jaki sposób powstaje luka?**
Luka powstaje w wyniku sposobu obsługiwania przez program Microsoft SharePoint specjalnie spreparowanych żądań wysyłanych do strony Pomocy.

**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**
Osoba atakująca może spowodować krótko- lub długotrwałą sytuację typu „odmowa usługi” na serwerze programu SharePoint.

**W jaki sposób osoba atakująca może wykorzystać tę lukę?**
Osoba atakująca może próbować wykorzystać lukę, przesyłając specjalnie spreparowane żądania do strony Pomocy serwera SharePoint i w rezultacie powodując awarię powiązanej puli aplikacji oraz jej ponowne uruchomienie przez program IIS. Pewna liczba automatycznych ponownych uruchomień w ograniczonych ramach czasowych spowoduje, że program IIS w konfiguracji domyślnej przestanie ponownie uruchamiać pulę aplikacji. Serwer przestanie wówczas reagować i sytuacja ta utrzyma się, dopóki administrator ręcznie nie uruchomi ponownie puli aplikacji.

**Jakie systemy są szczególnie narażone na skutki tej luki?**
Szczególnie zagrożone są serwery, na których działa program Microsoft Office SharePoint Server 2007.

**W jaki sposób działa aktualizacja?**
Ta aktualizacja eliminuje lukę w zabezpieczeniach poprzez poprawienie sposobu, w jaki program Microsoft SharePoint obsługuje specjalnie spreparowane żądania do strony Pomocy.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|
| Microsoft Office InfoPath 2003 z dodatkiem Service Pack 3                                                                                                      | Tak        |
| Microsoft Office InfoPath 2007 z dodatkiem Service Pack 1 i Microsoft Office InfoPath z dodatkiem Service Pack 2                                               | Tak        |
...
| Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 1 i Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 2 (wersje 32-bitowe) | Tak        |
| Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 1 i Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 2 (wersje 64-bitowe) | Tak        |
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|---------------------------|-----------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| Microsoft Office InfoPath 2003 z dodatkiem Service Pack 3                                                                                                      | Nie     | Nie                       | Tak                                                                                     | Tak                                                                                     |
| Microsoft Office InfoPath 2007 z dodatkiem Service Pack 1 i Microsoft Office InfoPath z dodatkiem Service Pack 2                                               | Nie     | Nie                       | Tak                                                                                     | Tak                                                                                     |
...
| Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 1 i Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 2 (wersje 32-bitowe) | Nie     | Nie                       | Tak                                                                                     | Tak                                                                                     |
| Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 1 i Microsoft Windows SharePoint Services 3.0 z dodatkiem Service Pack 2 (wersje 64-bitowe) | Nie     | Nie                       | Tak                                                                                     | Tak                                                                                     |
...
#### InfoPath 2003 (wszystkie wersje)
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/980923">artykuł 980923 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/979441">artykuł 979441 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 1 oraz Microsoft Office SharePoint Server 2007 z dodatkiem Service Pack 2 (wersje 64-bitowe):<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/979445">artykuł 979445 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/983444">artykuł 983444 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Rik Jones z instytucji Dallas County Community College District, za zgłoszenie luki w zabezpieczeniach strony pomocy programu Sharepoint umożliwiającej atak typu „odmowa usługi” (CVE-2010-1264)
