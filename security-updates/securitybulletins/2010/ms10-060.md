---
TOCTitle: 'MS10-060'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-060 - Krytyczna'
ms:assetid: 'ms10-060'
ms:contentKeyID: 61232853
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-060(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS10-060 - Krytyczna
==========================================================

Luki w zabezpieczeniach aparatu plików wykonywalnych języka wspólnego Microsoft .NET i w programie Microsoft Silverlight mogą umożliwić zdalne wykonanie kodu (2265906)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------

Opublikowano: 10 sierpnia 2010 | Zaktualizowano: 29 września 2010
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla wszystkich wersji składnika Microsoft .NET Framework, których dotyczy luka, w systemach Windows XP, Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2, a także dla programu Microsoft Silverlight 2 i Microsoft Silverlight 3. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa luki, zmieniając sposób obsługi wskaźników w programie Microsoft Silverlight i sposób obsługi interfejsów przez aparat plików wykonywalnych języka wspólnego systemu Microsoft .NET. Więcej informacji na temat luk może znaleźć w podsekcjach „Często zadawane pytania” dla pozycji określonych luk w zabezpieczeniach, znajdujących się poniżej następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2265906 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2265906) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
<sup>[1]</sup>Ten plik do pobrania uaktalnia program Microsoft Silverlight 2 do nowszej wersji, która nie podlega opisywanym lukom.

<sup>[2]</sup>Ta aktualizacja uaktualnia program Microsoft Silverlight do nowszej kompilacji, która nie podlega opisywanym lukom. Więcej informacji można znaleźć w sekcji **Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń**.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 z dodatkiem SP2 dla systemów z procesorem Itanium
</td>
<td style="border:1px solid black;">
Microsoft .NET Framework 3.0 z dodatkiem Service Pack 2
</td>
...
| Microsoft Silverlight 1 w systemie Microsoft Windows                            |
| Microsoft Silverlight 1 w systemie Mac OS (na komputerach z procesorem Intel)   |
| Microsoft Silverlight 1 w systemie Mac OS (na komputerach z procesorem PowerPC) |
| Microsoft Silverlight 4                                                         |
| Microsoft Silverlight 4 w systemie Mac OS (na komputerach z procesorem Intel)   |
| Microsoft Silverlight 4 w systemie Microsoft Windows                            |
...
**W których przeglądarkach sieci Web są obsługiwane aplikacje Silverlight?**  
Aby możliwe było uruchamianie aplikacji Silverlight, w przypadku większości przeglądarek sieci Web, w tym także programu Microsoft Internet Explorer, wymagana jest uprzednia instalacja programu Silverlight oraz włączenie odpowiedniego dodatku plug-in. Aby uzyskać więcej informacji na temat programu Silverlight, zobacz [oficjalną witrynę Microsoft Silverlight](http://www.microsoft.com/silverlight/). Więcej informacji na temat włączania i wyłączania dodatków plug-in można znaleźć w dokumentacji przeglądarki.

**Jakie wersje programu Microsoft Silverlight 3 podlegają lukom?**  
Luka omówiona w tym biuletynie dotyczy programu Microsoft Silverlight kompilacja 3.0.50106.0 i starsze. Program Microsoft Silverlight kompliacja 3.0.50611.0, będący najbardziej aktualną wersją programu Silverlight w momencie pierwszej publikacji tego biuletynu, eliminuje opisane luki i im nie podlega.

**Skąd wiadomo, która wersja i kompilacja programu Silverlight są aktualnie zainstalowane?**  
Jeśli program Silverlight został już zainstalowany na komputerze, należy przejść na stronę [Pobierz Microsoft Silverlight](http://www.microsoft.com/silverlight/get-started/install/), na której można uzyskać informacje dotyczące wersji Silverlight obecnej w systemie. Można również skorzystać z funkcji Zarządzaj dodatkami, która jest dostępna w najnowszych wersjach programu Microsoft Internet Explorer. Pozwoli ona określić wersję i kompilację zainstalowanej aplikacji.
...
Wersja instalowana z tą aktualizacją zabezpieczeń to 3.0.41130.0. Jeśli numer wersji posiadanego programu jest równy lub wyższy, system nie jest zagrożony.

**Jak mogę uaktualnić posiadaną wersję programu Silverlight?**  
Funkcja automatycznej aktualizacji programu Silverlight pomaga zagwarantować, że zainstalowane oprogramowanie Silverlight będzie zawsze zaktualizowane do najnowszej wersji wraz ze wszystkimi funkcjami i zabezpieczeniami. Aby uzyskać więcej informacji na temat funkcji automatycznej aktualizacji programu Silverlight, zobacz artykuł [Microsoft Silverlight Updater](http://www.microsoft.com/getsilverlight/resources/documentation/updater.aspx). Klienci, którzy wyłączyli funkcję automatycznej aktualizacji programu Silverlight, mogą zarejestrować się w witrynie [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747), aby otrzymać najnowszą wersję tego programu, lub pobrać tę wersję ręcznie przy użyciu łącza pobierania znajdującego się w tabeli Programy, których dotyczy problem, znajdującej się w poprzedniej sekcji **Programy, których dotyczy problem, i programy, których nie dotyczy problem**. Informacje na temat wdrażania programu Silverlight w środowisku firmy można znaleźć na stronie [Przewodnik wdrażania programu Silverlight w przedsiębiorstwie](http://go.microsoft.com/fwlink/?linkid=119611) (j. ang.).

**Czy ta aktualizacja obejmuje jakiekolwiek zmiany funkcjonalności niedotyczące zabezpieczeń?**  
Więcej informacji na temat zmian niedotyczących zabezpieczeń, które zostały wprowadzone w najnowszej wersji programu Silverlight można znaleźć w sekcji [Historia wydań programu Microsoft Silverlight](http://go.microsoft.com/fwlink/?linkid=92598).
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu Microsoft Silverlight związana z uszkodzeniem pamięci - CVE-2010-0019
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach związana z wyznaczaniem metody wirtualnej w programie Microsoft Silverlight i Microsoft .NET Framework CLR - CVE-2010-1898
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Silverlight 3 na komputerach Macintosh
</td>
<td style="border:1px solid black;">
**Krytyczny**  
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
Microsoft Silverlight 3 we wszystkich wersjach klientów Microsoft Windows
</td>
<td style="border:1px solid black;">
**Krytyczny**  
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Silverlight 3 we wszystkich wersjach serwerów systemu Microsoft Windows\*\*
</td>
<td style="border:1px solid black;">
**Krytyczny**  
Zdalne wykonanie kodu
...
W metodzie obsługi wskaźników w programu Microsoft Silverlight występuje luka umożliwiająca zdalne wykonanie kodu. Luka umożliwia zdalne wykonanie kodu, gdy użytkownik odwiedzi specjalnie spreparowaną witrynę sieci Web zawierającą treść Silverlight.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0019](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0019).

#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach programu Microsoft Silverlight związanej z uszkodzeniem pamięci - CVE-2010-0019
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach programu Microsoft Silverlight związaną z uszkodzeniem pamięci - CVE-2010-0019
...
-   **Tymczasowe zapobieganie uruchamianiu formantu ActiveX programu Microsoft Silverlight w programie Internet Explorer (Metoda 2)**
    ...
    **Uwaga** Nieprawidłowe korzystanie z Edytora rejestru może być przyczyną poważnych problemów, w wyniku których może być konieczna ponowna instalacja systemu operacyjnego. Firma Microsoft nie może zagwarantować rozwiązania problemów wynikających z nieprawidłowego użycia Edytora Rejestru. Zmian w rejestrze można dokonywać wyłącznie na własne ryzyko. Informacje na temat sposobu modyfikacji rejestru można znaleźć w temacie Pomocy „Zmienianie kluczy i wartości” programu Edytor rejestru (Regedit.exe) lub „Dodawanie i usuwanie informacji w rejestrze” oraz „Edytowanie danych rejestru” w przypadku programu Regedt32.exe.
    ...
    -   **Stosowanie metody interakcyjnej**
        ...
        3.  Kliknij prawym przyciskiem myszy klucz {DFEAF541-F3E1-4c24-ACAC-99C30715084A} i wybierz polecenie **Eksportuj**. Zapisz plik na dysku.
    ...
    **Cofnięcie obejścia.**
    ...
    -   **Stosowanie skryptu wdrażania zarządzanego**
        ...
        Przywróć plik kopii zapasowej wykonany w Kroku 1 za pomocą następującego polecenia:
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Microsoft Silverlight związanej z uszkodzeniem pamięci - CVE-2010-0019

**Jaki zakres obejmuje luka?**  
Jeśli w systemie jest zainstalowany program Microsoft Silverlight, luka ta może umożliwić zdalne wykonanie kodu w kontekście aktualnie zalogowanego użytkownika.

**Skąd bierze się luka?**  
Przyczyną występowania tej luki jest nieprawidłowa obsługa wskaźników w programie Microsoft Silverlight. Podczas analizy specjalnie spreparowanego kodu Silverlight w programie Silverlight może wystąpić uszkodzenie pamięci, po którym program ten przestanie odpowiadać lub które umożliwi wykonanie dowolnego kodu.
...
Aby można było wykorzystać tę lukę, użytkownik musi być zalogowany i odwiedzać witryny sieci Web przy użyciu przeglądarki sieci Web, w której można uruchomić aplikację Silverlight. Dlatego głównie narażone są wszystkie systemy (zarówno Microsoft Windows, jak Apple Mac OS), w których jest zainstalowany program Microsoft Silverlight. Najbardziej narażone na skutki wykorzystania tej luki są systemy, w których jest często używana przeglądarka sieci Web, takie jak stacje robocze i serwery terminali. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na przeglądanie i odczytywanie poczty e-mail na tych serwerach, mimo że najważniejsze wskazówki zdecydowanie to odradzają.
...
Aktualizacja modyfikuje sposób, w jaki program Microsoft Silverlight obsługuje wskaźniki.
...
W systemie Microsoft .NET Framework istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, która może pozwolić specjalnie spreparowanej aplikacji Microsoft .NET lub Silverlight na dostęp do pamięci, co pozwala na wykonanie dowolnego kodu niezarządzanego.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-1898](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1898).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z wyznaczaniem metody wirtualnej w programie Microsoft Silverlight i Microsoft .NET Framework CLR - CVE-2010-1898
...
-   Omawiana luka nie dotyczy bieżącej wersji programu Microsoft Silverlight - Silverlight 4. Program Silverlight będzie domyślnie sprawdzać dostępność aktualizacji w witrynie sieci Web firmy Microsoft, aby dostarczyć użytkownikowi najnowsze funkcje i udoskonalenia. Jeśli dostępna będzie nowsza wersja, zostanie ona pobrana i zainstalowana na komputerze. W większości systemów będzie już działać wersja Silverlight 4. Aby uzyskać więcej informacji, zobacz artykuł [Microsoft Silverlight Updater](http://www.microsoft.com/silverlight/resources/documentation/updater.aspx).

#### Obejścia problemu dotyczącego luki w zabezpieczeniach związanej z wyznaczaniem metody wirtualnej w programie Microsoft Silverlight i Microsoft .NET Framework CLR - CVE-2010-1898
...
-   **Uaktualnienie do najnowszej wersji programu Microsoft Silverlight**

    Omawiana luka w zabezpieczeniach nie dotyczy programu Silverlight 4. Zamiast instalacji aktualizacji zabezpieczeń programu Silverlight, można zainstalować uaktualnienie do najnowszej wersji Silverlight. Aby uzyskać więcej informacji, zobacz [Microsoft Silverlight](http://www.microsoft.com/silverlight/).

#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z wyznaczaniem metody wirtualnej w programie Microsoft Silverlight i Microsoft .NET Framework CLR - CVE-2010-1898
...
**Skąd bierze się luka?**  
Przyczyną powstawania luki jest sposób obsługi wyznaczania metody wirtualnej przez aparat plików wykonywalnych języka wspólnego (CLR) systemu Microsoft .NET.
...
| Microsoft Silverlight 3 w systemie Microsoft Windows                                                                                     | Tak        |
| Microsoft Silverlight 3 na komputerach Macintosh                                                                                         | Nie        |
...
| Microsoft Silverlight 3 w systemie Microsoft Windows                                                                                     | Nie     | Nie                       | Nie                       | Tak                        |
| Microsoft Silverlight 3 na komputerach Macintosh                                                                                         | Nie     | Nie                       | Nie                       | Nie                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2265906">artykuł 2265906 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
**Instalowanie aktualizacji dla programu Microsoft .NET Framework 3.5 (KB983582), Microsoft .NET Framework 2.0 z dodatkiem Service Pack 2 i Microsoft .NET Framework 3.5 z dodatkiem Service Pack 1 (KB983583)**
...
**Uwaga dotycząca aplikacji Microsoft .NET Framework 2.0 z dodatkiem Service Pack 2 (KB983583)** Podczas instalowania tej poprawki zabezpieczeń instalator sprawdza, czy aktualizowany produkt lub składnik był wcześniej aktualizowany za pomocą poprawki hotfix firmy Microsoft.
...
**Usuwanie aktualizacji dla programu Microsoft .NET Framework 3.5 (KB983582), Microsoft .NET Framework 2.0 z dodatkiem Service Pack 2 i Microsoft .NET Framework 3.5 z dodatkiem Service Pack 1 (KB983583)**
...
**Instalowanie aktualizacji dla programu Microsoft .NET Framework 2.0 z dodatkiem Service Pack 1, Microsoft .NET Framework 3.5 (KB983587), Microsoft .NET Framework 2.0 z dodatkiem Service Pack 2 i Microsoft .NET Framework 3.5 z dodatkiem Service Pack 1 (KB983588 i KB983589)**
...
-   Carstenowi Book z firmy za zgłoszenie luki w zabezpieczeniach programu Microsoft Silverlight związanej z uszkodzeniem pamięci (CVE-2010-0019)  
-   [Eamon Nerbonne](http://eamon.nerbonne.org) za zgłoszenie luki w zabezpieczeniach związanej z wyznaczaniem metody wirtualnej w programie Microsoft Silverlight i Microsoft .NET Framework CLR (CVE-2010-1898)
...
-   Wer. 1.1 (11 sierpnia 2010 r.): Dodano łącze do artykułu 2265906 bazy wiedzy Microsoft Knowledge Base w części „Znane problemy” sekcji „Streszczenie”. Poprawiono także wpisy dotyczące programu Microsoft Silverlight w tabeli „Programy, których nie dotyczy problem” oraz obejść luki w zabezpieczeniach programu Microsoft Silverlight związanej z uszkodzeniem pamięci - CVE-2010-0019.  
-   Wersja 1.2 (29 września 2010 r.): Dodano wartość "Compatibility Flags" do obejścia „Tymczasowe zapobieganie uruchamianiu formantu ActiveX programu Microsoft Silverlight w programie Internet Explorer (Metoda 1)”.
