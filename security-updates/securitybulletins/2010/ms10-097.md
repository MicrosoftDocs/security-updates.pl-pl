---
TOCTitle: 'MS10-097'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-097 - Ważna'
ms:assetid: 'ms10-097'
ms:contentKeyID: 61232890
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-097(v=Security.10)'
---


Biuletyn zabezpieczeń firmy Microsoft MS10-097 - Ważna
======================================================

Luka w zabezpieczeniach związana z niebezpiecznym ładowaniem bibliotek w Kreatorze rejestrowania połączenia internetowego może umożliwić zdalne wykonanie kodu (2443105)
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=fa9a1aac-b9c5-4d4e-9083-a080ad4ccc6f)                                 | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6dabc306-c858-46b1-815c-cd8d011ff62e)        | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8fa2cfa4-a01d-4910-b69f-736aeb585bab)                        | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=17b0b340-73b2-42a7-9d86-1297c63dcc2b)            | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=04a178cc-1afd-4e47-8cab-05e402e5a568) | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z niebezpiecznym ładowaniem bibliotek przez Kreatora rejestrowania połączenia internetowego — CVE-2010-3144</th>
...
Luka w zabezpieczeniach związana z niebezpiecznym ładowaniem bibliotek przez Kreatora rejestrowania połączenia internetowego — CVE-2010-3144  
--------------------------------------------------------------------------------------------------------------------------------------------

W Kreatorze rejestrowania połączenia internetowego, który stanowi składnik systemu Microsoft Windows, występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, wynikająca ze sposobu ładowania plików DLL. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3144](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144).
  
#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek przez Kreatora rejestrowania połączenia internetowego — CVE-2010-3144
...
#### Obejścia problemu dotyczącego luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek przez Kreatora rejestrowania połączenia internetowego — CVE-2010-3144
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek przez Kreatora rejestrowania połączenia internetowego — CVE-2010-3144
...
Luka powstaje, ponieważ Kreator rejestrowania połączenia internetowego nieprawidłowo ogranicza ścieżkę używaną do ładowania bibliotek zewnętrznych.
  
**Co to jest Kreator rejestrowania połączenia internetowego?**  
Kreator rejestrowania połączenia internetowego umożliwia użytkownikom skonfigurowanie połączenia na nowym komputerze lub użycie istniejącego konta usługi internetowej z poprzedniego komputera. Kreator zapewnia także pomoc użytkownikom, których ustawienia internetowe uległy uszkodzeniu. Funkcja automatycznej konfiguracji przywraca ustawienia, a użytkownik musi tylko podać identyfikator użytkownika, hasło i nazwę serwera punktu obecności (POP).
...
Osoba atakująca mogłaby nakłonić użytkownika do otwarcia prawidłowego pliku .ins lub .isp znajdującego się w tym samym katalogu sieciowym, co specjalnie spreparowany plik biblioteki dołączanej dynamicznie (biblioteki DLL). Podczas otwierania tego pliku Kreator rejestrowania połączenia internetowego podejmie próbę załadowania pliku DLL i wykonania zawartego w nim kodu.
  
Osoba atakująca za pośrednictwem poczty e-mail może wykorzystać tę lukę, wysyłając do użytkownika prawidłowy załącznik .ins lub .isp, a następnie przekonując użytkownika do umieszczenia załącznika w katalogu zawierającym specjalnie spreparowany plik DLL oraz do otwarcia pliku .ins lub .isp. Podczas otwierania pliku .ins lub .isp Kreator rejestrowania połączenia internetowego podejmie próbę załadowania pliku DLL i wykonania zawartego w nim kodu.
  
Osoba atakująca za pośrednictwem sieci może umieścić prawidłowy plik .ins lub .isp wraz ze specjalnie spreparowanym plikiem DLL w lokalizacji UNC lub WebDAV, a następnie przekonać użytkownika do otwarcia prawidłowego pliku. Osoba atakująca może także udostępnić witrynę sieci Web i stworzyć odwołanie do prawidłowego pliku w tej witrynie, powodując wyzwolenie luki przez przeglądarkę sieci Web.
...
Ta aktualizacja usuwa lukę, modyfikując sposób, w jaki Kreator rejestrowania połączenia internetowego ładuje biblioteki zewnętrzne.
  
**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**      
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-3144](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3144).
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2443105$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2443105">artykuł 2443105 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Muhaimin Dzulfakar z firmy [NGS Software](http://www.ngssoftware.com/) za zgłoszenie luki w zabezpieczeniach związanej z niebezpiecznym ładowaniem bibliotek przez Kreatora rejestrowania połączenia internetowego (CVE-2010-3144)
