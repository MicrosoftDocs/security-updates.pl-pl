---
TOCTitle: 'MS10-074'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-074 - Umiarkowana'
ms:assetid: 'ms10-074'
ms:contentKeyID: 61232867
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-074(v=Security.10)'
---


Biuletyn zabezpieczeń firmy Microsoft MS10-074 - Umiarkowana
============================================================

Luka w zabezpieczeniach biblioteki Microsoft Foundation Classes może pozwalać na zdalne wykonanie kodu (2387149)
----------------------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „umiarkowany” dla wszystkich obsługiwanych wersji systemu Microsoft Windows. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem, i programy, których nie dotyczy problem** niniejszej sekcji.

Niniejsza aktualizacja zabezpieczeń usuwa lukę, wprowadzając dodatkowe procedury kontrolne dotyczące żądań zmian tytułów okien. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=22f46b3b-9be6-45ea-a639-9974324ce4bd)                                                                                                    | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=285627b9-242d-4247-a4c8-55dc89386b62)                                                                           | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d220f04e-9dbb-4b6d-924a-23065b48b8b6)                                                                                           | Zdalne wykonanie kodu              | Umiarkowany                | [MS07-012](http://go.microsoft.com/fwlink/?linkid=78446) |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=de908137-33e0-4f23-b32b-cc1bdbcb349c)                                                                               | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=873dea9d-44cc-4e16-8a6d-dca678ce3a80)                                                                    | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=75ca4e2c-b0ae-46f4-a0fc-616510c41a55)                                                      | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0a12ff95-ea5c-4c48-96c5-9494eb8f9f0d)                              | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=952b3594-d980-45b1-8fa3-49403784afbf)\*\*               | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=21128031-d935-4e2d-b001-c502a2d6022c)\*\*     | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=2eca0c38-73f5-4f83-ab62-97f979716a1d) | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows 7 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=f09fbc23-cb6b-4525-8e41-8c14e8d03de9)                                                                                                       | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows 7 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=abc24826-b83a-4e01-be68-8e3a73c10494)                                                                                                  | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=e4d27aa6-9739-4e41-9536-5f0b8d26503c)\*\*                                                                      | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c1634278-5598-45e0-81c6-f18fb5ba54cf)                                                                      | Zdalne wykonanie kodu              | Umiarkowany                | Brak                                                     |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach biblioteki MFC systemu Windows związana z przepełnieniem buforu aktualizacji tytułu dokumentu – CVE-2010-3227</th>
...
Luka w zabezpieczeniach biblioteki MFC systemu Windows związana z przepełnieniem buforu aktualizacji tytułu dokumentu – CVE-2010-3227  
-------------------------------------------------------------------------------------------------------------------------------------

W procedurze zarządzania tytułami okien przez aplikacje napisane przy użyciu biblioteki Microsoft Foundation Class (MFC) istnieje luka umożliwiająca zdalne wykonanie kodu. Mimo, że luka ta znajduje się w bibliotece MFC i jest obecna w zagrożonych systemach operacyjnych, do jej wykorzystania może dojść tylko w sytuacji, gdy zdalna osoba atakująca może wpłynąć na tytuł dowolnego okna w aplikacji MFC. Osoba atakująca, która wykorzystałaby tę lukę, mogłaby wykonać dowolny kod w kontekście zabezpieczeń bieżącego użytkownika.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-3227](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3227).
  
#### Czynniki ograniczające zagrożenie powodowane przez lukę w zabezpieczeniach biblioteki MFC systemu Windows związaną z przepełnieniem buforu aktualizacji tytułu dokumentu – CVE-2010-3227
  
Firma Microsoft nie znalazła dla tej luki żadnych czynników ograniczających zagrożenie.
  
#### Obejścia problemu powodowanego przez lukę w zabezpieczeniach biblioteki MFC systemu Windows związaną z przepełnieniem buforu aktualizacji tytułu dokumentu – CVE-2010-3227
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach biblioteki MFC systemu Windows związanej z przepełnieniem buforu aktualizacji tytułu dokumentu – CVE-2010-3227
  
**Jaki zakres obejmuje luka?**    
Jest to luka umożliwiająca zdalne wykonanie kodu w kontekście zabezpieczeń aktualnie zalogowanego użytkownika.
  
**Skąd bierze się luka?**    
Przyczyną występowania tej luki jest sposób, w jaki biblioteka MFC obsługuje żądania aplikacji dotyczące zmiany nazwy tytułu okna.
...
Tak, aktualizacja będzie oferowana dla wszystkich systemów, w których działa oprogramowanie wymienione w sekcji Programy, których dotyczy problem. Jeśli w systemie aktualnie brak zainstalowanych aplikacji MFC, firma Microsoft zaleca użytkownikom zainstalowanie tej aplikacji, aby dodatkowo wzmocnić ochronę komputera w przypadku ataku z nowego kierunku lub kierunku, który jest obecnie nieznany.
...
**Czy firma Microsoft posiada informacje o aplikacjach MFC innych firm, które mogą posłużyć do przeprowadzenia ataku?**    
...
-   Aplikacja ustawia tytuły okien na podstawie informacji, które może kontrolować zdalny użytkownik
  
**Uwaga** Firma Microsoft zaleca, by aplikacje MFC dynamicznie dołączały wersje biblioteki MFC dostarczane wraz z systemem Windows. Jeśli aplikacja użytkownika jest dostarczana wraz z wersją MFC zawierającą lukę i dołącza ją statycznie, zdecydowanie zaleca się użytkownikom zaktualizowanie aplikacji, by dynamicznie dołączała wersję biblioteki MFC dostarczaną wraz z systemem Windows.
  
**Jakie mogą być skutki wykorzystania luki przez osobę atakującą?**       
Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak zalogowany użytkownik. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca może uzyskać pełną kontrolę nad systemem podlegającym luce. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**       
Aby można było pomyślnie wykorzystać tę lukę, w systemie docelowym musiałaby być zainstalowana aplikacja MFC, która mogłaby posłużyć jako droga ataku. Aplikacje MFC, które mogłyby posłużyć jako droga ataku, musiałyby zapewnić zdalnemu użytkownikowi możliwość wpływania na tytuły okien w aplikacji MFC. Jako przykłady można podać zmianę tytułu okna na podstawie zawartości pliku otwartego w aplikacji MFC lub zmianę tytułu okna na podstawie danych z sieci, na przykład z aplikacji do rozmów przez Internet lub przeglądarki internetowej. Osoba atakująca, w zależności od kierunku ataku, mogłaby być zmuszona do nakłonienia użytkownika do otwarcia specjalnie spreparowanego pliku przy użyciu określonej aplikacji MFC zainstalowanej w systemie użytkownika, a następnie mogłaby musieć wykonać określone działania. W przypadku ataku z innego kierunku, na przykład poprzez aplikację do rozmów, osobie atakującej mogłaby wystarczyć zmiana nazwy pokoju rozmów lub użycie specjalnie spreparowanego uchwytu podczas kontaktowania się z użytkownikiem.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**       
Szczególnie narażone są stacje robocze i serwery terminalowe, jeśli są na nich zainstalowane aplikacje MFC pozwalające zdalnemu użytkownikowi wpływać na tytuły okien w aplikacji MFC. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie takich aplikacji MFC. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.
  
**W jaki sposób działa aktualizacja?**       
Niniejsza aktualizacja usuwa lukę, wprowadzając dodatkowe procedury kontrolne dotyczące żądań zmian tytułów okien.
  
**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**    
Tak. Informacje o tej luce są znane publicznie. Do luki został przypisany numer w bazie danych znanych luk i zagrożeń [CVE-2010-3227](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3227).
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2387149$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2387149">artykuł 2387149 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Carsten H. Eiram z firmy [Secunia](http://secunia.com), za współpracę z firmą Microsoft przy usuwaniu luki w zabezpieczeniach biblioteki MFC systemu Windows związanej z przepełnieniem buforu aktualizacji tytułu dokumentu (CVE-2010-3227)
