---
TOCTitle: 'MS10-015'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-015 - Ważna'
ms:assetid: 'ms10-015'
ms:contentKeyID: 61232808
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-015(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-015 - Ważna
======================================================

Luki w zabezpieczeniach jądra systemu Windows umożliwiają podniesienie poziomu uprawnień (977165)
-------------------------------------------------------------------------------------------------

Opublikowano: 9 lutego 2010 | Zaktualizowano: 17 marca 2010
...
**Znane problemy.**[W artykule 977165 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/977165) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 z dodatkiem Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=ed8ac6a5-c8bb-4ed4-8994-810e9a1863c3)                                                                                        | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows XP z dodatkiem Service Pack 2 i Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e2b348f5-ec8d-4782-bb03-5de550adea77)                                                            | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e534d00c-6ddc-4eb3-9464-5db6e90afa3e)                                                                           | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=defd8603-ed9b-42f9-a539-2b6a690e9575)                                                                                           | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9873c962-9d3d-46ef-b54b-2a50696fb6b2)                                                                               | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c3c21225-8534-4c7f-96b6-20a743dcea74)                                                                    | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Vista, Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2761c7b4-d472-4f00-949b-af3ebafdc08d)                                       | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Vista x64 Edition, Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=38b40dab-6b4d-434b-9997-12ef70d6bbcc)   | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych\*](http://www.microsoft.com/downloads/details.aspx?familyid=21e87558-9bd2-4aa9-aaa5-7fd26a5b60e6)                 | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64\*](http://www.microsoft.com/downloads/details.aspx?familyid=0b93047d-f2c6-403b-9200-c251898bc1e0)       | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cd6b234b-8e96-4128-a77a-645a0882996a) | Podniesienie uprawnień             | Ważny                      | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows 7 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=66f14bb4-40fc-4ae3-9baf-429b7106cd91)                                                                                                       | Podniesienie uprawnień             | Ważny                      | Brak                                                      |
...
<span></span>
**Dlaczego niniejszy biuletyn zabezpieczeń został poprawiony w dniu 2 marca 2010 r.?**
Firma Microsoft uzupełniła niniejszy biuletyn o informację dotyczącą udostępnienia w witrynie Windows Update poprawionych pakietów dla aktualizacji MS10-015. Poprawka ta wynika ze zmiany sposobu instalacji pakietu, która zapobiega instalacji aktualizacji zabezpieczeń, jeśli w systemie występują określone nietypowe warunki. Takie nietypowe warunki w systemie mogą być efektem zainfekowania wirusem komputerowym, który zmodyfikował niektóre pliki systemu operacyjnego, co powoduje, że zainfekowany komputer jest niezgodny z aktualizacją MS10-015. W niektórych przypadkach zainstalowanie aktualizacji zabezpieczeń MS10-015 na zainfekowanym komputerze może spowodować ciągłe restartowanie komputera. Aby uzyskać więcej informacji związanych z tym problemem, odwiedź następującą [stronę sieci Web](http://www.microsoft.com/security/updates/015). Jest to wyłącznie zmiana sposobu instalacji pakietów aktualizacji rozprowadzanych za pośrednictwem witryny Windows Update; nie dokonano żadnych zmian w plikach binarnych aktualizacji zabezpieczeń ani w sposobie wykrywania wykorzystywanym przez witrynę Windows Update. Aktualizacje dostępne w Centrum pobierania firmy Microsoft nie zmieniły się i nie wykorzystują nowego sposobu instalacji pakietów. Klienci, którym udało się zaktualizować swoje systemy, włącznie z klientami z włączoną funkcję automatycznych aktualizacji, nie muszą podejmować żadnej czynności. Klienci, którzy mają włączony mechanizm aktualizacji automatycznych, a nie zainstalowali wcześniej tej aktualizacji, powinni jak najszybciej ją zastosować.
...
Tak, pakiet aktualizacji dla wszystkich platform Windows, których dotyczy problem (KB977165) obejmuje zmiany w jądrze systemu Windows opisane w [artykule 977165 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/977165).
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach jądra systemu Windows związana z procedurą obsługi wyjątków - CVE-2010-0232</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach jądra systemu Windows związana z podwójnym zwolnieniem - CVE-2010-0233</th>
...
Luka w zabezpieczeniach jądra systemu Windows związana z procedurą obsługi wyjątków - CVE-2010-0232  
---------------------------------------------------------------------------------------------------
  
<span></span>
W jądrze systemu Windows występuje luka w zabezpieczeniach umożliwiająca podniesienie uprawnień wynikająca ze sposobu, w jaki jądro obsługuje określone wyjątki. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod w trybie jądra. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach jądra systemu Windows związanej z procedurą obsługi wyjątków - CVE-2010-0232
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Omawiana luka nie dotyczy 64-bitowych systemów operacyjnych Microsoft Windows.  
...
#### Obejścia dotyczące luki w zabezpieczeniach jądra systemu Windows związanej z procedurą obsługi wyjątków - CVE-2010-0232
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   Wyłączanie podsystemu NTVDM
  
    **Uwaga** Zobacz [artykuł 979682 w bazie wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/979682), aby uzyskać informacje dotyczące sposobów automatycznego zastosowania tego obejścia.
    ...
    1.  Kliknij przycisk **Start**, kliknij polecenie **Uruchom**, wpisz polecenie **gpedit.msc** w polu **Otwórz**, a następnie kliknij przycisk **OK.**  
        Zostanie otwarta konsola Zasady grupowe.  
    2.  Rozwiń folder **Szablony administracyjne** i kliknij opcję **Składniki systemu Windows**.  
    3.  Kliknij folder **Zgodność aplikacji**.  
    4.  W okienku szczegółów kliknij dwa razy ustawienie zasad **Zapobiegaj dostępowi do aplikacji 16-bitowych**. W domyślnej konfiguracji ustawienie to jest skonfigurowane jako **Nieskonfigurowane**.  
    5.  Zmień ustawienie na **Włączone** i kliknij przycisk **OK**.
  
    **Wpływ obejścia.** Użytkownicy nie będą mogli uruchamiać aplikacji 16-bitowych.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach jądra systemu Windows związanej z procedurą obsługi wyjątków - CVE-2010-0232
...
**Czym jest podsystem wirtualnej maszyny DOS (NTVDM)?**  
Podsystem maszyny wirtualnej maszyny DOS (NTVDM) to podsystem środowiska chronionego, który emuluje środowisko systemu MS-DOS i 16-bitowe środowisko Windows w środowisku systemu operacyjnego Windows NT. VDM tworzona jest zawsze, gdy użytkownik uruchamia aplikację MS-DOS w systemie opartym na Windows NT.
...
Aktualizacja usuwa luki, zapewniając prawidłową obsługę wyjątków przez jądro systemu Windows.
  
**Czy luka ta była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**  
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2010-0232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232). Problem ten został po raz pierwszy omówiony w [poradniku zabezpieczeń firmy Microsoft 979682](http://technet.microsoft.com/security/advisory/979682).
...
Luka w zabezpieczeniach jądra systemu Windows związana z podwójnym zwolnieniem - CVE-2010-0233  
----------------------------------------------------------------------------------------------
  
<span></span>
W jądrze systemu Windows występuje luka w zabezpieczeniach umożliwiająca podniesienie uprawnień wynikająca z sytuacji „podwójnego zwolnienia”. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod w trybie jądra. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0233](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0233).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach jądra systemu Windows związanej z podwójnym zwolnieniem - CVE-2010-0233
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Osoba atakująca musi dysponować prawidłowymi poświadczeniami logowania oraz być w stanie zalogować się lokalnie, aby wykorzystać możliwości stwarzane przez lukę. Nie jest możliwe wykorzystanie luki w sposób zdalny lub przez użytkowników anonimowych.
  
#### Obejścia dotyczące luki w zabezpieczeniach jądra systemu Windows związanej z podwójnym zwolnieniem - CVE-2010-0233
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach jądra systemu Windows związanej z podwójnym zwolnieniem - CVE-2010-0233
  
**Jaki zakres obejmuje ta luka?**  
Jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, mogłaby wykonać dowolny kod i uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
**W jaki sposób powstaje luka?**  
Podczas zwalniania pamięci jądro systemu Windows nie zeruje prawidłowo wskaźnika. Powoduje to wystąpienie w jądrze systemu Windows sytuacji podwójnego zwolnienia.
...
**W jaki sposób działa aktualizacja?**  
Aktualizacja usuwa luki, zapewniając prawidłowe zerowanie wskaźników przez jądro systemu Windows podczas zwalniania pamięci.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB977165$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/977165">artykuł 977165 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">W przypadku pakietu opublikowanego 9 lutego 2010 r.:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows 2000\SP5\KB977165\Filelist<br />
W przypadku poprawionego pakietu opublikowanego 2 marca 2010 r.:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania</strong></td>
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w %Windir%\$NTUninstallKB977165 $\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/977165">artykuł 977165 bazy wiedzy Microsoft Knowledge Base</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Wszystkie obsługiwane 32-bitowe wersje systemu Windows XP, korzystające z pakietu opublikowanego 9 lutego 2010 r.:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB977165\Filelist<br />
Wszystkie obsługiwane 32-bitowe wersje systemu Windows XP, korzystające z poprawionego pakietu opublikowanego 2 marca 2010 r.:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Wszystkie obsługiwane 32-bitowe wersje systemu Windows Server 2003, korzystające z pakietu opublikowanego 9 lutego 2010 r.:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB977165\Filelist<br />
Wszystkie obsługiwane 32-bitowe wersje systemu Windows Server 2003, korzystające z pakietu opublikowanego 2 marca 2010 r.:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB977165-v2\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Wszystkie obsługiwane 64-bitowe wersje systemu Windows Server 2003 i wersje Windows Server 2003 dla systemów z procesorem Itanium, korzystające z pakietu opublikowanego 9 lutego 2010 r.:<br />
...
-   Tavis Ormandy z firmy [Google Inc.](http://www.google.com/), za zgłoszenie luki w zabezpieczeniach jądra systemu Windows związanej z podwójnym zwolnieniem (CVE-2010-0233)
...
-   Wer. 1.2 (2 marca 2010 r.): Dodano wpis do sekcji „**Często zadawane pytania (FAQ) dotyczące tej aktualizacji zabezpieczeń**”, aby poinformować o udostępnieniu poprawionych pakietów w Windows Update. Klienci, którym udało się zaktualizować swoje systemy, nie muszą podejmować żadnej czynności.  
-   Wersja 1.3 (17 marca 2010 r.): Dodano weryfikacyjne klucze rejestru odnoszące się do poprawionych pakietów opublikowanych 2 marca 2010 r., dla systemów Microsoft Windows 2000, Windows XP i Windows Server 2003. Jest to wyłącznie zmiana informacyjna.
