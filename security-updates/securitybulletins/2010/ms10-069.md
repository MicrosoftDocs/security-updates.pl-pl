---
TOCTitle: 'MS10-069'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-069 - Ważna'
ms:assetid: 'ms10-069'
ms:contentKeyID: 61232862
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-069(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS10-069 - Ważna
======================================================

Luka w zabezpieczeniach Podsystemu wykonawczego serwera klienta w systemie Windows może pozwolić na podniesienie poziomu uprawnień (2121546)
--------------------------------------------------------------------------------------------------------------------------------------------
...
Luka ta mogłaby umożliwić podniesienie poziomu uprawnień, jeśli osoba atakująca zalogowałaby się na zagrożony luką system z chińskimi, japońskimi lub koreańskimi ustawieniami regionalnymi. Osoba atakująca, której udałoby się wykorzystać tę lukę, mogłaby wówczas instalować programy, przeglądać, zmieniać lub usuwać dane oraz tworzyć nowe konta z pełnymi prawami użytkownika.

Aktualizacja zabezpieczeń usuwa lukę, poprawiając sposób alokacji pamięci przez Podsystem wykonawczy serwera/klienta (CSRSS) przy obsłudze niektórych transakcji. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
Firma Microsoft zaleca, aby administratorzy, osoby odpowiedzialne za instalacje korporacyjne oraz użytkownicy, którzy chcą zainstalować tę aktualizację zabezpieczeń ręcznie, zainstalowali tę aktualizację przy pierwszej sposobności.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=20091358-7127-4ace-bf96-4319461ad305)                                 | Podniesienie uprawnień             | Ważny                      | Brak                                                     |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=107eb958-b60f-40ae-a785-5d5b4d13d8c6)        | Podniesienie uprawnień             | Ważny                      | [MS07-021](http://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fd46ba66-8ca1-4aa2-b91b-9e5861a173f7)                        | Podniesienie uprawnień             | Ważny                      | [MS07-021](http://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ff5976e0-579c-4e6e-a225-c0d3913cdc85)            | Podniesienie uprawnień             | Ważny                      | [MS07-021](http://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=e450ca08-1d75-4419-ad9f-c5e5efb55cd5) | Podniesienie uprawnień             | Ważny                      | [MS07-021](http://go.microsoft.com/fwlink/?linkid=80251) |
...
**Nie korzystam z chińskiej, japońskiej ani koreańskiej wersji językowej systemu Windows. Czy niniejszy biuletyn zabezpieczeń mnie dotyczy?**  
Wszystkie wersje językowe zagrożonych systemów operacyjnych zawierają lukę w zabezpieczeniach, której dotyczy niniejszy biuletyn. Luki tej nie można jednak wykorzystać, jeśli system nie ma chińskich, japońskich lub koreańskich ustawień regionalnych.
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień – CVE-2010-1891</th>
...
Luka w zabezpieczeniach podsystemu CSRSS umożliwiająca lokalne podniesienie poziomu uprawnień – CVE-2010-1891  
-------------------------------------------------------------------------------------------------------------

W Podsystemie wykonawczym serwera/klienta (CSRSS) systemu Windows istnieje luka umożliwiająca podniesienie uprawnień wynikająca ze sposobu, w jaki podsystem CSRSS przypisuje pamięć dla określonych transakcji użytkownika. Osoba atakująca, która wykorzystałaby tę lukę, mogłaby wykonać dowolny kod w kontekście zabezpieczeń systemu lokalnego. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-1891](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1891).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień – CVE-2010-1891
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Zagrożone są tylko systemy z chińskimi, japońskimi lub koreańskimi ustawieniami regionalnymi.  
-   Osoba atakująca musi dysponować prawidłowymi poświadczeniami logowania oraz być w stanie zalogować się lokalnie lub zdalnie, aby wykorzystać możliwości stwarzane przez lukę.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach podsystemu CSRSS umożliwiającą lokalne podniesienie poziomu uprawnień – CVE-2010-1891
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień – CVE-2010-1891
...
Podsystem wykonawczy serwera/klienta (CSRSS) systemu Windows nie zawsze alokuje wystarczający obszar pamięci przy obsłudze określonych transakcji użytkownika w systemach Windows z chińskimi, japońskimi lub koreańskimi ustawieniami regionalnymi.
  
**Co to jest Podsystem wykonawczy serwera/klienta (CSRSS) systemu Windows?**      
Podsystem wykonawczy serwera/klienta (CSRSS) jest częścią podsystemu Win32 związaną z trybem użytkownika (podczas gdy Win32.sys jest częścią związaną z trybem jądra). CSRSS to skrót od „Client/Server Runtime Subsystem”; jest to podstawowy podsystem, który musi być zawsze uruchomiony. Podsystem CSRSS odpowiada za okna konsoli i tworzenie i/lub usuwanie wątków.
...
2.  W oknie **Opcje regionalne i językowe** kliknij kartę **Zaawansowane**.  
3.  W sekcji **Język dla programów nie obsługujących kodu Unicode** wybierz ustawienia regionalne systemu.
...
Aktualizacja usuwa lukę, poprawiając sposób alokacji pamięci przez podsystem CSRSS przy obsłudze niektórych transakcji.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2121546$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2121546">artykuł 2121546 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   [IBM Japan](http://www.ibm.com/jp/ja/) za zgłoszenie luki w zabezpieczeniach podsystemu CSRSS umożliwiającej lokalne podniesienie poziomu uprawnień – CVE-2010-1891
