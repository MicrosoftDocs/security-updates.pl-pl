---
TOCTitle: 'MS10-076'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-076 - Krytyczna'
ms:assetid: 'ms10-076'
ms:contentKeyID: 61232869
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-076(v=Security.10)'
---


Biuletyn zabezpieczeń firmy Microsoft MS10-076 - Krytyczna
==========================================================

Luka w zabezpieczeniach aparatu osadzonych czcionek OpenType umożliwia zdalne wykonanie kodu (982132)
-----------------------------------------------------------------------------------------------------
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=c3799399-ca72-4dec-a2a2-3571ad0b2f63)                                                                                                    | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=860ff738-205d-430e-b223-b333813fc590)                                                                           | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7b240b65-f3ca-465c-a606-b561999c1977)                                                                                           | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=70c9e826-b80b-4a20-82d2-8e52e5cca839)                                                                               | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=bd5878bb-f565-4303-afed-4e17b44a02f2)                                                                    | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=29c4afb1-227d-4572-b136-a78ef7e1df77)                                                      | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=880ad9a0-6ddd-41f4-a608-171d59a31b6a)                              | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=50386655-982e-4126-8261-2c972d695bbd)\*\*               | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=a6b2ae1d-9225-4495-8560-97860f87d7b4)\*\*     | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=a4e38a77-3835-47b3-bd86-6c039169abf5) | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows 7 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=f6cae091-e9f1-48e9-a035-4346b9c6fec6)                                                                                                       | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows 7 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=35882477-4e0a-4783-a4b4-0f1ea3398360)                                                                                                  | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=b060c516-233a-4e1e-9237-698420e97b2f)\*\*                                                                      | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=0ead2ed9-8b2f-496e-b7d1-3ad2b04be5cc)                                                                      | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z przepełnieniem liczby całkowitej osadzonych czcionek OpenType – CVE-2010-1883</th>
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z przepełnieniem liczby całkowitej osadzonych czcionek OpenType – CVE-2010-1883
...
-   **Wyłączenie obsługi analizowania osadzonych czcionek w programie Internet Explorer**
    ...
    **Stosowanie metody interakcyjnej:**
    ...
    1.  W menu programu Internet Explorer kliknij pozycję **Narzędzia**, a następnie **Opcje internetowe**.  
    2.  W oknie **Opcje internetowe** kliknij zakładkę **Zabezpieczenia**, wybierz strefę **Internet**, a następnie kliknij przycisk **Poziom niestandardowy…**  
    3.  W oknie **Ustawienia zabezpieczeń – Strefa internetowa** przewiń do pozycji **Pobieranie** na panelu **Ustawienia**, a następnie wybierz dla ustawienia **Pobieranie czcionek** wartość **Monituj** lub **Wyłącz**.  
    4.  Kliknij przycisk **OK**, aby zapisać zmienione ustawienia, a następnie ponownie kliknij przycisk **OK**, aby powrócić do okna programu Internet Explorer.
  
    **Korzystanie z zasad grupy:**
  
    **Uwaga** Za pomocą przystawki Zasady grupy konsoli MMC można utworzyć zasady dla systemu, jednostki organizacyjnej lub całej domeny. Więcej informacji na temat zasad grupy można znaleźć w następujących witrynach sieci Web firmy Microsoft:
    ...
    Aby korzystać z zasad grupy, wykonaj następujące czynności:
    ...
    2.  Kliknij kolejno opcje **Konfiguracja użytkownika**, **Ustawienia systemu Windows**, **Konserwacja programu Internet Explorer** oraz **Zabezpieczenia**.  
    3.  Kliknij dwukrotnie opcję **Strefy zabezpieczeń i klasyfikacje zawartości**, wybierz polecenie **Importuj bieżące ustawienia stref zabezpieczeń i prywatności**, a następnie kliknij opcję **Modyfikuj ustawienia**.
  
    **Uwaga** Spowoduje to utworzenie zasad grupy dla programu Internet Explorer na podstawie ustawień aktualnie zalogowanego użytkownika i otwarcie okna Właściwości Internetowe.
  
    1.  W oknie Właściwości Internetu kliknij zakładkę **Zabezpieczenia**, upewnij się, że wybrana jest strefa **Internet**, a następnie kliknij przycisk **Poziom niestandardowy…**  
    2.  W oknie **Ustawienia zabezpieczeń – Strefa internetowa** przewiń do pozycji **Pobieranie** na panelu **Ustawienia**, a następnie wybierz dla ustawienia **Pobieranie czcionek** wartość **Monituj** lub **Wyłącz**.  
    3.  Kliknij przycisk **OK**, aby powrócić do okna **Właściwości Internetowe**.  
    4.  Powtórz kroki 4-6 dla strefy **Lokalny intranet**.  
    5.  Kliknij trzy razy przycisk **OK**, aby wrócić do Konsoli zarządzania zasadami grupy.  
    6.  Odśwież zasady grupy na wszystkich komputerach lub poczekaj na następny zaplanowany interwał odświeżania zasad grupy, aby nowe ustawienia zostały zastosowane.
  
    **Stosowanie skryptu wdrażania zarządzanego:**
  
    To ustawienie zabezpieczeń można ręcznie wprowadzić do rejestru, tworząc skrypt rejestru i importując go poprzez dwukrotne kliknięcie albo uruchomienie programu regedit.exe jako części skryptu logowania lub uruchamiania komputera. W przypadku wdrożeń zarządzanych możliwe jest użycie programu regedit.exe w celu cichego zaimportowania skryptu rejestru za pomocą parametru „-s”. Więcej informacji na temat parametrów wiersza polecenia programu regedit zawiera [artykuł 82821 bazy wiedzy Microsoft Knowledge Base „Parametry wiersza poleceń Edytora rejestru (REGEDIT)”](http://support.microsoft.com/kb/82821).
    ...
    **Ostrzeżenie** Nieprawidłowe korzystanie z Edytora rejestru może spowodować poważne problemy, wymagające ponownego zainstalowania systemu operacyjnego. Firma Microsoft nie gwarantuje możliwości rozwiązania problemów, wynikających z nieprawidłowego użycia edytora rejestru. Zmian w rejestrze można dokonywać wyłącznie na własne ryzyko.
    ...
    Aby zmienić to ustawienie na opcję „Monituj” dla strefy internetowej i strefy lokalnego intranetu, należy wkleić następujący tekst do pliku .REG, a następnie zaimportować plik .REG na zarządzanych systemach jako część procesu wdrażania zarządzanego w organizacji:
    ...
    Aby zmienić to ustawienie na opcję „Wyłącz” dla strefy internetowej i strefy lokalnego intranetu, należy wkleić następujący tekst do pliku .REG, a następnie zaimportować plik .REG na zarządzanych systemach jako część procesu wdrażania zarządzanego w organizacji:
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z przepełnieniem liczby całkowitej osadzonych czcionek OpenType – CVE-2010-1883
...
Przyczyną tej luki w zabezpieczeniach jest przepełnienie liczby całkowitej, występujące, gdy składnik systemu Microsoft Windows – aparat osadzonych czcionek OpenType, analizuje określone tabele w specjalnie spreparowanych plikach i treściach zawierających czcionki osadzone.
  
**Co to są osadzone czcionki OpenType (EOT)?**      
Osadzone czcionki OpenType (EOT) to kompaktowa forma czcionek zaprojektowanych w celu użycia na stronach sieci Web. Czcionki te mogą zostać osadzone w dokumencie. Dzięki temu dokument jest wyświetlany zgodnie z zamierzeniami autora. Narzędzie Web Embedding Fonts Tool (WEFT) umożliwia autorom sieci Web tworzenie obiektów czcionek, które są powiązane z ich stronami sieci Web, dzięki czemu strony są wyświetlane w przeglądarce zgodnie ze stylem zawartym w obiekcie czcionki. Więcej informacji można znaleźć w artykule MSDN [About Font Embedding (j. ang.)](http://msdn.microsoft.com/en-us/library/ms533034.aspx). Wszystkie systemy operacyjne wymienione w tabeli „Programy, których dotyczy problem” domyślnie obsługują renderowanie czcionek EOT.
  
**Jakie mogą być skutki wykorzystania luki przez osobę atakującą?**       
Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka mogłaby wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB982132$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/982132">artykuł 982132 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Sebastian Apelt wraz z organizacjami [Tipping Point's](http://www.tippingpoint.com)[Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach związanej z przepełnieniem liczby całkowitej osadzonych czcionek OpenType (CVE-2010-1883)  
-   Ivan Fratric za zgłoszenie za pośrednictwem organizacji [iSIGHT Partners Global Vulnerability Partnership](https://gvp.isightpartners.com), luki w zabezpieczeniach związanej z przepełnieniem liczby całkowitej osadzonych czcionek OpenType (CVE-2010-1883)
