---
TOCTitle: 'MS10-047'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-047 - Ważna'
ms:assetid: 'ms10-047'
ms:contentKeyID: 61232840
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-047(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS10-047 - Ważna
======================================================

Luki w zabezpieczeniach jądra systemu Windows umożliwiają podniesienie uprawnień (981852)
-----------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla systemów Windows XP, Windows Vista i Windows Server 2008 oraz wskaźnik ważności „umiarkowany” dla systemów Windows 7 i Windows Server 2008 R2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa luki, modyfikując inicjację obiektów jądra systemu Windows i sprawdzanie poprawności list kontroli dostępu oraz wprowadzając dodatkowe sprawdzanie czasu uruchomienia do mechanizmu tworzenia wątków. Więcej informacji na temat luk może znaleźć w podsekcjach „Często zadawane pytania” dla pozycji określonych luk w zabezpieczeniach, znajdujących się poniżej następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e3574047-5ce5-4461-94aa-4eb3258d5e71)                                                                                                    | Podniesienie uprawnień             | Ważny                      | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4486f97c-4cf8-4236-bfc3-b50e72e2a5c1)                                                      | Podniesienie uprawnień             | Ważny                      | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b547898e-f8a9-49dc-b49d-cffec5a001bc)                              | Podniesienie uprawnień             | Ważny                      | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=611765ab-b3f3-45db-92b2-ee040b9cfd27)\*                 | Podniesienie uprawnień             | Ważny                      | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=131f3512-1585-462e-a4f1-3f359aac44bd)\*       | Podniesienie uprawnień             | Ważny                      | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=972efd3a-ec1e-49b2-835e-76f4b21b5b79) | Podniesienie uprawnień             | Ważny                      | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows 7 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=a7d60864-5942-47ed-a6f3-1c07b4833a14)                                                                                                       | Odmowa usługi                      | Umiarkowany                | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows 7 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=b00ec47c-402e-4207-a4c9-6c1900f254f8)                                                                                                  | Odmowa usługi                      | Umiarkowany                | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=c1ad1248-07f1-42d4-baa4-8a20837ec7b4)\*                                                                        | Odmowa usługi                      | Umiarkowany                | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=f23dec0f-a33b-4d8c-a86d-0e9368ae7ff5)                                                                      | Odmowa usługi                      | Umiarkowany                | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach jądra systemu Windows związana z inicjacją danych – CVE-2010-1888</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach jądra systemu Windows związana z podwójnym zwolnieniem – CVE-2010-1889</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach jądra systemu Windows związana z nieprawidłowym sprawdzaniem poprawności – CVE-2010-1890</th>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2 dla systemów opartych na procesorach Itanium[1]</td>
<td style="border:1px solid black;">Nie dotyczy</td>
<td style="border:1px solid black;">Nie dotyczy</td>
<td style="border:1px solid black;"><strong>Umiarkowany</strong> <br />
Odmowa usługi</td>
...
Luka w zabezpieczeniach jądra systemu Windows związana z inicjacją danych – CVE-2010-1888  
-----------------------------------------------------------------------------------------
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-1888](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach jądra systemu Windows związanej z inicjacją danych – CVE-2010-1888
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach jądra systemu Windows związaną z inicjacją danych – CVE-2010-1888
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach jądra systemu Windows związanej z inicjacją danych – CVE-2010-1888
...
Przyczyną tej luki w zabezpieczeniach jest sytuacja wyścigu występująca podczas tworzenia określonych typów wątków.
...
Luka w zabezpieczeniach jądra systemu Windows związana z podwójnym zwolnieniem – CVE-2010-1889  
----------------------------------------------------------------------------------------------

W jądrze systemu Windows występuje luka w zabezpieczeniach umożliwiająca podniesienie uprawnień wynikająca ze sposobu, w jaki jądro inicjuje obiekty podczas obsługi pewnych błędów. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod w trybie jądra. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-1889](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach jądra systemu Windows związanej z podwójnym zwolnieniem – CVE-2010-1889
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Osoba atakująca musi dysponować prawidłowymi poświadczeniami logowania oraz być w stanie zalogować się lokalnie, aby wykorzystać możliwości stwarzane przez lukę. Nie jest możliwe wykorzystanie luki w sposób zdalny lub przez użytkowników anonimowych.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach jądra systemu Windows związaną z podwójnym zwolnieniem – CVE-2010-1889
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach jądra systemu Windows związanej z podwójnym zwolnieniem – CVE-2010-1889
  
**Jaki zakres obejmuje luka?**      
Jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, mogłaby wykonać dowolny kod i uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
**Skąd bierze się luka?**      
Jądro systemu Windows nieprawidłowo inicjuje obiekty podczas obsługi pewnych błędów.
...
**W jaki sposób działa aktualizacja?**       
Aktualizacja usuwa lukę w zabezpieczeniach, poprawiając metodę inicjacji obiektów w jądrze systemu Windows podczas obsługi pewnych błędów.
...
Luka w zabezpieczeniach jądra systemu Windows związana z nieprawidłowym sprawdzaniem poprawności – CVE-2010-1890  
----------------------------------------------------------------------------------------------------------------

W zabezpieczeniach jądra systemu Windows istnieje luka umożliwiająca przeprowadzenie ataku typu „odmowa usługi” związana ze sposobem, w jaki jądro sprawdza poprawność list kontroli dostępu w obiektach jądra. Osoba atakująca może wykorzystać tę lukę, uruchamiając specjalnie spreparowaną aplikację, co spowoduje, że system przestanie reagować i automatycznie uruchomi się ponownie.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach jądra systemu Windows związanej z nieprawidłowym sprawdzaniem poprawności – CVE-2010-1890
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Osoba atakująca musi dysponować prawidłowymi poświadczeniami logowania oraz być w stanie zalogować się lokalnie, aby wykorzystać możliwości stwarzane przez lukę. Nie jest możliwe wykorzystanie luki w sposób zdalny lub przez użytkowników anonimowych.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach jądra systemu Windows związaną z nieprawidłowym sprawdzaniem poprawności – CVE-2010-1890
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach jądra systemu Windows związanej z nieprawidłowym sprawdzaniem poprawności – CVE-2010-1890
...
**Skąd bierze się luka?**      
Jądro systemu Windows nieprawidłowo sprawdza poprawność list kontroli dostępu w obiektach jądra.
...
**W jaki sposób działa aktualizacja?**       
Aktualizacja zabezpieczeń usuwa lukę, zmieniając sposób, w jaki jądro systemu Windows sprawdza poprawność list kontroli dostępu zastosowanych do obiektów jądra.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB981852$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/981852">artykuł 981852 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Tavis Ormandy z firmy [Google Inc.](http://www.google.com/) za zgłoszenie luki w zabezpieczeniach jądra systemu Windows związanej z inicjacją danych (CVE-2010-0810)  
-   Tavis Ormandy z firmy [Google Inc.](http://www.google.com/), za zgłoszenie luki w zabezpieczeniach jądra systemu Windows związanej z podwójnym zwolnieniem (CVE-2010-1889)  
-   Tavis Ormandy z firmy [Google Inc.](http://www.google.com/) za zgłoszenie luki w zabezpieczeniach jądra systemu Windows związanej z nieprawidłowym sprawdzaniem poprawności (CVE-2010-0810)
