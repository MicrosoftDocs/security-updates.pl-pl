...
-   **Wyłączenie modułu DLL konwertera programu Publisher**
    ...
    **32-bitowe wersje systemu Windows** **Vista, Windows Server 2008 i Windows 7:**
    ...
    `takeown /f "c:\program files\Microsoft Office\<wersja_office>\pubconv.dll"icacls "c:\program files\Microsoft Office\<wersja_office>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXTicacls "c:\program files\Microsoft Office\<wersja_office>\pubconv.dll" /deny everyone(F)`
  
    **Uwaga** Zamiast &lt;wersja\_office&gt; wprowadź numer wersji odpowiedniego składnika pakietu Microsoft Office zainstalowanego w systemie, np. „Office10” w przypadku programu Microsoft Publisher 2002, „Office11” w przypadku programu Microsoft Publisher 2003 lub „Office12” w przypadku programu Microsoft Publisher 2007. Aby sprawdzić posiadaną wersję, uruchom dany składnik pakietu Microsoft Office i kliknij polecenie **Pomoc**.
  
    **64-bitowe wersje systemu Windows** **Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2:**
  
    `takeown /f "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\pubconv.dll"icacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\pubconv.dll" /save %TEMP%\PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\pubconv.dll" /deny everyone (F)`
...
-   **Wyłączenie modułu DLL konwertera programu Publisher**
    ...
    **64-bitowe wersje systemu Windows** **Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2:**
    ...
    `takeown /f "<64BIT_PATH_AND_FILENAME>"icacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\pubconv.dll" /save %TEMP%\ PUBCONV_ACL.TXTicacls "%ProgramFiles(86)%\Microsoft Office\<wersja_office>\pubconv.dll" /deny everyone (F)`
