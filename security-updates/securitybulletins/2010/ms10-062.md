---
TOCTitle: 'MS10-062'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-062 - Krytyczna'
ms:assetid: 'ms10-062'
ms:contentKeyID: 61232855
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-062(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS10-062 - Krytyczna
==========================================================

Luka w zabezpieczeniach kodera-dekodera MPEG-4 może pozwolić na zdalne wykonanie kodu (975558)
----------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla wszystkich obsługiwanych wersji systemu Windows XP, Windows Server 2003 (z wyjątkiem wersji dla systemów z procesorem Itanium), Windows Vista i Windows Server 2008 (z wyjątkiem wersji dla systemów z procesorem Itanium). Omawiana luka nie dotyczy wersji systemów Windows Server 2003 i Windows Server 2008 dla systemów z procesorem Itanium oraz wszystkich obsługiwanych wersji systemu Windows 7 i Windows Server 2008 R2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem, i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń eliminuje lukę w zabezpieczeniach poprzez zmianę sposobu, w jaki koder-dekoder MPEG-4 obsługuje specjalnie spreparowaną zawartość multimedialną. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2084a01c-2a91-4650-8665-7053015f2083)                                                                                                | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1)                                                                       | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0a942985-081f-455c-bf9d-4345392c91b0)                                                                                       | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=284a0e80-fd03-4909-b354-0478f04585a1)                                                                           | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=84629c25-7827-40c1-86fb-7ffa247202a0)                                                  | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Vista x64 Edition z dodatkiem Service Pack 1 i Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=36e2a74b-e5c6-47d5-9cd9-b9171be63c7d)                          | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2008 dla systemów 32-bitowych i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=fdfc393e-a54d-44dd-ba45-c2a550ffd2a1)\*\*           | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem x64 i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem x64](http://www.microsoft.com/downloads/details.aspx?familyid=1b7af424-6286-4a80-827c-c4df4f92fe43)\*\* | Zdalne wykonanie kodu              | Krytyczny                  | Brak                                               |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach kodera-dekodera MPEG-4 — CVE-2010-0818</th>
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach kodera-dekodera MPEG-4 — CVE-2010-0818
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Ograniczenie dostępu do kodera-dekodera MPEG-4 w wersji 1**
  
    Aby ograniczyć dostęp do kodera-dekodera MPEG-4 w wersji 1, wykonaj następujące czynności:
    ...
    **Uwaga** Nieprawidłowe korzystanie z Edytora rejestru może być przyczyną poważnych problemów, w wyniku których może być konieczna ponowna instalacja systemu operacyjnego. Firma Microsoft nie może zagwarantować rozwiązania problemów wynikających z nieprawidłowego użycia Edytora Rejestru. Zmian w rejestrze można dokonywać wyłącznie na własne ryzyko. Informacje na temat sposobu modyfikacji rejestru można znaleźć w temacie Pomocy „Zmienianie kluczy i wartości” programu Edytor rejestru (Regedit.exe) lub „Dodawanie i usuwanie informacji w rejestrze” oraz „Edytowanie danych rejestru” w przypadku programu Regedt32.exe.
    ...
    1.  Utwórz kopię zapasową kluczy rejestru, korzystając ze skryptu wdrażania zarządzanego zawierającego następujące polecenia:  
        ...
        **Uwaga** W zależności od zainstalowanej w systemie użytkownika wersji kodera-dekodera MPEG-4 niektóre z powyższych kluczy rejestru mogą nie istnieć. Dla kluczy rejestru, których brak w systemie, nie zostaną utworzone kopie zapasowe.  
    2.  Zapisz następujący tekst w pliku z rozszerzeniem .REG, na przykład Restrict\_MPEG-4\_Workaround.reg:  
    ...
    **Wpływ obejścia **.Pliki zakodowane w formacie kodera-dekodera MPEG-4 w wersji 1 nie będą odtwarzane w aplikacjach takich jak Windows Media Player, które korzystają z kodera-dekodera MPEG-4.
    ...
    **Uwaga** Niektóre z powyższych kopii zapasowych plików rejestru mogą nie istnieć. Nie utworzono plików kopii zapasowych dla kluczy rejestru, które nie istniały w systemie przed wdrożeniem tego obejścia.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach kodera-dekodera MPEG-4 — CVE-2010-0818
...
Należący do koderów-dekoderów programu Windows Media koder-dekoder MPEG-4 nieprawidłowo obsługuje specjalnie spreparowane pliki multimedialne, które wykorzystują kodowanie wideo MPEG-4.
  
**Który z koderów-dekoderów MPEG-4 zawiera niebezpieczny kod?**      
MPEG-4 to specyfikacja organizacji ISO, obejmująca liczne zagadnienia z zakresu prezentacji multimediów — w tym kompresję, tworzenie i dostarczanie. Niebezpieczny kod znajduje się w koderze-dekoderze MPEG-4 służącym do dekodowania wideo w formacie MPEG-4.
...
Koder-dekoder może składać się z dwóch składników: kodera oraz dekodera. Koder odpowiada za kompresję (kodowanie), a dekoder przeprowadza dekompresję (dekodowanie). Część koderów-dekoderów zawiera oba te składniki, a część tylko jeden z nich. Przykładowo podczas przesyłania utworu z płyty CD audio do komputera program Windows Media Player domyślnie wykorzystuje koder-dekoder Windows Media Audio, aby skompresować ten utwór do pliku WMA o niewielkich rozmiarach. Podczas odtwarzania tego pliku WMA (lub dowolnego pliku WMA, który może być przesyłany strumieniowo z witryny sieci Web), odtwarzacz używa kodera-dekodera Windows Media Audio do dekompresji tego pliku, aby można było odtworzyć muzykę przez głośniki.
...
Osoba atakująca za pośrednictwem poczty e-mail może wykorzystać tę lukę, wysyłając do użytkownika plik multimedialny z osadzonym specjalnie spreparowanym plikiem MPEG-4 i nakłaniając go do otwarcia tego pliku.
  
Osoba atakująca może udostępniać złośliwą witrynę sieci Web, w której umieszczona jest specjalnie spreparowana zawartość multimedialna stworzona w celu wykorzystania omawianej luki za pośrednictwem przeglądarki sieci Web. Osoba taka może nakłonić użytkownika do odwiedzenia tej witryny sieci Web i otwarcia specjalnie spreparowanej zawartości multimedialnej.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**       
Na ryzyko narażone są szczególnie systemy, w których uruchomione jest oprogramowanie podlegające luce.
  
**W jaki sposób działa aktualizacja?**       
Ta aktualizacja eliminuje lukę w zabezpieczeniach poprzez zmianę sposobu, w jaki koder-dekoder MPEG-4 obsługuje specjalnie spreparowaną zawartość multimedialną.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB975558$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/975558">artykuł 975558 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Matthew Watchinski z firmy [Sourcefire VRT](http://www.sourcefire.com/services/sf_vrt.html), za zgłoszenie luki w zabezpieczeniach kodera-dekodera MPEG-4 (CVE-2010-0818)
