---
TOCTitle: 'MS10-019'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-019 - Krytyczna'
ms:assetid: 'ms10-019'
ms:contentKeyID: 61232812
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-019(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS10-019 - Krytyczna
==========================================================

Luki w zabezpieczeniach systemu Windows umożliwiają zdalne wykonanie kodu (981210)
----------------------------------------------------------------------------------

Opublikowano: 13 kwietnia 2010 | Zaktualizowano: 21 kwietnia 2010
...
**Znane problemy.** W [artykule 981210 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/981210) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
Firma Microsoft zaktualizowała niniejszy biuletyn zabezpieczeń w celu poinformowania o zmianie w sposobie wykrywania. Poprawiona procedura wykrywania udostępnia aktualizację zabezpieczeń Authenticode Signature Verification dla podlegających luce systemów Windows Server 2008 i Windows Server 2008 R2 zainstalowanych przy użyciu opcji instalacji Server Core, dla których wcześniej ta aktualizacja nie była oferowana. Poprawiona procedura wykrywania rozwiązuje ponadto problem z instalacją na wszystkich platformach, który mógł powodować, że instalacja aktualizacji KB978601 nie udawała się, jeżeli najpierw nie zainstalowano aktualizacji KB979309. Zmiana objęła tylko wykrywanie. Nie wprowadzono żadnych zmian do plików aktualizacji zabezpieczeń w tym biuletynie. Klienci, którzy pomyślnie zainstalowali tę aktualizację, nie będą musieli instalować jej ponownie.

**Czy w moim systemie wymagane jest zainstalowanie obu aktualizacji?**  
Tak, w każdym systemie operacyjnym wymagana jest aktualizacja dla każdego ze składników - Authenticode Signature Verification oraz Rozszerzenie zawartości powłoki plików cabinet. Należy zainstalować obie aktualizacje zgodnie z instrukcjami dla posiadanego systemu operacyjnego.
...
Tak. Oprócz zmian wymienionych w sekcji „Informacje o luce w zabezpieczeniach” tego biuletynu aktualizacja zawiera zmianę wyłączającą podpisy Authenticode w wersji 1 w przenośnych plikach wykonywalnych oraz przeprowadza dodatkową weryfikację w plikach cabinet.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach procedury sprawdzania poprawności podpisu funkcji WinVerifyTrust - CVE-2010-0486
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach procedury sprawdzania poprawności związana z uszkodzeniem składnika Cabview - CVE-2010-0487
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Rozszerzenie zawartości powłoki plików cabinet 5.1
</td>
<td style="border:1px solid black;">
Nie dotyczy
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Rozszerzenie zawartości powłoki plików cabinet 6.0
</td>
<td style="border:1px solid black;">
Nie dotyczy
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Rozszerzenie zawartości powłoki plików cabinet 6.1
</td>
<td style="border:1px solid black;">
Nie dotyczy
</td>
...
W funkcji Windows Authenticode Signature Verification używanej w odniesieniu do przenośnych plików wykonywalnych (PE) i plików cabinet istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu. Anonimowa osoba atakująca może wykorzystać tę lukę, modyfikując istniejący podpisany plik wykonywalny w celu zmanipulowania niezweryfikowanych części podpisu i pliku w taki sposób, aby bez unieważnienia podpisu wprowadzić do pliku złośliwy kod. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0486](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0486).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach procedury sprawdzania poprawności podpisu funkcji WinVerifyTrust - CVE-2010-0486

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

#### Obejścia problemu dotyczącego luki w zabezpieczeniach procedury sprawdzania poprawności podpisu funkcji WinVerifyTrust - CVE-2010-0486

Firma Microsoft nie znalazła żadnego obejścia tej luki.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach procedury sprawdzania poprawności podpisu funkcji WinVerifyTrust - CVE-2010-0486
...
Luka w zabezpieczeniach powstaje, gdy funkcja Windows Authenticode Signature Verification pomija pola podsumowania plików podczas podpisywania i weryfikacji plików PE lub plików cabinet.

**Co to jest funkcja Windows Authenticode Signature Verification?**  
Funkcja Windows Authenticode Signature Verification, lub WinVerifyTrust, wykonuje dla wskazanego obiektu sprawdzenie, czy jest on zaufany. Funkcja ta przekazuje zapytanie do dostawcy zaufania, który obsługuje identyfikator działania (jeśli istnieje). Funkcja WinVerifyTrust wykonuje dwa działania: sprawdzenie podpisu danego obiektu i sprawdzenie zaufania. Więcej informacji można znaleźć w artykule MSDN [Funkcja WinVerifyTrust](http://msdn.microsoft.com/en-us/library/aa388208(vs.85).aspx) (j. ang.).

**Co to jest format podpisu przenośnych plików wykonywalnych Windows Authenticode?**  
Authenticode to format podpisu cyfrowego, który służy do określenia pochodzenia i integralności plików binarnych oprogramowania. W formacie Authenticode używane są dane podpisane zgodnie ze standardami PKCS (Public-Key Cryptography Standards) \#7 oraz certyfikaty X.509, które wiążą plik binarny podpisany przy użyciu formatu Authenticode z tożsamością wydawcy oprogramowania. Pojęcie podpisu „Authenticode” oznacza format podpisu cyfrowego generowany i sprawdzany przy użyciu funkcji Authenticode Signature Verification. Więcej informacji na temat tego formatu można znaleźć w artykule dotyczącym systemu Windows [Format podpisu przenośnych plików wykonywalnych Windows Authenticode](http://www.microsoft.com/whdc/winlogo/drvsign/authenticode_pe.mspx) (j. ang.).

**Co to jest plik cabinet?**  
Plik cabinet to pojedynczy plik zazwyczaj z rozszerzeniem .CAB, który w bibliotece plików zawiera skompresowane pliki. Skompresowany plik może być podzielony między wiele plików cabinet. W trakcie instalacji program instalacyjny dekompresuje pliki zapisane w pliku cabinet i kopiuje je do systemu użytkownika. Więcej informacji można znaleźć w artykule MSDN [Pliki cabinet](http://msdn.microsoft.com/en-us/library/aa376906(v=vs.85).aspx).

**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**  
Osoba atakująca, której uda się wykorzystać tę lukę, może spowodować, że system Windows zainstaluje lub uruchomi dowolny kod. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

**W jaki sposób osoba atakująca może wykorzystać tę lukę?**  
Niniejsza luka może zostać wykorzystana pod warunkiem, że użytkownik, funkcja systemu Windows lub aplikacja uruchomi lub zainstaluje specjalnie spreparowany, podpisany plik PE lub plik cabinet. Osoba atakująca mogłaby bez unieważnienia podpisu zmodyfikować istniejący podpisany plik, tak aby zawrzeć w nim złośliwy kod. Kod ten zostałby wykonany w kontekście uprawnień, z jakimi go uruchomiono.

**Jakie systemy są szczególnie narażone na skutki tej luki?**  
Zagrożone są wszystkie systemy operacyjne, których dotyczy luka.

**W jaki sposób działa aktualizacja?**  
Aktualizacja usuwa lukę, wprowadzając dodatkowe operacje weryfikacji podczas podpisywania i weryfikowania przenośnych plików wykonywalnych i plików cabinet.
...
W funkcji Windows Authenticode Signature weryfikującej formaty plików cabinet (.cab) istnieje luka umożliwiająca zdalne wykonanie kodu. Anonimowa osoba atakująca może wykorzystać tę lukę, modyfikując istniejący podpisany plik cabinet tak, aby powiązać niezweryfikowane części podpisu ze złośliwym kodem, a następnie przekonać użytkownika do otwarcia lub wyświetlenia specjalnie spreparowanego pliku cabinet. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-0487](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0487).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach procedury sprawdzania poprawności związanej z uszkodzeniem składnika Cabview - CVE-2010-0487

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

#### Obejścia problemu dotyczącego luki w zabezpieczeniach procedury sprawdzania poprawności związanej z uszkodzeniem składnika Cabview - CVE-2010-0487

Firma Microsoft nie znalazła żadnego obejścia tej luki.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach procedury sprawdzania poprawności związanej z uszkodzeniem składnika Cabview - CVE-2010-0487

**Jaki zakres obejmuje ta luka?**  
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod z podniesionymi uprawnieniami w systemach, których ta luka dotyczy. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.

**W jaki sposób powstaje luka?**  
Luka w zabezpieczeniach powstaje, gdy Przeglądarka plików cabinet pomija pola podsumowania plików podczas podpisywania i weryfikacji plików cabinet.

**Co to jest Przeglądarka plików cabinet?**  
Przeglądarka plików cabinet (cabview.dll) pełni funkcję rozszerzenia powłoki wyświetlania systemu operacyjnego Windows dla plików cabinet. Składnik ten pozwala wyświetlać, otwierać, przeglądać i rozpakowywać pliki cabinet oraz archiwa.
...
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**  
W celu wykorzystania tej luki użytkownik musiałby otworzyć specjalnie spreparowany plik cabinet. Osoba atakująca może zmodyfikować istniejący podpisany plik cabinet tak, aby powiązać niezweryfikowane części podpisu ze złośliwym kodem. Kod ten zostałby wykonany w kontekście uprawnień, z jakimi go uruchomiono.

**Jakie systemy są szczególnie narażone na skutki tej luki?**  
Zagrożone są wszystkie systemy operacyjne, których dotyczy luka.

**W jaki sposób działa aktualizacja?**  
Aktualizacja zabezpieczeń eliminuje lukę w zabezpieczeniach poprzez wymuszenie przetwarzania wszystkich pól podsumowania plików podczas podpisywania i weryfikacji plików cabinet.
...
<br />
Rozszerzenie zawartości powłoki plików cabinet 5.1:<br />
...
<td style="border:1px solid black;">Authenticode Signature Verification 5.1:<br />
Tak, po zastosowaniu tej aktualizacji zabezpieczeń należy ponownie uruchomić system.<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 5.1:<br />
Ta aktualizacja nie wymaga ponownego uruchomienia komputera. Komputer należy jednak uruchomić ponownie w przypadku, gdy wymagane pliki są akurat używane. W takiej sytuacji wyświetlany jest komunikat z zaleceniem ponownego uruchomienia.</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">Authenticode Signature Verification 5.1:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB978601$\Spuninst<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 5.1:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB979309$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1:<br />
Zobacz <a href="http://support.microsoft.com/kb/978601">artykuł 978601 bazy wiedzy Microsoft Knowledge Base</a><br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 5.1:<br />
Zobacz <a href="http://support.microsoft.com/kb/979309">artykuł 979309 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1 w systemie Windows XP z dodatkiem Service Pack 2 i Windows XP z dodatkiem Service Pack 3:<br />
WindowsXP-KB978601-x86-ENU /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 w systemie Windows XP z dodatkiem Service Pack 2 i Windows XP z dodatkiem Service Pack 3:<br />
WindowsXP-KB979309-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2:<br />
WindowsServer2003.WindowsXP-KB978601-x64-ENU /quiet  
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2:<br />
...
KB978601.log<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0:<br />
KB979309.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Dodatkowe informacje</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1 we wszystkich obsługiwanych wersjach 32-bitowych systemu Windows Server 2003:<br />
WindowsServer2003-KB978601-x86-ENU /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 we wszystkich obsługiwanych wersjach 32-bitowych systemu Windows Server 2003:<br />
WindowsServer2003-KB979309-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1 we wszystkich obsługiwanych wersjach systemu Windows Server 2003 dla systemów z procesorem x64:<br />
WindowsServer2003.WindowsXP-KB978601-x64-ENU /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 we wszystkich obsługiwanych wersjach systemu Windows Server 2003 dla systemów z procesorem x64:<br />
WindowsServer2003.WindowsXP-KB979309-x64-ENU /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Authenticode Signature Verification 5.1 we wszystkich obsługiwanych wersjach systemu Windows Server 2003 dla systemów z procesorem Itanium:<br />
WindowsServer2003-KB978601-ia64-ENU /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 we wszystkich obsługiwanych wersjach systemu Windows Server 2003 dla systemów z procesorem Itanium:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Authenticode Signature Verification 6.0 we wszystkich obsługiwanych wersjach 32-bitowych systemu Windows Vista:<br />
Windows6.0-KB978601-x86 /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 we wszystkich obsługiwanych wersjach 32-bitowych systemu Windows Vista:<br />
Windows6.0-KB979309-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Authenticode Signature Verification 6.0 we wszystkich obsługiwanych wersjach systemu Windows Vista dla systemów z procesorem x64:<br />
Windows6.0-KB978601-x64 /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 we wszystkich obsługiwanych wersjach systemu Windows Vista dla systemów z procesorem x64:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Authenticode Signature Verification 6.0 we wszystkich obsługiwanych wersjach 32-bitowych systemu Windows Server 2008:<br />
Windows6.0-KB978601-x86 /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 we wszystkich obsługiwanych wersjach 32-bitowych systemu Windows Server 2008:<br />
Windows6.0-KB979309-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Authenticode Signature Verification 6.0 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 dla systemów z procesorem x64:<br />
Windows6.0-KB978601-x64 /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 dla systemów z procesorem x64:<br />
Windows6.0-KB979309-x64 /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Authenticode Signature Verification 6.0 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 dla systemów z procesorem Itanium:<br />
Windows6.0-KB978601-ia64 /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.0 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 dla systemów z procesorem Itanium:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Authenticode Signature Verification 6.1 we wszystkich obsługiwanych wersjach 32-bitowych systemu Windows 7:<br />
Windows6.1-KB978601-x86 /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.1 we wszystkich obsługiwanych wersjach 32-bitowych systemu Windows 7:<br />
Windows6.1-KB979309-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Authenticode Signature Verification 6.1 we wszystkich obsługiwanych wersjach systemu Windows 7 dla systemów z procesorem x64:<br />
Windows6.1-KB978601-x64 /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.1 we wszystkich obsługiwanych wersjach systemu Windows 7 dla systemów z procesorem x64:<br />
...
Tak, po zastosowaniu tej aktualizacji zabezpieczeń należy ponownie uruchomić system.<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.1:<br />
Ta aktualizacja nie wymaga ponownego uruchomienia komputera. Komputer należy jednak uruchomić ponownie w przypadku, gdy wymagane pliki są akurat używane. W takiej sytuacji wyświetlany jest komunikat z zaleceniem ponownego uruchomienia.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">Poprawianie na gorąco</td>
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Authenticode Signature Verification 6.1 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 R2 dla systemów z procesorem x64:<br />
Windows6.1-KB978601-x64 /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.1 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 R2 dla systemów z procesorem x64:<br />
Windows6.1-KB979309-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Authenticode Signature Verification 6.1 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 R2 dla systemów z procesorem Itanium:<br />
Windows6.1-KB978601-ia64 /quiet<br />
<br />
Rozszerzenie zawartości powłoki plików cabinet 6.1 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 R2 dla systemów z procesorem Itanium:<br />
...
-   Wer. 1.1 (14 kwietnia 2010 r.): Poprawiono zapis o instalacji Server Core dla systemów Windows Server 2008 i Windows Server 2008 R2, aby odnosił się tylko do aktualizacji KB978601.  
-   Wer. 1.2 (15 kwietnia 2010 r.): Do sekcji „Często zadawane pytania dotyczące aktualizacji” dodano wpis informujący o zmianie w sposobie wykrywania aktualizacji systemów Windows Server 2008 i Windows Server 2008 R2 w przypadku opcji instalacji Server Core. Zmiana objęła tylko wykrywanie. Nie wprowadzono żadnych zmian do plików aktualizacji zabezpieczeń w tym biuletynie. Klienci, którzy pomyślnie zainstalowali tę aktualizację, nie będą musieli instalować jej ponownie. Dodano także łącze do artykułu 981210 bazy wiedzy Microsoft Knowledge Base w części „Znane problemy” sekcji „Streszczenie”.  
-   Wer. 1.3 (21 kwietnia 2010 r.): Zaktualizowano sekcję „Często zadawane pytania”, aby sprecyzować zakres problemów instalacyjnych rozwiązanych w zmianie procedury wykrywania opublikowanej 15 kwietnia. Poprawiono także wpisy weryfikacji kluczy rejestru dla systemu Windows XP Professional x64 Edition z dodatkiem Service Pack 2.
