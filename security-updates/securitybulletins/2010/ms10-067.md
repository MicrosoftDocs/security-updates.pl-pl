---
TOCTitle: 'MS10-067'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS10-067 - Ważna'
ms:assetid: 'ms10-067'
ms:contentKeyID: 61232860
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms10-067(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS10-067 - Ważna
======================================================

Luka w zabezpieczeniach konwerterów tekstu programu WordPad może umożliwić zdalne wykonanie kodu (2259922)
----------------------------------------------------------------------------------------------------------
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=fc4369ec-864a-42ae-a850-b006872241fe)                                 | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7567986a-261d-4def-9fa5-c667994c7844)        | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3290e7ee-1e4a-464c-abfd-17fc4108601e)                        | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b21570cc-4f90-4ed8-b901-a34584d44a63)            | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=c9c4427d-54c8-4f3c-9a94-818196cd5180) | Zdalne wykonanie kodu              | Ważny                      | Brak                                               |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z uszkodzeniem pamięci konwertera tekstu programu WordPad Word 97 – CVE-2010-2563</th>
...
Luka w zabezpieczeniach związana z uszkodzeniem pamięci konwertera tekstu programu WordPad Word 97 – CVE-2010-2563  
------------------------------------------------------------------------------------------------------------------

Luka umożliwiająca zdalne wykonanie kodu występuje w sposobie przetwarzania pamięci przez program Microsoft WordPad podczas analizy specjalnie spreparowanego pliku programu Word 97. Luka ta umożliwia zdalne wykonanie kodu, jeśli użytkownik otworzy specjalnie spreparowany plik programu Word zawierający nieprawidłową strukturę.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2010-2563](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2563).
  
#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach związanej z uszkodzeniem pamięci konwertera tekstu programu WordPad Word 97 – CVE-2010-2563
...
-   Luki nie można wykorzystać automatycznie przez pocztę elektroniczną. Aby atak przeprowadzony w ten sposób powiódł się, użytkownik musi otworzyć załącznik wiadomości e-mail. Użytkownik może zostać zapytany, czy chce otworzyć plik, o ile uprzednio nie usunął zaznaczenia opcji „Zawsze pytaj przed otwarciem pliku tego typu”.  
...
#### Obejścia problemu dotyczącego luki w zabezpieczeniach związanej z uszkodzeniem pamięci konwertera tekstu programu WordPad Word 97 – CVE-2010-2563
...
-   Wyłączenie konwertera tekstu programu WordPad dla formatu Word 97 poprzez ograniczenie dostępu do pliku konwertera.
    ...
    **Jak cofnąć obejście.** Zaloguj się jako administrator uruchom następujące polecenia w wierszu polecenia.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci konwertera tekstu programu WordPad Word 97 – CVE-2010-2563
...
Luka w zabezpieczeniach powstaje, gdy konwerter tekstu programu WordPad nieprawidłowo analizuje określone pola w dokumencie programu Word 97.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2259922$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2259922">artykuł 2259922 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   S0lute z firmy [iDefense Labs](http://labs.idefense.com/) za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci konwertera tekstu programu WordPad Word 97 (CVE-2010-2563)
