---
TOCTitle: 'MS06-059'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS06-059 - Krytyczna'
ms:assetid: 'ms06-059'
ms:contentKeyID: 61232494
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms06-059(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS06-059 - Krytyczna
==========================================================

Luki w zabezpieczeniach programu Microsoft Excel umożliwiają zdalne wykonanie kodu (924164)
-------------------------------------------------------------------------------------------

Opublikowano: 10 października 2006 | Zaktualizowano: 12 grudnia 2006
...
-   Microsoft Office 2000 z dodatkiem Service Pack 3
    -   Microsoft Excel 2000 — [pobierz aktualizację (KB923090)](http://www.microsoft.com/downloads/details.aspx?familyid=a4b2a672-481b-4af6-89fe-de8d321d99e0)
-   Microsoft Office XP z dodatkiem Service Pack 3
    -   Microsoft Excel 2002 — [pobierz aktualizację (KB923089)](http://www.microsoft.com/downloads/details.aspx?familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984)
-   Pakiet Microsoft Office 2003 z dodatkiem Service Pack 1 lub Service Pack 2
    -   Microsoft Office Excel 2003 — [pobierz aktualizację (KB923088)](http://www.microsoft.com/downloads/details.aspx?familyid=a81a8537-e2b0-4629-8973-40c4f32d9728)
    -   Przeglądarka programu Microsoft Office Excel 2003 — [pobierz aktualizację (KB923275)](http://www.microsoft.com/downloads/details.aspx?familyid=74c72657-634d-4c31-a366-c68043fe3b34)
-   Microsoft Office 2004 dla komputerów Macintosh
    -   Microsoft Excel 2004 dla komputerów Macintosh — [pobierz aktualizację (KB924999)](http://www.microsoft.com/mac/)
-   Microsoft Office v. X dla komputerów Macintosh
    -   Microsoft Excel v. X dla komputerów Macintosh — [pobierz aktualizację (KB924998)](http://www.microsoft.com/mac/)
-   Pakiety Microsoft Works:
    -   Pakiet Microsoft Works 2004 - [pobierz aktualizację (KB923089)](http://www.microsoft.com/downloads/details.aspx?familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984) (tę samą, co w przypadku programu Microsoft Excel 2002)
    -   Pakiet Microsoft Works 2005 - [pobierz aktualizację (KB923089)](http://www.microsoft.com/downloads/details.aspx?familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984) (tę samą, co w przypadku programu Microsoft Excel 2002)
    -   Pakiet Microsoft Works 2006 - [pobierz aktualizację (KB923089)](http://www.microsoft.com/downloads/details.aspx?familyid=d86620e8-c77a-45a9-9ff3-0a6aaf308984) (tę samą, co w przypadku programu Microsoft Excel 2002)
...
Ta aktualizacja dotyczy kilku nowo wykrytych luk w zabezpieczeniach, które zostały zgłoszone przez użytkowników i organizacje publiczne. Każdą lukę opisano w osobnej sekcji „Szczegółowe informacje o luce w zabezpieczeniach” niniejszego biuletynu.
...
| Identyfikator luki                                                                                                                                                                              | Wpływ luki            | Microsoft Excel 2000 | Microsoft Excel 2002 | Microsoft Excel 2003 i Przeglądarka programu Excel 2003 | Microsoft Excel 2004 dla komputerów Macintosh i Excel v. X dla komputerów Macintosh |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|----------------------|----------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------|
| Luka w zabezpieczeniach programu Excel związana z nieprawidłowo utworzonym rekordem DATETIME — [CVE-2006-2387 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2387)        | Zdalne wykonanie kodu | Krytyczny            | Ważne                | Ważne                                                   | Ważne                                                                               |
| Luka w zabezpieczeniach programu Excel związana z nieprawidłowo utworzonym rekordem STYLE — [CVE-2006-3431 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3431)           | Zdalne wykonanie kodu | Krytyczny            | Ważne                | Ważne                                                   | Ważne                                                                               |
| Luka w zabezpieczeniach programu Excel związana z nieprawidłową obsługą plików programu Lotus 1-2-3 — [CVE-2006-3867 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3867) | Zdalne wykonanie kodu | Krytyczny            | Ważne                | Ważne                                                   | Ważne                                                                               |
| Luka w zabezpieczeniach programu Excel związana z nieprawidłowo utworzonym rekordem COLINFO — [CVE-2006-3875 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3875)         | Zdalne wykonanie kodu | Krytyczny            | Ważne                | Ważne                                                   | Ważne                                                                               |
| **Zbiorczy wskaźnik ważności wszystkich luk w zabezpieczeniach**                                                                                                                                |                  | **Krytyczny**        | **Ważny**            | **Ważny**                                               | **Ważny**                                                                           |
...
-   Wskaźnik ważności dla pakietu Microsoft Works 2004 jest taki sam, jak dla programu Microsoft Excel 2002.
-   Wskaźnik ważności dla pakietu Microsoft Works 2005 jest taki sam, jak dla programu Microsoft Excel 2002.
-   Wskaźnik ważności dla pakietu Microsoft Works 2006 jest taki sam, jak dla programu Microsoft Excel 2002.

Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń
---------------------------------------------------------------

**Dlaczego firma Microsoft ponownie opublikowała ten biuletyn 12 grudnia 2006 r.?**  
Firma Microsoft zaktualizowała ten biuletyn wraz z powiązanymi z nim aktualizacjami zabezpieczeń w celu rozwiązania problemów wskazanych w [artykule 924164 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/924164), które dotyczą programu Microsoft Excel 2002.
...
| Identyfikator biuletynu                                                 | Microsoft Excel 2000 | Microsoft Excel 2002 | Microsoft Excel 2003 i Przeglądarka programu Excel 2003 | Microsoft Excel 2004 dla komputerów Macintosh i Excel v. X dla komputerów Macintosh |
|-------------------------------------------------------------------------|----------------------|----------------------|---------------------------------------------------------|-------------------------------------------------------------------------------------|
| [**MS06-037**](http://technet.microsoft.com/security/bulletin/ms06-037) | Zastąpiony           | Zastąpiony           | Zastąpiony                                              | Zastąpiony                                                                          |
...
Bardziej szczegółowe informacje na temat wykrywania oraz wskazówki dotyczące wdrażania znajdują się w [artykule 910723 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/910723).
...
#### Luka w zabezpieczeniach programu Excel związana z nieprawidłowo utworzonym rekordem DATETIME — CVE-2006-2387:

W programie Excel istnieje luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca może wykorzystać tę lukę w programie Excel podczas analizowania i przetwarzania pliku z nieprawidłowo utworzonym rekordem DATETIME.
...
#### Obejścia dotyczące luki w zabezpieczeniach programu Excel związanej z nieprawidłowo utworzonym rekordem DATETIME — CVE-2006-2387:
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z nieprawidłowo utworzonym rekordem DATETIME — CVE-2006-2387:
...
Podczas przetwarzania zawartości pliku xls w programie Excel nie jest wystarczająco dokładnie sprawdzana poprawność danych. Jeśli w programie Excel zostanie otwarty i przeanalizowany specjalnie spreparowany plik programu Excel z nieprawidłowo utworzonym rekordem DATETIME, może nastąpić uszkodzenie pamięci systemowej, które umożliwi osobie atakującej wykonanie dowolnego kodu.
...
#### Luka w zabezpieczeniach programu Excel związana z nieprawidłowo utworzonym rekordem STYLE — CVE-2006-3431:

W programie Excel istnieje luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca może wykorzystać tę lukę w programie Excel podczas analizowania i przetwarzania pliku z nieprawidłowo utworzonym rekordem STYLE.

Jeśli użytkownik byłby zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzystałaby tę lukę, mogłaby uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z nieprawidłowo utworzonym rekordem STYLE — CVE-2006-3431:
...
#### Obejścia dotyczące luki w zabezpieczeniach programu Excel związanej z nieprawidłowo utworzonym rekordem STYLE — CVE-2006-3431:
...
-   Nie należy otwierać ani zapisywać plików Microsoft Excel otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.
-   Pobierz i uruchom narzędzie „[Office 2003 Add-in: Desktop Language Settings (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=cc37e08c-1019-4ae8-a258-0d5412876dec&displaylang=en&hash=d46v6q7)”, aby zmienić skonfigurowane ustawienia języka pakietu Office.
-   **Ustaw wartość „InstallLanguage” na inną niż dwubajtowy ciąg znaków**  
    Modyfikacja klucza rejestru „InstallLanguage” ułatwi ochronę systemu, w którym występuje luka, przed próbami jej wykorzystania.  
    ...
    **Uwaga** Zanotuj uprawnienia wymienione w tym oknie dialogowym, aby móc później przywrócić pierwotne wartości.
    ...
    2.  Rozwiń gałąź **HKEY\_CURRENT\_USER**, rozwiń następujące podklucze rejestru: **Software, Microsoft, Office**, **11.0, Common**.
    3.  Kliknij klucz **LanguageResources**, a następnie kliknij dwukrotnie wartość **InstallLanguage**, aby wyświetlić okno dialogowe **„Edytowanie wartości DWORD”**.
    4.  Zmień tę wartość na odpowiadającą językowi innemu niż wschodnioazjatycki. Na przykład wpisz wartość 409 (angielski — Stany Zjednoczone) i kliknij przycisk **OK**.  

    **Uwaga** Lista identyfikatorów języków znajduje się w następującym [artykule 324097 bazy wiedzy Knowledge Base (j.ang.)](http://support.microsoft.com/?id=324097).
...
**Wpływ obejścia:** Znaki specjalne Unicode w arkuszach kalkulacyjnych mogą być wyświetlane nieprawidłowo.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z nieprawidłowo utworzonym rekordem STYLE — CVE-2006-3431:
...
**Skąd bierze się luka?**  
Podczas przetwarzania zawartości pliku xls w programie Excel nie jest wystarczająco dokładnie sprawdzana poprawność danych. Jeśli w programie Excel zostanie otwarty i przeanalizowany specjalnie spreparowany plik programu Excel z nieprawidłowo utworzonym rekordem STYLE, może nastąpić uszkodzenie pamięci systemowej, które umożliwi osobie atakującej wykonanie dowolnego kodu.
...
#### Luka w zabezpieczeniach programu Excel związana z nieprawidłową obsługą plików programu Lotus 1-2-3 — CVE-2006-3867:

W programie Excel istnieje luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca może wykorzystać tę lukę, jeśli w programie Excel zostanie otwarty plik programu Lotus 1-2-3.

Jeśli użytkownik byłby zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzystałaby tę lukę, mogłaby uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z nieprawidłową obsługą plików programu Lotus 1-2-3 — CVE-2006-3867:

-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
-   Osoba atakująca za pośrednictwem sieci Web, która chce wykorzystać tę lukę, musi udostępnić witrynę sieci Web z odpowiednim plikiem programu Lotus 1-2-3, a następnie nakłonić użytkownika do otwarcia tego pliku w programie Excel. Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystywać tę lukę. Intruz nie może w żaden sposób zmusić użytkowników do odwiedzenia szkodliwej witryny. Musi natomiast przekonać ich do jej odwiedzenia, zazwyczaj poprzez kliknięcie łącza do tej witryny.
-   Luki nie można wykorzystać automatycznie, przez pocztę elektroniczną. Aby atak przeprowadzony w ten sposób powiódł się, użytkownik musi otworzyć załącznik wiadomości e-mail.
-   Użytkownicy, którzy zainstalowali i korzystają z narzędzia [Office Document Open Confirmation Tool](http://www.microsoft.com/downloads/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f&displaylang=pl) dla pakietu Office 2000, będą przed otwarciem dokumentu monitowani o **otwarcie**, **zapisanie** lub **anulowanie**. Funkcje narzędzia Office Document Open Confirmation Tool zostały udostępnione w pakietach Office XP i Office 2003.

#### Obejścia dotyczące luki w zabezpieczeniach programu Excel związanej z nieprawidłową obsługą plików programu Lotus 1-2-3 — CVE-2006-3867:

-   W programie Microsoft Excel nie należy otwierać ani zapisywać plików programu Lotus 1-2-3 otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z nieprawidłową obsługą plików programu Lotus 1-2-3 — CVE-2006-3867:
...
**Skąd bierze się luka?**  
Jeśli w programie Excel zostanie otwarty specjalnie spreparowany plik programu Lotus 1-2-3 , może nastąpić uszkodzenie pamięci systemowej, które pozwoli osobie atakującej na wykonanie dowolnego kodu.
...
**Czy luka była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**  
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem CVE-2006-3867.

**Czy firma Microsoft otrzymała zgłoszenia o wykorzystaniu luki w czasie, gdy opublikowano niniejszy biuletyn?**  
Nie. Firma Microsoft otrzymała przykładowe dowody istnienia publicznie dostępnego kodu koncepcyjnego, lecz przed opublikowaniem niniejszego biuletynu zabezpieczeń nie otrzymała informacji, które wskazywałyby, że luka została publicznie wykorzystana do ataku na systemy klientów.

#### Luka w zabezpieczeniach związana z nieprawidłowo utworzonym rekordem COLINFO — CVE-2006-3875:

W programie Excel istnieje luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca może wykorzystać tę lukę w programie Excel podczas analizowania i przetwarzania pliku z nieprawidłowo utworzonym rekordem COLINFO.

Jeśli użytkownik byłby zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzystałaby tę lukę, mogłaby uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z nieprawidłowo utworzonym rekordem COLINFO — CVE-2006-3875:
...
#### Obejścia dotyczące luki w zabezpieczeniach związanej z nieprawidłowo utworzonym rekordem COLINFO — CVE-2006-3875:

-   Nie należy otwierać ani zapisywać plików Microsoft Excel otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z nieprawidłowo utworzonym rekordem COLINFO — CVE-2006-3875:
...
**Skąd bierze się luka?**  
Podczas przetwarzania zawartości pliku xls w programie Excel nie jest wystarczająco dokładnie sprawdzana poprawność danych. Jeśli w programie Excel zostanie otwarty i przeanalizowany specjalnie spreparowany plik programu Excel z nieprawidłowo utworzonym rekordem COLINFO, może nastąpić uszkodzenie pamięci systemowej, które umożliwi osobie atakującej wykonanie dowolnego kodu.
...
1.  [Pobierz aktualizację zabezpieczeń dla programu Excel 2000 (j.ang.)](http://download.microsoft.com/download/3/6/d/36d75630-5526-404e-aea4-24fb5c8cce1f/office2000-kb923090-fullfile-enu.exe).
...
|-------------|------------|-------------|---------|-----------|
| Excel.exe   | 9.0.0.8950 | 06-wrz-2006 | 00:37   | 7 233 581 |
...
-   Na komputerze musi być zainstalowany dodatek Service Pack 3 (SP3) dla pakietu Office XP. Przed zainstalowaniem tej aktualizacji należy zainstalować [dodatek SP3 do pakietu Office XP](http://www.microsoft.com/downloads/details.aspx?familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e&dsplaylang=pl). Więcej informacji na temat instalacji dodatku SP3 do pakietu Office XP można znaleźć w [artykule 832671 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;832671).
...
1.  [Pobierz aktualizację zabezpieczeń dla programu Excel 2002 (j.ang.)](http://download.microsoft.com/download/6/e/4/6e483fd2-420f-45e2-9d21-e725f461c097/officexp-kb923089-v2-fullfile-enu.exe).
2.  Kliknij opcję **Zapisz ten program na dysku**, a następnie kliknij przycisk **OK**.
3.  Kliknij przycisk **Zapisz**.
4.  W Eksploratorze Windows znajdź folder zawierający zapisany plik, a następnie kliknij dwukrotnie ten plik.
5.  Po wyświetleniu monitu o zainstalowanie aktualizacji kliknij przycisk **Tak**.
...
| Nazwa pliku | Wersja      | Data        | Godzina | Rozmiar   |
|-------------|-------------|-------------|---------|-----------|
| Excel.exe   | 10.0.6816.0 | 17-sie-2006 | 22:20   | 9 358 096 |
...
-   Aktualizacja apletu Podgląd programu Excel 2003 wymaga zainstalowanego tego apletu. Przed instalacją tej aktualizacji należy zainstalować aplet [Podgląd programu Excel 2003](http://www.microsoft.com/downloads/details.aspx?familyid=c8378bf4-996c-4569-b547-75edbd03aaf0&displaylang=pl).
...
1.  [Pobierz aktualizację zabezpieczeń dla programu Excel 2003 (j.ang.)](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe) i/lub [aktualizację zabezpieczeń dla Przeglądarki programu Excel 2003 (j.ang.)](http://download.microsoft.com/download/2/2/e/22e6365d-2a66-4a8c-8867-06a723dc53cc/office2003-kb923275-fullfile-enu.exe)
2.  Kliknij opcję **Zapisz ten program na dysku**, a następnie kliknij przycisk **OK**.
3.  Kliknij przycisk **Zapisz**.
4.  W Eksploratorze Windows znajdź folder zawierający zapisany plik, a następnie kliknij dwukrotnie ten plik.
5.  Po wyświetleniu monitu o zainstalowanie aktualizacji kliknij przycisk **Tak**.
...
| Nazwa pliku | Wersja      | Data        | Godzina | Rozmiar    |
|-------------|-------------|-------------|---------|------------|
| Excel.exe   | 11.0.8105.0 | 24-sie-2006 | 03:20   | 10 269 456 |

Przeglądarka programu Excel 2003:

| Nazwa pliku | Wersja      | Data        | Godzina | Rozmiar   |
|-------------|-------------|-------------|---------|-----------|
| Xlview.exe  | 11.0.8104.0 | 17-sie-2006 | 22:58   | 5 237 520 |
...
-   Manuelowi Santamarina Suarez, współpracownikowi firm [Zero Day Initiative](http://www.zerodayinitiative.com/) i [TippingPoint](http://www.tippingpoint.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z przepełnieniem buforu podczas analizy formatu pliku — CVE-2006-2387.
-   Firmie [NSFocus Security Team](http://www.nsfocus.com/) za zgłoszenie luki w zabezpieczeniach programu Excel związanej z nieprawidłowo utworzonym rekordem COLINFO — [CVE-2006-3875 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3875).
...
-   V1.1 (29 listopada 2006 r.): W biuletynie zaktualizowano artykuł w bazie wiedzy Knowledge Base dotyczący programu „Przeglądarka programu Microsoft Office Excel 2003” w sekcji „Produkty zagrożone”.
-   V2.0 (12 grudnia 2006 r.): Zaktualizowany biuletyn został poprawiony i ponownie opublikowany dla programu Microsoft Excel 2002 w celu rozwiązania problemów wskazanych w [artykule 924164 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/924164).
