---
TOCTitle: 'MS06-032'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS06-032 - Ważna'
ms:assetid: 'ms06-032'
ms:contentKeyID: 61232468
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms06-032(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS06-032 - Ważna
======================================================

Luka w zabezpieczeniach protokołu TCP/IP może pozwolić na zdalne wykonanie kodu (917953)
----------------------------------------------------------------------------------------
...
**Ostrzeżenia:** [W artykule 917953 bazy wiedzy Microsoft Knowledge Base (j.ang.)](http://support.microsoft.com/kb/917953) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane rozwiązania tych problemów. Więcej informacji na ten temat można znaleźć w [artykule 917953 bazy wiedzy Microsoft Knowledge Base (j.ang.)](http://support.microsoft.com/kb/917953).

**Lokalizacje, z których można pobrać przetestowane oprogramowanie i aktualizacje zabezpieczeń:**

**Programy, których dotyczy problem:**

-   Microsoft Windows 2000 z dodatkiem Service Pack 4 — [Pobierz aktualizację](http://www.microsoft.com/downloads/details.aspx?familyid=305e208c-d75c-471b-9e57-30d01e320ad1&displaylang=pl)
-   Microsoft Windows XP z dodatkiem Service Pack 1 oraz Microsoft Windows XP z dodatkiem Service Pack 2 — [Pobierz aktualizację](http://www.microsoft.com/downloads/details.aspx?familyid=b62abe8e-4735-4934-a66e-5b957986efbf&displaylang=pl)
-   Microsoft Windows XP Professional x64 Edition — [Pobierz aktualizację (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=44213900-9082-45dc-b514-31d38717fe89)
-   Microsoft Windows Server 2003 i Microsoft Windows Server 2003 z dodatkiem Service Pack 1 — [Pobierz aktualizację](http://www.microsoft.com/downloads/details.aspx?familyid=ea319c61-b405-41ab-9eee-d5b3488b90e0&displaylang=pl)
-   Microsoft Windows Server 2003 dla systemów z procesorem Itanium oraz Microsoft Windows Server 2003 z dodatkiem SP1 dla systemów z procesorem Itanium — [Pobierz aktualizację (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=cd8b88b5-f90f-4c0c-a5ad-3641751381c9)
-   Microsoft Windows Server 2003 x64 Edition — [Pobierz aktualizację (j.ang.)](http://www.microsoft.com/downloads/details.aspx?familyid=cd8699bc-6760-4f0e-b8e0-2e7d89092ce8)
...
Klienci powinni jak najszybciej zastosować tę aktualizację.
...
|--------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|--------------|-------------------------------------------------|-------------------------------------------------|---------------------|------------------------------------------------|
| Luka w zabezpieczeniach dotycząca routingu źródła IP — [CVE-2006-2379 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2379) | Zdalne wykonanie kodu | Ważny        | Ważny                                           | Umiarkowany                                     | Ważny               | Umiarkowany                                    |
...
|-------------------------|--------------|-------------------------------------------------|-------------------------------------------------|---------------------|------------------------------------------------|
| **MS06-007**            | Nie dotyczy  | Zastąpiony                                      | Zastąpiony                                      | Zastąpiony          | Zastąpiony                                     |
| **MS05-019**            | Zastąpiony   | Nie zastąpiony                                  | Zastąpiony                                      | Zastąpiony          | Nie dotyczy                                    |
...
Upłynął okres pomocy technicznej dla systemów Windows NT Workstation 4.0 z dodatkiem Service Pack 6a, Windows NT Server 4.0 z dodatkiem Service Pack 6a, Windows 2000 z dodatkiem Service Pack 2 i Windows 2000 z dodatkiem Service Pack 3. Klienci korzystający z tych wersji systemów powinni traktować priorytetowo migrację do wersji obsługiwanych, aby zapobiec ewentualnym skutkom wystąpienia luk mogących się pojawić w przyszłości. Dodatkowe informacje na temat zasad cyklu pomocy technicznej dla systemu Windows można znaleźć w witrynie [zasad cyklu pomocy technicznej firmy Microsoft](http://go.microsoft.com/fwlink/?linkid=21742). Aby uzyskać więcej informacji na temat przedłużonego okresu obsługi aktualizacji zabezpieczeń dla tych wersji systemu operacyjnego, odwiedź witrynę [pomocy technicznej firmy Microsoft (j.ang.)](http://go.microsoft.com/fwlink/?linkid=33328).
...
Do wykrycia aktualizacji zabezpieczeń program SMS 2.0 może użyć dodatku SUS Feature Pack do programu SMS, zawierającego narzędzie Security Update Inventory Tool. Do wykrywania aktualizacji narzędzie SMS UIT wykorzystuje aparat MBSA 1.2.1. Więcej informacji na temat narzędzia Security Update Inventory Tool można znaleźć w [witrynie sieci Web firmy Microsoft](http://support.microsoft.com/kb/894154). Więcej informacji na temat ograniczeń narzędzia Security Update Inventory Tool można znaleźć w [artykule 306460 w bazie wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/306460). Dodatek SUS Feature Pack do programu SMS również zawiera narzędzie Microsoft Office Inventory Tool, które pozwala wykryć wymagane aktualizacje aplikacji pakietu Microsoft Office.
...
<span></span>
#### Luka w zabezpieczeniach dotycząca routingu źródła IP — CVE-2006-2379:

W sterowniku protokołu TCP/IP występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, przez co osoba atakująca, której uda się ją wykorzystać, może uzyskać pełną kontrolę nad systemem, którego luka dotyczy.

#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach dotyczącej routingu źródła IP — CVE-2006-2379:
...
-   Systemy są zagrożone tylko w przypadku włączonego routingu źródła IP. Routing źródła IP jest wyłączony w systemach Windows XP z dodatkiem Service Pack 2 i Windows Server 2003 z dodatkiem Service Pack 1.
-   Włączenie usługi Routing i dostęp zdalny powoduje włączenie routingu źródła IP.  Usługa ta jest jednak wyłączona we wszystkich wersjach systemu operacyjnego, których dotyczy problem.
...
#### Rozwiązania problemu spowodowanego luką w zabezpieczeniach dotyczącą routingu źródła IP — CVE-2006-2379:
...
-   **Blokowanie na zaporze pakietów IP z opcją 131 i 137 routingu źródła IP:**

    Pakiety IP z opcją 131 i 137 routingu źródła IP mogą posłużyć do zainicjowania połączenia ze składnikami, których dotyczy omawiana luka w zabezpieczeniach. Jeśli system chroniony jest zaporą lub routerem, zablokowanie tego typu pakietów na poziomie zapory lub routera pomaga lepiej chronić system przed atakami wykorzystującymi opisywaną lukę. Zaleca się zablokowanie całej niepożądanej komunikacji przychodzącej z Internetu. Aby zablokować wymienione typy połączeń, których luka dotyczy, można użyć aplikacji ISA Server 2004.
...
-   **Wyłączenie routingu źródła IP**
    Wyłączenie routingu źródła IP zapobiega przetwarzaniu przez hosta, którego dotyczy problem, pakietów związanych ze źródłem IP, co mogłoby umożliwić osobie atakującej wykonanie kodu. Routing źródła IP można dezaktywować wykonując następujące czynności:
    ...
    **Uwaga** Przed przystąpieniem do modyfikacji rejestru zaleca się utworzenie jego kopii zapasowej..
    ...
    3.  Dodaj wartość DWORD: **DisableIPSourceRouting**. Ustaw wartość **2**. Wartość ta powoduje wyłączenie routingu źródła IP. Domyślnie klucz ten nie istnieje.
    4.  Aby zmiana została zastosowana, należy ponownie uruchomić system.

Więcej informacji na temat wyłączania routingu źródła IP zawierają dodatkowe informacje na temat zabezpieczenia wymienione w artykule działu MSDN: [Jak zabezpieczyć stos TCP/IP (j.ang.)](http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnnetsec/html/hthardtcp.asp).

#### Często zadawane pytania dotyczące luki w zabezpieczeniach dotyczącej routingu źródła IP — CVE-2006-2379:
...
Jej źródłem jest niesprawdzony bufor w sterowniku protokołu TCP/IP.

**Co to jest routing źródła IP?**
Routing źródła IP to mechanizm, który umożliwia nadawcy określenie trasy IP dla datagramu przesyłanego przez sieć.
...
Osoba atakująca może próbować wykorzystać tę lukę, tworząc specjalnie spreparowany pakiet sieciowy i wysyłając ten pakiet do systemu, którego luka dotyczy.

**Jakie systemy są szczególnie narażone na skutki tej luki?**
Szczególnie zagrożone przez tę lukę są komputery z włączoną usługą RRAS.
...
Aktualizacja usuwa lukę, zmieniając sposób zatwierdzania długości komunikatów przez sterownik protokołu TCP/IP przed przekazaniem ich do przydzielonego buforu.
...
Ta aktualizacja zabezpieczeń nie obsługuje funkcji HotPatching. Więcej informacji na ten temat znajduje się w [artykule 897341 bazy wiedzy Microsoft Knowledge Base (j.ang.)](http://support.microsoft.com/kb/897341).

**Informacje dotyczące usuwania**

Do usunięcia tej aktualizacji należy użyć narzędzia Dodaj lub usuń programy w Panelu sterowania.

Administratorzy systemu mogą także usunąć tę aktualizację zabezpieczeń za pomocą narzędzia Spuninst.exe. Narzędzie Spuninst.exe znajduje się w folderze %Windir%\\$NTUninstallKB917953$\\Spuninst.
...
|-------------|---------------|------------|---------|---------|--------|
| Tcpip.sys   | 5.2.3790.537  | 20-05-2006 | 00:27   | 317 440 | RTMGDR |
| Tcpip.sys   | 5.2.3790.537  | 20-05-2006 | 00:39   | 318 464 | RTMQFE |
| Tcpip.sys   | 5.2.3790.2709 | 24-05-2006 | 01:05   | 333 312 | SP1GDR |
| Tcpip.sys   | 5.2.3790.2709 | 24-05-2006 | 01:20   | 386 048 | SP1QFE |
...
| Nazwa pliku | Wersja        | Data       | Godzina | Rozmiar   | Folder |
|-------------|---------------|------------|---------|-----------|--------|
| Tcpip.sys   | 5.2.3790.537  | 24-05-2006 | 20:34   | 973 824   | RTMGDR |
| Tcpip.sys   | 5.2.3790.537  | 24-05-2006 | 20:34   | 977 920   | RTMQFE |
| Tcpip.sys   | 5.2.3790.2709 | 24-05-2006 | 20:37   | 1 116 160 | SP1GDR |
| Tcpip.sys   | 5.2.3790.2709 | 24-05-2006 | 20:34   | 1 285 120 | SP1QFE |
...
| Nazwa pliku | Wersja        | Data       | Godzina | Rozmiar | Folder |
|-------------|---------------|------------|---------|---------|--------|
| Tcpip.sys   | 5.2.3790.2709 | 24-05-2006 | 20:38   | 703 488 | SP1GDR |
| Tcpip.sys   | 5.2.3790.2709 | 24-05-2006 | 20:34   | 812 544 | SP1QFE |
...
| Nazwa pliku | Wersja        | Data       | Godzina | Rozmiar | Folder |
|-------------|---------------|------------|---------|---------|--------|
| Tcpip.sys   | 5.1.2600.1831 | 20-04-2006 | 11:38   | 340 480 | SP1QFE |
| Tcpip.sys   | 5.1.2600.2892 | 20-04-2006 | 11:51   | 359 808 | SP2GDR |
| Tcpip.sys   | 5.1.2600.2892 | 20-04-2006 | 12:18   | 360 576 | SP2QFE |
...
|-------------|---------------|------------|---------|---------|
| Tcpip.sys   | 5.0.2195.7087 | 26-04-2006 | 02:08   | 320 336 |
...
-   [Andrejowi Minajewowi](https://technet.microsoft.com/pl-PL/mailto:angel3000@hotbox.ru) za zgłoszenie luki w zabezpieczeniach routingu źródła IP (CVE-2006-2379).
...
-   V1.1 (21 czerwca 2006 r.): Zaktualizowano część „Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń” w celu wyjaśnienia powodów zamiany biuletynu MS05-019. Zaktualizowano również część „Szczegółowe informacje o luce w zabezpieczeniach” w celu podania dodatkowych informacji na temat wyłączenia routingu źródła IP.
