---
TOCTitle: 'MS06-058'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS06-058 - Krytyczna'
ms:assetid: 'ms06-058'
ms:contentKeyID: 61232493
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms06-058(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS06-058 - Krytyczna
==========================================================

Luki w zabezpieczeniach programu Microsoft PowerPoint umożliwiają zdalne wykonanie kodu (924163)
------------------------------------------------------------------------------------------------

Opublikowano: 10 października 2006 | Zaktualizowano: 21 lutego 2007
...
-   Microsoft Office 2000 z dodatkiem Service Pack 3 — [pobierz aktualizację (KB923093)](http://www.microsoft.com/downloads/details.aspx?familyid=14a61fda-bfe2-47ca-8313-40b772359994&displaylang=pl)
    -   Microsoft PowerPoint 2000
-   Microsoft Office XP z dodatkiem Service Pack 3 — [pobierz aktualizację (KB923092)](http://www.microsoft.com/downloads/details.aspx?familyid=0fbd66fb-28bb-4587-9425-ad4a3f10651d&displaylang=pl)
    -   Microsoft PowerPoint 2002
-   Microsoft Office 2003 z dodatkiem Service Pack 1 lub dodatkiem Service Pack 2 — [pobierz aktualizację (KB923091)](http://www.microsoft.com/downloads/details.aspx?familyid=d0e30f77-b48f-4b8b-a6fa-105a354b1a4e&displaylang=pl)
    -   Microsoft Office PowerPoint 2003
-   Microsoft Office 2004 dla komputerów Macintosh
    -   Microsoft PowerPoint 2004 dla komputerów Macintosh — [pobierz aktualizację (KB924999) (j.ang.)](http://www.microsoft.com/mac/)
-   Microsoft Office v. X dla komputerów Macintosh
    -   Microsoft PowerPoint v. X dla komputerów Macintosh — [pobierz aktualizację (KB924998) (j.ang.)](http://www.microsoft.com/mac/)
...
Jeśli z wersji programu PowerPoint, w której występują luki, będzie korzystać użytkownik zalogowany z uprawnieniami administratora, osoba atakująca może wykorzystać te luki w celu uzyskania pełnej kontroli nad systemem. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

Zaleca się, aby klienci natychmiast zastosowali tę aktualizację.

**Wskaźniki ważności i identyfikatory luk:**

| Identyfikator luki                                                                                                                                                                                                      | Wpływ luki            | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft Office PowerPoint 2003 | Microsoft PowerPoint 2004 dla komputerów Macintosh i PowerPoint v. X dla komputerów Macintosh |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------|---------------------------|---------------------------|----------------------------------|-----------------------------------------------------------------------------------------------|
| Luka w zabezpieczeniach programu PowerPoint związana z nieprawidłowo utworzonym wskaźnikiem obiektu — [CVE-2006-3435 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435)                         | Zdalne wykonanie kodu | Brak                      | Brak                      | Ważne                            | Brak                                                                                          |
| Luka w zabezpieczeniach programu PowerPoint związana z nieprawidłowo utworzonym rekordem danych — [CVE-2006-3876 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876)                             | Zdalne wykonanie kodu | Krytyczny                 | Ważne                     | Ważne                            | Ważne                                                                                         |
| Luka w zabezpieczeniach programu PowerPoint związana z uszkodzeniem pamięci wynikającym z nieprawidłowo utworzonego rekordu — [CVE-2006-3877 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877) | Zdalne wykonanie kodu | Krytyczny                 | Ważne                     | Ważne                            | Ważne                                                                                         |
| Luka w zabezpieczeniach programu PowerPoint związana z nieprawidłowo utworzonym rekordem — [CVE-2006-4694 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4694)                                    | Zdalne wykonanie kodu | Krytyczny                 | Ważne                     | Ważne                            | Ważne                                                                                         |
...
| Identyfikator biuletynu                                                 | Microsoft PowerPoint 2000 | Microsoft PowerPoint 2002 | Microsoft Office PowerPoint 2003 | Microsoft PowerPoint 2004 dla komputerów Macintosh i PowerPoint v. X dla komputerów Macintosh |
|-------------------------------------------------------------------------|---------------------------|---------------------------|----------------------------------|-----------------------------------------------------------------------------------------------|
| [**MS06-028**](http://technet.microsoft.com/security/bulletin/ms06-028) | Zastąpiony                | Zastąpiony                | Zastąpiony                       | Zastąpiony                                                                                    |
...
| Microsoft Office PowerPoint 2003                   | Tak        | Tak      |
...
|----------------------------------------------------|---------|----------|
| Microsoft PowerPoint 2000                          | Tak     | Tak      |
| Microsoft PowerPoint 2002                          | Tak     | Tak      |
| Microsoft Office PowerPoint 2003                   | Tak     | Tak      |
| Microsoft PowerPoint 2004 dla komputerów Macintosh | Nie     | Nie      |
| Microsoft PowerPoint v. X dla komputerów Macintosh | Nie     | Nie      |
...
#### Luka w zabezpieczeniach programu PowerPoint związana z nieprawidłowo utworzonym wskaźnikiem obiektu — CVE-2006-3435:

W programie PowerPoint istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu. Osoba atakująca może wykorzystać tę lukę w programie PowerPoint podczas analizy pliku zawierającego nieprawidłowo utworzony wskaźnik do obiektu.
...
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym wskaźnikiem obiektu — CVE-2006-3435:

-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
-   Osoba atakująca za pośrednictwem sieci Web, która chce wykorzystać tę lukę, musiałaby udostępniać witrynę zawierającą plik programu Word. Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystywać tę lukę. Intruz nie może w żaden sposób zmusić użytkowników do odwiedzenia szkodliwej witryny. Musi natomiast przekonać ich do jej odwiedzenia, zazwyczaj poprzez kliknięcie łącza do tej witryny.
...
#### Obejścia dotyczące luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym wskaźnikiem obiektu — CVE-2006-3435:
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym wskaźnikiem obiektu — CVE-2006-3435:
...
Podczas przetwarzania zawartości pliku ppt w programie PowerPoint nie jest wystarczająco dokładnie sprawdzana poprawność danych. Jeśli w programie PowerPoint zostanie otwarty i przeanalizowany specjalnie spreparowany plik z nieprawidłowo utworzonym obiektem, może nastąpić uszkodzenie pamięci systemowej, które umożliwi osobie atakującej wykonanie dowolnego kodu.
...
Aktualizacja usuwa lukę, zmieniając sposób, w jaki program PowerPoint analizuje plik i sprawdza poprawność wskaźnika obiektu przed przekazaniem go do przydzielonego buforu.
...
#### Luka w zabezpieczeniach programu PowerPoint związana z nieprawidłowo utworzonym rekordem danych — CVE-2006-3876:

W programie PowerPoint istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu. Osoba atakująca może wykorzystać tę lukę w programie PowerPoint podczas analizy pliku zawierającego nieprawidłowo utworzony rekord danych.

Jeśli użytkownik byłby zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzystałaby tę lukę, mogłaby uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym rekordem danych — 2006-3876:
...
#### Obejścia dotyczące luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym rekordem danych — CVE-2006-3876:

-   Nie należy otwierać ani zapisywać plików programu Microsoft PowerPoint otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym rekordem danych — CVE-2006-3876:
...
**Skąd bierze się luka?**  
Podczas przetwarzania zawartości pliku ppt w programie PowerPoint nie jest wystarczająco dokładnie sprawdzana poprawność danych. Jeśli w programie PowerPoint zostanie otwarty i przeanalizowany specjalnie spreparowany plik z nieprawidłowo utworzonym rekordem danych, może nastąpić uszkodzenie pamięci systemowej, które umożliwi osobie atakującej wykonanie dowolnego kodu.
...
**W jaki sposób działa aktualizacja?**  
Aktualizacja usuwa lukę, zmieniając sposób, w jaki program PowerPoint analizuje plik i sprawdza długość rekordu danych przed przekazaniem go do przydzielonego buforu.
...
#### Luka w zabezpieczeniach programu PowerPoint związana z uszkodzeniem pamięci wynikającym z nieprawidłowego utworzenia rekordu — CVE-2006-3877:
...
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu PowerPoint związanej z z uszkodzeniem pamięci wynikającym z nieprawidłowego utworzenia rekordu — CVE-2006-3877:
...
#### Obejścia dotyczące luki w zabezpieczeniach programu PowerPoint związanej z z uszkodzeniem pamięci wynikającym z nieprawidłowego utworzenia rekordu — CVE-2006-3877:

-   Nie należy otwierać ani zapisywać plików programu Microsoft PowerPoint otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu PowerPoint związanej z uszkodzeniem pamięci wynikającym z nieprawidłowego utworzenia rekordu — CVE-2006-3877:
...
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**  
Osoba atakująca za pośrednictwem sieci Web, która chce wykorzystać tę lukę, może udostępniać witrynę zawierającą odpowiednią stronę sieci Web. Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika lub reklamy, jak również witryny niesprawdzone, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystać lukę w zabezpieczeniach. Jednakże w żadnym przypadku osoba atakująca nie może zmusić użytkowników do odwiedzenia takich witryn. Musi natomiast nakłonić użytkowników do odwiedzenia tej witryny, zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej, które przekieruje użytkowników do witryny osoby atakującej.
Osoba atakująca za pośrednictwem poczty e-mail może wykorzystać tę lukę, wysyłając specjalnie spreparowany plik programu PowerPoint do użytkownika i nakłaniając go do otwarcia takiego pliku.
...
#### Luka w zabezpieczeniach programu PowerPoint związana z nieprawidłowo utworzonym rekordem — CVE-2006-4694:

W programie PowerPoint istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, która może zostać wykorzystana w programie PowerPoint po otwarciu specjalnie spreparowanego pliku. Plik taki może zostać dołączony do wiadomości e-mail lub umieszczony na szkodliwej witrynie sieci Web. Osoba atakująca może wykorzystać tę lukę, tworząc specjalnie spreparowany plik PowerPoint, który potencjalnie umożliwia zdalne wykonanie kodu.

Jeśli użytkownik byłby zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzystałaby tę lukę, mogłaby uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym rekordem — CVE-2006-4694:
...
#### Obejścia dotyczące luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym rekordem — CVE-2006-4694:

-   Nie należy otwierać ani zapisywać plików programu Microsoft PowerPoint otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym rekordem — CVE-2006-4694:
...
**Skąd bierze się luka?**  
Przyczyną tej luki jest błąd dotyczący sposobu otwierania specjalnie spreparowanego pliku w programie PowerPoint. W efekcie podczas analizy symboli zastępczych w programie PowerPoint dochodzi do próby uzyskania dostępu do pamięci spoza wyznaczonych regionów.
...
1.  [Pobierz tę aktualizację zabezpieczeń dla programu PowerPoint 2000 (j.ang.)](http://download.microsoft.com/download/3/6/d/36d75630-5526-404e-aea4-24fb5c8cce1f/office2000-kb923090-fullfile-enu.exe).
...
|--------------|--------------|-------------|---------|-----------|
| Powerpnt.exe | 9.00.00.8952 | 27-wrz-2006 | 5:08    | 4 259 892 |
...
1.  [Pobierz tę aktualizację zabezpieczeń dla programu (j.ang.)](http://download.microsoft.com/download/2/c/5/2c56edfe-dfd3-4ec1-86c4-2f5c57879076/officexp-kb923092-fullfile-enu.exe) PowerPoint 2002.
2.  Kliknij opcję **Zapisz ten program na dysku**, a następnie kliknij przycisk **OK**.
3.  Kliknij przycisk **Zapisz**.
4.  W Eksploratorze Windows znajdź folder zawierający zapisany plik, a następnie kliknij dwukrotnie ten plik.
5.  Po wyświetleniu monitu o zainstalowanie aktualizacji kliknij przycisk **Tak**.
...
| Nazwa pliku  | Wersja          | Data        | Godzina | Rozmiar   |
|--------------|-----------------|-------------|---------|-----------|
| Powerpnt.exe | 10.00.6819.0000 | 28-wrz-2006 | 2:05    | 6 093 584 |
...
1.  [Pobierz tę aktualizację zabezpieczeń dla programu PowerPoint 2002 (j.ang.)](http://download.microsoft.com/download/2/c/5/2c56edfe-dfd3-4ec1-86c4-2f5c57879076/officexp-kb923089-fullfile-enu.exe).
2.  Kliknij opcję **Zapisz ten program na dysku**, a następnie kliknij przycisk **OK**.
3.  Kliknij przycisk **Zapisz**.
4.  Używając programu Windows Explorer, znajdź folder zawierający zapisany plik. Kliknij opcję **Start**, następnie **Uruchom**, wpisz polecenie przedstawione poniżej oraz kliknij przycisk **OK,** aby wyodrębnić plik .msp
    :**\[ścieżka\\nazwa pliku EXE\] /c /t:C:\\AdminUpdate**  
...
1.  [Pobierz tę aktualizację zabezpieczeń dla programu PowerPoint 2003](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe).
2.  Kliknij opcję **Zapisz ten program na dysku**, a następnie kliknij przycisk **OK**.
3.  Kliknij przycisk **Zapisz**.
4.  W Eksploratorze Windows znajdź folder zawierający zapisany plik, a następnie kliknij dwukrotnie ten plik.
5.  Po wyświetleniu monitu o zainstalowanie aktualizacji kliknij przycisk **Tak**.
...
| Nazwa pliku  | Wersja          | Data        | Godzina | Rozmiar   |
|--------------|-----------------|-------------|---------|-----------|
| Powerpnt.exe | 11.00.8110.0000 | 27-wrz-2006 | 1:27    | 6 396 688 |
...
1.  [Pobierz aktualizację zabezpieczeń dla programu PowerPoint 2003 (j.ang.)](http://download.microsoft.com/download/b/a/d/bada0a94-ed11-48ae-b2e2-1d52f6796370/office2003-kb923088-fullfile-enu.exe).
2.  Kliknij opcję **Zapisz ten program na dysku**, a następnie kliknij przycisk **OK**.
3.  Kliknij przycisk **Zapisz**.
4.  Używając programu Windows Explorer, znajdź folder zawierający zapisany plik. Kliknij opcję **Start**, następnie **Uruchom**, wpisz polecenie przedstawione poniżej oraz kliknij przycisk **OK,** aby wyodrębnić plik .msp
    :**\[ścieżka\\nazwa pliku EXE\] /c /t:C:\\AdminUpdate**  
...
#### Microsoft PowerPoint v. X dla komputerów Macintosh
...
-   Arnaud Dovi, współpracownikowi firm [Zero Day Initiative (ZDI)](http://www.zerodayinitiative.com/) i [TippingPoint](http://tippingpoint.com), za zgłoszenie luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym wskaźnikiem obiektu — [CVE-2006-3435 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3435).
-   Dejun Meng z firmy [Fortinet Inc.](http://www.fortinet.com/) za zgłoszenie luki w zabezpieczeniach programu PowerPoint związanej z nieprawidłowo utworzonym rekordem danych — [CVE-2006-3876 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3876).
-   Chrisowi Ries z firmy [VigilantMinds Inc.](http://www.vigilantminds.com) za zgłoszenie luki w zabezpieczeniach programu PowerPoint związanej z uszkodzeniem pamięci wynikającym z nieprawidłowo utworzonego rekordu — [CVE-2006-3877 (j.ang.)](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877).
...
-   Wersja 1.1 (21 lutego 2007 r.): Zaktualizowano biuletyn: Dalsze badanie usterki CVE-2006-3877 wykazało, że aktualizacja nie usuwała jej w wystarczającym stopniu z dotkniętych systemów. Wydany został biuletyn zabezpieczeń Microsoft MS07-015, który rozwiązuje problemy związane z usterką CVE-2006-3877. Zalecamy niezwłoczną instalację aktualizacji zawartej w tym biuletynie.
