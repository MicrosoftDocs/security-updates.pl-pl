---
TOCTitle: 'MS09-045'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-045 - Krytyczna'
ms:assetid: 'ms09-045'
ms:contentKeyID: 61232764
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-045(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS09-045 - Krytyczna
==========================================================

Luka w zabezpieczeniach aparatu skryptów JScript umożliwia zdalne wykonanie kodu (971961)
-----------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla aparatu JScript 5.1 w systemie Microsoft Windows 2000 z dodatkiem Service Pack 4 oraz aparatów JScript 5.6, JScript 5.7 i JScript 5.8 we wszystkich obsługiwanych wersjach systemu operacyjnego Windows z wyjątkiem Windows 7 i Windows Server 2008 R2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób przetwarzania skryptów ze stron sieci Web w aparacie JScript. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 971961 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/971961) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2bb3af8d-f36c-4497-9f48-fc59bcff2583">JScript 5.1 i JScript 5.6</a><br />
(KB971961)</td>
...
**\*\*** W systemach z zainstalowanym programem Internet Explorer 7.
  
**\*\*\*** W systemach z zainstalowanym programem Internet Explorer 8.
...
Firma Microsoft ponownie wydała niniejszy biuletyn, aby dodać program JScript 5.7 w systemie Microsoft Windows 2000 z dodatkiem Service Pack 4 do produktów, których dotyczy problem. Klienci, którzy zainstalowali już tę aktualizację, nie muszą podejmować żadnej czynności.
...
**Która wersja aparatu JScript jest zainstalowana w systemie?**    
Wersja aparatu JScript w systemie zależy od zainstalowanej w tym systemie wersji programu Internet Explorer i zostanie zmieniona na nowszą po zainstalowaniu nowszej wersji programu Microsoft Internet Explorer. Program Internet Explorer 6 zawiera aparat JScript 5.6, Internet Explorer 7 — JScript 5.7, a Internet Explorer 8 — JScript 5.8.
  
Aby ustalić, która wersja aparatu JSript jest zainstalowana w systemie:
  
1. Otwórz program Eksplorator Windows.
  
2. Przejdź do katalogu **%systemroot%\\system32**.
  
3. Kliknij prawym przyciskiem plik **jscript.dll**, wybierz polecenie **Właściwości**, a następnie kliknij kartę **Szczegóły**.
  
Numer wersji zostanie wyświetlony w polu **Wersja pliku**. Jeśli numer wersji pliku rozpoczyna się od **5.8** (na przykład 5.8.7600.16385), w systemie jest zainstalowany aparat JScript 5.8.
  
**Używam aparatu JScript 5.1. Czy ta luka jest dla mnie zagrożeniem?**    
Tak, to oprogramowanie jest zagrożone przez omawianą lukę. Zastosowanie niniejszej aktualizacji spowoduje podniesienie wersji do JScript 5.6. Informacje o plikach zawarte w [artykule 971961 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/971961) odnoszą się do tej sytuacji.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach aparatu JScript umożliwiająca zdalne wykonanie kodu — CVE-2009-1920  
</th>
<th style="border:1px solid black;" >
...
JScript 5.1 w systemie Microsoft Windows 2000 z dodatkiem Service Pack 4
</td>
<td style="border:1px solid black;">
**Krytyczny**   
...
<td style="border:1px solid black;">
JScript 5.6 w systemie Microsoft Windows 2000 z dodatkiem Service Pack 4
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.6 w systemie Windows Server 2003 z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.6 w systemie Windows Server 2003 z dodatkiem Service Pack 2 dla systemów z procesorem x64
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.6 w systemie Windows Server 2003 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.6 w systemie Windows XP z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.6 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7 w systemie Microsoft Windows 2000 z dodatkiem Service Pack 4
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.7\*\* w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7\* w systemie Windows XP z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.7 w systemie Windows XP z dodatkiem Service Pack 3
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7\*\* w systemie Windows Server 2003 z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.7\*\* w systemie Windows Server 2003 z dodatkiem Service Pack 2 dla systemów z procesorem x64
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7\*\* w systemie Windows Server 2003 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.7 w systemach Windows Vista, Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7 w systemie Windows Vista dla systemów z procesorem x64, Windows Vista z dodatkiem Service Pack 1 dla systemów z procesorem x64 oraz Windows Vista z dodatkiem Service Pack 2 dla systemów z procesorem x64
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.7 w systemach Windows Server 2008 i Windows Server 2008 z dodatkiem Service Pack 2\*
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.7 w systemie Windows Server 2008 dla systemów z procesorem x64 oraz Windows Server 2008 z dodatkiem Service Pack 2\* dla systemów z procesorem x64
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.7 w systemie Windows Server 2008 dla systemów z procesorem Itanium i Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8\*\* w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.8\*\*\* w systemach Windows XP z dodatkiem Service Pack 2 i Windows XP z dodatkiem Service Pack 3
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8\*\*\* w systemie Windows Server 2003 z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.8\*\*\* w systemie Windows Server 2003 z dodatkiem Service Pack 2 dla systemów z procesorem x64
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8\*\*\* w systemach Windows Vista, Windows Vista z dodatkiem Service Pack 1 i Windows Vista z dodatkiem Service Pack 2
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.8\*\*\* w systemie Windows Vista dla systemów z procesorem x64, Windows Vista z dodatkiem Service Pack 1 dla systemów z procesorem x64 oraz Windows Vista z dodatkiem Service Pack 2 dla systemów z procesorem x64
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
JScript 5.8\*\*\* w systemach Windows Server 2008 i Windows Server 2008 z dodatkiem Service Pack 2\*
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
JScript 5.8\*\*\* w systemie Windows Server 2008 dla systemów z procesorem x64 oraz Windows Server 2008 z dodatkiem Service Pack 2\* dla systemów z procesorem x64
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
W aparacie skryptów JScript występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, wynikająca ze sposobu przetwarzania skryptów ze stron sieci Web. Luka ta umożliwia zdalne wykonanie kodu, gdy użytkownik otworzy specjalnie spreparowany plik lub odwiedzi witrynę sieci Web, w której działa specjalnie spreparowany skrypt. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzysta tę lukę, może uzyskać pełną kontrolę nad systemem, którego ta luka dotyczy. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1920](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1920).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach aparatu JScript umożliwiającej zdalne wykonanie kodu — CVE-2009-1920
...
#### Obejścia problemu związanego z luką w zabezpieczeniach aparatu JScript umożliwiającą zdalne wykonanie kodu — CVE-2009-1920
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach aparatu JScript umożliwiającej zdalne wykonanie kodu — CVE-2009-1920

**Jaki zakres obejmuje ta luka?**  
W aparacie skryptów JScript występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, wynikająca ze sposobu przetwarzania skryptów ze stron sieci Web. Luka ta umożliwia zdalne wykonanie kodu, gdy użytkownik otworzy specjalnie spreparowany plik lub odwiedzi witrynę sieci Web, w której działa specjalnie spreparowany skrypt. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzysta tę lukę, może uzyskać pełną kontrolę nad systemem, którego ta luka dotyczy. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

**W jaki sposób powstaje luka?**  
Luka w zabezpieczeniach wynika ze sposobu, w jaki aparat skryptów JScript przetwarza skrypty ze stron sieci Web. Jeśli aparat skryptów JScript spróbuje załadować zdekodowany skrypt do pamięci w celu uruchomienia go, może wystąpić uszkodzenie pamięci, po którym program Internet Explorer może przestać odpowiadać, lub które może prowadzić do wykonania kodu.

**Co to jest JScript?**  
JScript to interpretowany, obiektowy język skryptów często używany do tworzenia witryn sieci Web w celu zapewnienia ich większej elastyczności lub interakcyjności. Skrypty JScript można uruchomić tylko po zainstalowaniu interpretera lub hosta, takiego jak aktywne strony serwera (ASP, Active Server Pages), Internet Explorer lub Host skrytpów systemu Windows. Dokładniej, JScript to implementacja specyfikacji ECMA 262 (ECMAScript Edition 3) wykonana przez firmę Microsoft. Więcej informacji na ten temat znajduje się w artykule MSDN [JScript Fundamentals](http://msdn.microsoft.com/en-us/library/6974wx4d(vs.85).aspx) lub w witrynie [ECMA International](http://www.ecma-international.org/) w sieci Web.
...
Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób przetwarzania skryptów ze stron sieci Web w aparacie JScript. Aparat skryptów JScript znajduje się w pliku JScript.dll.
...
<td style="border:1px solid black;">JScript 5.1 i JScript 5.6:<br />
...
<td style="border:1px solid black;">W przypadku aparatów JScript 5.1 i JScript 5.6 użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB971961$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku aparatu JScript 5.7 użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB975542$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/971961">artykuł 971961 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">JScript 5.6 w systemie Windows XP z dodatkiem Service Pack 2:<br />
WindowsXP-kb971961-JS56-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 w systemach Windows XP z dodatkiem Service Pack 2 i Windows XP z dodatkiem Service Pack 3:<br />
WindowsXP-kb971961-JS57-x86-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 w systemach Windows XP z dodatkiem Service Pack 2 i Windows XP z dodatkiem Service Pack 3:<br />
IE8-WindowsXP-kb971961-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.6 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2:<br />
WindowsServer2003.WindowsXP-kb971961-JS56-x64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2:<br />
WindowsServer2003.WindowsXP-kb971961-JS57-x64-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 w systemie Windows XP Professional x64 Edition z dodatkiem Service Pack 2:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Plik dziennika aktualizacji</td>
<td style="border:1px solid black;">JScript 5.6 i 5.7:<br />
KB971961.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania*</strong></td>
<td style="border:1px solid black;">JScript 5.6 i JScript 5.7:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB971961$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\ie8updates\KB971961-IE8\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/971961">artykuł 971961 bazy wiedzy Microsoft Knowledge Base</a></td>
...
**\*** Odinstalowanie aktualizacji zabezpieczeń może nie być możliwe, a weryfikacja klucza rejestru może dawać nieprawidłowe wyniki. Więcej informacji na ten temat znajduje się w [artykule 971961 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/971961).
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">JScript 5.6 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Server 2003:<br />
WindowsServer2003-kb971961-JS56-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Server 2003:<br />
WindowsServer2003-kb971961-JS57-x86-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Server 2003:<br />
IE8-WindowsServer2003-kb971961-x86-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.6 we wszystkich obsługiwanych wersjach x64 systemu Windows Server 2003:<br />
WindowsServer2003.WindowsXP-kb971961-JS56-x64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 we wszystkich obsługiwanych wersjach x64 systemu Windows Server 2003:<br />
WindowsServer2003.WindowsXP-kb971961-JS57-x64-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 we wszystkich obsługiwanych wersjach x64 systemu Windows Server 2003:<br />
IE8-WindowsServer2003.WindowsXP-kb971961-x64-enu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.6 we wszystkich obsługiwanych wersjach systemu Windows Server 2003 dla systemów z procesorem Itanium:<br />
WindowsServer2003-kb971961-JS56-ia64-enu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 we wszystkich obsługiwanych wersjach systemu Windows Server 2003 dla systemów z procesorem Itanium:<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania*</strong></td>
<td style="border:1px solid black;">W przypadku aparatów JScript 5.6 i JScript 5.7 użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB971961$\Spuninst</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">W przypadku aparatu JScript 5.8 użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\ie8updates\KB971961-IE8\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/971961">artykuł 971961 bazy wiedzy Microsoft Knowledge Base</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru*</strong></td>
<td style="border:1px solid black;">JScript 5.6 w systemie Windows Server 2003 z dodatkiem Service Pack 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB971961\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 w systemie Windows Server 2003 z dodatkiem Service Pack 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB971961\Filelist</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 w systemie Windows Server 2003 z dodatkiem Service Pack 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP0\KB971961-IE8\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.6 i JScript 5.7 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB971961\Filelist</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 w systemie Windows Server 2003 x64 Edition z dodatkiem Service Pack 2:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP0\KB971961-IE8\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.6 i JScript 5.7 w systemie Windows Server 2003 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium:<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB971961\Filelist</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">JScript 5.7 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Vista:<br />
Windows6.0-kb971961-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Vista:<br />
IE8-Windows6.0-kb971961-x86 /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 we wszystkich obsługiwanych wersjach x64 systemu Windows Vista:<br />
Windows6.0-kb971961-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 we wszystkich obsługiwanych wersjach x64 systemu Windows Vista:<br />
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">JScript 5.7 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Server 2008:<br />
Windows6.0-kb971961-x86 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 we wszystkich obsługiwanych 32-bitowych wersjach systemu Windows Server 2008:<br />
IE8-Windows6.0-kb971961-x86 /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 we wszystkich obsługiwanych wersjach x64 systemu Windows Server 2008:<br />
Windows6.0-kb971961-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.8 we wszystkich obsługiwanych wersjach x64 systemu Windows Server 2008:<br />
IE8-Windows6.0-kb971961-x64 /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">JScript 5.7 we wszystkich obsługiwanych wersjach systemu Windows Server 2008 dla systemów z procesorem Itanium:<br />
...
-   Ling i Wushi z [team509](http://www.team509.com/), we współpracy z [Zero Day Initiative](http://www.zerodayinitiative.com/) firmy Tipping Point, za zgłoszenie luki w zabezpieczeniach aparatu JScript umożliwiającej zdalne wykonanie kodu (CVE-2009-1920)
...
-   Wersja 1.1 (9 września 2009 r.): Poprawiono nazwę pliku pakietu aktualizacji JScript 5.6 we wszystkich obsługiwanych wersjach systemu Windows Server 2003 opartych na procesorach X64.  
-   Wersja 1.2 (30 września 2009 r.): Dodano informacje na temat znanych problemów związanych z odinstalowaniem aktualizacji zabezpieczeń i weryfikacją klucza rejestru w systemach Windows XP i Windows Server 2003.  
-   Wersja 2.0 (10 listopada 2009 r.): W sekcjach „Programy, których dotyczy problem” i „Wdrażania aktualizacji zabezpieczeń” dodano program JScript 5.7 w systemie Microsoft Windows 2000 z dodatkiem Service Pack 4 (KB975542).
