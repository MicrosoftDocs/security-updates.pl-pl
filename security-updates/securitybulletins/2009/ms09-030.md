...
-   **Wyłączenie modułu DLL konwertera programu Publisher**  
    ...
    **Uwaga** Należy używać ścieżek systemu Windows odpowiednich dla danego systemu. Na przykład „%ProgramFiles(86)%” lub „%windir%\\SysWOW64”.
    ...
    ```
    takeown /f <ŚCIEŻKA_I_NAZWA_PLIKU_64-BITOWEGO>
    icacls <ŚCIEŻKA_I_NAZWA_PLIKU_64-BITOWEGO> /save %TEMP%\ NAZWA_PLIKU _ACL.TXT
    icacls <ŚCIEŻKA_I_NAZWA_PLIKU_64-BITOWEGO> /deny everyone (F) 
    ```
