---
TOCTitle: 'MS09-027'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-027 - Krytyczna'
ms:assetid: 'ms09-027'
ms:contentKeyID: 61232746
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-027(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS09-027 - Krytyczna
==========================================================

Luki w zabezpieczeniach programu Microsoft Office Word umożliwiają zdalne wykonanie kodu (969514)
-------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla wszystkich obsługiwanych wersji programu Microsoft Office Word 2000. Dla wszystkich obsługiwanych wersji programu Microsoft Office Word 2002, programu Microsoft Office Word 2003, programu Microsoft Office Word 2007, pakietu Microsoft Office 2004 dla komputerów Macintosh i pakietu Microsoft Office 2008 dla komputerów Macintosh oraz dla wszystkich obsługiwanych wersji programów Open XML File Format Converter dla komputerów Macintosh, Pakiet zgodności dla systemu Microsoft Office i Podgląd programu Microsoft Office Word ta aktualizacja zabezpieczeń ma wskaźnik ważności „ważny”. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja usuwa lukę, zmieniając sposób, w jaki program Word otwiera i analizuje pliki. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.

**Zalecenie.** Firma Microsoft zaleca klientom natychmiastowe zastosowanie tej aktualizacji.

**Znane problemy.** [W artykule 969514 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/969514) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7e205108-4c28-4cab-a4d0-4ed3fd696473)  
(KB969604)
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7e205108-4c28-4cab-a4d0-4ed3fd696473)  
(KB969604)
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
[Pakiet zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
Nie dotyczy
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Pakiet zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
Nie dotyczy
...
[W artykule 969514 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/969514) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów. Tam, gdzie omówienia znanych problemów i zalecane rozwiązania odnoszą się tylko do określonych wersji tego oprogramowania, w artykule znajdują się łącza do dalszych materiałów.

**W biuletynach MS09-017 i MS09-021 opisano także luki w zabezpieczeniach pakietu Microsoft Office 2004 dla komputerów Macintosh, pakietu Microsoft Office 2008 dla komputerów Macintosh oraz programu Open XML File Format Converter dla komputerów Macintosh. Jaki jest związek biuletynów MS09-017 i MS09-021 z niniejszym biuletynem (MS09-027)?**  
Opisane w tym biuletynie (MS09-027) pakiety aktualizacji zabezpieczeń dla pakietu Microsoft Office 2004 dla komputerów Macintosh (KB969661), Microsoft Office 2008 dla komputerów Macintosh (KB971822) i programu Open XML File Format Converter dla komputerów Macintosh (KB971824) usuwają także luki opisane w biuletynie [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704) i [MS09-021](http://go.microsoft.com/fwlink/?linkid=147294). Użytkownicy pakietów Microsoft Office 2004 dla komputerów Macintosh, Microsoft Office 2008 dla komputerów Macintosh i Open XML File Format Converter dla komputerów Macintosh będą musieli zainstalować te pakiety aktualizacji zabezpieczeń, ale wystarczy jednorazowa instalacja.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu Word związana z przepełnieniem buforu — CVE-2009-0563
</th>
<th style="border:1px solid black;" >
Luka w zabezpieczeniach programu Word związana z przepełnieniem buforu — CVE-2009-0565
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-0563](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0563).

#### Czynniki ograniczające zagrożenie luką w zabezpieczeniach programu Word związaną z przepełnieniem buforu — CVE-2009-0563
...
#### Obejścia problemu spowodowanego luką w zabezpieczeniach programu Word związaną z przepełnieniem buforu — CVE-2009-0563
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Word związanej z przepełnieniem buforu — CVE-2009-0563
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-0565](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0565).

#### Czynniki ograniczające zagrożenie luką w zabezpieczeniach programu Word związaną z przepełnieniem buforu — CVE-2009-0565
...
#### Obejścia problemu spowodowanego luką w zabezpieczeniach programu Word związaną z przepełnieniem buforu — CVE-2009-0565
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Word związanej z przepełnieniem buforu — CVE-2009-0565
...
| Microsoft Office Word 2007 z dodatkiem Service Pack 1 i Microsoft Office Word 2007 z dodatkiem Service Pack 2                                                                                                                                                     | Tak      |
...
| Podgląd programu Microsoft Office Word 2003 z dodatkiem Service Pack 3                                                                                                                                                                                            | Tak      |
...
| Microsoft Office Word 2007 z dodatkiem Service Pack 1 i Microsoft Office Excel 2007 z dodatkiem Service Pack 2                                                                                                                                                    | Nie     | Nie                        | Tak                       | Tak                        |
...
| Podgląd programu Microsoft Office Word 2003 z dodatkiem Service Pack 3                                                                                                                                                                                            | Tak     | Tak                        | Tak                       | Tak                        |
| Podgląd programu Microsoft Office Word                                                                                                                                                                                                                            | Tak     | Tak                        | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/969600">artykuł 969600 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/969602">artykuł 969602 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### Word 2003 (wszystkie wersje), aplet Podgląd programu Word 2003 oraz aplet Podgląd programu Word
...
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Word 2003:<br />
Zobacz <a href="http://support.microsoft.com/kb/969603">artykuł 969603 bazy wiedzy Microsoft Knowledge Base</a>.<br />
<br />
Aplet Podgląd programu Word 2003 oraz aplet Podgląd programu Word:<br />
Zobacz <a href="http://support.microsoft.com/kb/969614">artykuł 969614 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### Word 2007 (wszystkie wersje) i Pakiet zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007
...
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Program Word 2007:<br />
Zobacz <a href="http://support.microsoft.com/kb/969604">artykuł 969604 bazy wiedzy Microsoft Knowledge Base</a>.<br />
<br />
Pakiet zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007:<br />
Zobacz <a href="http://support.microsoft.com/kb/969613">artykuł 969613 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Wushi z [team509](http://www.team509.com/), współpracującemu z firmą [Zero Day Initiative](http://www.zerodayinitiative.com/), za zgłoszenie luki w zabezpieczeniach programu Word związanej z przepełnieniem buforu (CVE-2009-0563).  
-   Nicolas Joly z firmy [VUPEN Security](http://www.vupen.com/), za zgłoszenie luki w zabezpieczeniach programu Word związanej z przepełnieniem buforu (CVE-2009-0565).
