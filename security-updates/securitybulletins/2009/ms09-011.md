---
TOCTitle: 'MS09-011'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-011 - Krytyczna'
ms:assetid: 'ms09-011'
ms:contentKeyID: 61232730
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-011(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS09-011 - Krytyczna
==========================================================

Luka w zabezpieczeniach programu Microsoft DirectShow może pozwolić na zdalne wykonanie kodu (961373)
-----------------------------------------------------------------------------------------------------
...
Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki program DirectShow dekompresuje pliki multimedialne. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
Szczegółowe informacje dotyczące plików znajdują się w [artykule 961373 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/961373).
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach dekompresowania plików MJPEG — CVE-2009-0084
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition i Windows XP Professional x64 Edition z dodatkiem Service Pack 2 i DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 z dodatkiem Service Pack 1 i Windows Server 2003 z dodatkiem Service Pack 2 i DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition i Windows Server 2003 x64 Edition z dodatkiem Service Pack 2 i DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 z dodatkiem SP1 dla systemów z procesorem Itanium i Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium i DirectX 9.0\*
</td>
<td style="border:1px solid black;">
**Krytyczny**   
Zdalne wykonanie kodu
...
W programie Microsoft DirectShow występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, wynikająca ze sposobu obsługi plików o obsługiwanym formacie przez ten program. Luka ta może umożliwić wykonanie kodu, jeśli użytkownik otworzy specjalnie spreparowany plik MJPEG. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzysta tę lukę, może uzyskać pełną kontrolę nad systemem, którego ta luka dotyczy. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-0084](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0084).

#### Czynniki ograniczające zagrożenie spowodowane przez lukę w zabezpieczeniach dekompresowania plików MJPEG — CVE-2009-0084
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z dekompresowaniem plików MJPEG — CVE-2009-0084

Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:

-   **Wyłączenie dekodowania treści MJPEG w pliku Quartz.dll**  
    ...
    **Stosowanie metody interakcyjnej**
    ...
    2.  Odnajdź i kliknij następujący podklucz rejestru: HKEY\_CLASSES\_ROOT\\CLSID\\{301056D0-6DFF-11D2-9EEB-006008039E37}
    3.  Kliknij menu **Plik** i wybierz polecenie **Eksportuj**.
    4.  W oknie dialogowym Eksportuj plik rejestru wprowadź nazwę **MJPEG\_Decoder\_Backup.reg** i kliknij przycisk **Zapisz**.  
    ...
    **Wpływ obejścia. **Odtwarzanie treści MJPEG zostanie wyłączone.
    ...
    **Cofnięcie obejścia.**
    ...
    3.  W oknie dialogowym Importuj plik rejestru wybierz plik **MJPEG\_Decoder\_Backup.reg** i kliknij przycisk **Otwórz**.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z dekompresowaniem plików MJPEG — CVE-2009-0084
...
Składnik Microsoft DirectShow nie obsługuje odpowiednio specjalnie spreparowanych, skompresowanych plików.
...
Ta luka w zabezpieczeniach wymaga, aby użytkownik otworzył specjalnie spreparowany plik MJPEG lub odebrał specjalnie spreparowany strumień danych z witryny sieci Web lub dowolnej aplikacji dostarczającej treści dla sieci Web.
...
Ta aktualizacja usuwa problem, modyfikując sposób, w jaki składnik DirectShow dekompresuje pliki multimedialne.
...
<td style="border:1px solid black;">Microsoft Windows 2000 z dodatkiem Service Pack 4 i programem DirectX 8.1:<br />
...
<br />
Microsoft Windows 2000 z dodatkiem Service Pack 4 i programem DirectX 8.1:<br />
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/961373">artykuł 961373 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">Instalowanie bez ponownego uruchomienia</td>
<td style="border:1px solid black;">Wszystkie obsługiwane 32-bitowe wersje systemu Windows XP z dodatkiem Service Pack 3 i programem DirectX 9.0, DirectX 9.0a, DirectX 9.0b lub DirectX 9.0c:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania</strong></td>
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB961373$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/961373">artykuł 961373 bazy wiedzy Microsoft Knowledge Base</a></td>
...
-   Piotrowi Bani z firmy [Kryptos Logic](http://www.kryptoslogic.com/) za zgłoszenie luki w zabezpieczeniach dekompresowania plików MJPEG (CVE-2009-0084)
...
-   Wersja 1.1 (22 kwietnia 2009 r.): Do tabeli „Programy, których nie dotyczy problem” dodano system Microsoft Windows 2000 z dodatkiem Service Pack 4 i programem DirectX 7.0. Zmiana ta ma wyłącznie charakter informacyjny.
