---
TOCTitle: 'MS09-007'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-007 - Ważna'
ms:assetid: 'ms09-007'
ms:contentKeyID: 61232726
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-007(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS09-007 - Ważna
======================================================

Luka w zabezpieczeniach SChannel może pozwolić na fałszowanie (960225)
----------------------------------------------------------------------
...
Aktualizacja zabezpieczeń usuwa lukę w zabezpieczeniach, zmieniając sposób, w jaki serwer analizuje dane wymiany klucza w trakcie fazy uzgadniania TLS. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 z dodatkiem Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=bf7065bc-c183-4a78-8d46-72fe7385c07c)                                                                                                                   | Fałszowanie                        | Ważny                      | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Microsoft Windows XP z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=942d87f6-3cb1-4d36-a70a-70d9c34488f3)                                                                                                                     | Fałszowanie                        | Ważny                      | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=942d87f6-3cb1-4d36-a70a-70d9c34488f3)                                                                                                                               | Fałszowanie                        | Ważny                      | Brak                                                     |
| [Windows XP Professional x64 Edition oraz Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6d02306e-9e2e-4ae8-bd21-8a2c1a229472)                                                             | Fałszowanie                        | Ważny                      | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Server 2003 z dodatkiem Service Pack 1 i Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0b3f6fdd-276e-4267-99d8-8f00d91ad6a2)                                                                     | Fałszowanie                        | Ważny                      | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Server 2003 x64 Edition i Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ce98ff55-f565-469d-bbd2-32b681faf908)                                                                        | Fałszowanie                        | Ważny                      | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Systemy operacyjne Windows Server 2003 z dodatkiem SP1 dla systemów z procesorem Itanium oraz Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=5ca3c72c-cadb-4b0a-b3a3-fb81d0bfd7b3) | Fałszowanie                        | Ważny                      | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Vista i Windows Vista z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=21086a04-402a-4940-8358-7fa63508102b)                                                                                                            | Fałszowanie                        | Ważny                      | Brak                                                     |
| [Windows Vista x64 Edition i Windows Vista x64 Edition z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c75a2ea9-b42f-457b-be09-5c8fa0339388)                                                                                    | Fałszowanie                        | Ważny                      | Brak                                                     |
| [Windows Server 2008 dla systemów 32-bitowych\*](http://www.microsoft.com/downloads/details.aspx?familyid=47b361ce-624b-466c-b5c5-8703f6532615)                                                                                                                      | Fałszowanie                        | Ważny                      | Brak                                                     |
| [Windows Server 2008 dla systemów opartych na procesorach X64](http://www.microsoft.com/downloads/details.aspx?familyid=5c81ac45-60e6-4121-ab6b-d3b3179aacc4)\*                                                                                                      | Fałszowanie                        | Ważny                      | Brak                                                     |
| [Windows Server 2008 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=bf8f5a86-1757-4f9b-b632-d4aa7005a9f8)                                                                                                               | Fałszowanie                        | Ważny                      | Brak                                                     |
...
Szczegółowe informacje dotyczące plików znajdują się w [artykule 960225 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/960225).
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach SChannel związana z fałszowaniem — CVE-2009-0085</th>
...
Luka w zabezpieczeniach SChannel związana z fałszowaniem — CVE-2009-0085  
------------------------------------------------------------------------
  
W składniku uwierzytelniania Microsoft Windows SChannel istnieje luka w zabezpieczeniach związana z fałszowaniem, która występuje podczas korzystania z uwierzytelniania bazującego na certyfikatach. Osoba atakująca, której uda się wykorzystać te lukę, może uwierzytelnić się na serwerze, dysponując tylko certyfikatem cyfrowym uwierzytelnionego użytkownika bez powiązanego klucza prywatnego.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-0085](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0085).
  
#### Czynniki ograniczające zagrożenie luką w zabezpieczeniach SChannel związaną z fałszowaniem — CVE-2009-0085
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Luka dotyczy użytkowników tylko wtedy, gdy certyfikat używany do uwierzytelniania zostanie wcześniej innymi drogami ujawniony osobie atakującej. W przypadku serwera IIS podczas uwierzytelniania certyfikaty nie są przesyłane w zwykłym formacie tekstowym.  
-   Zagrożone są tylko lokalnie skonfigurowane konta użytkowników. Klienci mapujący użytkowników aplikacji uwierzytelnionych przy użyciu certyfikatu do domeny Active Directory nie są zagrożeni przez omawianą lukę.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach SChannel związaną z fałszowaniem — CVE-2009-0085
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   Klienci mogą zastosować mapowanie certyfikatów Active Directory, które nie jest dotknięte przez omawianą lukę. Mapowanie certyfikatów Active Directory pozwala użytkownikowi posiadającemu zaufany klucz publiczny na dostęp do zasobów domeny bez konieczności wpisywania nazwy użytkownika i hasła. Certyfikat klienta może być zmapowany bezpośrednio na konto użytkownika Active Directory.  
    Aby uzyskać więcej informacji na temat różnych sposobów konfigurowania mapowania certyfikatów, zobacz [Mapowanie certyfikatów do kont użytkowników](http://technet.microsoft.com/en-us/library/cc736706.aspx).
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach SChannel związanej z fałszowaniem — CVE-2009-0085
  
**Jaki zakres obejmuje ta luka?**    
W składniku uwierzytelniania Microsoft Windows SChannel istnieje luka w zabezpieczeniach związana z fałszowaniem, która występuje podczas korzystania z uwierzytelniania bazującego na certyfikatach. Osoba atakująca, której uda się wykorzystać tę lukę, może podszyć się pod innego użytkownika i uwierzytelnić się na chronionym serwerze przy użyciu publicznego składnika poświadczeń uwierzytelniania tego użytkownika.
  
**W jaki sposób powstaje luka?**    
Składnik uwierzytelniania SChannel nie stosuje wystarczającego sprawdzenia poprawności określonych komunikatów uzgadniania TLS w celu upewnienia się, że klient naprawdę ma dostęp do klucza prywatnego powiązanego z certyfikatem użytym do uwierzytelniania.
  
**Co to jest pakiet zabezpieczeń bezpiecznego kanału (SChannel)?**    
Pakiet zabezpieczeń Bezpieczny kanał (Schannel) to dostawca obsługi zabezpieczeń (SSP) wdrażający protokoły SSL (Secure Sockets Layer) i TLS (Transport Layer Security), będące standardowymi protokołami uwierzytelniania w Internecie. Składniki te służą do zaprowadzenia bezpiecznej komunikacji wspierającej szereg typowych zastosowań związanych z Internetem i aplikacjami, takich jak przeglądanie sieci Web. Schannel wchodzi w skład pakietu zabezpieczeń realizującego usługę uwierzytelniania zapewniającą bezpieczeństwo komunikacji między klientem a serwerem. Więcej informacji na temat usług SChannel można znaleźć w następującej [witrynie MSDN poświęconej SChannel.](http://msdn.microsoft.com/en-us/library/ms678421.aspx)
  
**Co to jest certyfikat cyfrowy x.509?**    
Techniki szyfrowania wykorzystujące klucze prywatne i publiczne wymagają infrastruktury klucza publicznego (PKI), aby obsłużyć dystrybucję i certyfikacje kluczy publicznych. W certyfikatach cyfrowych spakowane są klucze publiczne, informacje o używanych algorytmach, dane właściciela lub podmiotu, podpis cyfrowy Urzędu Certyfikacji, który zweryfikował dane podmiotu oraz zakres dat, w którym certyfikat może być uważany za ważny.
  
Klient, taki jak program Internet Explorer, może sprawdzić poprawność certyfikatu cyfrowego, aby upewnić się, że serwer, z którym łączy się użytkownik, w rzeczywistości jest uprawnionym serwerem dla danej nazwy hosta. Certyfikaty mogą także służyć jako poświadczenia zabezpieczające na potrzeby uwierzytelniania i autoryzacji użytkowników.
  
**Co to jest biblioteka Microsoft Secure Sockets Library?**    
Biblioteka Microsoft Secure Sockets Layer umożliwia obsługę szeregu bezpiecznych protokołów komunikacji. Obejmuje to protokoły Transport Layer Security 1.0 (TLS 1.0), Secure Sockets Layer 3.0 (SSL 3.0), starszy i rzadko stosowany protokół Secure Sockets Layer 2.0 (SSL 2.0) oraz protokół Private Communication Technology 1.0 (PCT 1.0).
  
Protokoły te umożliwiają nawiązanie szyfrowanego połączenia między serwerem a systemem klienta. Protokół SSL może pomóc chronić informacje w przypadku nawiązywania przez użytkowników połączeń w sieciach publicznych, takich jak Internet. Obsługa SSL wymaga certyfikatu SSL, który musi być zainstalowany na serwerze. Aby uzyskać więcej informacji na temat protokołu SSL, zobacz [XADM: działanie protokołu Secure Sockets Layer](http://support.microsoft.com/default.aspx?scid=kb;en-us;q245152).
  
**Co to jest uzgadnianie TLS?**    
...
**Co to jest dostawca obsługi zabezpieczeń (SSP)?**    
Dostawca obsługi zabezpieczeń (SSP) ustanawia wspólny interfejs między aplikacjami warstwy transportowej, jak np. Microsoft Remote Procedure Call (RPC), i dostawcami zabezpieczeń, takimi jak Windows Distributed Security. Odbywa się to poprzez udostępnienie aplikacjom jednego lub większej liczby pakietów zabezpieczeń. Każdy pakiet zapewnia mapowanie między wywołaniami funkcji interfejsu dostawcy obsługi zabezpieczeń aplikacji a rzeczywistymi funkcjami protokołu zabezpieczeń. Pakiety zabezpieczeń obsługują takie protokoły zabezpieczeń, jak uwierzytelnianie Kerberos i Microsoft LAN Manager.
  
**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**    
Osoba atakująca może wykorzystać tę lukę do uwierzytelnienia się na chronionym serwerze i podszycia pod autoryzowanego użytkownika pomimo nieposiadania dostępu do klucza prywatnego tego użytkownika, który jest zazwyczaj wymagany do udanego uwierzytelniania na serwerach skonfigurowanych tak, aby wymagały uwierzytelniania klienta.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**    
Osoba atakująca musiałaby uzyskać dostęp do publicznego składnika certyfikatu, z którego użytkownik końcowy korzysta przy uwierzytelnianiu. Następnie mogłaby spreparować pakiet protokołu Transport Layer Security (TLS), aby ominąć sprawdzanie poprawności stosowane przez składnik SChannel w celu upewnienia się, że klucz prywatny jest obecny podczas uwierzytelniania.
  
W typowych wdrożeniach certyfikaty stosowane do uwierzytelniania klienta mają tylko jedno zakładane przeznaczenie, które konfiguruje się w kliencie systemu Windows. Certyfikaty te przesyła się tylko w określonym celu, na przykład podczas uwierzytelniania w sieci Web. W przypadku połączenia SSL z serwerem IIS (Internet Information Services) w sieci Web klucz publiczny nigdy nie jest przesyłany w formacie zwykłego tekstu. Jednakże w przypadkach, gdy jednego certyfikatu używa się równocześnie do uwierzytelniania klienta i innych celów, jak na przykład przy podpisywaniu wiadomości e-mail, lub gdy certyfikat służy do uwierzytelniania w wielu witrynach sieci Web, klucz publiczny może być szerzej rozpowszechniany.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**    
Omawiana luka dotyczy takich usług, jak serwery sieci Web, które korzystają z uwierzytelniania opartego na certyfikatach i podczas procesu uwierzytelniania wymagają od użytkownika udowodnienia posiadania odpowiadającego klucza prywatnego certyfikatu.
  
**W jaki sposób działa aktualizacja?**    
Aktualizacja usuwa lukę w zabezpieczeniach, zmieniając sposób, w jaki serwer analizuje dane wymiany klucza w trakcie fazy uzgadniania TLS.
...
<td style="border:1px solid black;">Microsoft Windows 2000 z dodatkiem Service Pack 4:<br />
Użyj narzędzia Dodaj lub usuń programy w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB960225$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/960225">artykuł 960225 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania</strong></td>
<td style="border:1px solid black;">Użyj narzędzia Dodaj lub usuń programy w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB960225$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/960225">artykuł 960225 bazy wiedzy Microsoft Knowledge Base</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania</strong></td>
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB960225$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/960225">artykuł 960225 bazy wiedzy Microsoft Knowledge Base</a></td>
...
-   [Secretaria da Fazenda do Estado do Rio Grande do Sul](http://www.sefaz.rs.gov.br/) za zgłoszenie luki w zabezpieczeniach SChannel związanej z fałszowaniem (CVE-2009-0085)  
-   [Cia de Processamento de Dados do Estado do Rio Grande do Sul](http://www.procergs.rs.gov.br/) za zgłoszenie luki w zabezpieczeniach SChannel związanej z fałszowaniem (CVE-2009-0085)
