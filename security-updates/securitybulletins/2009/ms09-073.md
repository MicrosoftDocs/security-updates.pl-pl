---
TOCTitle: 'MS09-073'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-073 - Ważna'
ms:assetid: 'ms09-073'
ms:contentKeyID: 61232792
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-073(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS09-073 - Ważna
======================================================

Luka w zabezpieczeniach konwerterów tekstu programu WordPad oraz pakietu Office może umożliwić zdalne wykonanie kodu (975539)
-----------------------------------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla programu WordPad we wszystkich obsługiwanych wersjach systemów Microsoft Windows 2000, Windows XP i Windows Server 2003. Ma ona także wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji programu Microsoft Office Word 2002 oraz Microsoft Office Word 2003, Microsoft Office Converter Pack oraz Microsoft Works 8.5. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki program WordPad oraz konwertery tekstu pakietu Office analizują dokumenty programu Word 97. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.

**Zalecenie.** Firma Microsoft zaleca klientom jak najszybsze zastosowanie tej aktualizacji.

**Znane problemy.**[W artykule 975539 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/975539) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=50936f51-b0a9-4e94-85bf-93f9ad74fdd1">Microsoft Windows 2000 z dodatkiem Service Pack 4</a><br />
(KB973904)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c090c4c2-c277-4d8c-91e1-28286bc5443e">Windows XP z dodatkiem Service Pack 2 i Windows XP z dodatkiem Service Pack 3</a><br />
(KB973904)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4b9bf156-cd34-460f-b4ad-571e37f54659">Windows XP Professional x64 Edition z dodatkiem Service Pack 2</a><br />
(KB973904)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b9678229-2473-4aae-a814-eca9ea556d17">Windows Server 2003 z dodatkiem Service Pack 2</a><br />
(KB973904)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=257facf3-20a1-49e2-ab4c-c1ae67fe05a0">Windows Server 2003 x64 Edition z dodatkiem Service Pack 2</a><br />
(KB973904)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=1a7784ef-5d25-4de1-a293-f742b5a3473d">Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium</a><br />
(KB973904)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;">Brak</td>
...
| Pakiet Office i inne programy                                                                                                                                                                                                                                     |
| Microsoft Office 2007 z dodatkiem Service Pack 1 i Microsoft Office 2007 z dodatkiem Service Pack 2                                                                                                                                                               |
...
**Dlaczego niniejszy biuletyn zabezpieczeń został zaktualizowany w dniu 13 stycznia 2010 r.?**  
Firma Microsoft zaktualizowała niniejszy biuletyn w celu zmiany nazwy pakietów aktualizacyjnych, które były wcześniej wymieniane jako **Microsoft Office Word 2002 z dodatkiem Service Pack 3 (KB975008)** i **Microsoft Office Word 2003 z dodatkiem Service Pack 3 (KB975051)**, odpowiednio na **Microsoft Office XP z dodatkiem Service Pack 3 (KB975008)** i **Microsoft Office 2003 z dodatkiem Service Pack 3 (KB975051)**. Jest to spowodowane tym, że te pakiety aktualizacyjne odnoszą się nie tylko do programu Microsoft Office Word, ale także do konwerterów tekstu, które są używane powszechnie w pakiecie Microsoft Office. Tabela „Programy, których dotyczy problem” i informacje dotyczące wdrażania zostały odpowiednio poprawione. Zmiana objęła tylko biuletyn. Nie wprowadzono żadnych zmian w logice wykrywania ani plikach aktualizacji. Klienci, którym udało się zaktualizować swoje systemy, włącznie z klientami z włączoną funkcję automatycznych aktualizacji, nie muszą podejmować żadnej czynności. Klienci, którzy nie zainstalowali wcześniej tej aktualizacji, mogą dokonać ponownej oceny, czy ich systemy wymagają aktualizacji, opierając się na poprawionej tabeli „Programy, których dotyczy problem”.
...
Tak, oprócz usunięcia luki w zabezpieczeniach niniejsza aktualizacja zapobiega także używaniu konwertera tekstu Word 6 programu WordPad do otwierania plików programów Word 6.0 i Write przez składniki systemu Windows i aplikacje innych producentów na platformach, których dotyczy problem. Kiedy program WordPad spróbuje otworzyć plik Word 6.0 lub Write, plik nie zostanie otwarty i zostanie wyświetlone okno dialogowe. Więcej informacji na ten temat można znaleźć w [artykule 975539 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/975539).

**Jakie znane problemy mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń?**  
W [artykule 975539 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/975539) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach związana z uszkodzeniem pamięci konwertera tekstu programu WordPad i pakietu Office - CVE-2009-2506
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
Luka umożliwiająca zdalne wykonanie kodu występuje w sposobie przetwarzania pamięci przez konwertery tekstu programów Microsoft WordPad i Microsoft Office Word w sytuacji, gdy użytkownik otworzy specjalnie spreparowany plik w formacie Word 97.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-2506](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2506).

#### Czynniki ograniczające zagrożenie w przypadku luki w zabezpieczeniach związanej z uszkodzeniem pamięci konwertera tekstu programu WordPad i pakietu Office - CVE-2009-2506
...
-   Witryna sieci Web wykorzystywana do prób wykorzystania omawianej luki spowodowałaby wyświetlenie okna dialogowego. Użytkownik zostałby zapytany, czy chce otworzyć plik, o ile uprzednio nie usunąłby zaznaczenia opcji „Zawsze pytaj przed otwarciem pliku tego typu”.

#### Obejścia problemu dotyczącego luki w zabezpieczeniach związanej z uszkodzeniem pamięci konwertera tekstu programu WordPad i pakietu Office - CVE-2009-2506
...
-   **Wyłączenie konwertera tekstu programu WordPad dla formatu Word 97 poprzez ograniczenie dostępu do pliku konwertera**  
    ...
    Uruchom następujące polecenia z wiersza polecenia administratora:
  
    **Uwaga** Przed zainstalowaniem aktualizacji zabezpieczeń należy cofnąć to obejście.

    W zależności od wersji systemu operacyjnego oraz historii jego aktualizacji i instalowania dodatków Service Pack niektóre z wymienionych poniżej plików mogą nie istnieć.
    ...
    **Wpływ obejścia.** Podczas otwierania dokumentu Word 97 w programie WordPad zamiast sformatowanego tekstu będą widoczne dane binarne.

    **Jak cofnąć obejście.** Uruchom następujące polecenia z wiersza polecenia administratora:
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci konwertera tekstu programu WordPad i pakietu Office - CVE-2009-2506
...
Luka w zabezpieczeniach wynika ze sposobu, w jaki konwerter tekstu dla plików formatu Word 97 (dołączony jako część programu WordPad oraz jako część konwerterów tekstu pakietu Office) analizuje specjalnie spreparowane dokumenty Word 97.
...
Szczególnie narażone na skutki tej luki są takie systemy jak stacje robocze i serwery terminalowe, w których zainstalowano program WordPad lub Microsoft Office Word i w których otwiera się dokumenty programu Word pochodzące z niezaufanych źródeł. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie programów. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.

**W jaki sposób działa aktualizacja?**  
Aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki program WordPad oraz konwertery tekstu pakietu Office analizują dokumenty programu Word 97.
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB973904$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/973904">artykuł 973904 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/975008">artykuł 975008 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
| Produkty ACCESS, OUTLOOK, PPT, PRJPRO, PRJSTD | TextConverters                                                                                     |  
| Produkty FP, PROPLUS                          | FPClientNonBootFiles, TextConverters, TCWord6Files, TCWord97Files, TCWP6Files, ProductNonBootFiles |  
| Produkty PRO, PUB, SBE, STDEDU, STD, WORD     | TextConverters, TCWord6Files, TCWord97Files, TCWP6Files                                            |
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/974882">artykuł 975051 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Microsoft Works 8.5:<br />
Zobacz <a href="http://support.microsoft.com/kb/977304">artykuł 977304 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/974882">artykuł 974882 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Seanowi Larsson i Jun Mao z firmy [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci konwertera tekstu programu WordPad i pakietu Office (CVE-2009-2506)
...
-   Wersja 1.1 (9 grudnia 2009 r.): Z tabeli „Programy, których dotyczy problem” usunięto nadmiarowy wpis dotyczący Pakietu zgodności formatu plików pakietu Microsoft Office. Poprawiono także kilka wpisów w tabelach dotyczących wdrażania w celu wyjaśnienia, że w niektórych przypadkach ta aktualizacja nie wymaga ponownego uruchomienia komputera. Zmiana ta ma wyłącznie charakter informacyjny.  
-   Wersja 2.0 (13 stycznia 2010 r.): Zmieniono nazwy pakietów aktualizacyjnych, które były wcześniej wymieniane jako **Microsoft Office Word 2002 z dodatkiem Service Pack 3 (KB975008)** i **Microsoft Office Word 2003 z dodatkiem Service Pack 3 (KB975051)**, odpowiednio na **Microsoft Office XP z dodatkiem Service Pack 3 (KB975008)** i **Microsoft Office 2003 z dodatkiem Service Pack 3 (KB975051)**. Dodano sekcję Często zadawane pytania dotyczące aktualizacji w celu wyjaśnienia, że zmiana dotyczy tylko tego biuletynu. Nie wprowadzono żadnych zmian w logice wykrywania ani plikach aktualizacji. Klienci, którym udało się zaktualizować swoje systemy, nie muszą podejmować żadnej czynności.
