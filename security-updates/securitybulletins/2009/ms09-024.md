---
TOCTitle: 'MS09-024'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-024 - Krytyczna'
ms:assetid: 'ms09-024'
ms:contentKeyID: 61232743
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-024(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS09-024 - Krytyczna
==========================================================

Luka w zabezpieczeniach konwerterów pakietu Microsoft Works może umożliwić zdalne wykonanie kodu (957632)
---------------------------------------------------------------------------------------------------------

Opublikowano: 9 czerwca 2009 | Zaktualizowano: 13 października 2009
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla obsługiwanych wersji programu Microsoft Office Word 2000. Ma ona ponadto wskaźnik ważności „ważny” dla obsługiwanych wersji programów Microsoft Office Word 2002, Microsoft Office Word 2003 z programem Microsoft Works 6–9 File Converter, programu Microsoft Office Word 2007 z dodatkiem Service Pack 1 oraz pakietu Microsoft Works 8.5 i Microsoft Works 9. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń eliminuje lukę w zabezpieczeniach poprzez zmianę sposobu, w jaki pakiet Microsoft Office otwiera pliki pakietu Works. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Dlaczego 13 października 2009 r. zmieniono niniejszy biuletyn?**    
Firma Microsoft uzupełniła niniejszy biuletyn o informację o dodaniu innych wersji językowych aktualizacji programu Works 9. Dodatkowe języki obejmują chorwacki, czeski, estoński, łotewski, litewski, macedoński, słowacki, słoweński i ukraiński. Program Works 9 nie był dostępny w tych językach w chwili publikacji pierwotnej wersji niniejszego biuletynu. Poprawiona wersja biuletynu nie dotyczy klientów, którzy zainstalowali już oryginalną aktualizację programu Works 9.
...
**Dlaczego ta aktualizacja ma krytyczny wskaźnik ważności dla programu Word 2000 i tylko wskaźnik „ważny” dla wszystkich pozostałych wersji programu Word zagrożonych przez lukę?**    
...
**W biuletynie MS09-017 opisano także luki w zabezpieczeniach pakietu Microsoft Works 8.5 i Microsoft Works 9. Jaki jest związek biuletynu MS09-017 z niniejszym biuletynem (MS09-024)?**    
Pakiety aktualizacji zabezpieczeń dla pakietów Microsoft Works 8.5 (KB967043) i Microsoft Works 9 (KB967044) znajdujące się w tym biuletynie (MS09-024) usuwają także luki opisane w biuletynie [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704). Użytkownicy pakietów Microsoft Works 8.5 i Microsoft Works 9 będą musieli zainstalować te pakiety aktualizacji zabezpieczeń, ale wystarczy jednorazowa instalacja.

**Co to jest Microsoft Works 6-9 File Converter?**    
Program Microsoft Works 6-9 Converter umożliwia programowi Microsoft Office Word 2003 otwieranie, edycję i zapisywanie plików w formacie Works Word Processor obsługiwanym przez pakiet Works w wersji 6, 7, 8 i 9. Aby uzyskać więcej informacji, zobacz stronę [Microsoft Works 6–9 File Converter](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en).
...
<th style="border:1px solid black;" >
Luka w zabezpieczeniach konwertera plików związana z przepełnieniem buforu — CVE-2009-1533
</th>
<th style="border:1px solid black;" >
Zbiorczy wskaźnik ważności
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Office 2007 z dodatkiem Service Pack 1
</td>
<td style="border:1px solid black;">
**Ważny**  
Zdalne wykonanie kodu
...
W zabezpieczeniach konwerterów dokumentów pakietu Works dla systemu Windows istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu i wynikająca ze sposobu obsługi specjalnie spreparowanych plików pakietu Works. Luka ta może pozwolić na zdalne wykonanie kodu, jeśli użytkownik otworzy specjalnie spreparowany plik .wps. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.

Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1533](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1533).

#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach konwertera plików związanej z przepełnieniem buforu — CVE-2009-1533

Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:

-   System Microsoft Office 2007 z dodatkiem Service Pack 2 nie jest zagrożony przez omawianą lukę.
-   Zagrożenie dotyczy pakietu Microsoft Office Word 2003, tylko jeśli zainstalowany jest podlegający luce konwerter pakietu Works. Aby uzyskać więcej informacji, zobacz stronę [Microsoft Works 6–9 File Converter](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en).
...
#### Obejścia problemu wynikającego z luki w zabezpieczeniach konwertera plików związanej z przepełnieniem buforu — CVE-2009-1533

Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:

-   **Wyłączenie konwerterów pakietu Works 4.x poprzez ograniczenie dostępu w przypadku programów Word 2000 i Word 2002**  

    Administrator może zastosować listę kontroli dostępu do konwerterów, których dotyczy problem, aby konwertery nie były ładowane przez pakiety Works i Office. To skutecznie zapobiega wykorzystaniu luki do ataku tą metodą.
    ...
    **Wpływ obejścia.** Po wprowadzeniu obejścia użytkownik nie będzie już mógł otwierać ani zapisywać dokumentów Works 4.x. Próba otwarcia dokumentu pakietu Works 4.x będzie zwracać błąd z komunikatem „Plik jest prawdopodobnie uszkodzony”.

-   **Wyłączenie konwerterów pakietu Works 6-9 poprzez ograniczenie dostępu w przypadku programu Word 2003 z programem** [**Microsoft Works 6–9 File Converter**](http://www.microsoft.com/downloads/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en) **i Word 2007**  

    Administrator może zastosować listę kontroli dostępu do konwerterów, których dotyczy problem, aby konwerter nie był ładowany przez pakiety Works i Office. To skutecznie zapobiega wykorzystaniu luki do ataku tą metodą.
    ...
    **Wpływ obejścia.** Po wprowadzeniu obejścia użytkownik nie będzie już mógł otwierać ani zapisywać dokumentów Works 6-9. Próba otwarcia dokumentu pakietu Works 6-9 będzie zwracać błąd z komunikatem „Plik jest prawdopodobnie uszkodzony”.

#### Często zadawane pytania dotyczące luki w zabezpieczeniach konwertera plików związanej z przepełnieniem buforu — CVE-2009-1533
...
Jeśli zostanie otwarty specjalnie spreparowany plik pakietu Works, może dojść do uszkodzenia pamięci systemowej w sposób umożliwiający osobie atakującej wykonanie dowolnego kodu.
...
Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik pakietu Works przy użyciu zagrożonej tą luką wersji oprogramowania.

W scenariuszu ataku za pośrednictwem poczty elektronicznej osoba atakująca może wykorzystać tę lukę poprzez wysłanie do użytkownika specjalnie spreparowanego pliku pakietu Works i nakłonienie użytkownika do jego otwarcia.

W przypadku ataku za pośrednictwem sieci Web witryna sieci Web mogłaby zawierać plik pakietu Works służący do wykorzystania tej luki. Osoba atakująca musiałaby przekonać użytkowników do odwiedzenia tej witryny i otwarcia specjalnie spreparowanego pliku pakietu Works, najczęściej zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej przekierowującego do witryny sieci Web osoby atakującej.
...
Ta aktualizacja eliminuje lukę w zabezpieczeniach poprzez zmianę sposobu, w jaki pakiet Microsoft Office otwiera pliki pakietu Works.
...
| Microsoft Office 2007 z dodatkiem Service Pack 1 | Tak      |
...
| Office 2003 z dodatkiem Service Pack 3           | Tak     | Tak                        | Tak                       | Tak                        |
| Microsoft Office 2007 z dodatkiem Service Pack 1 | Nie     | Nie                        | Tak                       | Tak                        |
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/957838">artykuł 957838 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/957646">artykuł 957646 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
#### Word 2003 (wszystkie wersje) z programem Microsoft Works 6–9 File Converter
...
<tr class="even">
<td style="border:1px solid black;">Instalowanie bez interwencji użytkownika</td>
<td style="border:1px solid black;">Program Microsoft Office Word 2003 z programem Microsoft Works 6-9 File Converter:<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/968326">artykuł 968326 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/969559">artykuł 969559 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Weryfikacja klucza rejestru</strong></td>
<td style="border:1px solid black;">Nie dotyczy</td>
...
-   Shaun Colley z firmy [NGS Software](http://www.ngssoftware.com/) i Yuji Ukai z [Fourteenforty Research Institute, Inc.](http://www.fourteenforty.jp/) za zgłoszenie luki w zabezpieczeniach konwertera plików związanej z przepełnieniem buforu (CVE-2009-1533)
...
-   Wersja 1.1 (13 października 2009 r.): Biuletyn uzupełniono o informację o dodaniu innych wersji językowych aktualizacji programu Works 9. Poprawiona wersja biuletynu nie dotyczy klientów, którzy zainstalowali już oryginalną aktualizację programu Works 9.
