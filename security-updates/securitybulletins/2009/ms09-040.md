---
TOCTitle: 'MS09-040'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-040 - Ważna'
ms:assetid: 'ms09-040'
ms:contentKeyID: 61232759
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-040(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS09-040 - Ważna
======================================================

Luka w zabezpieczeniach usługi kolejkowania wiadomości umożliwia podniesienie uprawnień (971032)
------------------------------------------------------------------------------------------------

Opublikowano: 11 sierpnia 2009 | Zaktualizowano: 30 czerwca 2010
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik „ważny” dla systemów Microsoft Windows 2000 z dodatkiem Service Pack 4, Windows XP z dodatkiem Service Pack 2 i Windows XP Professional x64 Edition z dodatkiem Service Pack 2 oraz wszystkich obsługiwanych wersji systemów Windows Server 2003; Windows Vista i Windows Vista x64 Edition. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa lukę, zmieniając sposób sprawdzania poprawności danych wejściowych w usłudze MSMQ przed przekazaniem ich do przydzielonego buforu. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.**  W [artykule 971032 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/971032) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń.
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 z dodatkiem Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=8ed8bad7-2885-452c-9c34-3982cd498be8)                     | Ważny                              | Podniesienie uprawnień     | [MS08-065](http://go.microsoft.com/fwlink/?linkid=128102) |
| [Microsoft Windows XP z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=93490aa7-9985-4658-b0d7-88fb3f27ada0)                       | Ważny                              | Podniesienie uprawnień     | [MS07-065](http://go.microsoft.com/fwlink/?linkid=94666)  |
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=12e6be68-dc87-450e-927b-3c9b6873eb13)        | Ważny                              | Podniesienie uprawnień     | Brak                                                      |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=52f59c56-2aba-4626-a90e-311e0e73c813)                        | Ważny                              | Podniesienie uprawnień     | Brak                                                      |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2f77ef7b-54f8-4260-b6a6-d62a0f85ef45)            | Ważny                              | Podniesienie uprawnień     | Brak                                                      |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ad55c653-ee6b-4c92-b7f4-3923bb916546) | Ważny                              | Podniesienie uprawnień     | Brak                                                      |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=00afd94c-b483-4155-884f-b617acca6e7d)                                                         | Ważny                              | Podniesienie uprawnień     | Brak                                                      |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=a0c698aa-a913-4981-8798-6bbb8cacfb86)                                             | Ważny                              | Podniesienie uprawnień     | Brak                                                      |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach usługi MSMQ związana z pustym wskaźnikiem – CVE-2009-1922</th>
...
Luka w zabezpieczeniach usługi MSMQ związana z pustym wskaźnikiem – CVE-2009-1922  
---------------------------------------------------------------------------------
  
W usłudze kolejkowania wiadomości systemu Windows (MSMQ, Message Queuing) istnieje luka w zabezpieczeniach wynikająca z określonej błędu występującego podczas analizy żądań IOCTL dotyczących usługi kolejkowania wiadomości. Usługa MSMQ nieprawidłowo sprawdza dane wejściowe przed przekazaniem ich do buforu. Osoba atakująca, której uda się wykorzystać tę lukę, mogłaby wykonać dowolny kod i uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-1922](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1922).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach usługi MSMQ związanej z pustym wskaźnikiem – CVE-2009-1922
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Składnik kolejkowania wiadomości domyślnie nie jest instalowany w żadnej wersji systemu operacyjnego, której dotyczy problem, i może być włączony tylko przez użytkownika z uprawnieniami administratora. Problem stanowi zagrożenie tylko dla klientów, którzy ręcznie włączyli usługę kolejkowania wiadomości.  
...
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach usługi MSMQ związaną z pustym wskaźnikiem – CVE-2009-1922
...
-   **Wyłącz Usługę kolejkowania wiadomości:**  
    ...
    -   Interakcyjnie  
        ...
        1. Kliknij przycisk **Start**, a następnie kliknij polecenie **Panel sterowania**. Alternatywnie wskaż polecenie **Ustawienia**, a następnie kliknij polecenie **Panel sterowania**.  
        2. Kliknij dwukrotnie ikonę **Narzędzia administracyjne**. Możesz też kliknąć opcję **Przełącz do widoku klasycznego**, a następnie kliknąć dwukrotnie folder **Narzędzia administracyjne**.  
    ...
    -   Za pośrednictwem zasad grupy  
        ...
        **Uwaga:** Warto także zapoznać się z podręcznikiem Windows Server 2003 Security Guide (Podręcznik zabezpieczeń systemu Windows Server 2003) Zawiera on informacje dotyczące wyłączania usług.  
        Więcej informacji na temat zasad grupy można znaleźć w następującej witrynie firmy Microsoft w sieci Web:  
        [Step-by-Step Guide to Understanding the Group Policy Feature Set (Opis zestawu funkcji dotyczących zasad grupy — Przewodnik krok po kroku)](http://technet.microsoft.com/en-us/library/bb742376.aspx)  
        [Windows 2000 Group Policy (Zasady grupy w systemie Windows 2000)](http://technet.microsoft.com/en-us/library/bb742376.aspx)  
        [Group Policy in Windows Server 2003 (Zasady grupy w systemie Windows Server 2003)](http://www.microsoft.com/windowsserver2003/technologies/management/grouppolicy/default.mspx)
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach usługi MSMQ związanej z pustym wskaźnikiem – CVE-2009-1922
  
**Jaki zakres obejmuje ta luka?**    
Jest to luka umożliwiająca podniesienie uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, mogłaby wykonać dowolny kod i uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
**W jaki sposób powstaje luka?**    
Usługa MSMQ nieprawidłowo sprawdza poprawność danych przekazywanych z trybu użytkownika do trybu jądra, umożliwiając osobie atakującej na wykonanie dowolnego kodu w kontekście LOCAL SYSTEM.
  
**Co to jest kolejkowanie wiadomości?**    
Technologia kolejkowania wiadomości Microsoft Message Queuing umożliwia uruchamianie aplikacji w różnym czasie w celu komunikacji między niejednorodnymi sieciami i systemami, które mogą tymczasowo pracować w trybie offline. Aplikacje wysyłają wiadomości do kolejek i odczytują wiadomości z kolejek. Kolejkowanie wiadomości gwarantuje ich dostarczenie, efektywne rozsyłanie, bezpieczeństwo i wysyłanie wiadomości w oparciu o priorytety. Może być ona stosowana we wdrażaniu rozwiązań zarówno dla asynchronicznych, jak i synchronicznych scenariuszy wysyłania wiadomości. Więcej informacji na temat usługi kolejkowania wiadomości znajduje się w dokumentacji produktu.
  
**Co to jest kontrola Wejścia/Wyjścia (IOCTL, Input Output Control)?**  
Aplikacje w systemie Windows mogą kierować żądania dotyczące sterowników urządzeń bezpośrednio do usług. Interfejs służący do tego celu to kontrola Wejścia/Wyjścia (IOCTL, Input Output Control).
...
Osoba atakująca może wykorzystać tę lukę, wysyłając specjalnie spreparowane żądanie IOCTL do usługi kolejkowania wiadomości. Wykorzystanie tej luki może prowadzić do uzyskania pełnego dostępu w kontekście LOCAL SYSTEM do systemu, którego dotyczy ten problem.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**    
Zagrożone są głównie stacje robocze i serwery z usługą kolejkowania wiadomości.
  
**W jaki sposób działa aktualizacja?**    
Aktualizacja usuwa lukę, zmieniając sposób sprawdzania poprawności danych wejściowych w usłudze MSMQ przed przekazaniem ich do przydzielonego buforu.
...
**Uwaga dotycząca systemu Windows** **Vista** Program Microsoft Systems Management Server 2003 z dodatkiem Service Pack 3 obsługuje system Windows Vista.
...
| **Wdrażanie**                                         |                                                                                                                                                                    |  
| Instalowanie bez interwencji użytkownika              | Windows2000-kb971032-x86-enu /quiet                                                                                                                                |  
| Instalowanie bez ponownego uruchomienia               | Windows2000-kb971032-x86-enu /norestart                                                                                                                            |  
| Plik dziennika aktualizacji                           | kb971032.log                                                                                                                                                       |  
...
| **Informacje dotyczące usuwania**                     | Użyj narzędzia **Dodaj lub usuń programy** w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\\$NTUninstallKB971032$\\Spuninst |  
| **Informacje dotyczące plików**                       | Zobacz [artykuł 971032 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/971032)                                                               |  
| **Weryfikacja klucza rejestru**                       | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971032\\Filelist                                                                          |
...
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB971032$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/971032">artykuł 971032 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
#### Windows Vista i Windows Vista x64 Edition
...
-   Nikita Tarakanov z firmy [Positive Technologies Research Team](http://en.securitylab.ru/lab/) za zgłoszenie luki w zabezpieczeniach usługi MSMQ związanej z pustym wskaźnikiem (CVE-2009-1922)
...
-   Wersja 1.1 (30 czerwca 2010 r.): Dodano łącze do artykułu 971032 bazy wiedzy Microsoft Knowledge Base w części „Znane problemy” sekcji „Streszczenie”.
