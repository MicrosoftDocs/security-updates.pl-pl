---
TOCTitle: 'MS09-015'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-015 - Umiarkowana'
ms:assetid: 'ms09-015'
ms:contentKeyID: 61232734
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-015(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS09-015 - Umiarkowana
============================================================

Luka w zabezpieczeniach funkcji SearchPath związana z mieszanym zagrożeniem może pozwolić na podniesienie uprawnień (959426)
----------------------------------------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „umiarkowany” dla wszystkich obsługiwanych wersji systemów Windows XP, Windows Server 2003, Windows Vista i Windows Server 2008. W odniesieniu do systemu Microsoft Windows 2000 aktualizacja ta jest klasyfikowana tylko jako kompleksowa zmiana zabezpieczeń. Szczegółowe informacje można znaleźć w sekcji **Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń**. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki system Windows ładuje pliki z poziomu pulpitu. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 z dodatkiem Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=c4e408d7-6716-4a12-ad3a-8029667f5c84)                                                                                                                   | Brak                               | Brak                       | Brak                                                     |
| [Windows XP z dodatkiem Service Pack 2 i Windows XP z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=3de0684d-605c-489b-bdc7-08bce9b2d4f6)                                                                                       | Podniesienie uprawnień             | Umiarkowany                | [MS07-035](http://go.microsoft.com/fwlink/?linkid=91397) |
| [Windows XP Professional x64 Edition oraz Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b743a7fe-7bf4-420d-a72e-39471e5659fa)                                                             | Podniesienie uprawnień             | Umiarkowany                | [MS07-035](http://go.microsoft.com/fwlink/?linkid=91397) |
| [Windows Server 2003 z dodatkiem Service Pack 1 i Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=992bb0cd-fbc7-4a7c-9088-f7f9d9a3ead0)                                                                     | Podniesienie uprawnień             | Umiarkowany                | [MS07-035](http://go.microsoft.com/fwlink/?linkid=91397) |
| [Windows Server 2003 x64 Edition i Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f0a58e8c-7d63-4d7d-ba95-b3787cf408f0)                                                                        | Podniesienie uprawnień             | Umiarkowany                | [MS07-035](http://go.microsoft.com/fwlink/?linkid=91397) |
| [Systemy operacyjne Windows Server 2003 z dodatkiem SP1 dla systemów z procesorem Itanium oraz Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=00c6479d-f81f-445d-b8e4-7b71d77d540a) | Podniesienie uprawnień             | Umiarkowany                | [MS07-035](http://go.microsoft.com/fwlink/?linkid=91397) |
| [Windows Vista i Windows Vista z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2b672d45-f33b-4edc-9f22-2f2c8c726a8b)                                                                                                            | Podniesienie uprawnień             | Umiarkowany                | Brak                                                     |
| [Windows Vista x64 Edition i Windows Vista x64 Edition z dodatkiem Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7576e7d5-5bb1-4a53-b568-1ee0500ce721)                                                                                    | Podniesienie uprawnień             | Umiarkowany                | Brak                                                     |
| [Windows Server 2008 dla systemów 32-bitowych\*](http://www.microsoft.com/downloads/details.aspx?familyid=6b73cf5e-66fe-4b7d-95fc-91a1c262c1e5)                                                                                                                      | Podniesienie uprawnień             | Umiarkowany                | Brak                                                     |
| [Windows Server 2008 dla systemów opartych na procesorach X64](http://www.microsoft.com/downloads/details.aspx?familyid=7e60847c-b341-4c38-bc25-2e3cf2d4ae14)\*                                                                                                      | Podniesienie uprawnień             | Umiarkowany                | Brak                                                     |
| [Windows Server 2008 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=de1c2b4b-af47-4b9a-8363-720e5527573c)                                                                                                               | Podniesienie uprawnień             | Umiarkowany                | Brak                                                     |
...
Szczegółowe informacje dotyczące plików znajdują się w [artykule 959426 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/959426).

**Czy ta aktualizacja obejmuje jakiekolwiek zmiany funkcjonalności dotyczące zabezpieczeń?**  
Tak. Poza modyfikacjami wymienionymi w sekcji **Informacje o luce w zabezpieczeniach** tego biuletynu niniejsza aktualizacja obejmuje także kompleksową zmianę zabezpieczeń, która wprowadza nowy interfejs API o nazwie SetSearchPathMode.

**Co umożliwia kompleksowa zmiana zabezpieczeń interfejsu SetSearchPathMode?**  
Nowy interfejs API wprowadza możliwość użycia trybu obsługi pojedynczych procesów podczas wyszukiwania plików za pomocą funkcji SearchPath. Dzięki temu aplikacje mogą wymusić przeszukanie bieżącego katalogu po przeszukaniu lokalizacji aplikacjami i lokalizacji systemowych.

**Czy w przypadku zainstalowania wyłącznie tej aktualizacji zabezpieczeń mój komputer będzie w pełni chroniony przed problemem związanym z mieszanym zagrożeniem opisanym w biuletynie CVE-2008-2540?**  
Nie, należy dodatkowo włączyć kompleksowe zabezpieczenie, jakie oferuje zbiorcza aktualizacja zabezpieczeń dla programu Internet Explorer [MS09-014](http://go.microsoft.com/fwlink/?linkid=146659). Należy jednak sprawdzić, czy włączenie kompleksowego zabezpieczenia przed problemem związanym z mieszanym zagrożeniem jest dopuszczalne w danym środowisku systemowym.

Aby włączyć kompleksowe zabezpieczenie w programie Internet Explorer, należy włączyć klucz kontroli funkcji SearchPath opisany w sekcji Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń biuletynu [MS09-014](http://go.microsoft.com/fwlink/?linkid=146659). Więcej informacji na temat problemu związanego z mieszanym zagrożeniem można znaleźć w bazie danych znanych luk i zagrożeń pod numerem [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540).

**Dlaczego system Microsoft Windows 2000 został umieszczony w tabeli „Programy, których dotyczy problem” bez podania wpływu dla bezpieczeństwa i wskaźnika ważności?**  
System Microsoft Windows 2000 został umieszczony w tabeli „Programy, których dotyczy problem” bez podania wpływu dla bezpieczeństwa ani wskaźnika ważności ponieważ niniejsza aktualizacja zawiera inny rodzaj poprawki dla systemu Microsoft Windows 2000 niż w przypadku innych obsługiwanych wersji systemu Windows. Niniejsza aktualizacja zawiera kompleksową zmianę zabezpieczeń przeznaczoną wyłącznie dla systemu Microsoft Windows 2000.

**Dlaczego poprawka rozwiązująca problem związany z mieszanym zagrożeniem w systemie Microsoft Windows 2000 jest inna niż w przypadku pozostałych platform?**  
W systemie Microsoft Windows 2000 nie istnieje element architektury odpowiedzialny za wdrażanie funkcji SetSearchPathMode, przez co usunięcie tej luki w systemie Microsoft Windows 2000 byłoby niemożliwe. W celu jej usunięcia należałoby dokonać istotnych zmian w znacznej części architektury systemu Microsoft Windows 2000, także niezwiązanej bezpośrednio z luką. Wynik końcowy tego typu działań mógłby okazać się w znacznym stopniu niezgodny z systemem Microsoft Windows 2000, w związku z czym niemożliwe byłoby zagwarantowanie ciągłości pracy aplikacji stworzonych na potrzeby systemu Microsoft Windows 2000 na tak zmienionym systemie. Pragniemy zaznaczyć, że firma Microsoft nie ma żadnych informacji na temat jakichkolwiek skutecznych prób wykorzystania tej luki w systemach Microsoft Windows 2000.

Z uwagi na zmiany w zakresie architektury w systemie Microsoft Windows 2000 należy włączyć kompleksową zmianę zabezpieczeń przeznaczoną specjalnie dla systemu Microsoft Windows 2000 przy użyciu klucza rejestru HKLM\\System\\CCS\\control\\Session Manager\\SafeDLLSearchMode. Więcej informacji na temat zawiera artykuł MSDN, [Porządek wyszukiwania bibliotek dołączanych dynamicznie](http://msdn.microsoft.com/en-us/library/ms682586.aspx) (j. ang.).

**Co to jest funkcja SearchPath?**  
Funkcja SearchPath służy do wyszukiwania określonego pliku w określonej ścieżce. Więcej informacji można znaleźć w artykule MSDN [SearchPath Function](http://msdn.microsoft.com/en-us/library/aa365527.aspx) (j. ang.)

**Co to jest funkcja LoadLibrary?**  
Funkcja LoadLibrary służy do ładowania określonego modułu do przestrzeni adresowej procesu wywoływania. Określony moduł może spowodować załadowanie innych modułów. Więcej informacji można znaleźć w artykule MSDN [LoadLibrary Function](http://msdn.microsoft.com/en-us/library/ms684175(vs.85).aspx) (j. ang.)
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z mieszanym zagrożeniem i umożliwiająca podniesienie uprawnień — CVE-2008-2540</th>
...
Luka w zabezpieczeniach związana z mieszanym zagrożeniem i umożliwiająca podniesienie uprawnień — CVE-2008-2540  
---------------------------------------------------------------------------------------------------------------
  
W funkcji SearchPath systemu Windows występuje luka w zabezpieczeniach związana z mieszanym zagrożeniem, umożliwiająca podniesienie uprawnień, wynikająca ze sposobu lokalizowania i otwierania plików przez tę funkcję. Osoba atakująca może wykorzystać tę lukę, nakłaniając użytkownika do pobrania specjalnie spreparowanego pliku do określonej lokalizacji, a następnie uruchomienia aplikacji, która załaduje ten plik w określonych warunkach.
...
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z mieszanym zagrożeniem i umożliwiającej podniesienie uprawnień — CVE-2008-2540
  
Firma Microsoft nie znalazła dla tej luki żadnych czynników ograniczających zagrożenie.
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z mieszanym zagrożeniem i umożliwiającą podniesienie uprawnień — CVE-2008-2540
  
Firma Microsoft nie znalazła żadnego obejścia tej luki.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z mieszanym zagrożeniem i umożliwiającej podniesienie uprawnień — CVE-2008-2540
  
**Jaki zakres obejmuje ta luka?**    
Luka związana jest z mieszanym zagrożeniem w zakresie podniesienia uprawnień. Osoba atakująca, której uda się wykorzystać tę lukę, może zdalnie uzyskać pełną kontrolę nad systemem jej podlegającym. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
...
Osoba atakująca może stworzyć odpowiednio spreparowany plik, a następnie nakłonić użytkownika do pobrania i zapisania go na pulpicie. Następnie użytkownik musiałby uruchomić aplikację, która otworzyłaby ten odpowiednio spreparowany plik. Jednak osoba atakująca nie może w żaden sposób zmusić użytkowników do pobrania tego typu plików i zapisania ich na pulpicie.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**    
Na skutki tej luki narażone są wszystkie systemy, w których użytkownicy mogą pobierać pliki i uruchamiać aplikacje, jak np. stacje robocze i serwery terminalowe.
  
**W jaki sposób działa aktualizacja?**    
Aktualizacja zmienia kolejność wyszukiwania bibliotek aplikacji w taki sposób, że w pierwszej kolejności przeszukiwany jest katalog systemowy, a dopiero po nim bieżące katalogi robocze. Aktualizacja wprowadza także kompleksową zmianę zabezpieczeń w postaci nowego interfejsu API o nazwie SetSearchPathMode, który ułatwia zaawansowanym użytkownikom ustawienie żądanej kolejności wyszukiwania dla funkcji SearchPath. Więcej informacji na temat tej kompleksowej zmiany zabezpieczeń można znaleźć w sekcji **Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń**.
  
**Czy luka ta była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn?**    
Tak. Informacje o tej luce są znane publicznie. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540). Niniejsza aktualizacja zabezpieczeń usuwa także lukę w zabezpieczeniach opisaną po raz pierwszy w [Poradniku zabezpieczeń firmy Microsoft 953818](http://technet.microsoft.com/security/advisory/953818).
...
<td style="border:1px solid black;">Microsoft Windows 2000 z dodatkiem Service Pack 4:<br />
Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB959426$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/959426">artykuł 959426 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>Informacje dotyczące usuwania</strong></td>
<td style="border:1px solid black;">Użyj narzędzia <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB959426$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/959426">artykuł 959426 bazy wiedzy Microsoft Knowledge Base</a></td>
...
-   [Aviv Raff](http://aviv.raffon.net), za zgłoszenie luki w zabezpieczeniach związanej z mieszanym zagrożeniem i umożliwiającej podniesienie uprawnień (CVE-2008-2540)
