---
TOCTitle: 'MS09-005'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS09-005 - Ważna'
ms:assetid: 'ms09-005'
ms:contentKeyID: 61232724
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms09-005(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS09-005 - Ważna
======================================================

Luki w zabezpieczeniach programu Microsoft Office Visio umożliwiają zdalne wykonanie kodu (957634)
--------------------------------------------------------------------------------------------------

Opublikowano: 10 lutego 2009
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla programu Microsoft Office Visio 2002 z dodatkiem Service Pack 2, Microsoft Office Visio 2003 z dodatkiem Service Pack 3 oraz Microsoft Office Visio 2007 z dodatkiem Service Pack 1. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń eliminuje luki w zabezpieczeniach poprzez zmianę sposobu, w jaki program Microsoft Office Visio wykonuje sprawdzanie poprawności podczas otwierania plików programu Visio. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=a30cef3f-9eaf-45bd-9a25-4b65302362cb">Microsoft Office Visio 2002 z dodatkiem Service Pack 2</a><br />
(KB955654)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=c9cb589e-1a37-485d-8402-7f42bcd7a1a9">Microsoft Office Visio 2003 z dodatkiem Service Pack 3</a><br />
(KB955655)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=115455">MS08-019</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=4b711e89-8de2-4f17-8afc-691e0604ff82">Microsoft Office Visio 2007 z dodatkiem Service Pack 1</a><br />
(KB957831)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=115455">MS08-019</a></td>
...
| Program Microsoft Office Visio Viewer 2007 i Microsoft Office Visio Viewer 2007 z dodatkiem Service Pack 1 |
  
Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń  
---------------------------------------------------------------
  
**Gdzie znajdują się szczegółowe informacje dotyczące plików?**      
Szczegółowe informacje dotyczące plików znajdują się w [artykule 957634 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/957634).
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana ze sprawdzaniem poprawności pamięci — CVE-2009-0095</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z uszkodzeniem pamięci — CVE-2009-0096</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z uszkodzeniem pamięci — CVE-2009-0097</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Visio 2007 z dodatkiem Service Pack 1</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
<td style="border:1px solid black;"><strong>Ważny</strong> <br />
Zdalne wykonanie kodu</td>
...
Luka w zabezpieczeniach związana ze sprawdzaniem poprawności pamięci — CVE-2009-0095  
------------------------------------------------------------------------------------
  
W programie Microsoft Office Visio występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana ze sposobem sprawdzania poprawności danych obiektu podczas otwierania plików programu Visio. Osoba atakująca może wykorzystać tę lukę poprzez wysłanie specjalnie spreparowanego pliku. Plik taki może zostać dołączony do wiadomości e-mail lub umieszczony w specjalnie spreparowanej witrynie sieci Web lub witrynie sieci Web, do której się włamano.
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-0095](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0095).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej ze sprawdzaniem poprawności pamięci — CVE-2009-0095
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Osoba atakująca może tylko uzyskać uprawnienia bieżącego użytkownika. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.  
...
#### Obejścia dotyczące luki w zabezpieczeniach związanej ze sprawdzaniem poprawności pamięci — CVE-2009-0095
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej ze sprawdzaniem poprawności pamięci — CVE-2009-0095
...
Przyczyną występowania tej luki jest błąd sprawdzania poprawności, który występuje, gdy program Microsoft Office Visio analizuje specjalnie spreparowany dokument.
...
Szczególnie narażone są systemy, w których używany jest program Microsoft Office Visio, takie jak stacje robocze i serwery terminalowe. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie programów. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.
  
**W jaki sposób działa aktualizacja?**      
Aktualizacja usuwa lukę, wprowadzając sprawdzenie poprawności podczas otwierania plików Visio.
...
Luka w zabezpieczeniach związana z uszkodzeniem pamięci — CVE-2009-0096  
-----------------------------------------------------------------------
  
W programie Microsoft Office Visio istnieje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana ze sposobem kopiowania przez ten program danych obiektu w pamięci. Osoba atakująca może wykorzystać tę lukę poprzez wysłanie nieprawidłowego pliku. Plik taki może zostać dołączony do wiadomości e-mail lub umieszczony w specjalnie spreparowanej witrynie sieci Web lub witrynie sieci Web, do której się włamano.
  
Jeśli użytkownik byłby zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzystałaby tę lukę, mogłaby uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-0096](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0096).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci — CVE-2009-0096
...
#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci — CVE-2009-0096
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   Nie należy otwierać plików programu Visio otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci — CVE-2009-0096
  
**Jaki zakres obejmuje ta luka?**      
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak zalogowany użytkownik. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzysta tę lukę, może uzyskać pełną kontrolę nad systemem, którego ta luka dotyczy. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
**W jaki sposób powstaje luka?**      
Luka w zabezpieczeniach związana jest z uszkodzeniem pamięci, które występuje, gdy program Microsoft Office Visio analizuje dokument.
...
**W jaki sposób działa aktualizacja?**      
Aktualizacja eliminuje lukę w zabezpieczeniach, poprawiając sposób, w jaki program Microsoft Office Visio obsługuje pamięć.
...
Luka w zabezpieczeniach związana z uszkodzeniem pamięci — CVE-2009-0097  
-----------------------------------------------------------------------
  
W programie Microsoft Office Visio występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, związana ze sposobem obsługi pamięci podczas otwierania plików programu Visio. Osoba atakująca może wykorzystać tę lukę poprzez wysłanie specjalnie spreparowanego pliku. Plik taki może zostać dołączony do wiadomości e-mail lub umieszczony w specjalnie spreparowanej witrynie sieci Web lub witrynie sieci Web, do której się włamano.
  
Jeśli użytkownik byłby zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzystałaby tę lukę, mogłaby uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2009-0097](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0097).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z uszkodzeniem pamięci — CVE-2009-0097
...
#### Obejścia dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci — CVE-2009-0097
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   Nie należy otwierać plików programu Visio otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z uszkodzeniem pamięci — CVE-2009-0097
  
**Jaki zakres obejmuje ta luka?**      
Jest to luka umożliwiająca zdalne wykonanie kodu. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak zalogowany użytkownik. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzysta tę lukę, może uzyskać pełną kontrolę nad systemem, którego ta luka dotyczy. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
**W jaki sposób powstaje luka?**      
Przyczyną występowania tej luki jest błąd sprawdzania poprawności, który występuje podczas analizy specjalnie spreparowanego dokumentu.
  
**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**      
Osoba atakująca, której uda się wykorzystać tę lukę, może uruchomić dowolny kod jako użytkownik zalogowany. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca może uzyskać pełną kontrolę nad systemem podlegającym luce. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**      
Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy nieprawidłowo utworzony plik programu Visio przy użyciu zagrożonej tą luką wersji programu Microsoft Office Visio.
...
**Jakie systemy są szczególnie narażone na skutki tej luki?**      
Szczególnie narażone na skutki tej luki są systemy, w który jest używany program Microsoft Office Visio, takie jak stacje robocze i serwery terminalowe. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie programów. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.
  
**W jaki sposób działa aktualizacja?**      
Aktualizacja eliminuje lukę w zabezpieczeniach, poprawiając sposób, w jaki program Microsoft Office Visio przeprowadza sprawdzenie poprawności przy alokowaniu pamięci podczas otwierania plików programu Visio.
...
| Microsoft Office Visio 2003 z dodatkiem Service Pack 3 | Tak     | Tak                        | Tak                       | Tak                        |  
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/957634">artykuł 957634 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Bing Liu z zespołu [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com) firmy Fortinet, za zgłoszenie luki w zabezpieczeniach związanej ze sprawdzaniem poprawności pamięci (CVE-2009-0095)  
-   Bing Liu z zespołu [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com) firmy Fortinet, za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci (CVE-2009-0096)  
-   Bing Liu z zespołu [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com) firmy Fortinet, za zgłoszenie luki w zabezpieczeniach związanej z uszkodzeniem pamięci (CVE-2009-0097)
