---
TOCTitle: 'MS08-065'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS08-065 - Ważna'
ms:assetid: 'ms08-065'
ms:contentKeyID: 61232706
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms08-065(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS08-065 - Ważna
======================================================

Luka w zabezpieczeniach kolejkowania wiadomości umożliwia zdalne wykonanie kodu (951071)
----------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń usuwa lukę w usłudze kolejkowania wiadomości (MSMQ, Message Queuing Service) systemów Microsoft Windows 2000, która została zgłoszona przez użytkowników. Luka umożliwia zdalne wykonanie kodu w systemach Microsoft Windows 2000 z włączoną usługą kolejkowania wiadomości.

Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji systemu Microsoft Windows 2000. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa lukę, zastępując ciągi API, których dotyczy problem, przetwarzane w usłudze kolejkowania wiadomości. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|----------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------------|
| [Microsoft Windows 2000 z dodatkiem Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=899e2728-2433-4ccb-a195-05b5d65e5469) | Zdalne wykonanie kodu              | Ważny                      | [MS07-065](http://go.microsoft.com/fwlink/?linkid=94666) |
...
Szczegółowe informacje dotyczące plików znajdują się w [artykule 951071 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/951071).
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach usługi kolejkowania wiadomości umożliwiająca zdalne wykonanie kodu — CVE-2008-3479</th>
...
Luka w zabezpieczeniach usługi kolejkowania wiadomości umożliwiająca zdalne wykonanie kodu — CVE-2008-3479  
----------------------------------------------------------------------------------------------------------
  
<span></span>
W usłudze kolejkowania wiadomości istnieje luka umożliwiająca zdalne wykonanie kodu, której przyczyną jest specyficzny błąd związany z analizą żądań RPC do usługi kolejkowania wiadomości.
  
Osoba atakująca może wykorzystać tę lukę, wysyłając specjalnie spreparowane żądanie RPC. Żądanie dotyczące stosu może zostać obsłużone, a następnie może dojść do przepełnienia buforu podczas niesprawdzonej operacji kopiowania ciągów. Wykorzystanie tej luki może prowadzić do uzyskania pełnego dostępu w kontekście SYSTEM do systemu, którego dotyczy ten problem. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-3479](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3479).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach usługi kolejkowania wiadomości umożliwiającej zdalne wykonanie kodu — CVE-2008-3479
...
#### Obejścia dotyczące luki w zabezpieczeniach usługi kolejkowania wiadomości umożliwiającej zdalne wykonanie kodu — CVE-2008-3479
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Zablokowanie następującego ruchu na zaporze zewnętrznej**  
...
-   **Wyłącz Usługę kolejkowania wiadomości:**
    ...
    -   Interakcyjnie  
        ...
        1. Kliknij przycisk Start, a następnie kliknij polecenie Panel sterowania. Możesz również wskazać polecenie Ustawienia, a następnie kliknąć polecenie Panel sterowania.  
        2. Kliknij dwukrotnie ikonę Narzędzia administracyjne. Możesz też kliknąć opcję Przełącz do widoku klasycznego, a następnie kliknąć dwukrotnie ikonę Narzędzia administracyjne.  
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach usługi kolejkowania wiadomości umożliwiającej zdalne wykonanie kodu — CVE-2008-3479
  
**Jaki zakres obejmuje ta luka?**    
Jest to luka umożliwiająca zdalne wykonanie kodu w systemach Microsoft Windows 2000 z włączoną usługą kolejkowania wiadomości. Osoba atakująca, której uda się wykorzystać tę lukę, może zdalnie uzyskać pełną kontrolę nad systemem jej podlegającym. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane.
  
**W jaki sposób powstaje luka?**    
W usłudze kolejkowania wiadomości są nieprawidłowo analizowane specjalnie spreparowane żądania RPC.
  
**Co to jest kolejkowanie wiadomości?**    
Technologia kolejkowania wiadomości Microsoft Message Queuing umożliwia uruchamianie aplikacji w różnym czasie w celu komunikacji między niejednorodnymi sieciami i systemami, które mogą tymczasowo pracować w trybie offline. Aplikacje wysyłają wiadomości do kolejek i odczytują wiadomości z kolejek. Kolejkowanie wiadomości gwarantuje ich dostarczenie, efektywne rozsyłanie, bezpieczeństwo i wysyłanie wiadomości w oparciu o priorytety. Może być ona stosowana we wdrażaniu rozwiązań zarówno dla asynchronicznych, jak i synchronicznych scenariuszy wysyłania wiadomości. Więcej informacji na temat usługi kolejkowania wiadomości znajduje się [w dokumentacji produktu](http://www.microsoft.com/windowsserver2003/technologies/msmq/default.mspx).
  
**Co to jest RPC?**    
Microsoft RPC to model programowania w środowisku rozproszonym. Celem modelu RPC jest zapewnienie przejrzystej komunikacji bezpośredniej między klientem a serwerem. Implementacja RPC firmy Microsoft jest zgodna z modelem RPC OSF (Open Software Foundation) DCE (Distributed Computing Environment). Więcej informacji na temat modelu RPC można znaleźć [w witrynie MSDN dotyczącej modelu RPC](http://msdn.microsoft.com/en-us/library/ms691207(vs.85).aspx).
  
**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**    
Uwierzytelniona osoba atakująca może zdalnie uruchomić dowolny kod w kontekście SYSTEM, wysyłając specjalnie spreparowane żądanie RPC do usługi kolejkowania wiadomości. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**    
Osoba atakująca może wykorzystać tę lukę, wysyłając specjalnie spreparowane żądanie RPC do usługi kolejkowania wiadomości. Żądanie dotyczące stosu może zostać obsłużone, a następnie może dojść do przepełnienia buforu podczas niesprawdzonej operacji kopiowania ciągów. Wykorzystanie tej luki może prowadzić do uzyskania pełnego dostępu w kontekście SYSTEM do systemu, którego dotyczy ten problem.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**    
Zagrożone są systemy Microsoft Windows 2000 z włączoną usługą kolejkowania wiadomości.
  
**W jaki sposób działa aktualizacja?**    
Aktualizacja usuwa lukę, modyfikując sposób sprawdzania poprawności parametrów w usłudze kolejkowania wiadomości przekazywanych do ciągu API wywoływanego przez tę usługę.
...
<td style="border:1px solid black;">Microsoft Windows 2000 z dodatkiem Service Pack 4:<br />
Użyj narzędzia Dodaj lub usuń programy w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB951071$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/951071">artykuł 951071 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Cody Pierce i Aaron Portnoy z firmy [TippingPoint DVLabs](http://dvlabs.tippingpoint.com), za zgłoszenie luki w zabezpieczeniach usługi MSMQ umożliwiającej zdalne wykonanie kodu (CVE-2008-3479)
...
-   Wersja 1.1 (15 października 2008 r.): W tabeli „Programy, których dotyczy problem” dodano łącze do biuletynu MS07-065, który jest zastępowany przez niniejszą aktualizację.
