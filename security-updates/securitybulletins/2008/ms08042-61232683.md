---
TOCTitle: 'MS08-042'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS08-042 - Ważna'
ms:assetid: 'ms08-042'
ms:contentKeyID: 61232683
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms08-042(v=Security.10)'
---

Security Bulletin

Biuletyn zabezpieczeń firmy Microsoft MS08-042 - Ważna
======================================================

Luka w zabezpieczeniach programu Microsoft Word może pozwolić na zdalne wykonanie kodu (955048)
-----------------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla obsługiwanych wersji programów Microsoft Word 2002 i Microsoft Word 2003. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Ta aktualizacja zabezpieczeń eliminuje lukę w zabezpieczeniach poprzez zmianę sposobu, w jaki program Microsoft Word obsługuje specjalnie spreparowane pliki programu Word. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.

Niniejsza aktualizacja zabezpieczeń usuwa także lukę w zabezpieczeniach opisaną po raz pierwszy w [Poradniku zabezpieczeń firmy Microsoft 953635](http://technet.microsoft.com/security/advisory/953635).
...
<td style="border:1px solid black;">
[Microsoft Word 2002 z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=c7146dfc-e1be-4d13-877b-1d9bcacc4a64) (KB954463)
</td>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Word 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=13a37b76-9fec-426f-8176-3c95f934efe0) (KB954464)
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
<td style="border:1px solid black;">
[Microsoft Word 2003 z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=13a37b76-9fec-426f-8176-3c95f934efe0) (KB954464)
</td>
<td style="border:1px solid black;">
Zdalne wykonanie kodu
</td>
...
|---------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------|
| Microsoft Office 2000 z dodatkiem Service Pack 3                                                                                | Microsoft Word 2000 z dodatkiem Service Pack 3 |
| Pakiet Microsoft Office 2007                                                                                                    | Microsoft Word 2007                            |
| Pakiet Microsoft Office 2007 z dodatkiem Service Pack 1                                                                         | Microsoft Word 2007 z dodatkiem Service Pack 1 |
...
Szczegółowe informacje dotyczące plików znajdują się w [artykule 955048 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/955048).
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach programu Word związana z analizą rekordów — CVE-2007-1202:</th>
...
Luka w zabezpieczeniach programu Word związana z analizą rekordów — CVE-2007-1202:  
----------------------------------------------------------------------------------
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-2244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Word związanej z analizą rekordów — CVE-2008-2244
...
#### Obejścia dotyczące luki w zabezpieczeniach programu Word związanej z analizą rekordów — CVE-2008-2244
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności
  
-   Do otwierania i wyświetlania plików programu Microsoft Word należy używać programów [Podgląd programu Microsoft Office Word 2003](http://www.microsoft.com/downloads/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf&displaylang=en) lub [Podgląd programu Microsoft Office Word 2003 z dodatkiem Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=c6e56e97-17d7-4c48-9b2e-474cb3cdcc45&displaylang=en).  
...
#### Często zadawane pytania na temat luki w zabezpieczeniach programu Word związanej z analizą rekordów — CVE-2008-2244
...
Luka w zabezpieczeniach związana jest z błędem obsługi pamięci, który występuje podczas analizy wartości rekordów w specjalnie spreparowanym pliku programu Word. Błąd ten może spowodować uszkodzenie pamięci systemowej w sposób umożliwiający osobie atakującej wykonanie dowolnego kodu.
...
Aktualizacja usuwa lukę, modyfikując sposób, w jaki program Word inicjuje pamięć podczas przetwarzania wartości rekordów w otwieranych plikach tego programu.
  
**Czy luka ta była powszechnie znana w czasie, gdy opublikowano niniejszy biuletyn? **  
Tak. W chwili pierwszego wydania tego biuletynu zabezpieczeń luka ta była powszechnie znana. Została ona zarejestrowana w bazie danych znanych luk i zagrożeń pod numerem [CVE-2008-2244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244). Po raz pierwszy opisano ją w [Poradniku zabezpieczeń firmy Microsoft 953635.](http://technet.microsoft.com/security/advisory/953635).
...
Tak. Ta aktualizacja zabezpieczeń eliminuje aktualnie wykorzystywaną lukę. Informacje o usuniętej luce w zabezpieczeniach zostały zarejestrowane w bazie danych znanych luk i zagrożeń pod numerem [CVE-2008-2244](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244).
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/955048">artykuł 955048 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   [ISC/SANS](http://isc.sans.org/) za zgłoszenie luki w zabezpieczeniach programu Word związanej z analizą rekordów (CVE-2008-2244).
