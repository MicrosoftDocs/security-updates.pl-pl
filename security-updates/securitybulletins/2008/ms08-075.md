---
TOCTitle: 'MS08-075'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS08-075 - Krytyczna'
ms:assetid: 'ms08-075'
ms:contentKeyID: 61232716
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms08-075(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS08-075 - Krytyczna
==========================================================

Luki w zabezpieczeniach Usługi wyszukiwania systemu Windows umożliwiają zdalne wykonanie kodu (959349)
------------------------------------------------------------------------------------------------------
...
Najpoważniejsza luka w zabezpieczeniach ma wskaźnik ważności „krytyczny” dla wszystkich obsługiwanych wersji systemu Windows Vista i Windows Server 2008. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa luki, modyfikując sposób, w jaki program Eksplorator Windows zwalnia pamięć podczas zapisywania plików Usługi wyszukiwania systemu Windows oraz zmieniając sposób interpretowania parametrów przez ten program podczas analizowania protokołu search-ms. Więcej informacji na temat luk może znaleźć w podsekcjach „Często zadawane pytania” dla pozycji określonych luk w zabezpieczeniach, znajdujących się poniżej następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=0dcc5373-0435-42d5-864d-298e5bb122d9">Windows Vista i Windows Vista z dodatkiem Service Pack 1</a><br />
(KB958623)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=5b1b65f0-6848-47c6-bdd5-be3c0621b323">Windows Vista i Windows Vista z dodatkiem Service Pack 1</a><br />
(KB958624)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=2112c5c8-7c9f-4491-b127-b1093085e105">Windows Vista x64 Edition i Windows Vista x64 Edition z dodatkiem Service Pack 1</a><br />
(KB958623)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=117296">MS08-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=eb1d0ffe-1644-457b-9e82-768bd4c7f7ab">Windows Vista x64 Edition i Windows Vista x64 Edition z dodatkiem Service Pack 1</a><br />
(KB958624)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=90ab7e6f-5ae7-4f55-8838-868fc98d8a16">Windows Server 2008 dla systemów 32-bitowych*</a><br />
(KB958623)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=117296">MS08-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=470d506f-77ae-4a44-8598-df645f484295">Windows Server 2008 dla systemów 32-bitowych*</a><br />
(KB958624)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e1deab57-ada2-4b12-9157-5615e7b0071d">Windows Server 2008 dla systemów opartych na procesorach X64</a>\*<br />
(KB958623)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=117296">MS08-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e41f23e4-6a2f-4ebb-b425-d241a08da316">Windows Server 2008 dla systemów opartych na procesorach X64</a>\*<br />
(KB958624)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=48bed90d-c243-4969-8e54-326d9a7af343">Windows Server 2008 dla systemów z procesorem Itanium</a><br />
(KB958623)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=117296">MS08-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=83de2263-de2a-4c13-96ba-ecfebdaf0bb9">Windows Server 2008 dla systemów z procesorem Itanium</a><br />
(KB958624)</td>
<td style="border:1px solid black;">Zdalne wykonanie kodu</td>
<td style="border:1px solid black;">Krytyczny</td>
<td style="border:1px solid black;">Brak</td>
...
Szczegółowe informacje dotyczące plików znajdują się w [artykule 959349 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/959349).
  
**Dlaczego ten biuletyn zawiera dwie aktualizacje dla każdego systemu operacyjnego, którego dotyczy problem?**      
Niniejszy biuletyn zawiera dwie identyfikowane na podstawie numeru bazy wiedzy aktualizacje dla każdego systemu operacyjnego, którego dotyczy problem, ponieważ modyfikacje wymagane do usunięcia luk znajdują się w oddzielnych składnikach. Klienci muszą zainstalować obie aktualizacje dla każdego systemu operacyjnego znajdującego się w ich środowisku.
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach systemu Windows związana z zapisanymi wynikami wyszukiwania — CVE-2008-4268</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach Usługi wyszukiwania systemu Windows związana z analizowaniem — CVE-2008-4269</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
Luka w zabezpieczeniach systemu Windows związana z zapisanymi wynikami wyszukiwania — CVE-2008-4268  
---------------------------------------------------------------------------------------------------
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-4268](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4268).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach systemu Windows związanej z zapisanymi wynikami wyszukiwania — CVE-2008-4268
...
-   Osoba atakująca za pośrednictwem sieci Web może udostępnić witrynę sieci Web zawierającą specjalnie spreparowany plik z zapisanymi wynikami wyszukiwania (search-ms). Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika lub reklamy, jak również witryny niesprawdzone, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystać lukę w zabezpieczeniach. Jednakże w żadnym przypadku osoba atakująca nie może zmusić użytkowników do odwiedzenia takich witryn. Próby ataków wykorzystujących tę lukę wymagają działania ze strony użytkownika.  
-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.  
-   Użytkownicy programu Internet Explorer 7 zobaczą wyświetlone okno dialogowe informujące, że strona sieci Web próbuje otworzyć zawartość w programie Windows Explorer. Okno to zawiera monit o dopuszczenie lub zablokowanie tej zawartości, a także umożliwia użytkownikowi wyłączenie wyświetlania komunikatów tego typu w przyszłości. Monit nie będzie wyświetlany w przypadku użytkowników, którzy wcześniej zaznaczyli opcję „Nie pokazuj ostrzeżenia dla tego programu ponownie” w odniesieniu do programu Eksplorator Windows.
  
#### Obejścia dotyczące luki w zabezpieczeniach związanej z zapisanymi wynikami wyszukiwania — CVE-2008-4268
...
-   Tymczasowo zmień typ pliku skojarzony z rozszerzeniem „search-ms”. Wprowadź następujące polecenie w wierszu polecenia z podniesionymi uprawnieniami:
    ...
    **Jak cofnąć obejście.** Wprowadź następujące polecenie w wierszu polecenia z podniesionymi uprawnieniami:
...
-   Zmodyfikuj rejestr, aby uniemożliwić otwieranie plików z zapisanymi wynikami wyszukiwania i uzyskiwanie dostępu do folderu z zapisanymi wynikami wyszukiwania.
    ...
    **Jak cofnąć obejście.** Przywróć poprzednio skonfigurowane uprawnienia w kluczu rejestru, klikając pole wyboru **Dołącz uprawnienia dziedziczne z tego obiektu nadrzędnego**, aby je zaznaczyć, a następnie klikając dwa razy przycisk **OK**.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z zapisanymi wynikami wyszukiwania — CVE-2008-4268
...
Program Eksplorator Windows nie wykonuje prawidłowego zwolnienia pamięci podczas zapisywania plików Usługi wyszukiwania systemu Windows.
...
**Czy składnik Usługa wyszukiwania systemu Windows dostępny dla systemu Windows XP jest zagrożony?**  
Nie. Mimo, że Usługa wyszukiwania systemu Windows jest opcjonalnym dodatkiem dla systemu Windows XP, omawiany problem jej nie dotyczy.
...
Osoba atakująca za pośrednictwem sieci Web może wykorzystać tę lukę, udostępniając witrynę sieci Web z odpowiednim plikiem zawierającym zapisane wyniki wyszukiwania. Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika, jak również witryny niesprawdzone, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystać lukę w zabezpieczeniach. Osoba atakująca musiałaby wówczas nakłonić użytkownika do otwarcia i zapisania specjalnie spreparowanych plików z wynikami wyszukiwania. Intruz nie może w żaden sposób zmusić użytkowników do odwiedzenia specjalnie spreparowanej witryny. Musi natomiast przekonać użytkowników do odwiedzenia tej witryny sieci Web, najczęściej zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej, które przekieruje użytkowników do witryny osoby atakującej.
...
Aktualizacja usuwa lukę, zmieniając sposób, w jaki program Eksplorator Windows zwalnia pamięć podczas zapisywania plików Usługi wyszukiwania systemu Windows.
...
Luka w zabezpieczeniach Usługi wyszukiwania systemu Windows związana z analizowaniem — CVE-2008-4269  
----------------------------------------------------------------------------------------------------
  
W programie Eksplorator Windows występuje luka umożliwiająca zdalne wykonanie kodu, która pozwala osobie atakującej na przygotowanie niebezpiecznej strony sieci Web zawierającej wywołanie procedury obsługi protokołu search-ms. Procedura obsługi protokołu przekazuje z kolei niezaufane dane do programu Eksplorator Windows.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-4269](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4269).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach Usługi wyszukiwania systemu Windows związanej z analizowaniem — CVE-2008-4269
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Osoba atakująca za pośrednictwem sieci Web może udostępnić witrynę sieci Web zawierającą specjalnie spreparowany adres URL Usługi wyszukiwania systemu Windows (search-ms://). Dodatkowo, witryny sieci Web, które akceptują lub udostępniają zawartość wprowadzoną przez użytkownika lub reklamy, jak również witryny niesprawdzone, mogą zawierać specjalnie spreparowane treści, które mogą wykorzystać lukę w zabezpieczeniach. Jednakże w żadnym przypadku osoba atakująca nie może zmusić użytkowników do odwiedzenia takich witryn. Próby ataków wykorzystujących tę lukę wymagają działania ze strony użytkownika.  
-   Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać takie same uprawnienia, jak użytkownik lokalny. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.  
-   Klienci, którzy korzystają z programu Internet Explorer 7 z domyślnymi ustawieniami, zobaczą wyświetlone w oknie wyskakującym ostrzeżenie z pytaniem, czy chcą umożliwić komunikację strony sieci Web z programem Eksplorator Windows. Ustawieniem domyślnym jest zablokowanie komunikacji.  
-   Przed wykonaniem programu pochodzącego spoza intranetu systemy Windows Vista i Windows Server 2008 wyświetlą okno dialogowe z ostrzeżeniem. Ostrzeżenie to nie zostanie wyświetlone, jeśli osoba atakująca próbuje odwołać się do pliku wykonywalnego w intranecie lub na komputerze docelowym.
  
#### Obejścia problemu wynikającego z luki w zabezpieczeniach Usługi wyszukiwania systemu Windows związanej z analizowaniem — CVE-2008-4269
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Wyłączenie procedury obsługi protokołu search-ms w programie Eksplorator Windows**  
    ...
    **Stosowanie metody interakcyjnej**
    ...
    1.  Kliknij przycisk **Start**, kliknij polecenie **Uruchom**, w polu Otwórz wpisz „regedit” (bez cudzysłowów), a następnie kliknij przycisk **OK**.  
    2.  Odszukaj i rozwiń następujący podklucz rejestru:  
    3.  **HKEY\_CLASSES\_ROOT\\search-ms\\shell\\open**.  
    4.  Kliknij **Polecenie**.  
    5.  Kliknij menu **Plik** i wybierz polecenie **Eksportuj**.  
    6.  W oknie dialogowym Eksportuj plik rejestru wprowadź nazwę „Search-ms\_pluggable\_protocol\_registry\_backup.reg” i kliknij przycisk **Zapisz**.  
    7.  Edytuj wartość rejestru (Default), klikając ja dwukrotnie. Usuń wszystkie dane z pola Dane wartości: .  
    8.  Kliknij **OK**.
  
    **Stosowanie skryptu wdrażania zarządzanego**
  
    1.  Utwórz kopię zapasową kluczy rejestru, korzystając ze skryptu wdrażania zarządzanego zawierającego następujące polecenie:  
        regedit /e Search-ms\_pluggable\_protocol\_registry\_backup.reg HKEY\_CLASSES\_ROOT\\search-ms\\shell\\open\\command.  
    2.  Następnie zapisz w pliku z rozszerzeniem reg, na przykład  
    ...
    **Wpływ obejścia.**
    ...
    Strony sieci Web nie będą mogły uruchamiać wyszukiwania systemu Windows.
    ...
    **Cofnięcie obejścia.**
    ...
    1.  Kliknij przycisk **Start**, kliknij polecenie **Uruchom**, wpisz polecenie **regedit** w polu Otwórz, a następnie kliknij przycisk **OK.**  
    2.  Kliknij menu Plik i wybierz polecenie Importuj.  
    3.  W oknie dialogowym Importuj plik rejestru wybierz plik „Search-ms\_pluggable\_protocol\_registry\_backup.reg” i kliknij polecenie **Otwórz**.
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach Usługi wyszukiwania systemu Windows związanej z analizowaniem — CVE-2008-4269
  
**Jaki zakres obejmuje ta luka?**      
Jest to luka umożliwiająca zdalne wykonanie kodu. Jeśli użytkownik jest zalogowany jako administrator, osoba atakująca, która pomyślnie wykorzysta tę lukę, może uzyskać pełną kontrolę nad systemem, którego ta luka dotyczy. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami. Użytkownicy, których konta zostały skonfigurowane w taki sposób, że mają niewielkie uprawnienia w systemie, ponoszą mniejsze ryzyko niż ci, którzy pracują z uprawnieniami administracyjnymi.
  
**W jaki sposób powstaje luka?**      
Podczas analizowania protokołu search-ms program Eksplorator Windows nie przeprowadza prawidłowej interpretacji parametrów.
  
**Co to jest protokół search-ms?**      
Protokół aplikacji search-ms to konwencja zapytań do indeksu Usługi wyszukiwania systemu Windows. Umożliwia on aplikacjom, np. programowi Eksplorator Windows, zadawanie zapytań do indeksu przy użyciu argumentów parametr-wartość, w tym argumentów dotyczących właściwości, poprzednio zapisanych wyników wyszukiwania, zaawansowanej składni kwerendy, naturalnej składni kwerendy oraz identyfikatorów kodu języka (LCID), zarówno w odniesieniu do indeksatora, jak i samego zapytania. Więcej informacji znajduje się w następującym [artykule MSDN](http://msdn.microsoft.com/en-us/library/bb266520(vs.85).aspx).
...
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**      
Osoba atakująca może udostępnić specjalnie spreparowaną witrynę sieci Web, zaprojektowaną w celu wykorzystania luki w zabezpieczeniach, a następnie nakłonić użytkownika do odwiedzenia takiej witryny. Osoba ta może również wykorzystywać witryny sieci Web, które akceptują lub udostępniają treści lub reklamy wprowadzone przez użytkownika. Witryny te mogą zawierać specjalnie spreparowane treści, które mogą wykorzystywać omawianą lukę w zabezpieczeniach. Jednakże w żadnym przypadku osoba atakująca nie może zmusić użytkowników do odwiedzenia takich witryn. Musi natomiast przekonać użytkowników do odwiedzenia tej witryny, najczęściej zachęcając do kliknięcia łącza w wiadomości e-mail lub wiadomości błyskawicznej, które przekieruje użytkowników do witryny osoby atakującej.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**      
Szczególnie narażone są stacje robocze i serwery terminalowe. Zagrożenie serwerów może być większe, jeśli administratorzy zezwolą użytkownikom na logowanie do tych serwerów i uruchamianie programów. Jednak zestawy najlepszych praktyk zdecydowanie to odradzają.
  
**W jaki sposób działa aktualizacja?**      
Aktualizacja zabezpieczeń usuwa lukę, zmieniając sposób interpretacji parametrów w programie Eksplorator Windows podczas analizowania protokołu search-ms.
...
<br />
Wszystkie obsługiwane 32-bitowe wersje systemu Windows Vista:<br />
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/959349">artykuł 959349 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="odd">
...
Windows6.0-KB958623-x86 /quiet<br />
<br />
Wszystkie obsługiwane wersje 32-bitowe systemu Windows Server 2008:<br />
Windows6.0-KB958624-x86 /quiet<br />
<br />
...
-   Andre Protas z firmy [eEye Digital Security](http://www.eeye.com/), za zgłoszenie luki w zabezpieczeniach systemu Windows związanej z zapisanymi wynikami wyszukiwania — (CVE-2008-4268)  
-   Nate McFeters, za zgłoszenie luki w zabezpieczeniach Usługi wyszukiwania systemu Windows związanej z analizowaniem (CVE-2008-4269)
...
-   V1.1 (10 grudnia 2008 r.): Poprawiono klucz rejestru w sekcji **Obejścia problemu wynikającego z luki w zabezpieczeniach Usługi wyszukiwania systemu Windows związanej z analizowaniem — CVE-2008-4269**.
