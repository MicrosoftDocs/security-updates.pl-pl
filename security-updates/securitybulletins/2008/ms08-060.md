---
TOCTitle: 'MS08-060'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS08-060 - Krytyczna'
ms:assetid: 'ms08-060'
ms:contentKeyID: 61232701
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms08-060(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS08-060 - Krytyczna
==========================================================

Luka w zabezpieczeniach usługi Active Directory umożliwia zdalne wykonanie kodu (957280)
----------------------------------------------------------------------------------------
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla wdrożeń usługi Active Directory w systemie Microsoft Windows 2000 Server. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa lukę, zapewniając prawidłową alokację zasobów pamięci dla zapytań LDAP klienta. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
|----------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|-----------------------------------------------------------|
| Microsoft Windows 2000 Server z dodatkiem Service Pack 4 | [Active Directory](http://www.microsoft.com/downloads/details.aspx?familyid=8ed7bb9a-4b26-49d7-8c14-60226d2bc20d) | Zdalne wykonanie kodu              | Krytyczny                  | [MS08-035](http://go.microsoft.com/fwlink/?linkid=111953) |
...
Szczegółowe informacje dotyczące plików znajdują się w [artykule 957280 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/957280).
...
Aktualizacja oferowana będzie wyłącznie dla systemów, w których dotknięty przez lukę jest zarówno zainstalowany, jak i włączony. Komputery z systemem Microsoft Windows 2000 Server, które nie są skonfigurowane jako kontrolery domeny, nie są zagrożone przez lukę i nie będzie dla nich proponowana instalacja niniejszej aktualizacji.
  
**Czy omawiany problem dotyczy także programu ADAM (Active Directory Application Mode) lub usługi AD LDS (Active Directory Lightweight Directory Service)?**      
Nie. Problem dotyczy tylko serwerów z systemem Microsoft Windows 2000 skonfigurowanych jako kontrolery domeny Active Directory. Omawiana luka nie dotyczy innych platform ani usług.
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach usługi Active Directory związana z przepełnieniem — CVE-2008-4023</th>
...
Luka w zabezpieczeniach usługi Active Directory związana z przepełnieniem — CVE-2008-4023  
-----------------------------------------------------------------------------------------
  
We wdrożeniach usługi Active Directory w systemie Microsoft Windows 2000 Server występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu. Przyczyną jej występowania jest nieprawidłowa alokacja pamięci w przypadku odebrania specjalnie spreparowanego zapytania LDAP lub LDAPS. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-4023](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4023).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach usługi Active Directory związanej z przepełnieniem — CVE-2008-4023
...
-   Luka ta dotyczy wyłącznie serwerów pracujących pod nadzorem systemu Microsoft Windows 2000 skonfigurowanych jako kontrolery domen. Jeśli serwer z systemem Microsoft Windows 2000 nie funkcjonuje jako kontroler domeny, nie będzie nasłuchiwać zapytań LDAP ani LDAPS i nie będzie zagrożony przez omawianą lukę.  
    Aby stwierdzić, czy serwer nasłuchuje zapytań LDAP lub LDAPS, uruchom następujące polecenie z wiersza polecenia administratora i sprawdź, czy ma miejsce nasłuchiwanie na porcie LDAP (389) lub LDAPS (636):
  
    `netstat –a`
  
    Wyniki zawierające następujące elementy oznaczają, że protokół LDAP jest włączony:
  
    `Proto Local Address Foreign Address StateTCP 0.0.0.0:389 0.0.0.0:0 LISTENINGTCP 0.0.0.0:636 0.0.0.0:0 LISTENING`
  
#### Obejścia problemu wynikającego z luki w zabezpieczeniach usługi Active Directory związanej z przepełnieniem — CVE-2008-4023
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Zablokowanie portów TCP 389 i 636 na zaporze zewnętrznej**  
...
#### Często zadawane pytania dotyczące luki w zabezpieczeniach usługi Active Directory związanej z przepełnieniem — CVE-2008-4023
...
**Uwaga.** Ataki z próbami wykorzystania tej luki mogłyby także skończyć się sytuacją typu „odmowa usługi”. Osoba atakująca może także wykorzystać lukę, aby wymusić ponowne uruchomienie systemu. Jednakże ze względu na możliwość zdalnego wykonania kodu ogólny zakres obejmowany przez lukę wykracza poza sytuację typu „odmowa usługi”.
  
**W jaki sposób powstaje luka?**      
Usługa LDAP nieprawidłowo przydziela pamięć dla specjalnie spreparowanych żądań LDAP.
...
**Co to jest LDAP?**      
[LDAP](http://msdn2.microsoft.com/en-us/library/aa503238.aspx) (Lightweight Directory Access Protocol) to otwarty standard protokołu internetowego opracowany z myślą o zapewnianiu dostępu do rozproszonych katalogów.
  
**Co to jest LDAP over SSL?**      
Domyślnie ruch LDAP jest przesyłany w postaci niezabezpieczonej. Możliwe jest jednak utajnienie i zabezpieczenie ruchu LDAP poprzez użycie technologii Secure Sockets Layer (SSL)/Transport Layer Security (TLS). Administratorzy mogą włączyć protokół LDAPS (LDAP over SSL), instalując odpowiednio sformatowany certyfikat od urzędu certyfikacji firmy Microsoft lub innego urzędu certyfikacji, postępując zgodnie ze wskazówkami zawartymi w [artykule 321051 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/321051/en-us).
...
Osoba atakująca może próbować wykorzystać tę lukę, wysyłając specjalnie spreparowany pakiet LDAP do kontrolera domeny z systemem Microsoft Windows 2000. Tę lukę może wykorzystać każdy użytkownik anonimowy mający dostęp do sieci docelowej, wysyłając specjalnie spreparowany pakiet sieciowy do systemu, którego dotyczy luka.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**      
Usługa Active Directory wymaga protokołu LDAP. Luka istnieje w każdym systemie Windows 2000 Server, w którym jest zainstalowana usługa Active Directory Server.
  
**W jaki sposób działa aktualizacja?**      
Aktualizacja usuwa lukę, zapewniając prawidłową alokację zasobów pamięci dla specjalnie spreparowanych zapytań LDAP klienta.
...
<td style="border:1px solid black;">Microsoft Windows 2000 z dodatkiem Service Pack 4:<br />
Użyj narzędzia Dodaj lub usuń programy w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB957280$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/957280">artykuł 957280 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
-   Paul Miseiko z firmy [nCircle](http://www.ncircle.com/), za zgłoszenie luki w zabezpieczeniach usługi Active Directory związanej z przepełnieniem (CVE-2008-4023)
...
-   Wersja 1.1 (15 października 2008 r.): Zaktualizowano tabelę „Programy, których nie dotyczy problem”.
