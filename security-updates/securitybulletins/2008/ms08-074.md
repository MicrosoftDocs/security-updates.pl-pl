---
TOCTitle: 'MS08-074'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS08-074 - Krytyczna'
ms:assetid: 'ms08-074'
ms:contentKeyID: 61232715
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms08-074(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS08-074 - Krytyczna
==========================================================

Luki w zabezpieczeniach programu Microsoft Office Excel umożliwiają zdalne wykonanie kodu (959070)
--------------------------------------------------------------------------------------------------

Opublikowano: 9 grudnia 2008 | Zaktualizowano: 28 stycznia 2009
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „krytyczny” dla wszystkich obsługiwanych wersji programu Microsoft Office Excel 2000. Dla wszystkich obsługiwanych wersji programów Microsoft Office Excel 2002, Microsoft Office Excel 2003, Przeglądarka programu Microsoft Office Excel 2003, Microsoft Office Excel 2007, Pakiet zgodności formatu plików pakietu Microsoft Office, Przeglądarka programu Microsoft Office Excel, pakietu Microsoft Office 2004 dla komputerów Macintosh, pakietu Microsoft Office 2008 dla komputerów Macintosh oraz programu Open XML File Format Converter dla komputerów Macintosh, ta aktualizacja zabezpieczeń ma wskaźnik ważności „ważny”. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.
...
**Znane problemy.** W [artykule 959070 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/959070) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Przeglądarka programu Microsoft Office Excel 2003](http://www.microsoft.com/downloads/details.aspx?familyid=4b3989ef-02b8-4bd2-b2ab-c3716079936e)  
(KB958434)
</td>
<td style="border:1px solid black;">
Nie dotyczy 
...
<tr>
<td style="border:1px solid black;">
[Pakiet zgodności dla Microsoft Office dla formatów plików programów Word, Excel i PowerPoint 2007](http://www.microsoft.com/downloads/details.aspx?familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f)  
(KB958439)
</td>
<td style="border:1px solid black;">
Nie dotyczy 
...
**Dlaczego niniejszy biuletyn zabezpieczeń został poprawiony w dniu 28 stycznia 2009?**    
Firma Microsoft poprawiła niniejszy biuletyn w celu przekazania, że aby uchronić się przed działaniem opisanych w nim luk, w przypadku obsługiwanych wersji programu Microsoft Office Excel 2007 poza pakietem aktualizacji zabezpieczeń KB958437 klienci muszą zainstalować także aktualizację zabezpieczeń [Pakietu zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007](http://www.microsoft.com/downloads/details.aspx?familyid=99cca4ed-f1f9-4cfd-a986-edbec82ced4f) (KB958439). Klienci, którzy wcześniej pomyślnie zainstalowali pakiety aktualizacji zabezpieczeń KB958437 i KB958439, nie muszą instalować ich ponownie.

**Dlaczego aktualizacja KB958439 jest wymagana dla programu Excel 2007?**    
Obsługiwane wersje programu Microsoft Office Excel 2007 zawierają zagrożony składnik Excel Converter, który jest aktualizowany przez aktualizację dla Pakietu zgodności formatu plików pakietu Microsoft Office dla programów Word, Excel i PowerPoint 2007 (KB958439). Aktualizacja dla programów Microsoft Office Excel 2007 i Microsoft Office Excel 2007 z dodatkiem Service Pack 1 (KB958437) nie powoduje zaktualizowania składnika Excel Converter.

**Gdzie znajdują się szczegółowe informacje dotyczące plików?**    
Szczegółowe informacje dotyczące plików znajdują się w [artykule 959070 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/959070).

**W biuletynie MS08-072 opisano także luki w zabezpieczeniach pakietu Microsoft Office 2004 dla komputerów Macintosh, pakietu Microsoft Office 2008 dla komputerów Macintosh oraz programu Open XML File Format Converter dla komputerów Macintosh. Jaki jest związek biuletynu MS08-072 z niniejszym biuletynem (MS08-074)?**    
Niniejsza aktualizacja zabezpieczeń dla programów Microsoft Office 2004 dla komputerów Macintosh (960402), Microsoft Office 2008 dla komputerów Macintosh (960401) i Open XML File Format Converter dla komputerów Macintosh (960403) usuwa także luki opisane w biuletynie MS08-072. Użytkownicy programów Microsoft Office 2004 dla komputerów Macintosh, Microsoft Office 2008 dla komputerów Macintosh i Open XML File Format Converter dla komputerów Macintosh będą musieli zainstalować tę aktualizację zabezpieczeń, ale wystarczy jednorazowa instalacja.
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z analizowaniem formatu pliku — CVE-2008-4265</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z analizowaniem formatu pliku — CVE-2008-4264</th>
<th style="border:1px solid black;" >Luka w zabezpieczeniach programu Excel związana z uszkodzeniem pamięci tablicy globalnej — CVE-2008-4266</th>
...
Luka w zabezpieczeniach związana z analizowaniem formatu pliku — CVE-2008-4265  
------------------------------------------------------------------------------
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-4265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4265).
  
#### Czynniki ograniczające zagrożenie wynikające z luki związanej z analizowaniem formatu pliku — CVE-2008-4265
...
#### Obejścia problemu wynikającego z luki związanej z analizowaniem formatu pliku — CVE-2008-4265
...
#### Często zadawane pytania dotyczące luki związanej z analizowaniem formatu pliku — CVE-2008-4265
...
W programie Microsoft Office Excel istnieje luka umożliwiająca osobie atakującej wykonanie kodu, kiedy użytkownik wersji programu Excel, której dotyczy luka, otworzy specjalnie spreparowany, dostarczony przez tę osobę plik arkusza kalkulacyjnego programu Excel. Luka wynika ze sposobu, w jaki w programie Microsoft Office Excel jest analizowany format pliku arkusza kalkulacyjnego programu Excel.
...
Niniejsza aktualizacja eliminuje lukę, zmieniając sposób, w jaki program Microsoft Office Excel obsługuje otwieranie specjalnie spreparowanych plików Excel
...
Luka w zabezpieczeniach związana z analizowaniem formatu pliku — CVE-2008-4264  
------------------------------------------------------------------------------
...
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-4264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4264).
  
#### Czynniki ograniczające zagrożenie wynikające z luki związanej z analizowaniem formatu pliku — CVE-2008-4264
...
#### Obejścia problemu wynikającego z luki związanej z analizowaniem formatu pliku — CVE-2008-4264
...
#### Często zadawane pytania dotyczące luki związanej z analizowaniem formatu pliku — CVE-2008-4264
...
Luka w zabezpieczeniach programu Excel związana z uszkodzeniem pamięci tablicy globalnej — CVE-2008-4266  
--------------------------------------------------------------------------------------------------------
  
W programie Microsoft Office Excel występuje luka w zabezpieczeniach umożliwiająca zdalne wykonanie kodu, będąca wynikiem uszkodzenia stosu podczas ładowania rekordów programu Excel. Luka ta umożliwia zdalne wykonanie kodu, jeśli użytkownik otworzy specjalnie spreparowany plik programu Excel zawierający nieprawidłowy obiekt. Osoba atakująca, której uda się wykorzystać tę lukę, może uzyskać pełną kontrolę nad systemem, którego dotyczy luka. Osoba taka może wówczas instalować programy, przeglądać, zmieniać i usuwać dane oraz tworzyć nowe konta z pełnymi uprawnieniami.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2008-4266](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4266).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci tablicy globalnej — CVE-2008-4266
...
#### Obejścia problemu związanego z luką w zabezpieczeniach programu Excel związaną z uszkodzeniem pamięci tablicy globalnej — CVE-2008-4266
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   Nie należy otwierać ani zapisywać plików pakietu Microsoft Office otrzymanych z niezaufanych źródeł albo otrzymanych niespodziewanie ze źródeł zaufanych. Niniejsza luka może zostać wykorzystana, jeśli użytkownik otworzy specjalnie spreparowany plik.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci tablicy globalnej — CVE-2008-4266
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/959070">artykuł 959070 bazy wiedzy Microsoft Knowledge Base</a>.</td>
</tr>
<tr class="even">
...
-   Joshua J. Drake z firmy [VeriSign iDefense Labs](http://labs.idefense.com/), za zgłoszenie luki w zabezpieczeniach związanej z analizowaniem formatu pliku (CVE-2008-4265)  
-   Claes M Nyberg z firmy [signedness.org](http://www.signedness.org/), za zgłoszenie luki w zabezpieczeniach związanej z analizowaniem formatu pliku (CVE-2008-4264)  
-   Dyon Balding z firmy [Secunia](http://secunia.com/), za zgłoszenie luki w zabezpieczeniach programu Excel związanej z uszkodzeniem pamięci tablicy globalnej (CVE-2008-4266)
...
-   Wersja 2.0 (28 stycznia 2009 r.): Do tabeli **Programy, których dotyczy problem** oraz do dwóch wpisów w sekcji **Często zadawane pytania dotyczące tej aktualizacji zabezpieczeń** dodano przypis dolny odnoszący się do aktualizacji zabezpieczeń KB958437 i KB958439 dla obsługiwanych wersji programu Microsoft Office Excel 2007. Nie wprowadzono żadnych zmian do plików binarnych ani logiki wykrywania aktualizacji zabezpieczeń. Klienci posiadający program Microsoft Office Excel 2007 lub Microsoft Office Excel 2007 z dodatkiem Service Pack 1, którzy zainstalowali już pomyślnie aktualizacje KB958437 i KB958439, nie muszą instalować ich ponownie.
