---
TOCTitle: 'MS12-001'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS12-001 - Ważna'
ms:assetid: 'ms12-001'
ms:contentKeyID: 61233000
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms12-001(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS12-001 - Ważna
======================================================

Luka w zabezpieczeniach jądra systemu Windows może pozwolić na obejście funkcji zabezpieczeń (2644615)
------------------------------------------------------------------------------------------------------

Opublikowano: 10 stycznia 2012 | Zaktualizowano: 22 lutego 2012
...
Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla obsługiwanych wersji x64 systemu Windows XP oraz wszystkich obsługiwanych wersji systemów Windows Server 2003, Windows Vista, Windows Server 2008, Windows 7 i Windows Server 2008 R2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki jądro systemu Windows ładuje strukturalne tablice obsługi wyjątków. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2644615 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2644615) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------|----------------------------|----------------------------------------------------|
| [Windows XP Professional x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                                                                       | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                                                                       | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Server 2003 x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                                                           | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                                                                | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Vista z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                                                             | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Vista x64 Edition z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                                                                 | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów 32-bitowych z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                                                            | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Server 2008 dla systemów z procesorem x64 z dodatkiem Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                                                       | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Server 2008 z dodatkiem Service Pack 2 dla systemów z procesorem Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                                                     | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows 7 dla systemów 32-bitowych i Windows 7 z dodatkiem Service Pack 1 dla systemów 32-bitowych](http://www.microsoft.com/downloads/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                                                   | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows 7 dla systemów opartych na procesorach x64 i Windows 7 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64](http://www.microsoft.com/downloads/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
| [Windows Server 2008 R2 dla systemów opartych na procesorach Itanium i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach Itanium](http://www.microsoft.com/downloads/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | Obejście funkcji zabezpieczeń      | Ważny                      | Brak                                               |
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach związana z obejściem funkcji SafeSEH jądra systemu Windows — CVE-2012-0001</th>
...
Luka w zabezpieczeniach związana z obejściem funkcji SafeSEH jądra systemu Windows — CVE-2012-0001  
--------------------------------------------------------------------------------------------------
  
W zabezpieczeniach systemu Windows występuje luka związana z obejściem funkcji zabezpieczeń, wynikająca ze sposobu, w jaki jądro ładuje strukturalne tablice obsługi wyjątków. Osoba atakująca, której uda się wykorzystać tę lukę, może obejść kompleksowy mechanizm zabezpieczeń SafeSEH, aby ułatwić sobie wykorzystanie innych luk w zabezpieczeniach.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2012-0001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001).
  
#### Czynniki ograniczające zagrożenie wynikające z luki w zabezpieczeniach związanej z obejściem funkcji SafeSEH jądra systemu Windows — CVE-2012-0001
  
Ograniczenie sprowadza się do odpowiedniego ustawienia, typowej konfiguracji lub najważniejszej wskazówki ogólnej, które istnieją w stanie domyślnym i mogą zmniejszyć zagrożenie wykorzystaniem omawianej luki w zabezpieczeniach. W tej sytuacji pomocne mogą być następujące czynniki ograniczające zagrożenie:
  
-   Omawiana luka może zostać wykorzystana tylko przy użyciu aplikacji skompilowanych przy użyciu oprogramowania Microsoft Visual C++ .NET 2003.
  
    **Uwaga** Informacje pomocne w określaniu, jakiego produktu użyto do skompilowania danej aplikacji, można znaleźć w [artykule 2644615 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2644615).
  
#### Obejścia problemu spowodowanego przez lukę w zabezpieczeniach związaną z obejściem funkcji SafeSEH jądra systemu Windows — CVE-2012-0001
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Ponowna kompilacja aplikacji za pomocą nowszej wersji oprogramowania Microsoft Visual C++**  
  
    Omawiana luka może zostać wykorzystana tylko przy użyciu aplikacji skompilowanych przy użyciu oprogramowania Microsoft Visual C++ .NET 2003. W celu obejścia omawianego problemu należy dokonać ponownej kompilacji modelu przy użyciu oprogramowania Microsoft Visual C++ 2005, Microsoft Visual C++ 2008 lub Microsoft Visual C++ 2010.
  
-   **Włączenie funkcji SEHOP (Structured Exception Handling Overwrite Protection)**  
  
    Użytkownicy systemów Windows Vista, Windows 7, Windows Server 2008 i Windows Server 2008 R2 powinni zapoznać się z artykułem [Jak włączyć funkcję ochrony przed zastępowaniem strukturalnej obsługi wyjątków (SEHOP, Structured Exception Handling Overwrite Protection) w systemach operacyjnych Windows](http://support.microsoft.com/kb/956607), aby uzyskać wskazówki dotyczące włączania funkcji SEHOP dla istniejących aplikacji.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach związanej z obejściem funkcji SafeSEH jądra systemu Windows — CVE-2012-0001
  
**Jaki zakres obejmuje ta luka?**  
Jest to luka związana z obejściem funkcji zabezpieczeń. Osoba atakująca, której uda się wykorzystać tę lukę, może obejść funkcję zabezpieczeń SafeSEH, aby ułatwić sobie wykorzystanie innych luk.
  
**W jaki sposób powstaje luka?**  
Luka powstaje, gdy podczas wykonywania pliku binarnego jądro systemu Windows ładuje strukturalną tablicę obsługi wyjątków do nagłówka PE „Load Configuration”.
...
Składnikiem zagrożonym przez lukę jest biblioteka Ntdll.dll.
  
**Jakie mogą być skutki wykorzystania tej luki przez osobę atakującą?**  
Osoba atakująca, której uda się wykorzystać tę lukę, może obejść funkcję zabezpieczeń SafeSEH w aplikacji. Osoba atakująca może następnie użyć innych luk, aby wykorzystać strukturalną procedurę obsługi wyjątków do uruchomienia dowolnego kodu.
  
**W jaki sposób osoba atakująca może wykorzystać tę lukę?**  
Aby wykorzystać tę lukę do wykonania dowolnego kodu, osoba atakująca musi najpierw obejść funkcję zabezpieczeń SafeSEH, a następnie dzięki temu wykorzystać inną lukę, która umożliwi wykonanie dowolnego kodu.
  
**Co to jest strukturalna procedura obsługi wyjątków?**  
Strukturalna procedura obsługi wyjątków (SEH, Structured Exception Handler) to mechanizm pozwalający aplikacjom na obsługę wyjątków sprzętowych i programowych. Procedura SEH umożliwia programistom pełną kontrolę nad obsługą wyjątków, zapewnia pomoc osobom usuwającym błędy aplikacji i może być stosowana w połączeniu z wszystkimi językami programowania i typami komputerów.
  
**Co to jest SafeSEH?**  
SafeSEH to funkcja zabezpieczeń chroniąca procedurę SEH przed uszkodzeniem lub przejęciem nad nią kontroli w przypadku, gdy dojdzie do przepełnienia buforu.
  
**Jakie systemy są szczególnie narażone na skutki tej luki?**  
Na niekorzystne skutki tej luki potencjalnie narażone są stacje robocze i serwery.
  
**W jaki sposób działa aktualizacja?**  
Aktualizacja usuwa lukę w zabezpieczeniach, modyfikując sposób, w jaki jądro systemu Windows ładuje strukturalne tablice obsługi wyjątków.
...
<td style="border:1px solid black;">Użyj pozycji <strong>Dodaj lub usuń programy</strong> w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\$NTUninstallKB2644615$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>Informacje dotyczące plików</strong></td>
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2644615">artykuł 2644615 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
Użyj pozycji **Dodaj lub usuń programy** w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\\$NTUninstallKB2644615$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zobacz [artykuł 2644615 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2644615)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Joshua J. Drake z firmy [Accuvant LABS](http://www.accuvant.com/), za zgłoszenie luki w zabezpieczeniach związanej z obejściem funkcji SafeSEH jądra systemu Windows (CVE-2012-0001)
...
-   Wersja 1.1 (22 lutego 2012 r.): W części „Znane problemy” sekcji „Streszczenie” dodano łącze do artykułu 2644615 bazy wiedzy Microsoft Knowledge Base.
