---
TOCTitle: 'MS12-017'
Title: 'Biuletyn zabezpieczeń firmy Microsoft MS12-017 - Ważna'
ms:assetid: 'ms12-017'
ms:contentKeyID: 61233016
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/ms12-017(v=Security.10)'
---

Biuletyn zabezpieczeń firmy Microsoft MS12-017 - Ważna
======================================================

Luka w zabezpieczeniach serwera DNS umożliwia przeprowadzenie ataku typu „odmowa usługi” (2647170)
--------------------------------------------------------------------------------------------------

Opublikowano: 13 marca 2012 | Zaktualizowano: 18 kwietnia 2012
...
Ta aktualizacja zabezpieczeń usuwa lukę w zabezpieczeniach systemu Microsoft Windows. Luka w zabezpieczeniach umożliwia przeprowadzenie ataku typu „odmowa usługi”, jeśli nieuwierzytelniona osoba atakująca zdalnie wyśle specjalnie spreparowaną kwerendę DNS do atakowanego serwera DNS.

Niniejsza aktualizacja zabezpieczeń ma wskaźnik ważności „ważny” dla wszystkich obsługiwanych wersji systemu Windows Server 2003, wersji 32-bitowych i x64 systemu Windows Server 2008 oraz wersji x64 systemu Windows Server 2008 R2. Więcej informacji można znaleźć w podsekcji **Programy, których dotyczy problem i programy, których nie dotyczy problem** niniejszej sekcji.

Aktualizacja zabezpieczeń usuwa lukę, modyfikując sposób, w jaki serwer DNS obsługuje obiekty w pamięci. Więcej informacji na temat luki można znaleźć w podsekcji „Często zadawane pytania” w części poświęconej tej luce w następnej sekcji, **Informacje o luce w zabezpieczeniach**.
...
**Znane problemy.** W [artykule 2647170 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2647170) udokumentowano znane obecnie problemy, które mogą wystąpić przy instalacji niniejszej aktualizacji zabezpieczeń. Artykuł ten przedstawia również zalecane obejścia tych problemów.
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=b04da098-666f-4760-90da-d2a17e78bf47">Windows Server 2003 z dodatkiem Service Pack 2</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=647eaf09-3959-439e-8418-fd25221eb6b9">Windows Server 2003 x64 Edition z dodatkiem Service Pack 2</a></td>
<td style="border:1px solid black;">Odmowa usługi</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=238474">MS12-009</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=92f3af60-9a9b-4419-9e95-55f5cb54cf00">Windows Server 2003 z dodatkiem SP2 dla systemów z procesorem Itanium</a></td>
<td style="border:1px solid black;">Odmowa usługi</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a>,<br />
<a href="http://go.microsoft.com/fwlink/?linkid=238474">MS12-009</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=233c62b7-f2b1-49ce-9a7f-e51435be0d26">Windows Server 2008 dla systemów 32-bitowych z dodatkiem Service Pack 2</a>*</td>
<td style="border:1px solid black;">Odmowa usługi</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=56eae770-5990-4e1b-8b48-3d0602fcc72b">Windows Server 2008 dla systemów z procesorem x64 z dodatkiem Service Pack 2</a>*</td>
<td style="border:1px solid black;">Odmowa usługi</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=19a4f3d1-24d2-41af-a41a-e5cc2c6232e8">Windows Server 2008 R2 dla systemów opartych na procesorach x64 i Windows Server 2008 R2 z dodatkiem Service Pack 1 dla systemów opartych na procesorach x64</a>*</td>
<td style="border:1px solid black;">Odmowa usługi</td>
<td style="border:1px solid black;">Ważny</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=221812">MS11-058</a></td>
</tr>
...
Aktualizacja może być zainstalowana wyłącznie wówczas, gdy w systemach operacyjnych wymienionych w tabeli „Programy, których dotyczy problem” włączona jest usługa DNS. Domyślnie w systemach tych usługa DNS jest wyłączona, więc propozycja aktualizacji nie jest wyświetlana bez jej uprzedniego włączenia.
...
<th style="border:1px solid black;" >Luka w zabezpieczeniach DNS umożliwiająca atak typu „odmowa usługi” — CVE-2012-0006</th>
<th style="border:1px solid black;" >Zbiorczy wskaźnik ważności</th>
</tr>
</thead>
<tbody>
...
Luka w zabezpieczeniach DNS umożliwiająca atak typu „odmowa usługi” — CVE-2012-0006  
-----------------------------------------------------------------------------------
  
Luka w zabezpieczeniach powstaje, kiedy serwer DNS nieprawidłowo obsługuje w pamięci obiekty podczas sprawdzania rekordu zasobów domeny. Osoba atakująca, której udałoby się skutecznie wykorzystać tę lukę, mogłaby doprowadzić do tego, że serwer DNS na zaatakowanym komputerze przestałby odpowiadać i automatycznie uruchomiłby się ponownie.
  
Aby wyświetlić tę lukę w zabezpieczeniach jako standardową pozycję na liście znanych luk i zagrożeń, zobacz [CVE-2012-0006](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006).
  
#### Czynniki ograniczające zagrożenie związane z luką w zabezpieczeniach DNS umożliwiającą atak typu „odmowa usługi” — CVE-2012-0006
  
Firma Microsoft nie znalazła dla tej luki żadnych czynników ograniczających zagrożenie.
  
#### Obejścia problemu związanego z luką w zabezpieczeniach DNS umożliwiającą atak typu „odmowa usługi” — CVE-2012-0006
  
Obejście oznacza wprowadzenie zmiany ustawienia lub konfiguracji, która nie powoduje wyeliminowania samej luki, lecz może pomóc w zablokowaniu znanych kierunków ataku przed zastosowaniem aktualizacji Firma Microsoft przetestowała następujące obejścia i przedstawią swoją opinię w kwestii ograniczania przez nie funkcjonalności:
  
-   **Okresowe czyszczenie pamięci podręcznej DNS**  
  
    Uruchom polecenie dnscmd w sposób opisany w artykule [Składnia polecenia Dnscmd](http://technet.microsoft.com/en-us/library/cc756116(v=ws.10).aspx):
  
    ```
  
    dnscmd [nazwa_serwera] /clearcache
  
    ```
  
    Polecenie może być uruchamiane zgodnie z harmonogramem lub tak często, jak jest to wymagane.
  
    **Wpływ obejścia.** Usuwa rekordy zasobów z pamięci podręcznej DNS określonego serwera DNS.
  
    **Cofnięcie obejścia.**
  
    Usuń lub wyłącz zadania w harmonogramie, w ramach których uruchamiane jest polecenie dnscmd.
  
#### Często zadawane pytania dotyczące luki w zabezpieczeniach DNS umożliwiającej atak typu „odmowa usługi” — CVE-2012-0006
  
**Jaki zakres obejmuje ta luka?**  
Ta luka powoduje awarię typu odmowa usługi.
  
**W jaki sposób powstaje luka?**  
Luka w zabezpieczeniach powstaje, kiedy serwer DNS nieprawidłowo obsługuje w pamięci obiekty, sprawdzając jednocześnie rekord zasobów.
...
Nieuwierzytelniona osoba atakująca może zdalnie wykorzystać tę lukę, wysyłając do zagrożonego serwera DNS specjalnie spreparowaną kwerendę DNS.
...
Aktualizacja usuwa lukę, modyfikując sposób, w jaki serwer DNS obsługuje obiekty w pamięci.
...
<td style="border:1px solid black;" colspan="2">
Użyj pozycji **Dodaj lub usuń programy** w Panelu sterowania lub narzędzia Spuninst.exe, które znajduje się w folderze %Windir%\\$NTUninstallKB2647170$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
Zobacz [artykuł 2647170 bazy wiedzy Microsoft Knowledge Base](http://support.microsoft.com/kb/2647170)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">Zobacz <a href="http://support.microsoft.com/kb/2647170">artykuł 2647170 bazy wiedzy Microsoft Knowledge Base</a></td>
</tr>
<tr class="odd">
...
-   Wersja 1.1 (18 kwietnia 2012 r.): W części „Znane problemy” sekcji „Streszczenie” dodano łącze do artykułu 2647170 bazy wiedzy Microsoft Knowledge Base, poprawiono też sekcję zastępowanych biuletynów dotyczącą systemów Windows Server 2003 z dodatkiem Service Pack 2, Windows Server 2003 x64 Edition z dodatkiem Service Pack 2 oraz Windows Server 2003 z dodatkiem SP2 dla systemów z procesorami Itanium. Zmiana objęła tylko biuletyn. Nie wprowadzono żadnych zmian do wykrywania lub plików aktualizacji zabezpieczeń.
