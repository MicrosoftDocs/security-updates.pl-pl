---
TOCTitle: 981169
Title: Poradnik zabezpieczeń firmy Microsoft 981169
ms:assetid: 981169
ms:contentKeyID: 61232289
ms:mtpsurl: 'https://technet.microsoft.com/pl-PL/library/981169(v=Security.10)'
---

Poradnik zabezpieczeń firmy Microsoft 981169
============================================

Luka w zabezpieczeniach VBScript może umożliwić zdalne wykonanie kodu
---------------------------------------------------------------------

Opublikowano: 1 marca 2010 | Zaktualizowano: 13 kwietnia 2010

Firma Microsoft zakończyła już wstępne badanie publicznego doniesienia dotyczącego tej luki w zabezpieczeniach. Aby rozwiązać ten problem, opublikowano biuletyn zabezpieczeń [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779). Więcej informacji na temat tego problemu oraz łącza pobierania dostępnej aktualizacji zabezpieczeń można znaleźć w biuletynie zabezpieczeń [MS10-022](http://go.microsoft.com/fwlink/?linkid=184779). Opisywaną luką w zabezpieczeniach jest luka w zabezpieczeniach związana z naciśnięciem przycisku pomocy VBScript [CVE-2010-0483](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0483).
...
-   Wer. 1.0 (1 marca 2010 r.): Poradnik opublikowany.  
