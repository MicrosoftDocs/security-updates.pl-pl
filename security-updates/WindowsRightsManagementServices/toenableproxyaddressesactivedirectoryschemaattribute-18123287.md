...
ms:contentKeyID: 18123287
ms:mtpsurl: 'https://technet.microsoft.com/pl-pl/library/Cc720282(v=WS.10)'
---
...
| ![](images/Cc720282.Important(WS.10).gif)Ważne                                                                  |
|----------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720282.note(WS.10).gif)Uwaga                                                                                   |
|----------------------------------------------------------------------------------------------------------------------------------------------------------|
...
2.  Insert the Windows Server 2003 product CD and navigate to Support\\Tools.
    ...
    | ![](images/Cc720282.Caution(WS.10).gif)Przestroga                                                            |
    |-------------------------------------------------------------------------------------------------------------------------------------------|
